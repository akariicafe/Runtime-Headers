@class SWWakingTimer, NSMutableDictionary, NEIPSecSASession, NSObject, NWEndpoint, NEIKEv2Packet, NSMutableArray, NEIKEv2IKESA, NEIKEv2ConfigurationMessage, NSString, NEIKEv2RTT, NEIKEv2IKESAConfiguration, NEIKEv2ChildSAConfiguration;
