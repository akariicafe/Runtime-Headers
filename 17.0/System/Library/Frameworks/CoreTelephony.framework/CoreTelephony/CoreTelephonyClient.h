...
- (void)carrierOneTimeCodeSendersWithCompletion:(id /* block */)a0;
...
- (void)invalidateCrossPlatformPlanTransfer:(id /* block */)a0;
...
- (void)prepareCrossPlatformPlanTransfer:(id)a0 completion:(id /* block */)a1;
