...
+ (void)_setContent:(id)a0 includeAttachments:(BOOL)a1 shouldQuote:(BOOL)a2 prependBlankLine:(BOOL)a3 delegate:(id)a4 signpostID:(unsigned long long)a5;
+ (void)_setContent:(id)a0 includeAttachments:(BOOL)a1 shouldQuote:(BOOL)a2 prependBlankLine:(BOOL)a3 delegate:(id)a4 storeOriginalAttachments:(BOOL)a5 signpostID:(unsigned long long)a6;
...
+ (void)setupWithContent:(id)a0 delegate:(id)a1 signpostID:(unsigned long long)a2;
