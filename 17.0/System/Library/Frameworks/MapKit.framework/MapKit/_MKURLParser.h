@class NSString, NSArray, GEOMuninViewState, MKMapCamera, GEOEnrichmentInfo, GEOURLExtraStorage, GEOMapURLParser, GEOUserSessionEntity, GEOMapRegion, GEOURLCollectionStorage;
