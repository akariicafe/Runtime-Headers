...
@property (class, readonly, nonatomic) UIFont *contactCardStaticHeaderDefaultNameFont;
@property (class, readonly, nonatomic) UIFont *contactCardStaticHeaderDefaultTaglineFont;
@property (class, readonly, nonatomic) UIFont *contactCardStaticHeaderNicknameTaglineFont;
...
+ (id)boldFontWithFontDescriptor:(id)a0;
