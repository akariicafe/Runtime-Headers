@class CNActionMenuHelper, NSArray, NSString, CNContactListActionExecutor, CNContactListActionConfiguration, CNContactOrbActionsController;
...
- (id /* block */)searchMenuActionProviderForContacts:(id)a0;
