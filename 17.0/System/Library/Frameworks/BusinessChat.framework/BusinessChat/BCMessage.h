@class NSUUID, NSString, NSURL, BCMessageInfo, NSData, BCMessageData, BCImageStore, NSDictionary, NSAttributedString, UIImage;
...
- (id)initWithData:(id)a0 url:(id)a1 sessionIdentifier:(id)a2 isFromMe:(BOOL)a3;
