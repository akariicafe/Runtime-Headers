...
+ (id)descriptorWithKernelWidth:(unsigned long long)a0 kernelHeight:(unsigned long long)a1 strideInX:(unsigned long long)a2 strideInY:(unsigned long long)a3 dilationRateInX:(unsigned long long)a4 dilationRateInY:(unsigned long long)a5 dataLayout:(unsigned long long)a6;
+ (id)descriptorWithKernelWidth:(unsigned long long)a0 kernelHeight:(unsigned long long)a1 strideInX:(unsigned long long)a2 strideInY:(unsigned long long)a3 dilationRateInX:(unsigned long long)a4 dilationRateInY:(unsigned long long)a5 paddingLeft:(unsigned long long)a6 paddingRight:(unsigned long long)a7 paddingTop:(unsigned long long)a8 paddingBottom:(unsigned long long)a9 dataLayout:(unsigned long long)a10;
