...
- (id)initWithGraph:(id)a0 inputTensors:(id)a1 controlDependencies:(id)a2 mode:(unsigned long long)a3 nearestRoundingMode:(unsigned long long)a4 centerResult:(BOOL)a5 alignCorners:(BOOL)a6 name:(id)a7;
