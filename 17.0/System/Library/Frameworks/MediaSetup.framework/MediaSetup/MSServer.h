...
- (void)addMediaService:(id)a0 usingSetupBundles:(id)a1 completion:(id /* block */)a2;
...
- (void)getMediaServiceChoicesForSharedUser:(id)a0 completion:(id /* block */)a1;
...
- (void)getSupportedThirdPartyMediaServices:(id /* block */)a0;
