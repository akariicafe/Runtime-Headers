@class NSHashTable, UIView, PKInk, PKTool, PKDrawing, NSString, UIScrollView, UIHoverGestureRecognizer, PKTiledView, PKCanvasAttachmentView, UIGestureRecognizer;
@protocol PKRulerHostingDelegate, PKCanvasViewDelegate, UICoordinateSpace;
...
@property (nonatomic, setter=_setDisableTileRendering:) BOOL _disableTileRendering;
@property (retain, nonatomic, setter=_setContentCoordinateSpace:) id<UICoordinateSpace> _contentCoordinateSpace;
@property (nonatomic, setter=_setDrawBitmapEraserMask:) BOOL _drawBitmapEraserMask;
...
- (BOOL)_canvasViewSnapshottingDisabled:(id)a0;
- (void)_canvasViewWillBeginDrawing:(id)a0;
- (void)_canvasViewWillCreateSnapshot:(id)a0;
- (id)_currentStroke;
...
- (void)canvasView:(id)a0 didChangeHiddenState:(BOOL)a1;
- (void)canvasView:(id)a0 endedStroke:(id)a1 shapeStrokes:(id)a2;
- (BOOL)canvasView:(id)a0 hoverShouldBeActiveAt:(struct CGPoint { double x0; double x1; })a1;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 sixChannelBlend:(BOOL)a1 snapshotView:(id)a2;
- (BOOL)predictionDisabled;
- (BOOL)rulerHostWantsSharedRuler;
- (id)rulerHostingView;
- (struct CGPoint { double x0; double x1; })rulerSnapLineOriginAndNormal:(struct CGPoint { double x0; double x1; } *)a0 topSide:(BOOL)a1;
...
- (void)setupDrawingWidth:(double)a0 fixedPixelSizeScrollView:(id)a1 sixChannelBlend:(BOOL)a2 drawBitmapEraserMask:(BOOL)a3;
