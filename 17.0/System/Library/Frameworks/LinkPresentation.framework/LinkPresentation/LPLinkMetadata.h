@class TUConversationActivity, _SWCollaborationMetadata, LPAudioMetadata, SYContentItem, NSMutableArray, NSString, LPAudio, LPARAsset, LPSpecializationMetadata, NSArray, LPSourceApplicationMetadata, NSItemProvider, NSObject, LPARAssetMetadata, LPProductMetadata, LPAssociatedApplicationMetadata, LPVideo, LPIconMetadata, LPImage, LPImageMetadata, NSURL, LPVideoMetadata;
