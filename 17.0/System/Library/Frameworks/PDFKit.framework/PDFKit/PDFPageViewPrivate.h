@class PDFPageViewAnnotationController, PDFHighlightDetectedFormFieldsEffectLayer, UIImage, PDFPageLayerEffect, CALayer, NSMutableDictionary, PDFPage, NSMutableArray, NSObject, NSTextStorage, PDFRenderingProperties, PDFAnnotation;
