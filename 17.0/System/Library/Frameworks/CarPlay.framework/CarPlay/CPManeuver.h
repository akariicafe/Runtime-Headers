@class NSUUID, NSString, NSArray, CPImageSet, NSSet, CPLaneGuidance, NSDictionary, UIImage, CPTravelEstimates, NSMeasurement, UIColor;
...
- (id)maneuverWithComponent:(id)a0;
