...
- (id)initUsingLocalDeviceLibraryDestinationWithImportElements:(id)a0 referralObject:(id)a1 usingLocalLibraryDestination:(BOOL)a2 usingCloudLibraryDestination:(BOOL)a3;
- (id)initUsingLocalDeviceLibraryDestinationWithImportElements:(id)a0 usingLocalLibraryDestination:(BOOL)a1 usingCloudLibraryDestination:(BOOL)a2;
