...
- (void)_fetchTokenForAccount:(id)a0 accountStore:(id)a1 forceFetch:(BOOL)a2 withHandler:(id /* block */)a3;
...
- (void)_performLoginDelegatesRequestForAccount:(id)a0 store:(id)a1 handler:(id /* block */)a2;
