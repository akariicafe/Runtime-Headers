...
- (void)_retrieveAuthURIForAccount:(id)a0 withHost:(id)a1 withCompletion:(id /* block */)a2;
- (unsigned long long)_accountOAuthVersion:(id)a0;
- (void)_assignConnectionPropertiesToSessionConfiguration:(id)a0 withAccountId:(id)a1;
- (BOOL)_jwksDataCacheValidForAccount:(id)a0;
- (void)_retrieveJWKSDataForAccount:(id)a0 fromURI:(id)a1 withCompletion:(id /* block */)a2;
- (void)_retrieveOpenIDMetadataForAccount:(id)a0 fromURI:(id)a1 withCompletion:(id /* block */)a2;
