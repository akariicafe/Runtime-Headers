...
@interface Highlights.AFibBurdenHistogramHighlightAnalyticsEvent : _TtCs12_SwiftObject <HKAnalyticsEvent> {
    void /* unknown type, empty encoding */ distributionResult;
}
