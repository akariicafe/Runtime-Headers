...
@interface MenstrualCyclesAppPlugin.CycleTimelineCollectionViewController : UICollectionViewController <UISplitViewControllerDelegate, UIGestureRecognizerDelegate> {
