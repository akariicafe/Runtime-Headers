@class NSSet, NSString, NSURL, BWEspressoInferenceContext, NSMutableArray, NSMutableDictionary;
...
@interface BWEspressoInferenceProvider : NSObject <BWInferenceProvider, BWInferenceExecutable, BWInferenceSubmittable, BWEspressoInferenceBinding, BWEspressoInferencePropagatable> {
