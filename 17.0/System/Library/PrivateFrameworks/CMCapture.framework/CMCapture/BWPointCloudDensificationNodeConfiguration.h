...
- (void)dealloc;
- (id)initWithRGBSensorConfiguration:(id)a0 timeOfFlightSensorConfiguration:(id)a1 rgbCameraHorizontalSensorBinningFactor:(int)a2 rgbCameraVerticalSensorBinningFactor:(int)a3 filteringEnabled:(BOOL)a4 depthPixelFormat:(unsigned int)a5 depthOutputDimensions:(struct { int x0; int x1; })a6 videoInputDimensions:(struct { int x0; int x1; })a7 timeOfFlightCameraType:(int)a8;
