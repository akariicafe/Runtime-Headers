...
+ (struct CGPoint { double x0; double x1; })smileShapeAlignmentPointForDevice:(id)a0;
+ (id)smileShapeForDevice:(id)a0;
+ (struct CGSize { double x0; double x1; })smileShapeSizeForDevice:(id)a0;
