...
+ (id)smileShapeWithDevice:(id)a0 outerRadius:(double)a1 innerRadius:(double)a2 angle:(double)a3 strokeWidth:(double)a4 filled:(BOOL)a5;
+ (id)topLeftCornerShapeWithDevice:(id)a0 size:(struct CGSize { double x0; double x1; })a1 innerCircleRadius:(double)a2 strokeWidth:(double)a3 filled:(BOOL)a4;
