@class NSMutableArray, NSString, NTKComplicationCollection, NSMutableDictionary, NSMapTable, CLKDevice, NSDictionary;
...
- (id)_lock_sampleTemplateForWidget:(id)a0 family:(long long)a1;
