...
+ (id)asynchronouslyLoadCycleFactorsIntoDictionary:(id)a0 FromHKHealthStore:(id)a1 upToLastDay:(long long)a2 withAdditionalDayCount:(long long)a3 withDispatchGroup:(id)a4 withError:(id *)a5;
...
+ (id)asynchronouslyLoadDaySummaryDayInputsIntoDictionary:(id)a0 FromHealthStore:(id)a1 upToJulianDay:(long long)a2 withAdditionalDayCount:(long long)a3 includeWristTemperature:(BOOL)a4 withDispatchGroup:(id)a5 error:(id *)a6;
+ (id)asynchronouslyLoadHeartRateDayInputsIntoDictionary:(id)a0 fromHealthStore:(id)a1 upToJulianDay:(long long)a2 withAdditionalDayCount:(long long)a3 withDispatchGroup:(id)a4 error:(id *)a5;
+ (id)asynchronouslyLoadMostRecentBMIIntoNSNumber:(id *)a0 FromHKHealthStore:(id)a1 asOfJulianDay:(long long)a2 withDispatchGroup:(id)a3 withError:(id *)a4;
+ (id)asynchronouslyLoadMostRecentBodyMassInGramsIntoNSNumber:(id *)a0 FromHKHealthStore:(id)a1 asOfJulianDay:(long long)a2 withDispatchGroup:(id)a3 withError:(id *)a4;
+ (id)asynchronouslyLoadMostRecentHeightInMetersIntoNSNumber:(id *)a0 FromHKHealthStore:(id)a1 asOfJulianDay:(long long)a2 withDispatchGroup:(id)a3 withError:(id *)a4;
+ (id)asynchronouslyLoadQuantityType:(id)a0 IntoNSNumber:(id *)a1 WithUnit:(id)a2 FromHKHealthStore:(id)a3 asOfJulianDay:(long long)a4 withDispatchGroup:(id)a5 withError:(id *)a6;
