@class NSHashTable, HKActivitySummary, HKCurrentActivityCacheQuery, HKHealthStore, NSMutableDictionary, NSDictionary, NSObject, FIUIWeeklyGoalModel, HKActivityCache, _HKCurrentActivitySummaryQuery;
