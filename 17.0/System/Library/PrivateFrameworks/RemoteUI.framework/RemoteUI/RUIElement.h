...
- (id)_symbolConfigurationWithRenderingMode:(id)a0 tintColor:(id)a1;
- (id)customSymbolImageNamed:(id)a0 symbolRenderingMode:(id)a1 tintColor:(id)a2;
...
- (id)systemImageNamed:(id)a0 symbolRenderingMode:(id)a1 tintColor:(id)a2;
