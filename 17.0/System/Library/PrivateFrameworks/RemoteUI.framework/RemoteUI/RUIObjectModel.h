...
- (void)startActivityIndicatorWithAttributes:(id)a0;
...
- (id)elementForActivityIndicatorAnchorId:(id)a0;
- (id)elementForActivityIndicatorWithActivatedElement:(id)a0;
- (id)elementForActivityIndicatorWithAttributes:(id)a0;
...
- (void)startActivityIndicatorForElement:(id)a0;
