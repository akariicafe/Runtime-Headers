@class RUIObjectModel, NSString, NSArray, RUITableView, NSSet, FAInviteContext, NSObject, RemoteUIController, FAInviteSuggestions, FAProfilePictureStore, CNContactStore;
...
- (id)initWithTableView:(id)a0 ruiTableView:(id)a1 pictureStore:(id)a2 recommendations:(id)a3 emergencyContacts:(id)a4 context:(id)a5 viewController:(id)a6 suggester:(id)a7 objectModel:(id)a8;
