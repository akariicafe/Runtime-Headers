...
+ (id)getFamilySettingsViewControllerWithViewModel:(id)a0 locationModel:(id)a1 pictureStore:(id)a2 appleAccount:(id)a3 accountManager:(id)a4 delegate:(id)a5 appleCardFamilySettingsViewModel:(id)a6;
