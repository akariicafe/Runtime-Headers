...
@protocol EXBDisplayAssertionCoordinatorDelegate;

@interface EXBDisplayAssertionCoordinator : NSObject <_EXBDisplayAssertionStackDelegate, EXBDisplayAssertionProviding> {
    NSMutableDictionary *_assertionStackMap;
    NSMutableDictionary *_assertionPreferencesMap;
}

@property (weak, nonatomic) id<EXBDisplayAssertionCoordinatorDelegate> delegate;
