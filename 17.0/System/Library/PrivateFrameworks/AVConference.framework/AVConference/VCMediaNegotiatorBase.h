@class NSString, VCMediaNegotiatorResults, VCMediaNegotiatorResultsAudio, VCMediaNegotiatorResultsVideo, NSMutableArray, VCMediaNegotiatorLocalConfiguration, VCMediaNegotiatorResultsMediaRecorder, VCMediaNegotiatorResultsFaceTimeSettings;
