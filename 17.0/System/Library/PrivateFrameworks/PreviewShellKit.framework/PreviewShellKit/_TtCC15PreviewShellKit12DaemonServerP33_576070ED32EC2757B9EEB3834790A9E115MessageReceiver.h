...
- (id)init;
- (void).cxx_destruct;
- (void)copyURLToAgentDescriptorPayload:(id)a0 usingData:(id)a1 replyHandler:(id /* block */)a2;
- (void)grantExecutePermissionToAgentDescriptorPayload:(id)a0 usingData:(id)a1 replyHandler:(id /* block */)a2;
