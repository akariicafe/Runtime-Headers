@class UIWindow, SBHIconImageCache, ATXAppDirectoryClient, UITapGestureRecognizer, _UILegibilitySettings, UIView, NSString, NSSet, SBHIconModel, SBRootFolder, SBFolderIconImageCache, SBHLibraryCategoriesFolderDataSource, SBHLibraryCategoryMap, SBIconListView;
