...
- (id)initWithPersonURL:(id)a0 sourceIconView:(id)a1 referenceIconView:(id)a2 containerViewController:(id)a3 containerView:(id)a4 homeScreenContentView:(id)a5 homeScreenContentFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a6;
