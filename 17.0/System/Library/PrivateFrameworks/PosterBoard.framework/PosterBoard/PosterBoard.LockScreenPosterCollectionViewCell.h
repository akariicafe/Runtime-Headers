@interface PosterBoard.LockScreenPosterCollectionViewCell : PosterBoard.PosterPairCollectionViewCell <UIScrollViewDelegate, CHSWidgetDescriptorProviderObserver, PREditingSceneViewControllerObserver> {
    ...
    void /* unknown type, empty encoding */ isComplicationContainerHiddenInFullscreenLayout;
    void /* unknown type, empty encoding */ displayedComplicationLocation;
    ...
    void /* unknown type, empty encoding */ widgetSidebarProminentController;
