...
- (id)browserControllerTabContentContainerView:(id)a0;
...
- (id)browserController:(id)a0 delegateForBannerController:(id)a1;
...
- (void)browserController:(id)a0 scrollViewDidScroll:(id)a1;
...
- (BOOL)browserControllerShouldUpdateWebViewGeometryOnScroll:(id)a0;
