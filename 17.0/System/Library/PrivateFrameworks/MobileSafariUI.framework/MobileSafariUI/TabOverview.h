@class UIVisualEffectView, UILabel, NSMutableArray, NSString, NSTimer, NSArray, SFLockedPrivateBrowsingView, TabOverviewToolbar, ReorderingAutoscroller, UITextInputPasswordRules, NSCountedSet, TabOverviewInterpolatedLocation, TabOverviewItemView, SFScrollingPanGestureRecognizer, UIView, UIPointerInteraction, CADisplayLink, UIToolbar, UISearchBar, TabExplanationView, SFGradientView, TabOverviewItem, NSIndexSet, UITapGestureRecognizer, NSHashTable;
@protocol TabOverviewThemeProviding, TabOverviewDelegate;

@interface TabOverview : UIView <ReorderingAutoscrollerDelegate, _UIBasicAnimationFactory, _UIScrollToTopView, UIGestureRecognizerDelegate, UIPointerInteractionDelegate, UISearchBarDelegate, UISearchBarDelegate_Private, UIKeyInput, TabThumbnailCollectionView, TabCollectionViewDragDropSupport> {
...
- (void)copyGeometryFromTabOverview:(id)a0;
- (void)_close:(id)a0;
...
- (void)setShowsLockedPrivateBrowsingView:(BOOL)a0 withUnlockHandler:(id /* block */)a1;
