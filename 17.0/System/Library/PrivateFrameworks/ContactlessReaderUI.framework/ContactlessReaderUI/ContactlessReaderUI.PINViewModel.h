@interface ContactlessReaderUI.PINViewModel : _TtCs12_SwiftObject <ProximityReader.PINUI> {
    ...
    void /* unknown type, empty encoding */ voiceOverObserver;
    void /* unknown type, empty encoding */ $__lazy_storage_$_fineRotationManager;
    void /* unknown type, empty encoding */ $__lazy_storage_$_pinKeyboardConfig;
    void /* unknown type, empty encoding */ drawNumberRecognizer;
    void /* unknown type, empty encoding */ voiceOverWasEnabled;
    void /* unknown type, empty encoding */ swipeInstructionsPlayed;
    ...
    void /* unknown type, empty encoding */ instructionsTimer;
    ...
    void /* unknown type, empty encoding */ _inhibitsGestures;
    ...
    void /* unknown type, empty encoding */ drawNumberAllowed;
    ...
    void /* unknown type, empty encoding */ accessibilityEntryType;
    void /* unknown type, empty encoding */ drawNumberFailures;
