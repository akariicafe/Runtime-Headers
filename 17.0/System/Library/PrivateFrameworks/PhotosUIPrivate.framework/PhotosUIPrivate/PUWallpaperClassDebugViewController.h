@class NSString, PUPassiveContentDataSource, PXAssetsDataSourceManager, PUWallpaperDebugViewSpec, NSDictionary, PUParallaxLayerStackDebugViewController, PHSuggestion, PUProgressIndicatorView;

@interface PUWallpaperClassDebugViewController : UICollectionViewController <PXOneUpPresentationDelegate, PUPassiveContentDataSourceDelegate>
...
@property (retain, nonatomic) PUPassiveContentDataSource *dataSource;
