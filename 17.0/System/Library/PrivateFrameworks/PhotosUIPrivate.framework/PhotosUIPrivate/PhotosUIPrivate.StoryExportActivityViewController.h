@interface PhotosUIPrivate.StoryExportActivityViewController : UIActivityViewController <UIActivityViewControllerObjectManipulationDelegate, UIActivityViewControllerAirDropDelegate> {
