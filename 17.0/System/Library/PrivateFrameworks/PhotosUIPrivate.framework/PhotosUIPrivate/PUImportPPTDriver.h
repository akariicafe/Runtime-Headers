@class PUTabbedLibraryViewController, NSString, PXImportController, NSArray, NSMutableDictionary, NSDictionary, PUImportPPTImportSource, PXImportMediaProvider, NSObject, PUImportActionCoordinator, PXImportAssetsDataSourceManager;
@protocol PXImportViewControllerProvider, OS_dispatch_semaphore;
...
@property (class, readonly, nonatomic) NSArray *importMediaURLs;
