@class NSData, NSString, NSURL, NSArray, PUEditableMediaProviderVideoURLNode, PUImageDataRenderNode, PUVideoExportNode, PUEditableMediaProviderImageDataNode;
...
- (id)initWithDirectory:(id)a0 imageDataNode:(id)a1 imageRenderNode:(id)a2 videoURLNode:(id)a3 videoRenderNode:(id)a4;
