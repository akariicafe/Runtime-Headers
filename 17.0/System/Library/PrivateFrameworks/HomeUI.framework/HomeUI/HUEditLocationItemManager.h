@class HFItem, HUSiriTriggerPhraseSettingItem, HFPinCodeManager, NSString, HFItemProvider, HFHomeBuilder, HUUserNotificationTopicListModule, HUMatterConnectedServicesItemModule;
