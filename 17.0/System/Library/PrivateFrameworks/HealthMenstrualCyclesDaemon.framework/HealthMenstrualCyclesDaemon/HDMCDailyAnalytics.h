...
- (BOOL)_collectSensitiveFieldsForMetric:(id)a0 settingsManager:(id)a1 menstrualCyclesSettings:(id)a2 heartRateInputFeatureStatus:(id)a3 deviationDetectionSettings:(id)a4 wristTemperatureInputFeatureStatus:(id)a5 gregorianCalendar:(id)a6 error:(id *)a7;
