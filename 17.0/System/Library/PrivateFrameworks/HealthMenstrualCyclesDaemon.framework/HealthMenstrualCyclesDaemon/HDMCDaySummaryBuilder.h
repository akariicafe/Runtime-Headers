@class NSArray, HDProfile, NSMutableDictionary, NSMutableArray, HKCalendarCache;
...
- (id)initWithProfile:(id)a0 dayIndex:(long long)a1 orderedWatchSources:(id)a2 calendarCache:(id)a3;
