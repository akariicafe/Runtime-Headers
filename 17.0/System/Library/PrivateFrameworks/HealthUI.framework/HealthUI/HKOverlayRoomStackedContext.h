...
- (id)initWithDisplayType:(id)a0 overlayDisplayType:(id)a1 stackedDisplayType:(id)a2 overlayChartController:(id)a3 currentCalendarOverride:(id)a4 applicationItems:(id)a5 isInfoButtonHidden:(BOOL)a6;
- (id)initWithDisplayType:(id)a0 overlayDisplayType:(id)a1 stackedSampleType:(id)a2 overlayChartController:(id)a3 currentCalendarOverride:(id)a4 applicationItems:(id)a5 isInfoButtonHidden:(BOOL)a6;
- (id)initWithDisplayType:(id)a0 templateDisplayType:(id)a1 sampleType:(id)a2 overlayDisplayType:(id)a3 stackedDisplayType:(id)a4 stackedTemplateDisplayType:(id)a5 stackedSampleType:(id)a6 overlayChartController:(id)a7 currentTimeScope:(long long)a8 currentCalendar:(id)a9 applicationItems:(id)a10 isInfoButtonHidden:(BOOL)a11;
- (id)initWithSampleType:(id)a0 overlayDisplayType:(id)a1 stackedDisplayType:(id)a2 overlayChartController:(id)a3 currentCalendarOverride:(id)a4 applicationItems:(id)a5 isInfoButtonHidden:(BOOL)a6;
- (id)initWithSampleType:(id)a0 overlayDisplayType:(id)a1 stackedSampleType:(id)a2 overlayChartController:(id)a3 currentCalendarOverride:(id)a4 applicationItems:(id)a5 isInfoButtonHidden:(BOOL)a6;
