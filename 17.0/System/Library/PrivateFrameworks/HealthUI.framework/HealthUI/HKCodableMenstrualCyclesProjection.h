...
@interface HKCodableMenstrualCyclesProjection : PBCodable <NSCopying> {
    struct APPLE_HKCodableMenstrualCyclesProjection_1 { unsigned char daysOffsetFromCalendarMethod : 1; unsigned char endMean : 1; unsigned char endStandardDeviation : 1; unsigned char predictionPrimarySource : 1; unsigned char startMean : 1; unsigned char startStandardDeviation : 1; unsigned char isPartiallyLogged : 1; } _has;
}
