...
- (id)initWithBaseChartDisplayType:(id)a0 trendModel:(id)a1 displayDate:(id)a2 applicationItems:(id)a3 timeScopeRanges:(id)a4 initialTimeScope:(long long)a5 wrappedOverlay:(id)a6 overrideFirstWeekday:(long long)a7 overrideCalendar:(id)a8 additionalChartOptions:(unsigned long long)a9;
