...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_boundsForString:(id)a0 coordinate:(id)a1 valueAttributes:(id)a2 rectsToAvoid:(id)a3;
