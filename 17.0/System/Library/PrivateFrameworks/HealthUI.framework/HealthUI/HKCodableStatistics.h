...
@interface HKCodableStatistics : PBCodable <NSCopying> {
    struct APPLE_HKCodableStatistics_1 { unsigned char baselineRelativeValueState : 1; unsigned char dataCount : 1; unsigned char dataType : 1; unsigned char endDate : 1; unsigned char startDate : 1; } _has;
}
