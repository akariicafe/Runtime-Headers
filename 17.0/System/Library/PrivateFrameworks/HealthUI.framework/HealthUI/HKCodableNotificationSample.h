@class NSString, HKCodableMetadataDictionary;

@interface HKCodableNotificationSample : PBCodable <NSCopying> {
    struct APPLE_HKCodableNotificationSample_1 { unsigned char categoryValue : 1; unsigned char dataType : 1; unsigned char endDate : 1; unsigned char latestSupportedVersion : 1; unsigned char minimumSupportedVersion : 1; unsigned char startDate : 1; } _has;
}
