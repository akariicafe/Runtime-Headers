...
- (void)_submitMaximumValueQueryForQuantityType:(id)a0 aggregateQueryFinishedBlock:(id /* block */)a1;
- (void)_submitRangeValueQueryForQuantityType:(id)a0 aggregateQueryFinishedBlock:(id /* block */)a1;
