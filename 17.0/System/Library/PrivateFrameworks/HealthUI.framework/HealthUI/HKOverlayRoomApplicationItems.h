@class HKDisplayTypeController, HKChartDataCacheController, HKHealthStore, HKSelectedTimeScopeController, HKSampleTypeDateRangeController, HKUnitPreferenceController, HKDateCache, HKSampleTypeUpdateController;
