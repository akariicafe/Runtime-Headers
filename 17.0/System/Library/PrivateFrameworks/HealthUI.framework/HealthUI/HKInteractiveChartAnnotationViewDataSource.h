...
- (void)_updateDateTextWithTimeScope:(long long)a0 resolution:(long long)a1;
...
- (void)updateWithSelectionContext:(id)a0 displayType:(id)a1 timeScope:(long long)a2 resolution:(long long)a3 healthStore:(id)a4 viewController:(id)a5;
