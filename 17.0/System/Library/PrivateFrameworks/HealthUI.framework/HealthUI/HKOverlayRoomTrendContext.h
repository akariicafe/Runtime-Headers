...
- (id)_buildTrendDisplayTypeFromModel:(id)a0 baseDisplayType:(id)a1 unitController:(id)a2;
- (id)_adjustTrendValueRange:(id)a0 timescope:(long long)a1 calendar:(id)a2;
- (id)_buildAnnotatedHorizontalLineSeriesUsingDisplayType:(id)a0 unitController:(id)a1;
