...
@interface HKCodableSummaryActivityRingsValue : PBCodable <NSCopying> {
    struct APPLE_HKCodableSummaryActivityRingsValue_1 { unsigned char activityMoveMode : 1; unsigned char creationDate : 1; unsigned char dateData : 1; unsigned char endDate : 1; unsigned char startDate : 1; unsigned char hasEverHadAWatch : 1; } _has;
}
