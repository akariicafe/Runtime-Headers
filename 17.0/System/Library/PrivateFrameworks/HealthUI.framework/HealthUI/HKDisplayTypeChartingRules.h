@class NSMutableDictionary, HKRemoteChartConfiguration, NSDictionary, NSNumber;
...
- (id)initWithDefaultChartStyle:(long long)a0 chartingOptions:(unsigned long long)a1 preferredTimeScope:(long long)a2;
