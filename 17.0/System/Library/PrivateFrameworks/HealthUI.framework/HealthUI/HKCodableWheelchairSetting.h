@interface HKCodableWheelchairSetting : PBCodable <NSCopying> {
    struct APPLE_HKCodableWheelchairSetting_1 { unsigned char latestSupportedVersion : 1; unsigned char minimumSupportedVersion : 1; unsigned char isUsingWheelchair : 1; } _has;
}
