...
@interface HKCodableNotificationDataSourceQueryData : PBCodable <NSCopying> {
    struct APPLE_HKCodableNotificationDataSourceQueryData_1 { unsigned char count : 1; unsigned char dataType : 1; unsigned char latestSupportedVersion : 1; unsigned char minimumSupportedVersion : 1; } _has;
}
