@interface HKCodableSummarySleepDurationValue : PBCodable <NSCopying> {
    struct APPLE_HKCodableSummarySleepDurationValue_1 { unsigned char asleepDuration : 1; unsigned char endOfSleepTimeIntervalSinceReferenceDate : 1; unsigned char inBedDuration : 1; } _has;
}
