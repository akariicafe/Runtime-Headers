...
- (void)reboot:(id)a0;
- (void)handoffCompleteWithHandoffType:(unsigned long long)a0;
...
- (void)fetchLatestSignposts:(long long)a0 completionHandler:(id /* block */)a1;
...
- (void)handoffCancelWithHandoffType:(unsigned long long)a0;
- (void)handoffSetDeviceAsStereoLeader:(BOOL)a0 withOptions:(id)a1;
- (void)handoffStartWithArtworkColors:(id)a0 handoffType:(unsigned long long)a1;
- (void)handoffStartWithHandoffType:(unsigned long long)a0;
- (void)handoffUpdateIntensity:(float)a0 handoffType:(unsigned long long)a1;
