...
- (void).cxx_destruct;
- (id)initWithConfusion:(id)a0 correction:(id)a1 locales:(id)a2 leftContext:(id)a3 rightContext:(id)a4 requiresLexiconMatch:(BOOL)a5 shouldPreserveOriginal:(BOOL)a6;
