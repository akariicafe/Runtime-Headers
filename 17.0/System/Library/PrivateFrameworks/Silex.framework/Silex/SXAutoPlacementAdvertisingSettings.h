...
- (void).cxx_destruct;
- (id)initWithFrequency:(unsigned long long)a0 bannerType:(unsigned long long)a1 layout:(id)a2 distanceFromMedia:(struct _SXConvertibleValue { double x0; unsigned long long x1; })a3;
