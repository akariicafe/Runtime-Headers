...
- (long long)hyphenationMinimumCharactersAfterWithValue:(id)a0 withType:(int)a1;
- (long long)hyphenationMinimumCharactersBeforeWithValue:(id)a0 withType:(int)a1;
- (long long)hyphenationMinimumWordLengthWithValue:(id)a0 withType:(int)a1;
- (long long)hyphenationWithValue:(id)a0 withType:(int)a1;
- (double)hyphenationZoneWithValue:(id)a0 withType:(int)a1;
