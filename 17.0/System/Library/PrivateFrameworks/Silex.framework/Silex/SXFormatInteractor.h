@class NSString;
@protocol SXLayoutOptionsFactory, SXSubscriptionStatusProviding, SXNewsletterSubscriptionStatusProviding, SXPresentationEnvironment, SXOfferUpsellScenarioProviding, SXRenderingConfigurationProvider, SXSubscriptionActivationEligibilityProviding, SXFormatInteractorDelegate, SXDebugLayoutOptionsProviding, SXLayoutCoordinator, SXPresentationAttributesProvider;
...
- (id)initWithLayoutCoordinator:(id)a0 layoutOptionsFactory:(id)a1 presentationAttributesProvider:(id)a2 subscriptionStatusProvider:(id)a3 debugLayoutOptionsProvider:(id)a4 newsletterSubscriptionStatusProvider:(id)a5 offerUpsellScenarioProvider:(id)a6 subscriptionActivationEligibilityProvider:(id)a7 renderingConfigurationProvider:(id)a8;
