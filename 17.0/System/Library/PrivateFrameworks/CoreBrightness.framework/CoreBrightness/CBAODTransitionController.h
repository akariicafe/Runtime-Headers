@class CBRampManager, CBAmmolite, CBAODFlipBookWrapper, CBAODThresholdModule, NSObject, CBTwilight, CBAPEndpoint;
...
@interface CBAODTransitionController : CBModule {
    ...
    struct { unsigned int ID; BOOL brightness_set; float brightness; BOOL whitepoint_set; float whitepoint[3][3]; BOOL pccfactor_set; float pccfactor; BOOL brightnessLimit_set; float brightnessLimit; BOOL lowAmbientAdaptationStrength_set; float lowAmbientAdaptationStrength; float lowAmbientAdaptationLux; BOOL ammoliteStrength_set; float ammoliteStrength; float ammoliteLux; unsigned char reserved[5]; } _currentFlipBookEntry;
...
- (void)addFlipBookEntry:(struct { unsigned int x0; BOOL x1; float x2; BOOL x3; float x4[3][3]; BOOL x5; float x6; BOOL x7; float x8; BOOL x9; float x10; float x11; BOOL x12; float x13; float x14; unsigned char x15[5]; })a0;
...
- (BOOL)currentFlipBookEntry:(struct { unsigned int x0; BOOL x1; float x2; BOOL x3; float x4[3][3]; BOOL x5; float x6; BOOL x7; float x8; BOOL x9; float x10; float x11; BOOL x12; float x13; float x14; unsigned char x15[5]; } *)a0;
- (int)currentTransitionUpdateID;
- (float)currentTwilightLux;
- (void)enableDCPFlipBookUpdates:(BOOL)a0;
- (BOOL)flipBookEntryForID:(int)a0 entry:(struct { unsigned int x0; BOOL x1; float x2; BOOL x3; float x4[3][3]; BOOL x5; float x6; BOOL x7; float x8; BOOL x9; float x10; float x11; BOOL x12; float x13; float x14; unsigned char x15[5]; } *)a1;
...
- (void)logTransitionParameters:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; float x4; BOOL x5; float x6; BOOL x7; float x8; BOOL x9; float x10; BOOL x11; float x12; BOOL x13; float x14; })a0;
...
- (BOOL)startTransition:(id)a0 transitionParameters:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; float x4; BOOL x5; float x6; BOOL x7; float x8; BOOL x9; float x10; BOOL x11; float x12; BOOL x13; float x14; })a1 rampDoneCallback:(id /* block */)a2 rampCanceledCallback:(id /* block */)a3;
...
- (void)updateAmmoliteStrength:(float)a0;
...
- (void)updateFlipBookEntryWithAmmoliteLux:(float)a0;
- (void)updateFlipBookEntryWithAmmoliteStrength:(float)a0;
- (void)updateFlipBookEntryWithBrightness:(float)a0;
- (void)updateFlipBookEntryWithBrightnessLimit:(float)a0;
- (void)updateFlipBookEntryWithTwilightLux:(float)a0;
- (void)updateFlipBookEntryWithTwilightStrength:(float)a0;
- (void)updateLumaBoostFactor:(float)a0;
- (void)updateSDRBrightness:(float)a0;
- (void)updateTwilightStrength:(float)a0;
