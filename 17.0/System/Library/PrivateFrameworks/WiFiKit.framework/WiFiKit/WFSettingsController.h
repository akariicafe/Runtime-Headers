@class WFNetworkSettingsConfig, NSString, WFNetworkScanRecord, WFNetworkSettingsViewController, NSOperationQueue, WFAppearanceProxy, WFDetailsContext, WFIPMonitor;
