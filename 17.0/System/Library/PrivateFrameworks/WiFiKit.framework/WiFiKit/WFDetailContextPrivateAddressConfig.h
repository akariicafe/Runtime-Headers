...
@property (nonatomic, getter=isPrivateAddressSupported) BOOL privateAddressSupported;
@property (readonly, nonatomic, getter=isAlwaysDisplayRandomAddress) BOOL alwaysDisplayRandomAddress;

- (void).cxx_destruct;
- (id)initWithRandomMACAddress:(id)a0 hardwareMACAddress:(id)a1 randomMACSwitchOn:(BOOL)a2 randomMACAddressDisabled:(BOOL)a3 connectedWithHardwareAddress:(BOOL)a4 privateAddressSupported:(BOOL)a5;
