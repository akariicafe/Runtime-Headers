...
+ (void)drawDisparity:(const struct __CVBuffer { } *)a0 onColor:(struct __CVBuffer { } *)a1 canonical:(BOOL)a2 rawShiftInvalidThreshold:(int)a3 focusMachineState:(int)a4 offsetX:(unsigned long long)a5 offsetY:(unsigned long long)a6;
...
- (id).cxx_construct;
- (id)initWithProperties:(id)a0 commandQueue:(id)a1 notificationQueue:(id)a2 error:(id *)a3;
...
- (int)makeMetalContextWithOptionalCommandQueue:(id)a0 error:(id *)a1;
