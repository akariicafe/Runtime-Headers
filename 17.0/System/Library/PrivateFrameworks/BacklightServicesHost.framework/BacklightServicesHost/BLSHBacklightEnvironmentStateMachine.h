@class NSString, BLSHPresentationDateSpecifier, NSSet, BLSHBacklightEnvironmentPresentation, NSMutableArray, NSMutableSet, NSMapTable, BLSSetPresentationOperation;
