...
- (id)description;
- (void).cxx_destruct;
- (id)initWithApplicationActivityTypes:(id)a0 activitiesByUUID:(id)a1 favoritesProxies:(id)a2 suggestionProxies:(id)a3 orderedUUIDs:(id)a4 excludedActivityTypes:(id)a5 activityCategory:(long long)a6;
