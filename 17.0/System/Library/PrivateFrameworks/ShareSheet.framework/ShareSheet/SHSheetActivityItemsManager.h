...
+ (id)_placeholderActivityItemValuesForActivityItem:(id)a0 activityViewController:(id)a1 shouldUpdateMappings:(BOOL)a2;
+ (id)placeholderActivityItemValuesForActivityItem:(id)a0 activityViewController:(id)a1;

- (void)invalidateCache;
- (void).cxx_destruct;
- (void)_configureContentManagedForActivityItem:(id)a0 activityItemValue:(id)a1 outURLs:(id)a2 outScopedURLs:(id)a3;
