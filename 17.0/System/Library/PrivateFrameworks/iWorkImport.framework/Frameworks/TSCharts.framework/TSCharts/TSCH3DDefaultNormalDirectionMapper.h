...
+ (id)mapperWithNormalBias:(void *)a0;

- (id).cxx_construct;
- (id)initWithNormalBias:(void *)a0;
- (void)mapFromVertexArray:(const void *)a0 normalArray:(const void *)a1 normalMatrix:(void *)a2 numVertices:(long long)a3 destination:(void *)a4;
