...
@interface HFSoftwareUpdateManager : NSObject <HFAccessoryObserver, HFHomeObserver, HFAccessorySoftwareUpdateControllerV2Observer, HFExecutionEnvironmentObserver, HFSoftwareUpdateObserver>
