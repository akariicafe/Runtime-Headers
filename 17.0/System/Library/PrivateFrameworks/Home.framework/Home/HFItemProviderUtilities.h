...
+ (id)_servicesForHome:(id)a0 canShowInControlCentre:(BOOL)a1 withLimit:(unsigned long long)a2 includes:(unsigned long long)a3 ignoreUUIDs:(id)a4;
...
+ (id)predictionsPaddingFavoriteServicesForHome:(id)a0 withLimit:(unsigned long long)a1 ignoreUUIDs:(id)a2;
+ (id)predictionsPaddingNonFavoriteServicesForHome:(id)a0 withLimit:(unsigned long long)a1;
+ (id)predictionsPaddingNonFavoriteServicesForHome:(id)a0 withLimit:(unsigned long long)a1 ignoreUUIDs:(id)a2;
