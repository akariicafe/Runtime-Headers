...
- (void)recordDidActivateCardWithBundleID:(id)a0 launchReason:(id)a1 deviceLocked:(BOOL)a2 didShowCardInline:(BOOL)a3 isOutOfBoxURL:(BOOL)a4;
- (void)recordDidInstallWithBundleID:(id)a0 succeeded:(BOOL)a1;
- (void)recordDidOpenAppClipWithBundleID:(id)a0 launchReason:(id)a1 didShowCard:(BOOL)a2 didOpenFullApp:(BOOL)a3 didInstallAppClip:(BOOL)a4 isOutOfBoxURL:(BOOL)a5;
