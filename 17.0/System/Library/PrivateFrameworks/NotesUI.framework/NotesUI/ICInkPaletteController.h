...
- (void)dealloc;
- (void).cxx_destruct;
- (void)_toolPickerDidInvokeDoneAction:(id)a0;
...
- (void)_toolPickerVisibilityDidChange:(id)a0 isAnimationFinished:(BOOL)a1;
...
- (void)updateUserInterfaceStyle:(long long)a0;
