@class ATXSuggestedPagesWidgetAggregator, NSSet, NSDictionary, ATXSuggestedPagesAppAggregator, ATXSuggestedPagesSleepShortcutsDataSource, ATXWidgetDescriptorCache, ATXSuggestedPagesTunableConstants;
...
- (id)initWithWidgetAggregator:(id)a0 appAggregator:(id)a1 shortcutsDataSource:(id)a2 descriptorCache:(id)a3;
