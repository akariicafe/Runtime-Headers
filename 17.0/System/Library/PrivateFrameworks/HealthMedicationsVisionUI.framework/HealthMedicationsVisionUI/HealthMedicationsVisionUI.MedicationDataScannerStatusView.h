@interface HealthMedicationsVisionUI.MedicationDataScannerStatusView : UIView {
    void /* unknown type, empty encoding */ systemIconName;
    ...
    void /* unknown type, empty encoding */ secondaryAction;
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_detailsLabel;
