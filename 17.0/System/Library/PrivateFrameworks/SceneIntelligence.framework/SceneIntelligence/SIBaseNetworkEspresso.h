...
- (BOOL)setOutputBlob:(id)a0 forOutputSurface:(struct __IOSurface { } *)a1;
- (void)addPrewiringBuffersToStreamForFunctionName:(id)a0 inputPools:(id)a1 outputPools:(id)a2 clearWiredBuffer:(BOOL)a3;
...
- (unsigned long long)getOutputBytePerRow:(id)a0;
- (unsigned long long)getOutputChannels:(id)a0;
- (unsigned long long)getOutputComponentSize:(id)a0;
...
- (void)unwirePrewiringBuffersForFunctionName:(id)a0;
