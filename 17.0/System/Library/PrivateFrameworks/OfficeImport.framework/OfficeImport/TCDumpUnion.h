...
- (id)initWithSelectorField:(id)a0 members:(id)a1;
- (id)initWithSelectorFieldName:(id)a0 selectorEnumType:(id)a1 members:(id)a2;
- (id)initWithSelectorFieldName:(id)a0 selectorEnumType:(id)a1 selectorField:(id)a2 members:(id)a3;
