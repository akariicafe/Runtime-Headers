...
- (id)initWithCount:(int)a0 countFieldType:(int)a1 countFieldName:(id)a2 elementType:(id)a3;
- (id)initWithCount:(int)a0 elementType:(id)a1;
- (id)initWithCountFieldName:(id)a0 elementType:(id)a1;
- (id)initWithCountFieldType:(int)a0 elementType:(id)a1;
