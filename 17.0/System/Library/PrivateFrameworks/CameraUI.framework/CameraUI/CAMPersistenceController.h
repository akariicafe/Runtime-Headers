...
- (void)videoPersistenceCoordinator:(id)a0 requestsRemotePersistenceForLocalPersistenceResult:(id)a1 captureRequest:(id)a2 powerAssertionReason:(unsigned int)a3;
...
- (void)_dispatchRemotePersistenceForLocalPersistenceResult:(id)a0 filteredLocalResult:(id)a1 request:(id)a2 powerAssertionReason:(unsigned int)a3 loggingIdentifier:(id)a4;
- (void)_handleStillImagePersistenceForRequest:(id)a0 withResult:(id)a1;
- (id)_jobDictionaryForVideoLocalResult:(id)a0 fromRequest:(id)a1;
- (id)_physicallyRotatedJPEGDataFromCapturePhoto:(id)a0;
- (void)_dispatchRemotePersistenceForLocalVideoPersistenceResult:(id)a0 request:(id)a1 powerAssertionReason:(unsigned int)a2 loggingIdentifier:(id)a3;
...
- (void)stillImagePersistenceCoordinator:(id)a0 requestsRemotePersistenceForLocalPersistenceResult:(id)a1 filteredLocalResult:(id)a2 request:(id)a3 powerAssertionReason:(unsigned int)a4;
...
- (id)_jobDictionaryForStillImageLocalResult:(id)a0 filteredLocalResult:(id)a1 fromRequest:(id)a2;
