@class NSString, NSTimer, _UIExpandingGlyphsView, STUIStatusBarIdentifier, STUIStatusBarLockView;

@interface STUIStatusBarLockItem : STUIStatusBarItem <_UIBasicAnimationFactory>

@property (class, readonly) STUIStatusBarIdentifier *textDisplayIdentifier;
