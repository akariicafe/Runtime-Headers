@class NSMutableDictionary, NSSet, NSString, STUIStatusBarIdentifier, STUIStatusBar;

@interface STUIStatusBarItem : NSObject <BSDebugDescriptionProviding>

@property (class, readonly) STUIStatusBarIdentifier *identifier;
@property (class, readonly) STUIStatusBarIdentifier *defaultDisplayIdentifier;
