@class NSMutableDictionary, STStatusBarData, UIScreen, NSDictionary, STUIStatusBarAction, UIView, UIColor, NSString, NSSet, UIPointerInteraction, UIGestureRecognizer, STMutableStatusBarData, STUIStatusBarStyleAttributes, NSArray, UIAccessibilityHUDGestureManager, STUIStatusBarDataAggregator;
@protocol STUIStatusBarActionable, STUIStatusBarVisualProvider;
...
@property (readonly, nonatomic, getter=_useAutomaticStyle) BOOL useAutomaticStyle;
...
- (void)updateForDataChange:(id)a0;
...
- (id)_expandedDescriptionBuilderWithMultilinePrefix:(id)a0;
...
- (void)_setAutomaticStyle:(long long)a0 additionalStylesForRegionIdentifiers:(id)a1;
