...
- (void)_deleteRecoveryKey:(id /* block */)a0;
- (void)_generateRecoveryKeyWithType:(long long)a0 attributes:(id)a1 completion:(id /* block */)a2;
- (BOOL)_shouldMatchAction:(id)a0;
- (void)_verifyRecoveryKeyWithType:(long long)a0 attributes:(id)a1 completion:(id /* block */)a2;
