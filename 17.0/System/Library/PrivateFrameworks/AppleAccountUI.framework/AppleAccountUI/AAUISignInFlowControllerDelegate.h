...
@property (nonatomic, getter=wasProgressViewAlreadyPresented) BOOL progressViewAlreadyPresented;
...
- (void)signInFlowController:(id)a0 presentProgressViewForAccount:(id)a1 completion:(id /* block */)a2;
