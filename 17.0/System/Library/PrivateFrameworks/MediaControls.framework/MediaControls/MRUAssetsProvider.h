...
@property (class, readonly, nonatomic) NSString *volumePackageName;
@property (class, readonly, nonatomic) NSString *volumeBoldPackageName;
@property (class, readonly, nonatomic) NSString *volumeRTLPackageName;
...
@property (class, readonly, nonatomic) NSString *suggestedRouteWaveformPackageName;
...
- (void).cxx_destruct;
- (void)applicationIconForBundleIdentifier:(id)a0 size:(struct CGSize { double x0; double x1; })a1 completion:(id /* block */)a2;
