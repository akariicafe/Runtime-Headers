@class MRUVolumeGroupCoordinator, MRUStepper, MRUVolumeController, MRUVisualStylingProvider, NSString, UIWindowScene, MRUGroupSlider;
@protocol MRUNowPlayingVolumeControlsViewDelegate, MPVolumeControllerDataSource;
