@interface _TtCO24IntelligencePlatformCore16LifeEventStructs20DateRelationshipType : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ occurrenceDate_predicate;
    void /* unknown type, empty encoding */ occurrenceDate;
    void /* unknown type, empty encoding */ imputedOccurrenceDate_predicate;
    void /* unknown type, empty encoding */ imputedOccurrenceDate;
}
