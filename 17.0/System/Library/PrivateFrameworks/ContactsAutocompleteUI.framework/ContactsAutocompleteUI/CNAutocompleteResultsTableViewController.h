@class _CNAutocompleteResultsTableViewModel, NSArray, NSString, NSMutableSet, CNAutocompleteSearchControllerOptions, NSMutableArray, CNAvatarViewControllerSettings;
