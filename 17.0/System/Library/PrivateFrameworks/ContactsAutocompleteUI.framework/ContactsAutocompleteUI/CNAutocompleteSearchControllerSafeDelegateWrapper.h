...
- (void)searchController:(id)a0 textViewTextDidChange:(id)a1;
- (id)searchController:(id)a0 tintColorForRecipient:(id)a1;
- (void)searchController:(id)a0 willDisplayRowForRecipient:(id)a1;
- (void)searchController:(id)a0 didAddRecipientByResultsController:(id)a1;
- (void)searchController:(id)a0 didAddRecipientBySuggestionsController:(id)a1;
