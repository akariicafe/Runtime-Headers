...
+ (struct SUUIStackedImageConfiguration { struct UIOffset { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; long long x2; })_configurationForSize:(struct CGSize { double x0; double x1; })a0;
