@class NSHashTable, NSString, UIView, SUUIViewElement, CALayer, SUUIBackgroundImageWrapperForHorizontalLockup, SUUISizeValue, SUUICardLayout, SUUICardViewElement, NSMapTable;
...
- (void)suuiadvertising_advertSelectionEventShouldBeForwarded:(id)a0;
