@class NSString, NSArray, UINavigationController, SUUIClientContext, SUUIReportAConcernViewController, SUUIOverlayContainerViewController, NSMutableArray, UIViewController, SUUIStoreDialogController, UIPopoverController;
@protocol SUUIModalDocumentDelegate, SUUIModalSourceViewProvider, SUUIModalDocumentDataSource, UINavigationControllerDelegate;
