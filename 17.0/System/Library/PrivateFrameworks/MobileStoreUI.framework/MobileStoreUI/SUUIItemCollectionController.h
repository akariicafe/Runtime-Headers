@class NSString, NSArray, SUUIClientContext, SUUIItemArtworkContext, SUUIStyledImageDataConsumer, SUUIScreenshotDataConsumer, SUUIResourceLoader, NSMutableDictionary, UIImage;
@protocol SUUIItemCollectionDelegate;
