@class SUUIContentInsetScrollView, NSString, NSArray, UINavigationController, CLLocationManager, SUUIMetricsImpressionSession, SUUIExploreTemplateElement, SUUIStorePageSectionsViewController, UISplitViewController;
