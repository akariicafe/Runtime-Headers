@class SSVPlatformContext, NSCache, NSMapTable, NSDictionary, NSBundle, SUUIStoreDialogController, SUUIURLBag, NSMutableArray, SUUIURL, SUClientInterface, NSString, IKAppContext, SUUILocalizedStringDictionary, NSOperationQueue, NSArray, SSURLBag, SUUITrendingSearchProvider, SUUIApplicationController;
...
@property (weak, nonatomic, getter=_applicationController, setter=_setApplicationController:) SUUIApplicationController *_applicationController;
...
@property (readonly, weak, nonatomic, getter=applicationController) SUUIApplicationController *applicationController;
