@class CNContactPickerViewController, NSString, NSArray, NSAttributedString, SUUIGiftContactSearchController, UIView, CNContactStore, CNComposeRecipientTextView, UILabel;
