@class NSCache, NSString, NSArray, SUUIImageDataConsumer, UIImage, NSMutableDictionary, SUUIIPadDownloadsViewController, SSDownloadManager, SUUIIPhoneDownloadsViewController;
