@class NSString, SUUILabelViewElement, NSArray, NSAttributedString;
...
@property (readonly, nonatomic) struct SUUIEditorialStyle { long long alignment; long long bodyFontWeight; float bodyFontSize; float linkSpacing; long long titleFontWeight; float titleFontSize; float titleSpacing; } editorialStyle;
