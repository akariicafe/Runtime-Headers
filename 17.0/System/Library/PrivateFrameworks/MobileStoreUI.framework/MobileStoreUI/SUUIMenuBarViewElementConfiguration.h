@class NSString, NSArray, SUUIMenuItemViewElement, IKAppMenuBarDocument;
...
@property (weak, nonatomic, getter=_reloadDelegate, setter=_setReloadDelegate:) id<_SUUIMenuBarViewElementConfigurationReloadDelegate> reloadDelegate;
