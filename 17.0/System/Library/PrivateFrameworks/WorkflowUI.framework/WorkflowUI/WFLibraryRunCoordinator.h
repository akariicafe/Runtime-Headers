@class NSHashTable, NSString, WFExecutableAutoShortcut, WFWorkflowRunViewSource, WFWorkflowReference, WFAction, WFDialogTransformer, WFShortcutsAppRunnerClient, NSProgress, WFWorkflowRunEvent, WFDatabase;
...
- (void)openWorkflowReferenceAndRun:(id)a0 fromSource:(id)a1 withInput:(id)a2 state:(id)a3 requestOutput:(BOOL)a4 runViewSource:(id)a5 completionHandler:(id /* block */)a6;
...
- (void)runContextualAction:(id)a0;
- (void)runWorkflowReference:(id)a0 fromSource:(id)a1 withInput:(id)a2 requestOutput:(BOOL)a3 runViewSource:(id)a4 completionHandler:(id /* block */)a5;
