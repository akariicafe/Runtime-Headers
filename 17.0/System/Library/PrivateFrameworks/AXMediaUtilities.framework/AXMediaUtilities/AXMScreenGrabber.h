...
- (id)_renderOptionsForSurface:(struct __IOSurface { } *)a0 captureRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 displayName:(id)a2 scaleFactor:(double)a3 ignoredLayerContextIDs:(id)a4 includedLayerContextIDs:(id)a5 snapshotLayerID:(id)a6 snapshotContextID:(id)a7;
