@class UIApplicationSceneSettingsDiffInspector, NSString, SBDeviceApplicationSceneHandle, SBDeviceApplicationSceneView, UIView, BSUIOrientationTransformWrapperView;
