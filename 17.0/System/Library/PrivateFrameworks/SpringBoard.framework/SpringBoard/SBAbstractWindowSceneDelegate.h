@class SBWindowSceneContext, SBWindowHidingManager, SBModalLibraryController, SBCoverSheetPresentationManager, SBSystemPointerInteractionManager, SBModalUIFluidDismissGestureManager, SBFZStackParticipant, SBWallpaperController, SBMedusaHostedKeyboardWindowController, SBLayoutStateTransitionCoordinator, SBControlCenterController, SBLockScreenManager, SBSceneLayoutStateProvider, SBRecordingIndicatorManager, SBAmbientPresentationController, SBTransientUIInteractionManager, SBDisplayAppInteractionEventSource, UIWindow, SBHardwareButtonZStackClient, SBSystemApertureController, SBLockedPointerManager, SBWindowScene, SBFloatingDockController, SBReachabilitySceneController, SBWindowScenePIPManager, NSString, SBModalAlertPresentationCoordinator, SBAlertItemsController, SBSystemGestureManager, TRAArbiter, SBFZStackResolver, SBTraitsPipelineManager, SBSceneManager, SBSwitcherController, CSCoverSheetViewController, BNBannerController, SBMainDisplayLayoutStateManager;
...
@interface SBAbstractWindowSceneDelegate : NSObject <SBWindowSceneContextProviding, SBFZStackParticipantDelegate, SBWindowSceneDelegate, EXBDisplayEndpointDelegate> {
...
- (id)_pipelineManager;
- (void)displayEndpointDidUpdateRootWindow:(id)a0;
...
- (id)_createPresentationBinderWithRootWindow:(id)a0;
