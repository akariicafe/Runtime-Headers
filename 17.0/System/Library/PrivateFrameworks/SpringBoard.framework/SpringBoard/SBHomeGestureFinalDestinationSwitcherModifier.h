...
- (BOOL)_hasTraveledSufficientDistanceForHomeOrAppSwitcherForMouseEvent:(BOOL)a0;
...
- (id)initWithDelegate:(id)a0 initialTranslationAdjustment:(struct CGPoint { double x0; double x1; })a1 minYDistanceForHomeOrSwitcher:(double)a2 startingEnvironmentMode:(long long)a3 continuingGesture:(BOOL)a4 dockModifier:(id)a5;
- (id)studyLogData;
