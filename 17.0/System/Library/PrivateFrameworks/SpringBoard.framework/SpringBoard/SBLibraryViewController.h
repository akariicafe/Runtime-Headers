...
@interface SBLibraryViewController : SBHLibraryViewController <SBHLibraryViewControllerObserver, SBBarSwipeAffordanceObserver, SBBarSwipeAffordanceDelegate, SBBarSwipeAffordanceControllingDelegate, SBLayoutStateTransitionObserver>
...
- (void)_handlePressesBegan:(id)a0;
