@class SBWallpaperController, SBSystemGestureManager, SBFZStackResolver, SBIconController, SBCoverSheetPresentationManager, CSCoverSheetViewController, SBSystemApertureController, SBControlCenterController, SBAlertItemsController, SBSwitcherController, SBLockScreenManager, SBModalAlertPresentationCoordinator, TRAArbiter, SBFloatingDockController, SBWindowHidingManager;
