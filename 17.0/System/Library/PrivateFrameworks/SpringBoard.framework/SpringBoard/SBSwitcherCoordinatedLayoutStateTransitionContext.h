...
+ (id)coordinatedLayoutStateTransitionContextForMovingDisplayItems:(id)a0 fromSwitcherController:(id)a1 fromAppLayout:(id)a2 toAppLayout:(id)a3 toSwitcherController:(id)a4 withApplicationController:(id)a5;
+ (id)coordinatedLayoutStateTransitionContextForMovingDisplayItems:(id)a0 toSwitcherController:(id)a1 toAppLayout:(id)a2 withApplicationController:(id)a3;
