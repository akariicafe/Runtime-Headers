@class SBNubView, TRAParticipant, BSAbsoluteMachTimer, SBTraitsSceneParticipantDelegate, UITapGestureRecognizer, SBTransientUIInteractionManager, SBSceneViewStatusBarAssertion, SBSystemPointerInteractionManager, UIView, SBDeviceApplicationSceneHandle, NSString, SBSystemNotesInteractionSettings, SBSystemNotesPlaceholderContentProvider, SBSSystemNotesPresentationConfiguration, SBDeviceApplicationSceneViewController, SBSystemNotesContentPresentationContext, TRAArbiter, SBApplicationBlurContentView, SBWindowScene, SBMainWorkspace;
