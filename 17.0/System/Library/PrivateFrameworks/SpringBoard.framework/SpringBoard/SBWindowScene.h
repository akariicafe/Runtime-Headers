@class SBControlCenterController, CSCoverSheetViewController, SBModalAlertPresentationCoordinator, SBAlertItemsController, SBReachabilitySceneController, NSString, SBWindowScenePIPManager, SBSystemGestureManager, SBModalLibraryController, SBMedusaHostedKeyboardWindowController, SBLockedPointerManager, TRAArbiter, SBLockScreenManager, SBSceneLayoutStateProvider, SBFZStackResolver, SBSwitcherController, SBLayoutStateTransitionCoordinator, SBWindowHidingManager, SBModalUIFluidDismissGestureManager, SBAmbientPresentationController, SBDisplayAppInteractionEventSource, SBSystemApertureController, SBTraitsPipelineManager, SBWallpaperController, SBCoverSheetPresentationManager, SBMainDisplayLayoutStateManager, SBFloatingDockController, BNBannerController, SBSystemPointerInteractionManager, SBSceneManager, SBTransientUIInteractionManager, SBRecordingIndicatorManager;
