...
- (id)initWithContinuousConversationContext:(id)a0;
- (id)initWithContinuousConversationHearstContext:(id)a0;
- (id)initWithContinuousConversationJarvisContext:(id)a0;
