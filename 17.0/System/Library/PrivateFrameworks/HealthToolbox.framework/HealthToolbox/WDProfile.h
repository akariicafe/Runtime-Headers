@class HKDateCache, WDSourceOrderController, HKChartDataCacheController, WDUserActivityManager, _HKWheelchairUseCharacteristicCache, HKDisplayTypeController, HKHealthStore, HKUnitPreferenceController, HKSelectedTimeScopeController, WDFavoriteDisplayTypesController, HKManualEntryValidationController, NSString, HKSampleTypeDateRangeController, WDUserDefaults, HKSampleTypeUpdateController, HKHealthRecordsStore, HKUCUMUnitDisplayConverter, WDNotificationManager;
