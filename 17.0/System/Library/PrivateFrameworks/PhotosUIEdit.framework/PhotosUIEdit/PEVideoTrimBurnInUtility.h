...
+ (id)_fileType;
+ (id)_fileExtension;
+ (void)burnInTrimToNewAsset:(id)a0 compositionController:(id)a1 asShotCompositionController:(id)a2 cinematographyScript:(id)a3 queue:(id)a4 completion:(id /* block */)a5;
