...
- (int)process:(id)a0 clipped:(id)a1 lscGainsTex:(id)a2 validRect:(id)a3 awbStatsBuffer:(id)a4 awbTileStatsConfig:(struct { BOOL x0; int x1; int x2; int x3; int x4; unsigned short x5; unsigned short x6; } *)a5 anstSkinMask:(id)a6 anstSkinMaskData:(id *)a7 downsizeFactor:(unsigned int *)a8;
