...
- (void)finish;
- (void).cxx_destruct;
- (void)addFrame:(struct __CVBuffer { } *)a0 metaData:(id)a1 frameOptions:(id)a2 rectangleRequest:(id)a3 pixelFocalLength:(float)a4 cameraIntrinsicData:(struct __CFData { } *)a5;
