@interface SeymourUI.SessionPresenter : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ audioFocusPresenter;
    ...
    void /* unknown type, empty encoding */ workoutSessionConfiguration;
    void /* unknown type, empty encoding */ privacyPreferenceClient;
    void /* unknown type, empty encoding */ workoutPlanArchiver;
    ...
    void /* unknown type, empty encoding */ isPictureInPictureAllowed;
    ...
    void /* unknown type, empty encoding */ allowDistributedSessionBrokering;
    void /* unknown type, empty encoding */ termination;
    void /* unknown type, empty encoding */ workout;
    void /* unknown type, empty encoding */ onSessionCreationError;
    void /* unknown type, empty encoding */ estimatedMetricsPromptVisible;
    void /* unknown type, empty encoding */ brokerDistributedSessionRetryTimer;
