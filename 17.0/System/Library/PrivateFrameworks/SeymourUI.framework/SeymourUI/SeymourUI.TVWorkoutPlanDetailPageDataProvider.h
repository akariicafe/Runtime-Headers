@interface SeymourUI.TVWorkoutPlanDetailPageDataProvider : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ backgroundArtworkDelegate;
    ...
    void /* unknown type, empty encoding */ nextWorkoutsShelf;
    void /* unknown type, empty encoding */ weeklyWorkoutsShelves;
    void /* unknown type, empty encoding */ previousWeeklyWorkoutsShelves;
    void /* unknown type, empty encoding */ allWeeklyWorkoutShelves;
    void /* unknown type, empty encoding */ metricPage;
    void /* unknown type, empty encoding */ page;
    void /* unknown type, empty encoding */ workoutPlan;
    void /* unknown type, empty encoding */ workoutPlanSummary;
