...
+ (void)clearEventsWithHomeIdentifier:(id)a0 completion:(id /* block */)a1;
...
+ (void)writeFakeEventsWithDate:(id)a0 homeIdentifier:(id)a1 count:(long long)a2 completion:(id /* block */)a3;
