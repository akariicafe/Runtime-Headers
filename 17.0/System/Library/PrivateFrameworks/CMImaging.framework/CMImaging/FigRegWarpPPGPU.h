...
- (int)_determineNumPyrLevels:(unsigned int)a0 pyramid0Height:(unsigned int)a1;
...
- (int)computeHomography:(struct { void /* unknown type, empty encoding */ x0[3]; } *)a0 referenceKeypoints:(id)a1 nonReferenceKeypoints:(id)a2 keypointsCount:(unsigned int)a3;
- (id)initWithOptionalCommandQueue:(id)a0 config:(struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; float x7; float x8; unsigned int x9; unsigned int x10; BOOL x11; BOOL x12; } *)a1;
