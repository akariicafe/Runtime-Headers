...
+ (int)CheckParameters:(struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; float x7; float x8; unsigned int x9; unsigned int x10; BOOL x11; BOOL x12; } *)a0 imageWidth:(unsigned int)a1 imageHeight:(unsigned int)a2 imageFormat:(unsigned int)a3;
+ (unsigned int)computeExternalMemoryBlockSize:(struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; float x7; float x8; unsigned int x9; unsigned int x10; BOOL x11; BOOL x12; } *)a0 imageWidth:(unsigned int)a1 imageHeight:(unsigned int)a2 imageFormat:(unsigned int)a3;
...
+ (void)getDefaults:(struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; float x7; float x8; unsigned int x9; unsigned int x10; BOOL x11; BOOL x12; } *)a0;
+ (unsigned int)getMaxNumCorners;

- (void)releaseResources;
- (id)initWithConfig:(struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; float x7; float x8; unsigned int x9; unsigned int x10; BOOL x11; BOOL x12; } *)a0;
- (void)dealloc;
- (void).cxx_destruct;
...
- (int)computeHomography:(struct { void /* unknown type, empty encoding */ x0[3]; } *)a0 referenceKeypoints:(struct { float x0; float x1; float x2; } *)a1 nonReferenceKeypoints:(struct { float x0; float x1; float x2; } *)a2 keypointsCount:(unsigned int)a3;
