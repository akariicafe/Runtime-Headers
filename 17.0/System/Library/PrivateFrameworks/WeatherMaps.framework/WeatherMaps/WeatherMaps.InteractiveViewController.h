...
@interface WeatherMaps.InteractiveViewController : UIViewController <MKMapViewDelegate, WeatherMaps.WeatherMKMapViewAccessibilityDelegate> {
    ...
    void /* unknown type, empty encoding */ supportsControlEffects;
    void /* unknown type, empty encoding */ contentStatusBannerViewController;
    void /* unknown type, empty encoding */ pendingBannerReplacementBlock;
    ...
    void /* unknown type, empty encoding */ wasPlayingBeforeSonificationDate;
    void /* unknown type, empty encoding */ overlayIsLoading;
    void /* unknown type, empty encoding */ overlayLoadingWasInterruptedByUserInteraction;
