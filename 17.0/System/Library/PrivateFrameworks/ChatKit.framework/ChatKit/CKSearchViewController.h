...
- (long long)_indexForExistingConversationToken:(id)a0;
- (void)_insertTokenToSearchTextField:(id)a0;
- (BOOL)_isSectionShowingTokenSuggestions:(long long)a0;
...
- (id)contextMenusForConversation:(id)a0;
