...
- (id)transferWithFileURL:(id)a0 transcoderUserInfo:(id)a1 attributionInfo:(id)a2 hideAttachment:(BOOL)a3 isScreenshot:(BOOL)a4 stickerEffectType:(unsigned long long)a5;
- (id)transferWithStickerFileURL:(id)a0 transferUserInfo:(id)a1 attributionInfo:(id)a2 animatedImageCacheURL:(id)a3;
