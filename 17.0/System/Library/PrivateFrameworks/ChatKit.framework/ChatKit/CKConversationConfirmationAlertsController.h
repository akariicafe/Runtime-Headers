...
- (id)_recoveryAlertMessageForBlockedConversationsCount:(unsigned long long)a0 allowedConversationsCount:(unsigned long long)a1;
- (id)_recoveryAlertMessageForMessagesCount:(unsigned long long)a0;
- (id)_recoveryAlertTitleForBlockedConversationsCount:(unsigned long long)a0 allowedConversationsCount:(unsigned long long)a1;
- (id)_recoveryAlertTitleForMessagesCount:(unsigned long long)a0;
