...
- (id)_allowedDeviceQueriesForAccessRights:(unsigned long long)a0 isDataSeparated:(BOOL)a1;
...
- (id)_eraseDeviceFailedToEraseErrorWithUnderlayingError:(id)a0;
- (id)_eraseDeviceInvalidMDMProfileErrorWithUnderlayingError:(id)a0;
- (id)_eraseDeviceInvalidWiFiProfileErrorWithUnderlayingError:(id)a0;
...
- (id)_performSetAwaitUserConfiguration:(id)a0;
