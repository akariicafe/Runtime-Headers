@class AAUIGenericTermsRemoteUI, NSArray, ICQUICloudStorageOffersManager, NSString;
...
@property (retain, nonatomic, setter=_setOffersManager:) ICQUICloudStorageOffersManager *_offersManager;
