...
@protocol UIViewControllerInteractiveTransitioning, PXPhotosViewUIInteractionDelegate, PXMemoryAssetsActionFactory;
...
- (BOOL)allowsPreviewCommittingForContextMenuInteraction:(id)a0;
...
- (BOOL)oneUpPresentation:(id)a0 allowsPreviewCommittingForContextMenuInteraction:(id)a1;
