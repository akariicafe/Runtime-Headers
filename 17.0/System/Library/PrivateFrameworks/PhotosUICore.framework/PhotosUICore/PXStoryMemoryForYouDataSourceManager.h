@class NSDate, NSString, PXUpdater, PXStateBasedMemoriesDataSource, PHPhotoLibrary, NSObject, PXLibraryFilterState, PHFetchResult, PXFetchResultBasedMemoriesDataSourceManager;
...
- (id)initWithPhotoLibrary:(id)a0 libraryFilterState:(id)a1;
