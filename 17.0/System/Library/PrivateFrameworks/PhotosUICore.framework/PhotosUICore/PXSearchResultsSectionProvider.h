@class PHCachingImageManager, NSArray, NSDictionary, NSString, PXSearchQueryMatchInfo, PHPhotoLibrary;
...
- (void)_setSearchResults:(id)a0 searchAssetResults:(id)a1 curatedAssetsFetchResult:(id)a2 reloadItemIdentifiers:(id)a3 localizedQueryString:(id)a4 searchQueryMatchInfo:(id)a5;
