@class PXSharedLibraryStatusProvider, PXCPLPhotoLibrarySource, PXCuratedLibraryAnalysisStatus, PXCuratedLibraryViewModel, PXFooterSettings, PXAssetsDataSourceCountsController, NSString, PXCloudQuotaControllerHelper, PHPhotoLibrary, NSArray, PXCPLUIStatusProvider, PXLibraryFilterState, PXFilterFooterController;
