...
+ (void)_requestImageForContact:(id)a0 targetSize:(struct CGSize { double x0; double x1; })a1 displayScale:(double)a2 isRTL:(BOOL)a3 deliverOnce:(BOOL)a4 completion:(id /* block */)a5;
...
+ (void)requestImageForContact:(id)a0 targetSize:(struct CGSize { double x0; double x1; })a1 displayScale:(double)a2 isRTL:(BOOL)a3 deliverOnce:(BOOL)a4 completion:(id /* block */)a5;
