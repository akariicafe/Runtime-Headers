...
- (id)_createSectionHeaderLayoutForDataSource:(id)a0 sectionIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a1 spec:(id)a2 outAlignment:(unsigned long long *)a3;
