...
+ (id)createTableSQL;
+ (id)_insertEarnedInstances:(id)a0 provenance:(long long)a1 useLegacySyncIdentity:(BOOL)a2 profile:(id)a3 databaseContext:(id)a4 error:(id *)a5;
...
+ (id)_insertEarnedInstance:(id)a0 provenance:(long long)a1 syncIdentity:(long long)a2 database:(id)a3 error:(id *)a4;
...
+ (id)insertEarnedInstances:(id)a0 provenance:(long long)a1 useLegacySyncIdentity:(BOOL)a2 profile:(id)a3 databaseContext:(id)a4 error:(id *)a5;
