...
- (void)_addPrereqisiteTemplateNameFieldToTemplates:(id)a0;
...
- (void)_addSyncIdentityColumnToTemplateEntityToMigrator:(id)a0;
- (void)_removeMoveGoalMultiplierEarnedInstances:(id)a0;
- (long long)currentSchemaVersionForProtectionClass:(long long)a0;
- (void)_addAddSuffixesColumnMigrationToMigrator:(id)a0;
- (void)_removePerfectMonthEarnedInstances:(id)a0;
- (void)_addSyncIdentityColumnToEarnedInstanceEntityToMigrator:(id)a0;
