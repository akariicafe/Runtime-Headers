...
+ (id)dateTimeItemWithMaximumDate:(id)a0 displayName:(id)a1;
+ (id)dateTimeItemWithMaximumDate:(id)a0 highlightWhenEditing:(BOOL)a1 displayName:(id)a2;
...
- (void).cxx_destruct;
- (void)setValue:(id)a0;
- (id)_createHXUIInlinePickerTableViewCellWithTitle:(id)a0;
...
- (id)_createHXUIInlineDatePickerTableViewCellWithTitle:(id)a0 datePickerMode:(long long)a1 maxDate:(id)a2;
