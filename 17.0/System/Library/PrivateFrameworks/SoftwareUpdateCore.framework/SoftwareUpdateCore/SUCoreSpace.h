...
+ (void)checkPurgeableSpaceOffloadApps:(unsigned long long)a0 cacheDeleteUrgency:(long long)a1 withCompletionQueue:(id)a2 completion:(id /* block */)a3;
...
+ (void)offloadAppsPurge:(unsigned long long)a0 cacheDeleteUrgency:(long long)a1 withCompletionQueue:(id)a2 completion:(id /* block */)a3;
