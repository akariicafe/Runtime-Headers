...
+ (id)trackingInfoWithARFrame:(id)a0 worldAlignment:(long long)a1 captureOrientation:(long long)a2 interfaceOrientation:(long long)a3 constrainHeadPose:(BOOL)a4;
