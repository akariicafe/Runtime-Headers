...
@property (nonatomic) union { struct { double x; double y; double z; } ; void /* unknown type, empty encoding */ vector; } initialVelocity;
@property (nonatomic) union { struct { double x; double y; double z; } ; void /* unknown type, empty encoding */ vector; } initialTargetVelocity;
