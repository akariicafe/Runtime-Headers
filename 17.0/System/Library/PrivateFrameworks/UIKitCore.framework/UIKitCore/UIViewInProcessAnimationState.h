...
- (BOOL)_decomposeActionIfPossibleForLayer:(id)a0 key:(id)a1 view:(id)a2 currentValueVector:(id)a3 targetValue:(id)a4;
...
- (void)_runActionForLayer:(id)a0 key:(id)a1 view:(id)a2 currentValueVector:(id)a3 targetValue:(id)a4 force:(BOOL)a5;
