...
+ (id)componentsFromDateFormatString:(id)a0 locale:(id)a1 followsSystemHourCycle:(BOOL)a2;
+ (id)componentsFromDateFormatString:(id)a0 locale:(id)a1 followsSystemHourCycle:(BOOL)a2 desiredUnits:(long long)a3;
