...
+ (id)defaultSpringAnimationForKey:(id)a0 mass:(double)a1 stiffness:(double)a2 damping:(double)a3 velocity:(double)a4 allowsOverdamping:(BOOL)a5;
...
- (void)generateSpringPropertiesForPerceptualDuration:(double)a0 bounce:(double)a1 velocity:(double)a2;
