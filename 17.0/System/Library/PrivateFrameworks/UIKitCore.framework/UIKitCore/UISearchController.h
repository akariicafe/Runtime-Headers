...
@property (nonatomic, setter=_setUsesSearchSuggestionsMenuForStackedSearch:) BOOL _usesSearchSuggestionsMenuForStackedSearch;
...
- (void)_setDeferredSearchSuggestionGroups:(id)a0;
