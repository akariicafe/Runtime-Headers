...
+ (id)formatWithCalendar:(id)a0 locale:(id)a1 followsSystemHourCycle:(BOOL)a2;

- (void).cxx_destruct;
- (id)copyWithZone:(struct _NSZone { } *)a0;
- (id)initWithCalendar:(id)a0 locale:(id)a1 forceDoubleDigitHours:(BOOL)a2 displaysTimeZone:(BOOL)a3;
- (id)initWithCalendar:(id)a0 locale:(id)a1 followsSystemHourCycle:(BOOL)a2 forceDoubleDigitHours:(BOOL)a3 displaysTimeZone:(BOOL)a4;
