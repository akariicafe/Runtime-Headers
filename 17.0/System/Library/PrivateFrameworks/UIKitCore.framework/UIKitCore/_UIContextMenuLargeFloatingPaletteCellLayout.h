@class UIColor, NSArray, UIHoverStyle, NSString, _UIContextMenuCellContentView, _UIFloatingContentView;
...
- (void)_configureSharedFloatingContentViewStyleForImageStyle:(BOOL)a0;
