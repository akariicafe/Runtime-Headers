@class UIInputWindowController, UIView, NSArray, UIKBVisualEffectView, UIViewSpringAnimationBehavior, UIKeyboardFloatingTransitionState, NSString, UIPanGestureRecognizer, _UIPopoverStandardChromeView, UIKeyboardFloatingPinchGestureRecognizer, NSMapTable;
...
- (void)setKeyboardLayoutGuideInTransition:(BOOL)a0 forWindow:(id)a1;
