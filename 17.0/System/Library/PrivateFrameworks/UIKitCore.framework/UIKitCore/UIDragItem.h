...
@property (nonatomic, getter=_visibleDropItemCenter, setter=_setVisibleDropItemCenter:) struct CGPoint { double x; double y; } visibleDropItemCenter;
...
@property (nonatomic) struct CGAffineTransform { double a; double b; double c; double d; double tx; double ty; } _suggestedTransform;
