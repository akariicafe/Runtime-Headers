...
@interface _UICollectionViewLayoutSwipeActionsModule : NSObject <UISwipeActionHost_Internal> {
    struct { unsigned char layoutUpdateOrRefreshPending : 1; unsigned char hasDeferredLayoutUpdateOrRefresh : 1; unsigned char preserveExistingLayoutAttributesForSwipedViews : 1; } _flags;
}
...
- (BOOL)hasActiveSwipe;
- (void)finalizeCollectionViewUpdate:(id)a0;
...
- (void)updateWithDataSourceTranslator:(id)a0;
