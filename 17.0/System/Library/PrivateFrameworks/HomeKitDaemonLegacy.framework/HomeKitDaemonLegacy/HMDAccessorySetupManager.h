@class HMDAccessorySetupCoordinator, NSString, HMSetupAccessoryDescription, HMDHomeManager, NSUUID, HMDSBSRemoteAlertHandleProvider, HMFMessageDispatcher, NSObject, HMDXPCClientConnection;
...
- (id)_setupRequestBlockingPairedAccessoriesForHome:(id)a0;
