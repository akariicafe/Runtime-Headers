@class BKUICurvesView, BKExtendEnrollTouchIDOperation, UILabel, NSDate, NSObject, BioStreamsEventHelper, BKUIFingerPrintEnrollmentPhaseViewController, BKUIAlertView, BKDeviceTouchID, UIView, NSString, BKUIFingerPrintEnrollTutorialViewController, NSTimer, BKIdentity, BKEnrollTouchIDOperation;
@protocol OS_os_log;
...
- (void)_resetUI;
- (void)_resetUIWithTransitionToTutorial:(BOOL)a0;
...
- (void)_startInitialTutorialAnimated:(BOOL)a0;
