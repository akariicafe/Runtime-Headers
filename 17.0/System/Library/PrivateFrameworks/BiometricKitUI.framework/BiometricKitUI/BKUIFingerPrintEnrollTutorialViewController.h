...
@protocol UITraitChangeRegistration, OS_os_log, BKUIEmbeddedEnrollmentSelectionType;
...
- (id)initInBuddy:(BOOL)a0 displayRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (void)loadAVPlayer;
- (id)tutorialImage;
- (id)tutorialText;
