...
- (void)_applyStyleForCreateOrForgot:(id)a0;
...
- (void)_setCreateButtonEnabled:(BOOL)a0;
- (void)_setCreateButtonHidden:(BOOL)a0;
- (void)_setForgotButtonHidden:(BOOL)a0;
...
- (id)_userFriendlyUsername:(id)a0;
