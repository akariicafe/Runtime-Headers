...
+ (struct CGPoint { double x0; double x1; })_endPointOfBoundingLineSegmentFromPointyPointThroughtPoint:(struct CGPoint { double x0; double x1; })a0 forAnnotation:(id)a1;
+ (double)maxOutset;
+ (double)minOutset;
