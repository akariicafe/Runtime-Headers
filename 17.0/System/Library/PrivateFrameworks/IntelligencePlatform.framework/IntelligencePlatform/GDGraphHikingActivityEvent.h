@class NSNumber, NSString, GDGraphDateRelationship, NSArray, GDGraphHikingActivityEventEntityIdentifier, GDGraphLocationEntityIdentifier, GDGraphActivityEventTypeEntityIdentifier;
