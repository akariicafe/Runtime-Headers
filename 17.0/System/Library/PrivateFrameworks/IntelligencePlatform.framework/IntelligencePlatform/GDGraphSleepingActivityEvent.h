@class GDGraphActivityEventTypeEntityIdentifier, NSString, GDGraphDateRelationship, NSArray, GDGraphLocationEntityIdentifier, NSNumber, GDGraphSleepingActivityEventEntityIdentifier;
