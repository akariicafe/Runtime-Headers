@class NSNumber, NSString, GDGraphDateRelationship, NSArray, GDGraphMindfulnessActivityEventEntityIdentifier, GDGraphLocationEntityIdentifier, GDGraphActivityEventTypeEntityIdentifier;
