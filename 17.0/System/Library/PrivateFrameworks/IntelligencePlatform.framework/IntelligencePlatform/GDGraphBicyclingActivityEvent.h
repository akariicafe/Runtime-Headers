@class NSNumber, NSString, GDGraphDateRelationship, NSArray, GDGraphLocationEntityIdentifier, GDGraphBicyclingActivityEventEntityIdentifier, GDGraphActivityEventTypeEntityIdentifier;
