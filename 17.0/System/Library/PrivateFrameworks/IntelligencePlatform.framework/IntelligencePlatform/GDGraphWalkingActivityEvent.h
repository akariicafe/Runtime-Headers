@class NSNumber, NSString, GDGraphDateRelationship, GDGraphWalkingActivityEventEntityIdentifier, NSArray, GDGraphLocationEntityIdentifier, GDGraphActivityEventTypeEntityIdentifier;
