@class NSNumber, NSString, GDGraphDateRelationship, NSArray, GDGraphLocationEntityIdentifier, GDGraphDrivingActivityEventEntityIdentifier, GDGraphActivityEventTypeEntityIdentifier;
