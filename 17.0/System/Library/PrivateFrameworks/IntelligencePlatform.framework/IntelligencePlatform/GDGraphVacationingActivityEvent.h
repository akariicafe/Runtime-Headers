@class NSNumber, NSString, GDGraphDateRelationship, NSArray, GDGraphVacationingActivityEventEntityIdentifier, GDGraphLocationEntityIdentifier, GDGraphActivityEventTypeEntityIdentifier;
