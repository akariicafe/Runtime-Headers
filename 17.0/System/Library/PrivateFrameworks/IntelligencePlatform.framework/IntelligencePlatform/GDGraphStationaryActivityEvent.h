@class NSNumber, NSString, GDGraphDateRelationship, GDGraphStationaryActivityEventEntityIdentifier, NSArray, GDGraphLocationEntityIdentifier, GDGraphActivityEventTypeEntityIdentifier;
