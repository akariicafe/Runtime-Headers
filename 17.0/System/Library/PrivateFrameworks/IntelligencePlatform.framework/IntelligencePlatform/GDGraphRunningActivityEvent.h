@class NSNumber, NSString, GDGraphDateRelationship, NSArray, GDGraphRunningActivityEventEntityIdentifier, GDGraphLocationEntityIdentifier, GDGraphActivityEventTypeEntityIdentifier;
