@class NSNumber, NSString, GDGraphDateRelationship, GDGraphShoppingActivityEventEntityIdentifier, NSArray, GDGraphLocationEntityIdentifier, GDGraphActivityEventTypeEntityIdentifier;
