@class GDGraphActivityEventTypeEntityIdentifier, NSString, GDGraphDateRelationship, NSArray, GDGraphLocationEntityIdentifier, NSNumber, GDGraphWakingUpActivityEventEntityIdentifier;
