@class NSNumber, NSString, GDGraphDateRelationship, GDGraphGoingToBedActivityEventEntityIdentifier, NSArray, GDGraphLocationEntityIdentifier, GDGraphActivityEventTypeEntityIdentifier;
