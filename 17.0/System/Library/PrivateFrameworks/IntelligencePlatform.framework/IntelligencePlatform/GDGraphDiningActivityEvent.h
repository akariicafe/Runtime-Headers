@class NSNumber, NSString, GDGraphDateRelationship, GDGraphDiningActivityEventEntityIdentifier, NSArray, GDGraphLocationEntityIdentifier, GDGraphActivityEventTypeEntityIdentifier;
