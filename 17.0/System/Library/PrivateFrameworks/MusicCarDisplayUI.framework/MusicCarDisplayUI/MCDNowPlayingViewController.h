@class UITableViewController, NSString, UIActivityIndicatorView, NSArray, MPWeakTimer, UILabel, UIBarButtonItem;
...
- (void)contentManager:(id)a0 pushViewController:(id)a1;
- (void)contentManager:(id)a0 sectionName:(id)a1;
- (void)contentManager:(id)a0 setAdditionalBarButtonItems:(id)a1;
