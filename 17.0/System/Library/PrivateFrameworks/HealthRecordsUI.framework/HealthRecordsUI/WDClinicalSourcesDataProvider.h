...
- (void)beginInitialLoginSessionForGateway:(id)a0 fromViewController:(id)a1 loginCancelledHandler:(id /* block */)a2 errorHandler:(id /* block */)a3;
- (void)beginReloginSessionForAccount:(id)a0 fromViewController:(id)a1 profile:(id)a2 loginCancelledHandler:(id /* block */)a3 errorHandler:(id /* block */)a4;
