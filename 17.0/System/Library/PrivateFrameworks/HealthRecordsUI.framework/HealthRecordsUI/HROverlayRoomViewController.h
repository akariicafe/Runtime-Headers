...
+ (id)_verticalAxis;
+ (void)determineChartabilityOfOntologyConcept:(id)a0 withApplicationItems:(id)a1 completion:(id /* block */)a2;
...
- (id)initWithOntologyConcept:(id)a0 configuration:(id)a1 displayDate:(id)a2 masterDataSource:(id)a3 seriesDataSources:(id)a4 outOfRangeDataSource:(id)a5 noRangeDataSource:(id)a6 overlayMode:(long long)a7 applicationItems:(id)a8;
