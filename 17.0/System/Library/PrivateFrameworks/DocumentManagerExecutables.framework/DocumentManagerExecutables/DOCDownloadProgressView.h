@class UIColor, UITapGestureRecognizer, NSProgress, NSOperationQueue, DOCDeterminateProgressRingView, DOCIndeterminateProgressRingView, DOCGhostRingView;

@interface DOCDownloadProgressView : UIView {
    NSOperationQueue *_pendingAnimationQueue;
}

@property (class, readonly, copy, nonatomic) UIColor *defaultTrackColor;
@property (class, readonly, copy, nonatomic) UIColor *defaultTrackColorOnSelectedBackground;
@property (class, readonly, copy, nonatomic) UIColor *defaultProgressColor;
