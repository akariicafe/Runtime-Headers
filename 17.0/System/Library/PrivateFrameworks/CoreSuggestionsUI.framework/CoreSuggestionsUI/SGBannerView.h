@class SGSuggestionAction, NSString, NSArray, NSAttributedString, SGBannerDividerParameter, SGSuggestionStore, _TtC17CoreSuggestionsUI26SGBannerContentHostingView, UIVisualEffectView, _TtC17CoreSuggestionsUI15SGBannerContent, UIColor;
