@class SGSuggestionAction, NSString, NSArray, UIView, EKICSPreviewController, SGSuggestionStore, NSMutableArray, UIViewController, SGSuggestionCategoryList;
...
- (void)dismissICSPreviewController:(id)a0;
- (id)formatMixedCategoriesSubtitle:(id)a0;
- (id)formatMixedCategoriesTitle:(id)a0;
- (id)icsPreviewControllerForData:(id)a0 andEventStore:(id)a1;
