...
@interface AppStoreKit.ArtworkView : AppStoreKit.RoundedCornerView {
    ...
    void /* unknown type, empty encoding */ updatingFrameForSymbolSizeChange;
    ...
    void /* unknown type, empty encoding */ shouldSymbolImageSelfSize;
    void /* unknown type, empty encoding */ setImageDisablesAnimations;
