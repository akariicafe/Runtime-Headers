@class _TtC13iCloudQuotaUI19ICQLiftUIDataSource, NSDictionary, ICQLiftUIController, ACAccount, NSURL;
...
- (void).cxx_destruct;
- (void)didFinish;
- (void)didCancelWithUserInfo:(id)a0;
- (void)didFinishWithUserInfo:(id)a0;
