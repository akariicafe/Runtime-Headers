...
+ (id)getTitleAndDetailsForPlanType:(unsigned long long)a0 transferCapability:(unsigned long long)a1;
...
- (void)_maybeDisplayConsent:(BOOL)a0 phoneNumber:(id)a1 completion:(id /* block */)a2;
- (void)_maybeLaunchURLForCarrierDirectAuth:(id)a0;
...
- (id)initWithCrossPlatformTransferPlan:(id)a0;
