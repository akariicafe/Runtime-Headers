@class NSObject, HKHealthStore, HKHRCardioFitnessFeatureStatusManager;
@protocol HKRegulatoryDomainProvider, OS_dispatch_queue, HKFeatureAvailabilityProviding;
