...
@property (readonly, nonatomic) BOOL switchInterfaceOrNoCVMSuccess;
...
- (id)initWithVasResponses:(id)a0 cardHolderData:(id)a1 network:(id)a2 outcomeStatus:(unsigned char)a3 errorIndicationStatusWord:(id)a4 errorIndicationMsgOnError:(unsigned char)a5 cvmType:(unsigned char)a6 cvmResult:(id)a7 merchantCategoryCode:(id)a8 pinRequired:(BOOL)a9 kernelIdentityKeyAttestation:(id)a10 ecdsaCertificate:(id)a11 transactionResultData:(id)a12 kekId:(id)a13 pinKekId:(id)a14 isPinSupported:(BOOL)a15 languagePreference:(id)a16 transactionId:(id)a17 readError:(long long)a18 payAppletFinalStatus:(unsigned char)a19 isPINBypassAllowed:(BOOL)a20 forFallback:(BOOL)a21 fallbackAmount:(id)a22;
- (id)initWithVasResponses:(id)a0 cardHolderData:(id)a1 network:(id)a2 outcomeStatus:(unsigned char)a3 errorIndicationStatusWord:(id)a4 errorIndicationMsgOnError:(unsigned char)a5 cvmType:(unsigned char)a6 cvmResult:(id)a7 merchantCategoryCode:(id)a8 pinRequired:(BOOL)a9 kernelIdentityKeyAttestation:(id)a10 ecdsaCertificate:(id)a11 transactionResultData:(id)a12 kekId:(id)a13 pinKekId:(id)a14 isPinSupported:(BOOL)a15 languagePreference:(id)a16 transactionId:(id)a17 readError:(long long)a18 payAppletFinalStatus:(unsigned char)a19 isPINBypassAllowed:(BOOL)a20 forFallback:(BOOL)a21 fallbackAmount:(id)a22 switchInterfaceOrNoCVMSuccess:(BOOL)a23;
