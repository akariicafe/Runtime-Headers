...
- (id)_iCloudDeleteConfirmationViewController:(id /* block */)a0;
...
- (id)_makeRemoteSecretInputEventWithContext:(id)a0 device:(id)a1;
...
- (void)sendEscapeOfferSelectedEvent:(id)a0;
- (void)sendRemoteSecretInputEventWithContext:(id)a0 device:(id)a1;
