...
- (id)initWithTransactionAmount:(id)a0 currencyCode:(id)a1 merchantCountryCode:(id)a2 merchantIdentifier:(id)a3 originURL:(id)a4 webMerchantIdentifier:(id)a5 webMerchantName:(id)a6 merchantName:(id)a7 adamIdentifier:(id)a8 isMerchantTokenRequest:(BOOL)a9 isMultiTokenRequest:(BOOL)a10 channel:(unsigned long long)a11 channelType:(unsigned long long)a12 supportedNetworks:(id)a13 suppressionMode:(long long)a14;
