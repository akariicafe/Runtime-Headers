...
+ (id)inAppQueryWithSupportedNetworkIDs:(id)a0 merchantCapabilities:(unsigned long long)a1 merchantCountryCode:(id)a2 paymentMode:(long long)a3 paymentApplicationStates:(id)a4 paymentRequestType:(id)a5 isMultiTokensRequest:(BOOL)a6 webService:(id)a7;
...
- (void).cxx_destruct;
- (id)initWithIssuedOnTheWeb:(BOOL)a0 supportedNetworkIDs:(id)a1 merchantCapabilities:(unsigned long long)a2 merchantCountryCode:(id)a3 paymentMode:(long long)a4 paymentApplicationStates:(id)a5 paymentRequestType:(id)a6 isMultiTokensRequest:(BOOL)a7 webService:(id)a8;
