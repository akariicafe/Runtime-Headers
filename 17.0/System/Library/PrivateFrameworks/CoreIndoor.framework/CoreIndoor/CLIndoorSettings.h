...
@property (nonatomic) struct duration<long double, std::ratio<1>> { long double __rep_; } debounceInterval;
@property (nonatomic) struct duration<long long, std::ratio<1, 1000000000>> { long long __rep_; } errorBackoffDuration;
@property (nonatomic) struct duration<long long, std::ratio<1>> { long long __rep_; } tilePrefetchActivityInterval;
...
@property (nonatomic) struct duration<long long, std::ratio<1>> { long long __rep_; } tilePrefetchRelevancyWindow;
