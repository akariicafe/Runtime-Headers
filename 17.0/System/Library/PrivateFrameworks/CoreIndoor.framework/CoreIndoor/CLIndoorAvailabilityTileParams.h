@interface CLIndoorAvailabilityTileParams : NSObject {
    struct optional<proto::params::LocalizerParameters> { BOOL m_initialized; struct aligned_storage<proto::params::LocalizerParameters> { union dummy_u { char data[312]; struct a8 { } aligner_; } dummy_; } m_storage; } _optionalParams;
}
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (struct optional<proto::params::LocalizerParameters> { BOOL x0; struct aligned_storage<proto::params::LocalizerParameters> { union dummy_u { char x0[312]; struct a8 { } x1; } x0; } x1; })localizerParams;
