@interface _TtCV16MagnifierSupport13MFEnvironment8LiveLens : _TtCV16MagnifierSupport13MFEnvironment8Category {
    ...
    void /* unknown type, empty encoding */ _usingCameraMacroControl;
    void /* unknown type, empty encoding */ _cameraType;
    void /* unknown type, empty encoding */ _hasSwitchedFirstCamera;
    void /* unknown type, empty encoding */ _lastVideoOrientation;
    ...
    void /* unknown type, empty encoding */ _liveImageBuffer;
    void /* unknown type, empty encoding */ _filterScrubberExpanded;
}
