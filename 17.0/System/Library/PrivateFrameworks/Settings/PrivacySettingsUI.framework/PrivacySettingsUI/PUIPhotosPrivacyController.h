...
+ (void)setTCCForService:(struct __CFString { } *)a0 appIdentifier:(id)a1 value:(int)a2 completion:(id /* block */)a3;
...
- (id)appSpecifierWithName:(id)a0 bundleID:(id)a1 showPhotosAccess:(BOOL)a2 showPhotosAddAccess:(BOOL)a3 showPickerUsage:(BOOL)a4;
