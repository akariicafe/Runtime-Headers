@class NSMutableDictionary, NSMapTable, WFAction, NSDate, WFWorkflowControllerState, WFContentCollection, WFSmartPromptsExfiltrationLogger, WFOutOfProcessWorkflowController, NSDictionary, NSObject, WFContentItemCache, WFWorkflowRunningContext, WFControlFlowAttributionTracker, NSString, WFWorkflowRunViewSource, RBSAssertion, WFWorkflow, NSProgress;
