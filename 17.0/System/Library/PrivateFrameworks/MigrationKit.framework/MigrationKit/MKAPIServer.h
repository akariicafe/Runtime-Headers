@class MKDisplaySettingMigrator, MKProgress, MKPhotoLibraryMigrator, MKAccessibilitySettingMigrator, MKPlaceholderMigrator, MKContainerMigrator, MKHTTPServer, MKContactMigrator, NSString, MKDiagnosticsMigrator, NSHashTable, NSDate, MKContext, MKFileMigrator, MKCertificate, MKPhotoLibraryAlbumMigrator, MKClient, MKApplicationMigrator, MKAccountMigrator, MKSIMMigrator, MKCalendarMigrator, MKGETStatusRouter, MKBookmarkMigrator, MKMessageMigrator;
@protocol MKAPIServerDelegate;

@interface MKAPIServer : NSObject <MKHTTPServerDelegate, MKGETSRPRouterDelegate, MKGETCertificateRouterDelegate, MKPOSTCertificateRouterDelegate, MKPUTRouterDelegate, MKPOSTClientRouterDelegate, MKPOSTSRPRouterDelegate, MKPOSTProgressRouterDelegate, MKMigratorDelegate, MKDELETESIMRouterDelegate> {
    BOOL _success;
    BOOL _isImporting;
...
- (void)router:(id)a0 didReceiveImageChunk:(id)a1 identifier:(id)a2 offset:(unsigned long long)a3 length:(unsigned long long)a4 total:(unsigned long long)a5 filename:(id)a6 collection:(id)a7 originalFilename:(id)a8;
...
- (void)router:(id)a0 didReceiveSIMEncodedInJSON:(id)a1;
- (void)router:(id)a0 didReceiveVCard:(id)a1;
- (void)router:(id)a0 didReceiveVideoChunk:(id)a1 identifier:(id)a2 offset:(unsigned long long)a3 length:(unsigned long long)a4 total:(unsigned long long)a5 filename:(id)a6 collection:(id)a7 originalFilename:(id)a8;
