...
- (id)initWithPresentingViewController:(id)a0 detailViewController:(id)a1 shouldPlayFlipInAnimation:(BOOL)a2 initialBadgeFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 conversionView:(id)a4 willStartAnimationBlock:(id /* block */)a5 presentAlongsideBlock:(id /* block */)a6 dismissAlongsideBlock:(id /* block */)a7 completionBlock:(id /* block */)a8;
