...
+ (int)_actionForCertificate:(struct __SecCertificate { } *)a0 policy:(struct __SecPolicy { } *)a1 uncommentedAddress:(id)a2;
+ (int)actionForEncryptionCertificate:(struct __SecCertificate { } *)a0 address:(id)a1;
+ (int)actionForSigningIdentity:(struct __SecIdentity { } *)a0 address:(id)a1;
