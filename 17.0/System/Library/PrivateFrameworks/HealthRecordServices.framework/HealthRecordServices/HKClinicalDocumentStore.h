...
- (void)notifyDownloadingCompleteAndRequestMoreWithIdentifiers:(id)a0 requestBatchSize:(id)a1 completion:(id /* block */)a2;
...
- (void)runMedicalDownloadableAttachmentPipelineWithCompletion:(id /* block */)a0;
- (void)updateErrorStatusAndRetryCountForAttachmentWithIdentifier:(id)a0 errorStatus:(long long)a1 lastError:(id)a2 retryCount:(long long)a3 completion:(id /* block */)a4;
