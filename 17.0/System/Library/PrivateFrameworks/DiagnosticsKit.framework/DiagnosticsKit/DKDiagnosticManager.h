...
@protocol DKProgressResponder, DKViewControllerDelegate, DKAssetResponder, DKUserAlertResponder, DKBrightnessResponder, OS_dispatch_queue, DKVolumeHUDResponder, DKAccessoryResponder;

@interface DKDiagnosticManager : NSObject <DKProgressResponder, DKAssetResponder, DKAccessoryResponder, DKBrightnessResponder, DKVolumeHUDResponder, DKRequestViewControllerDelegate, DKUserAlertResponder, DKPluginReloadResponder>
