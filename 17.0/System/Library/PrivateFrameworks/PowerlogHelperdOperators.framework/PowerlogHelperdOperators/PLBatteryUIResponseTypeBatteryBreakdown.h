...
- (short)getWidgetTypeForEnergyEntry:(id)a0;
- (short)getWidgetTypeForHostName:(id)a0;
- (id)getWidgetUpdateTypeToCount:(id)a0 inRange:(struct _PLTimeIntervalRange { double x0; double x1; })a1;
