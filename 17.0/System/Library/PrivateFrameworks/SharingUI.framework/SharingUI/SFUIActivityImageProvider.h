...
- (int)requestImageForBundleIdentifier:(id)a0 activityCategory:(long long)a1 contentSizeCategory:(id)a2 iconFormat:(int)a3 synchronous:(BOOL)a4 resultHandler:(id /* block */)a5;
- (id)_fetchActionImageForActivity:(id)a0 contentSizeCategory:(id)a1 imageSymbolConfiguration:(id)a2;
- (void)_fetchBundleImageForBundleIdentifier:(id)a0 activityCategory:(long long)a1 contentSizeCategory:(id)a2 iconFormat:(int)a3;
