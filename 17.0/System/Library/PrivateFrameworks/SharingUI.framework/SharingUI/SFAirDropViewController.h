@class NSString, _SFAirDropRemoteViewController, _UIRemoteViewController, NSExtension, UIViewController;
...
- (void)airDropViewServiceRequestingSendingAppBundleIdentifierWithCompletionHandler:(id /* block */)a0;
