...
- (id)initWithRequestID:(int)a0 identifier:(id)a1 activityCategory:(long long)a2 contentSizeCategory:(id)a3 iconFormat:(int)a4 synchronous:(BOOL)a5 resultHandler:(id /* block */)a6;
