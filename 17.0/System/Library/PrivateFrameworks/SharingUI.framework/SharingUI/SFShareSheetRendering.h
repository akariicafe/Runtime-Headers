...
+ (long long)_hostIdiomFromConfig:(id)a0;
+ (id)_nearbyBadgeFontForIdiom:(long long)a0;
+ (double)_nearbyBadgeNumberStringTopInsetForIdiom:(long long)a0;
+ (double)_normalCellWidthForIdiom:(long long)a0;
