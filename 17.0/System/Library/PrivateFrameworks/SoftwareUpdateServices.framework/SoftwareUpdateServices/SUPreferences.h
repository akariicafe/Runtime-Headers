...
@property (nonatomic, setter=enablePreviousUserSpecifiedAutoDownload:) BOOL previousUserSpecifiedAutoDownload;
...
@property (readonly, nonatomic) BOOL useSUCoreXPCActivityScheduler;
...
@property (readonly, nonatomic) BOOL haveEnoughSpace;
@property (readonly, nonatomic) BOOL spacePurgeSuccessful;
@property (readonly, nonatomic) BOOL bypassSystemRootWarning;
@property (readonly, nonatomic) BOOL disableAutoDownloadJitter;
