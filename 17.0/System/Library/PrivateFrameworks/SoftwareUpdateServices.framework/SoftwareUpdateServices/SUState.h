@class NSDate, SUInstallPolicy, SUDownload, NSDictionary, NSObject, NSMutableArray, SURollbackDescriptor, SUCorePersistedState, NSString, SUDescriptor, SUManagedDeviceUpdateDelay, SUCoreDescriptor, SUCoreDDMDeclaration, NSArray, SUScanOptions, _SUAutoInstallOperationModel, NSNumber;
...
- (void)setDdmPersistedErrorDescription:(id)a0;
