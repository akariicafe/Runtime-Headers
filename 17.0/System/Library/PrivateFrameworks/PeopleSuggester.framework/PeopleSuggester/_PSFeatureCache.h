@class NSUserDefaults, LCFFeatureStore, _PSPredictionContext, NSArray, NSSet, NSMutableDictionary, _CDInteractionStore, BMSource, NSObject, _PSHistogramFeatureData, _PSShareSheetEphemeralFeatureManager;
