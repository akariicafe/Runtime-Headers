@class NSError, NSString, NSURL, VUIMutableBookmark, NSDictionary, VUIStoreFPSKeyLoader, NSObject, TVPPlayer, VUIVideoManagedObject;
...
- (BOOL)hasTrait:(id)a0;
- (id)initWithVideoManagedObject:(id)a0 isForStartingDownload:(BOOL)a1;
