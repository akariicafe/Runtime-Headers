...
@interface VideosUI.RootSplitViewController : UISplitViewController <VUIRootSplitViewController, UISplitViewControllerDelegate, UISplitViewControllerDelegatePrivate, VUITVAppNavigationControllerObserver, UIPopoverPresentationControllerDelegate, AMSUIMessageViewControllerDelegate, VUITVAppRootViewController> {
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_splitTabBarController;
    ...
    void /* unknown type, empty encoding */ stagedLibrarySidebarItems;
    ...
    void /* unknown type, empty encoding */ userHasHiddenSidebar;
