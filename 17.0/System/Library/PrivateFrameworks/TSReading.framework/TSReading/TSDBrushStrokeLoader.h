...
- (void)p_loadLineEndTextureForBrush:(id)a0 lineEnd:(id)a1 path:(struct CGPath { } *)a2 andBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3;
