...
+ (void)presentProductPageWithTitle:(id)a0 body:(id)a1 approve:(id)a2 decline:(id)a3 itemIdentifier:(id)a4 previewURL:(id)a5 offerName:(id)a6 requestString:(id)a7 requestSummary:(id)a8 priceSummary:(id)a9;
