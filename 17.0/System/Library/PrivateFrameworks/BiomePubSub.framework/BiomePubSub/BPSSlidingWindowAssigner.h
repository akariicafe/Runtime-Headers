...
- (id)updateWindowStateNonOverlappingIntervals:(id)a0 timestamp:(id)a1 input:(id)a2;
- (id)updateWindowStateOverlappingIntervals:(id)a0 timestamp:(id)a1 input:(id)a2;
