...
+ (id)assetWriterWithURL:(id)a0 andTrack:(id)a1 andBitrate:(long long)a2 withOutputSize:(struct CGSize { double x0; double x1; })a3 enableAudio:(BOOL)a4;
...
- (void).cxx_destruct;
- (void)cancel;
- (int)setupVideoTrack:(long long)a0 withOutputSize:(struct CGSize { double x0; double x1; })a1;
- (int)setupAudioTrack;
...
- (id)initWithURL:(id)a0 andTrack:(id)a1 andBitrate:(long long)a2 withOutputSize:(struct CGSize { double x0; double x1; })a3 enableAudio:(BOOL)a4;
