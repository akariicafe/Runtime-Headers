...
- (id)_writeRepresentationsForImage:(struct CGImageSource { } *)a0 target:(long long)a1 sourceURL:(id)a2 sizes:(id)a3 maxDimension:(unsigned long long)a4 srcUTI:(struct __CFString { } *)a5 inFormat:(struct __CFString { } *)a6 estimator:(id)a7 isLQMEnabled:(BOOL)a8 telemetry:(id)a9;
