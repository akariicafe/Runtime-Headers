@class UIView, CEKSliderDotView, CEKSliderTickMarksView, CEKEdgeGradientView, CEKSelectionFeedbackGenerator, UIImageView, CEKAnimationGenerator, NSString, UILabel, UIScrollView;
