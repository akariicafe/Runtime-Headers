...
- (struct CGPath { } *)centerShadowPathWithSize:(struct CGSize { double x0; double x1; })a0 width:(double)a1;
- (struct CGPath { } *)centerPathWithSize:(struct CGSize { double x0; double x1; })a0;
- (id)initWithRotationAngle:(double)a0;
- (double)intensityForPlane:(long long)a0;
- (struct CGPath { } *)pathForOutlineWithSize:(struct CGSize { double x0; double x1; })a0 cornerRadius:(double)a1;
- (struct CGPath { } *)pathForPlane:(long long)a0 size:(struct CGSize { double x0; double x1; })a1;
