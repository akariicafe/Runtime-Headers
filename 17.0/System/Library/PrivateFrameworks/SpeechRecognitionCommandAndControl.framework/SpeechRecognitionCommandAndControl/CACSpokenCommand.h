...
- (id)_axActionOfType:(long long)a0 forElement:(id)a1;
- (void)_didShowOverlayWithHintIdentifier:(id)a0 hint:(id)a1;
- (void)_displayNumberedGridAtCurrentNumberOfColumnsAndRows;
- (id)_dragActionForLabeledElement:(id)a0;
- (id)_dropActionForLabeledElement:(id)a0;
- (id)_elementActionManager;
- (BOOL)_endDragForLabeledElement:(id)a0;
...
- (BOOL)_startDragForLabeledElement:(id)a0;
...
- (void)surroundSelectionWithPunctuation:(id)a0;
- (void)swipeDown;
- (void)swipeLeft;
- (void)swipeRight;
