...
- (BOOL)unearnedAchievementIsVisibleNow:(id)a0 activityMoveMode:(long long)a1 experienceType:(unsigned long long)a2 isFitnessPlusSubscriber:(BOOL)a3;
- (BOOL)unearnedAchievementIsVisibleNow:(id)a0 activityMoveMode:(long long)a1 experienceType:(unsigned long long)a2 isFitnessPlusSubscriber:(BOOL)a3 isWheelchairUser:(BOOL)a4;
