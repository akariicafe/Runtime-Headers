...
- (void)_sendAsyncMessageToServer:(id)a0 withIdentifier:(unsigned long long)a1 completion:(id /* block */)a2;
- (id)_sendMessageToServer:(id)a0 withIdentifier:(unsigned long long)a1;
- (id)_sendMessageToServer:(id)a0 withIdentifier:(unsigned long long)a1 error:(id *)a2;
...
- (void)clearQuickActionsWithCompletion:(id /* block */)a0;
...
- (void)requestCrownPressWithCompletionHandler:(id /* block */)a0;
...
- (void)unregisterQuickActionIdentifiers:(id)a0 startupCallback:(id /* block */)a1;
