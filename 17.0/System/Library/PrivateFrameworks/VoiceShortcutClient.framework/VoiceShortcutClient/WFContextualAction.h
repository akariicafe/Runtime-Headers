...
- (void)wf_launchAppIfNeededUsingSurface:(unsigned long long)a0 linkAction:(id)a1 appBundleIdentifier:(id)a2 actionIdentifier:(id)a3;
- (BOOL)wf_shouldLaunchApWithSurface:(unsigned long long)a0 linkAction:(id)a1 actionMetadata:(id)a2 appBundleIdentifier:(id)a3 actionIdentifier:(id)a4;
