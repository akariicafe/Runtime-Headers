...
@property (readonly, nonatomic) BOOL isRemoteUnmanagedChild;
@property (readonly, nonatomic) BOOL isLocalOrRemotelyManagedUser;
@property (readonly, nonatomic) BOOL isLocalOrRemotelyManagedUserWithScreenTimeDisabled;
...
@property (readonly, nonatomic) BOOL canEditScreenTimePasscode;
