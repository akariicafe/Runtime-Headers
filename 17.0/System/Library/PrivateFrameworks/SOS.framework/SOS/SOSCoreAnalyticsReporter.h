...
+ (void)reportSOSAutomaticCallCountdownEnabled:(BOOL)a0;
+ (void)reportSOSAutomaticNewtonEnabled:(BOOL)a0;
+ (void)reportSOSLongPressTriggersEmergencySOS:(BOOL)a0;
+ (void)reportSOSNumberOfVoiceLoops:(long long)a0;
+ (void)reportSOSShouldPlayAudioDuringCountdown:(BOOL)a0;
