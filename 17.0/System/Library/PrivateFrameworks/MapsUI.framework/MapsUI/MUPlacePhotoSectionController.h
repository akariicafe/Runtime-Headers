@class UIImageView, MUPlaceSectionView, MUPlacePhotoSectionControllerConfiguration, MKLookAroundView, MKLookAroundContainerView, MUPlaceSectionHeaderViewModel, UIViewController, MUUserSubmittedPhoto, MUPlacePhotoGalleryViewController, UIView, MUPunchoutViewModel, NSString, NSArray, MUPlaceCallToActionAppearance, MUPhotoSliderTileProvider, MUPlaceSectionFooterViewModel, MUPlacePhotoSliderView;
