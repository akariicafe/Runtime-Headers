@class UIView, MUPlaceSectionFooterViewModel, NSString, NSArray, MUPlaceSectionHeaderViewModel, MUPlaceCallToActionAppearance, MUScrollableStackView, MUPlaceRatingReviewTitleBuilder, UIViewController, MUPlaceSectionView, MUPlaceReviewAvatarGenerator;
