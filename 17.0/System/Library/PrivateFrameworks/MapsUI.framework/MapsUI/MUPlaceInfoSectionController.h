@class MUPlaceInfoSectionView, MUPlaceSectionHeaderViewModel, UIViewController, MUPlaceDataAvailability, NSMutableArray, UIView, GEOPlaceDetailsModuleConfiguration, NSString, MUDisclosureActionRowView, MUPlaceHoursSectionViewConfiguration, NSArray, MUPlaceCallToActionAppearance, MUContactsViewModelGenerator, MUPlaceSectionFooterViewModel, GEOInlineRapEnablement;
...
- (id)_loadViewWithContactMetadata:(id)a0;
