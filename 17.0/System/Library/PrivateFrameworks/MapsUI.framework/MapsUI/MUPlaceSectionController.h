@class UIView, MUPlaceSectionHeaderViewModel, NSArray, GEOAPPlaceCardModule, MKMapItem, MUPlaceSectionFooterViewModel, MUPlaceCallToActionAppearance, NSString, UIViewController, GEORevealedPlaceCardModule, MUImpressionElement;
