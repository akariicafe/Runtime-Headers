@class UIView, MUPlaceSectionFooterViewModel, NSArray, MUPlaceSectionHeaderViewModel, MUPlaceCallToActionAppearance, NSString, MUTextPairVerticalCardView, UIViewController, MUPlaceSectionView;
