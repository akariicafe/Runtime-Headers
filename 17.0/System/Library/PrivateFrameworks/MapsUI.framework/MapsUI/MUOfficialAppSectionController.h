@class UIView, MUPlaceSectionFooterViewModel, NSString, NSArray, MUPlaceSectionHeaderViewModel, MUPlaceCallToActionAppearance, MUPlaceAppLockupView, GEOAppleMediaServicesResult, MUTimeExpirableLRUCache, UIViewController, MUPlaceSectionView;
