@class UIView, MUPlaceSectionFooterViewModel, NSString, NSArray, MUPlaceSectionHeaderViewModel, MUPlaceCallToActionAppearance, MUPlaceTilesView, UIImageView, MUPunchoutViewModel, UIViewController, MUPlacePhotoGalleryViewController, MUPlaceSectionView;
