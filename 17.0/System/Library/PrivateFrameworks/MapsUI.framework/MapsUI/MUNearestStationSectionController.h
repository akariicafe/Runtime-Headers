@class MUPlaceSectionView, MKMapItem, MUPlaceSectionHeaderViewModel, UIViewController, MUPlaceFooterAtributionViewModel, UIView, NSString, MKETAProvider, MUPlaceVerticalCardContainerView, NSArray, MUPlaceCallToActionAppearance, MUPlaceSectionFooterViewModel, MUNearestStationRowView;
