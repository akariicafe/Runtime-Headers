@class MUWebContentViewController, MUPlaceSectionView, MUPlaceEnrichmentContextMenu, MUPlaceSectionHeaderViewModel, UIViewController, UIContextMenuInteraction, UIView, MUPlaceEnrichmentActionManager, NSString, GEOEnrichmentData, NSArray, MUPlaceCallToActionAppearance, MUPlaceEnrichmentAction, MUPlaceSectionFooterViewModel;
