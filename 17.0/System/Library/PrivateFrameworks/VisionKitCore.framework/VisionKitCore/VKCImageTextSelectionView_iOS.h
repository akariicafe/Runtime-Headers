@class UITextInputPasswordRules, VKCTextSelectionLongPressDelegateHandler, UITextRange, UIInputContextHistory, NSDictionary, VKCTextPointerTrackingView, VKTextRange, UITextSelectionGrabberSuppressionAssertion, UITextInteraction, UIColor, UIDragInteraction, UILongPressGestureRecognizer, NSString, NSIndexSet, UITextInputStringTokenizer, _UISupplementalLexicon, NSArray, UITextPosition, UIView, UIImage;
...
- (id)preSelectionChangeSelectedRangeForTextRecognitionResult:(id)a0;
- (id)text;
- (void)deleteBackward;
...
- (void)setSelectedVKRange:(id)a0;
- (void)presentShareSheetForCustomStrings:(id)a0 attributedString:(id)a1;
- (unsigned long long)currentDraggedRectEdge;
- (id)selectedRangeForTextRecognitionResult:(id)a0;
