...
- (id)initWithFocusModeUUID:(id)a0 configurationType:(long long)a1 variant:(long long)a2 options:(unsigned long long)a3 imageScaleRelativeToScreen:(double)a4 orientation:(long long)a5 maxCount:(unsigned long long)a6;
