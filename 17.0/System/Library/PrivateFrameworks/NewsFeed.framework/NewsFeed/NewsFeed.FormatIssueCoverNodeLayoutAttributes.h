@interface NewsFeed.FormatIssueCoverNodeLayoutAttributes : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ nodeIdentifier;
    ...
    void /* unknown type, empty encoding */ issueCoverViewLayoutAttributes;
    void /* unknown type, empty encoding */ auxViewRequirements;
}
