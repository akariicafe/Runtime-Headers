...
- (id /* block */)scheduledStickerResourceProviderForThumbnailForModelPreset:(id)a0 presetOverrides:(id)a1 avatarConfiguration:(id)a2 stickerConfiguration:(id)a3 correctClipping:(BOOL)a4;
