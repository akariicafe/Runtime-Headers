...
- (id)readOnlySharingType:(long long)a0 withFilter:(BOOL)a1;
- (void)fetchPermissionsOnQueue:(id)a0 completion:(id /* block */)a1;
- (void)filterPeopleWithPredicate:(id)a0;
- (void)filterReadOnlySharingPeopleWithPredicate:(id)a0;
- (void)filterReadOnlySharingTypesWithPredicate:(id)a0;
...
- (long long)readOnlySharingPeopleCountWithFilter:(BOOL)a0;
- (id)readOnlySharingPerson:(long long)a0 withFilter:(BOOL)a1;
- (long long)readOnlySharingTypesCountWithFilter:(BOOL)a0;
