@interface NEFeedNavImageAssetHandle : NSObject {
    ...
    void /* unknown type, empty encoding */ overrideFallbackColor;
}
...
- (id)initWithTag:(id)a0 feedNavImageSize:(struct CGSize { double x0; double x1; })a1 feedNavImageStyler:(id)a2 scale:(double)a3 overrideFallbackColor:(id)a4;
