@interface NewsUI2.SearchService : NSObject {
    ...
    void /* unknown type, empty encoding */ configPromise;
    void /* unknown type, empty encoding */ searchEndpointConfigs;
    void /* unknown type, empty encoding */ searchEndpointConfigManager;
    ...
    void /* unknown type, empty encoding */ localAreas;
