@class MTIDCache, NSString, MTInterprocessChangeNotifier, NSMutableDictionary, MTIDConfig, NSObject, MTPromise, NSNumber;
...
- (void)_getIDs;
- (id)_IDInfoForNamespace:(id)a0 options:(id)a1 fromConfig:(id)a2;
- (void)_getConfig;
- (void)_getSecrets;
- (void)_resetIDs;
- (id)configPromise;
