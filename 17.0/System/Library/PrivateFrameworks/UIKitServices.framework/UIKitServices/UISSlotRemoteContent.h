...
- (id)newTouchAuthenticationSpecificationWithAuthenticationMessageContext:(unsigned long long)a0 backgroundStatisticsRegion:(struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; })a1 backgroundStatisticsForeground:(float)a2 backgroundStatisticsPassingContrast:(float)a3 backgroundStatisticsFailingContrast:(float)a4 hitTestInformationMask:(unsigned long long)a5 initialSampleEvent:(long long)a6 secureName:(unsigned int)a7;
