...
- (void)_endReporting;
- (id)_expressEnableFailureAlertWithRetryIndexPath:(id)a0;
...
- (void)_reportExpressModeEnable:(id)a0 conflictingPasses:(id)a1;
- (void)_reportExpressModeEvent:(id)a0 forPass:(id)a1 conflictingPasses:(id)a2;
