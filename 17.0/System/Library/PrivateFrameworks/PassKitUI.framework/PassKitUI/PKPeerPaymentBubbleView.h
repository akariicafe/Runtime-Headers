@class NSDate, NSString, PKContinuousButton, PKPeerPayment3DTextView, PKPeerPaymentRecurringPaymentMemo, UIActivityIndicatorView, CAShapeLayer, UIImageView, NSTimer, NSDecimalNumber, UILabel;
