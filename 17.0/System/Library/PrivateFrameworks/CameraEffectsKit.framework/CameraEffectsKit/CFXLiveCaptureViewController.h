@class UIView, CFXEffectComposition, JFXImageView, UIColor, JFXVideoWriter, CFXRenderer, NSString, JTImage, NSObject, NSMutableArray, JFXOrientationMonitor, CFXThermalPolicyManager;
