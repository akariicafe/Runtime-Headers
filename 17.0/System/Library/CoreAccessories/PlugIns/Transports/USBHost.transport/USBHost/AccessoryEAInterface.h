...
- (struct IOUSBInterfaceStruct942 **)_createInterfaceFromUSBID:(unsigned long long)a0;
...
- (BOOL)closeDataPipes;
- (id)initWithProtocol:(id)a0 endpointUUID:(id)a1 vid:(unsigned short)a2 pid:(unsigned short)a3 eaSessionUUID:(id)a4 USBDeviceID:(unsigned long long)a5;
