@class UIViewController, HUGridHomeCell, NSString, HFItem, HUMosaicLayoutGeometry, HFHomeKitDispatcher, HUGridLayoutOptions, HUMosaicLayout, UICollectionViewCell, HUCCSmartGridItemManager;
@protocol HFAccessoryRepresentableItem, HUOpenURLHandling, HFServiceLikeItem, HUCCSmartGridViewControllerDelegate, HUPresentationDelegateHost;
