@class UIView, NSString, HUCCSmartContainerView, HUCCSmartGridViewController, UIViewPropertyAnimator, NSDictionary, HUCCDashboardContainerViewController, UIViewController, UIVisualEffectView, HUCCSmartGridPropertyAnimator, UILabel;
@protocol HUOpenURLHandling, HUCCAccessoryControlsHosting, HUCCSmartGridContentViewControllerDelegate, NSObject;
...
- (void)willDismissAccessoryControlsViewController:(id)a0;
- (void)willPresentAccessoryControlsViewController:(id)a0;
