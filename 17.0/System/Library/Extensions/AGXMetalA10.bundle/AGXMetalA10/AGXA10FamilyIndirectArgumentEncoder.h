...
@interface AGXA10FamilyIndirectArgumentEncoder : IOGPUMetalIndirectArgumentEncoder <MTLArgumentEncoder> {
    struct IndirectArgumentEncoder { AGXA10FamilyDevice *device; struct IndirectArgumentLayout *layout; char *arguments; AGXA10FamilyBuffer *current_argument_buffer; } _impl;
}
