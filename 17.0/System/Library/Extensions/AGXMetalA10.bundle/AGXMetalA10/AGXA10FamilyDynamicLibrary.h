...
@interface AGXA10FamilyDynamicLibrary : _MTLDynamicLibrary <MTLDynamicLibrarySPI> {
    struct shared_ptr<AGX::G9::DynamicLibrary> { struct DynamicLibrary *__ptr_; struct __shared_weak_count *__cntrl_; } _impl;
}
