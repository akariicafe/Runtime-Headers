...
@interface VPNConnectionStore : NSObject {
    BOOL _gradeCurrentConnectionHasBeenSet[9];
    VPNConnection *_gradeCurrentConnection[9];
    NSUUID *_gradeActiveVPNID[9];
    BOOL _gradeActiveVPNIDLoaded[9];
    NSMutableArray *_gradeVPNServiceIDs[9];
    NSMutableDictionary *_connectionDict[9];
}
...
- (id)currentPerAppConnections:(BOOL)a0 withGrade:(unsigned long long)a1;
