...
@protocol OS_xpc_object, OS_dispatch_data, OS_nw_context, OS_nw_parameters, OS_nw_protocol_options, OS_nw_protocol_metadata, OS_dispatch_queue;

@interface nwswifttls : NSObject {
