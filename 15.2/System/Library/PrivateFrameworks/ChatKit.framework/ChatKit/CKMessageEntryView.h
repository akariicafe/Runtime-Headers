@class UIVisualEffectView, CKActionMenuGestureRecognizerButton, UILabel, CKMessageEntryContentView, NSMutableSet, CKMentionEntityNode, CKMessageEntryWaveformView, CKScheduledUpdater, NSString, CKBrowserSwitcherFooterView, CKAudioRecorder, NSMutableDictionary, UIInputContextHistory, UIKBVisualEffectView, CAMShutterButton, NSArray, UIButton, _UIClickInteraction, CKComposition, UIView, CKActionMenuController, _UISupplementalLexicon, CKInlineAudioReplyButtonController, UISwipeGestureRecognizer, CKMessageEntryRecordedAudioView, CKMessageEntryAudioHintView, UITraitCollection, CKPaddleOverlayView, CKMentionSuggestionView, CKEntryViewButton, CKConversation;
@protocol _UIClickInteractionDelegate, CKExternalAppBrowserMenuHost, CKMessageEntryViewDelegate, UITextInputTraits_Private, CKMessageEntryViewInputDelegate;
