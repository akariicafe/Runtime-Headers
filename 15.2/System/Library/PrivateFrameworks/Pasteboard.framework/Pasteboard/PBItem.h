@class NSData, NSUUID, NSArray, NSURL, NSString, NSMutableDictionary, NSDictionary, NSMutableOrderedSet;
...
- (void)uikit_loadObjectOfClass:(Class)a0 completionBlock:(id /* block */)a1;
...
- (void)_loadObjectOfClass:(Class)a0 completionBlock:(id /* block */)a1;
- (void)_loadRepresentationAsType:(id)a0 completionBlock:(id /* block */)a1;
...
- (void)loadObjectOfClass:(Class)a0 completionBlock:(id /* block */)a1;
