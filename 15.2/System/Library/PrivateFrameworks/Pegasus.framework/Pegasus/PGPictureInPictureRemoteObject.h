@class PGInterruptionAssistant, UIImage, NSObject, FBScene, PGProcessAssertion, PGPlaybackState, NSString, NSTimer, PGPictureInPictureViewController, NSArray, NSXPCConnection, PGPictureInPictureApplication, NSUUID;
...
- (oneway void)setScreenSharingTitle:(id)a0 avatar:(id)a1;
