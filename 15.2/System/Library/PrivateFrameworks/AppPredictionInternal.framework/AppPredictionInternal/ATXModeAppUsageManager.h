...
- (id)_totalAppLaunchesPerMode:(id)a0;
- (id)_calculateResponseTimeStatistics:(id)a0;
- (id)_probabilityModeGivenApp:(id)a0 appLaunchThreshold:(double)a1;
...
- (BOOL)isAppNotificationsAllowedInMode:(int)a0 forBundle:(id)a1;
...
- (id)calculateAppScoresWithAppLaunchThreshold:(double)a0;
