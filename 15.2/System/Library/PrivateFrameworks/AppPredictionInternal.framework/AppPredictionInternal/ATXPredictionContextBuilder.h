@class ATXBiomePredictionContextStream, NSDate, ATXBiomeLocationStream, _PASLock;
...
- (id)initWithAppInfoManager:(id)a0 locationManager:(id)a1 motionManagerWrapper:(id)a2 ambientLightMonitor:(id)a3 deviceStateMonitorClass:(Class)a4 contextSourcesInitialized:(BOOL)a5 contextStream:(id)a6 locationStream:(id)a7;
