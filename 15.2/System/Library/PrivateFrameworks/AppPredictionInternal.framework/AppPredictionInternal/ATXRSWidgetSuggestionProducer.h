@class ATXRSFilter, ATXInformationDescendingStartDateRanker, ATXClientModelSuggestionReceiver, NSObject, ATXRSRelevanceMonitor, ATXWidgetSuggestionAbuseGuard, _ATXDuetHelper, NSString, ATXAvocadoDescriptorCache, ATXInformationFeatureWeights, ATXInformationFeaturizer, ATXInfoToBlendingConfidenceMapper, _PASSimpleCoalescingTimer;
