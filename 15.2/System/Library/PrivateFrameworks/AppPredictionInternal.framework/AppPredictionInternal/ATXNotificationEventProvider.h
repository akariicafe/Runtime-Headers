@class NSString, NSArray, ATXModeEntityModelTrainingContext;
...
- (id)initWithEventTypes:(id)a0 trainingContext:(id)a1;
- (double)secondsSinceReceiptForModeEvent:(id)a0;
- (id)initWithEventType:(long long)a0 trainingContext:(id)a1;
