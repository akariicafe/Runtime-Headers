@class NSURL, _BlastDoorLPVideoMetadata, _BlastDoorLPARAssetMetadata, _BlastDoorLPAudioMetadata, NSItemProvider, _BlastDoorLPARAsset, _BlastDoorLPAudio, _BlastDoorLPSpecializationMetadata, NSString, _BlastDoorLPAssociatedApplicationMetadata, _BlastDoorLPImageMetadata, _BlastDoorLPImage, NSArray, _BlastDoorLPVideo, _BlastDoorLPIconMetadata;
