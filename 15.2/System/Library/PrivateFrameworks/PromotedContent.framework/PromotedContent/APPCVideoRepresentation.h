...
- (void).cxx_destruct;
- (id)initWithIdentifier:(id)a0 adType:(long long)a1 desiredPosition:(long long)a2 videoURL:(id)a3 duration:(double)a4 fileSize:(long long)a5 skipThreshold:(double)a6 skipEnabled:(BOOL)a7 unbranded:(BOOL)a8 bitrate:(double)a9 connectionType:(long long)a10 signalStrength:(unsigned long long)a11 tapAction:(id)a12 adPolicyData:(id)a13;
