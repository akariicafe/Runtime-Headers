@class NSTimer, NSString, UIImage, _UILegibilitySettings, SBFWallpaperConfiguration, AVURLAsset, NSDictionary, _SBSUIOrientedImageView, SBFWallpaperCoreAnalyticsLogger, SBFWallpaperOptions, SBFWallpaperConfigurationManager, SBSUIProgressHUD;
