@class TransparencyManagedDataStore, NSMutableArray, NSDictionary, NSData, SignedObject, TransparencyLogEntryVerifier;
...
- (unsigned long long)setInclusionResult:(unsigned long long)a0 signedLogHead:(id)a1 error:(id *)a2;
