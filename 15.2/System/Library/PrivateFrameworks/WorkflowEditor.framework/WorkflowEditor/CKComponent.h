...
@interface CKComponent : NSObject {
    ...
    struct unique_ptr<CKComponentMountInfo, std::default_delete<CKComponentMountInfo>> { struct __compressed_pair<CKComponentMountInfo *, std::default_delete<CKComponentMountInfo>> { struct CKComponentMountInfo *__value_; } __ptr_; } _mountInfo;
}
...
- (struct CKComponentLayout { id x0; struct CGSize { double x0; double x1; } x1; struct shared_ptr<const std::vector<CKComponentLayoutChild>> { void *x0; struct __shared_weak_count *x1; } x2; id x3; })layoutThatFits:(struct CKSizeRange { struct CGSize { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 parentSize:(struct CGSize { double x0; double x1; })a1;
...
- (id)initWithView:(const void *)a0 size:(const struct CKComponentSize { struct CKRelativeDimension { int x0; double x1; } x0; struct CKRelativeDimension { int x0; double x1; } x1; struct CKRelativeDimension { int x0; double x1; } x2; struct CKRelativeDimension { int x0; double x1; } x3; struct CKRelativeDimension { int x0; double x1; } x4; struct CKRelativeDimension { int x0; double x1; } x5; } *)a1;
...
- (struct vector<CKComponentAnimation, std::allocator<CKComponentAnimation>> { struct CKComponentAnimation *x0; struct CKComponentAnimation *x1; struct __compressed_pair<CKComponentAnimation *, std::allocator<CKComponentAnimation>> { struct CKComponentAnimation *x0; } x2; })animationsOnInitialMount;
- (struct vector<CKComponentAnimation, std::allocator<CKComponentAnimation>> { struct CKComponentAnimation *x0; struct CKComponentAnimation *x1; struct __compressed_pair<CKComponentAnimation *, std::allocator<CKComponentAnimation>> { struct CKComponentAnimation *x0; } x2; })animationsFromPreviousComponent:(id)a0;
