...
- (void)configureViewWithParameter:(id)a0 state:(id)a1 editable:(BOOL)a2 processing:(BOOL)a3 shouldFocus:(BOOL)a4 variableProvider:(id)a5 widgetFamily:(long long)a6 fillProvider:(id)a7 overridingCellBackgroundColor:(id)a8 updateBlock:(id /* block */)a9;
