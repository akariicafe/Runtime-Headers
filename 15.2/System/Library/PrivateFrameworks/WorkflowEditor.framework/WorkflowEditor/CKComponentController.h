...
@interface CKComponentController : NSObject {
    ...
    struct CKComponentControllerAnimationWrapper { struct unique_ptr<CKComponentControllerAnimationData, std::default_delete<CKComponentControllerAnimationData>> { struct __compressed_pair<CKComponentControllerAnimationData *, std::default_delete<CKComponentControllerAnimationData>> { struct CKComponentControllerAnimationData *__value_; } __ptr_; } _animationData; } _animationData;
}
