...
- (id)initWithShowPreviewsSetting:(long long)a0 announcementSetting:(long long)a1 announcementHeadphonesSetting:(long long)a2 announcementCarPlaySetting:(long long)a3 scheduledDeliverySetting:(long long)a4 scheduledDeliveryTimes:(id)a5 scheduledDeliveryShowNextSummarySetting:(long long)a6;
- (id)initWithShowPreviewsSetting:(long long)a0 announcementSetting:(long long)a1 announcementHeadphonesSetting:(long long)a2 announcementCarPlaySetting:(long long)a3 scheduledDeliverySetting:(long long)a4 scheduledDeliveryTimes:(id)a5 scheduledDeliveryShowNextSummarySetting:(long long)a6 modifiedSettings:(unsigned long long)a7;
