...
+ (id)ensureNewVersionDirURLForModel:(id)a0 withVersion:(short)a1 andCreationTime:(long long)a2;
...
+ (id)parseCompiledModel:(id)a0 atLocation:(id)a1 withVersion:(id)a2 error:(id *)a3;
+ (void)deleteModelFromStorage:(id)a0 error:(id *)a1;
+ (void)unzipCompiledModel:(id)a0 copyToDestination:(id)a1 error:(id *)a2;
