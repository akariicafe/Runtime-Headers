...
- (id)_updateMenuElementItems:(id)a0 withActions:(id)a1 view:(id)a2 interactionDelegate:(id)a3;
- (id)contextMenuConfigurationWithIdentifier:(id)a0 inView:(id)a1 context:(id)a2 defaultAction:(id *)a3 menuProvider:(id /* block */ *)a4;
- (id)_rawContextMenuContentForView:(id)a0 interactionDelegate:(id)a1 context:(id)a2 elements:(id)a3 defaultAction:(id *)a4;
