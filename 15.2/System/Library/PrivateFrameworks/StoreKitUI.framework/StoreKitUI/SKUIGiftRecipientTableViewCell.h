@class CNContactPickerViewController, NSString, NSArray, MFComposeRecipientTextView, NSAttributedString, UIView, CNContactStore, SKUIGiftContactSearchController, UILabel;

@interface SKUIGiftRecipientTableViewCell : UITableViewCell <CNContactPickerDelegate, MFComposeRecipientTextViewDelegate, SKUIGiftContactSearchDelegate> {
...
@property (nonatomic) double recipientViewMinHeight;
