@class SSVPlatformContext, SSUpdatableAssetController, NSMapTable, NSDictionary, NSBundle, NSMutableArray, SKUIURL, SKUIStoreDialogController, SKUIURLBag, SKUITrendingSearchProvider, NSString, SUClientInterface, IKAppContext, NSOperationQueue, NSArray, SSURLBag, SKUIApplicationController, SKUILocalizedStringDictionary, NSCache;
