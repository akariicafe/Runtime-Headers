@class _UILegibilitySettings, SBIconListView, SBFolderController, NSMutableDictionary, SBRootFolder, SBHIconImageCache, NSMapTable, SBWorkspaceInteractionContext, UIViewController, CHSAvocadoDescriptorProvider, SBHomeScreenDefaults, NSMutableOrderedSet, NSObject, SBFolder, SBIconLabelImageCache, BSEventQueue, SBHIconShareSheetManager, NSMutableArray, SBFolderIcon, NSSet, SBSearchGesture, SBIconPreviousLocationTracker, NSTimer, NSHashTable, SBFolderIconImageCache, SBHFocusMode, SBHHomeScreenUsageMonitor, SBHMultiplexingManager, SBHomeScreenIconTransitionAnimator, SBHHomeScreenSettings, SBReusableViewMap, UIImpactFeedbackGenerator, NSArray, SBModalWidgetIntroductionViewController, SBHWidgetMetricsProvider, SBHIconModel, SBRootFolderController, SBFloatingDockViewController, NSString, SBIconDragManager, ATXDefaultWidgetSuggesterClient, SBHRootFolderSettings, NSCountedSet, ATXHomeScreenPageIconRanker, SBFParallaxSettings, NSDictionary, SBIconView, NSMutableSet, SBIcon, SBHTrialClientManager, SBHLibraryViewController, SBHWidgetIntroductionSettings, SBHPeopleWidgetPersonDetailInteraction, SBIconPageIndicatorImageSetCache;
@protocol SBHRootFolderCustomViewPresenting, SBHSidebarProvider, SBHIconManagerDelegate, SBHLegibility, OS_os_activity, SBHIconRootViewProviding, SBHTodayViewController, BSInvalidatable, SBIconListLayoutProvider;
...
@property (nonatomic) unsigned long long widgetIntroductionCounter;
...
@property (nonatomic) BOOL modalIntroductionViewControllerIsPrewarming;
...
@property (nonatomic) BOOL widgetDiscoverabilityHasRun;
...
@property (nonatomic) unsigned long long maximumNumberOfWidgetsToMaintainPreventBackgroundAssertions;
...
- (void)todayViewController:(id)a0 contentVisibilityWillChange:(unsigned long long)a1;
...
- (void)_scheduleAvocadoBackgroundCullingForReason:(id)a0;
...
- (void)todayViewControllerDidAppear:(id)a0;
...
- (void)_removeAssertionsForNowOccludedTodayViewController:(id)a0;
...
- (void)_cleanupAssertionForAvocadoHostViewController:(id)a0 reason:(id)a1;
- (void)_updateAssertionsForWidgetStackViewController:(id)a0;
...
- (void)widgetViewControllerUsesSystemBackgroundMaterialDidChange:(id)a0;
...
- (void)_cullAvocadoBackgroundsIfNeededForReason:(id)a0;
...
- (void)todayViewControllerWillDisappear:(id)a0;
...
- (void)todayViewControllerDidDisappear:(id)a0;
- (void)_cullAvocadoBackgroundsForTimerFired:(id)a0;
...
- (void)presentLibraryOverlayForIconDragManager:(id)a0;
...
- (void)_cullAvocadoBackgroundsForReason:(id)a0;
...
- (unsigned long long)supportedMedusaShortcutActionsForIconView:(id)a0;
...
- (void)dismissLibraryOverlayForIconDragManager:(id)a0;
- (BOOL)isTodayViewEffectivelyVisible;
- (void)_iconModelWillLayout:(id)a0;
- (void)_collectAvocadoHostViewControllersForWhenTodayViewControllerIsOccluded:(id)a0;
- (void)_removeAllPreventAvocadoBackgroundAssertions:(id)a0;
...
- (id)windowForIconDragPreviewsForIconDragManager:(id)a0;
...
- (void)_scheduleAvocadoBackgroundCullingForReason:(id)a0 interval:(double)a1;
- (void)todayViewController:(id)a0 contentVisibilityDidChange:(unsigned long long)a1;
- (void)rootFolder:(id)a0 wantsToDoPageHidingEducationWithCompletion:(id /* block */)a1;
- (void)_markAvocadoHostViewControllerForDeferredCleanup:(id)a0;
...
- (BOOL)widgetViewControllerShouldTransitionSceneToBackground:(id)a0;
...
- (void)_removeReasonToNotManageBackgroundAssertions:(id)a0;
...
- (void)_addReasonToNotManageBackgroundAssertions:(id)a0;
