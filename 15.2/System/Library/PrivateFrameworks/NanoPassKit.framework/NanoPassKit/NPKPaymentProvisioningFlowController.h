@class PKPaymentRequest, PKContactlessCardIngester, PKPaymentAuthorizationController, PKPaymentProvisioningMethodMetadata, NPKFidoAuthCoordinator, PKPaymentSetupProduct, NPKPaymentProvisioningFlowControllerRequestContext, NSObject, PKPaymentSetupFieldsModel, NSDecimalNumber, PKPaymentProvisioningController, NSString, PKPaymentPass, PKServiceProviderPurchase, PKAddPaymentPassRequest, NSData, PKAddPaymentPassRequestConfiguration, PKPaymentWebService, PKPaymentCredential;
...
- (void)ensureMetadataForCredentials:(id)a0 requestContext:(id)a1 completionHandler:(id /* block */)a2;
