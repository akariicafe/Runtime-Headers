@class NSString, ACHMobileAssetProvider, ACHAchievementStore, ACHTemplateSourceScheduler, HDProfile, HDXPCClient, ACHEarnedInstanceStore, NSObject, ACHTemplateStore;
...
+ (id)serverWithClient:(id)a0 templateStore:(id)a1 earnedInstanceStore:(id)a2 awardingScheduler:(id)a3 achievementStore:(id)a4 mobileAssetProvider:(id)a5 templateSourceScheduler:(id)a6 error:(id *)a7;
+ (id)serverWithTemplateStore:(id)a0 earnedInstanceStore:(id)a1 awardingScheduler:(id)a2 achievementStore:(id)a3 mobileAssetProvider:(id)a4 templateSourceScheduler:(id)a5;
...
- (id)initWithClient:(id)a0 templateStore:(id)a1 earnedInstanceStore:(id)a2 awardingScheduler:(id)a3 achievementStore:(id)a4 mobileAssetProvider:(id)a5 templateSourceScheduler:(id)a6;
