@class NSDictionary, ACAccount, UIViewController, SFSession, AVAudioSession, SSAccount, NSMutableArray, NSString, RPCompanionLinkClient, HMHome, AVAudioPlayer, NSArray, AMSPromise, SFDeviceOperationHomeKitSetup, SFDeviceOperationWiFiSetup, NSObject, NSSet, AFEnablementConfiguration, TRSession, TROperationQueue, SFDeviceOperationCDPSetup, AFVoiceInfo, HMAccessory, ACAccountStore, APCListener, SFDevice, AFEnablementFlowConfigurationProvider;
