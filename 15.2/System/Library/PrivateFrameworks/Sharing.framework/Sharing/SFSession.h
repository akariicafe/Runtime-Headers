@class NSMutableDictionary, NSMutableData, SFAppleIDContactInfo, SFDevice, NSDictionary, NSObject, CUPairingSession, CUAppleIDClient, SDStatusMonitor, NSString, TRSession, SFTRSession, NSXPCListenerEndpoint, CUMessageSession, CUMessageSessionServer, NSXPCConnection, NSUUID;
