@class TSDMPSImageConversionStorage, KNAnimatedSlideView, KNAnimationRegistryWithFallbacks, KNSlide, KNAnimationContext, TSKAccessController, NSMutableArray, KNAnimationTestResultLogger, KNSlideNode, NSString, KNPlaybackSessionConfiguration, KNAnimatedTextureManager, TSULRUCache, CALayer, NSArray, TSDGLLayer, KNShow, TSDBitmapRenderingQualityInfo;
