...
- (id)compactQualifiedColumnNameForAggregateIndex:(unsigned long long)a0 locale:(id)a1;
...
- (id)qualifiedColumnNameForAggregateIndex:(unsigned long long)a0 locale:(id)a1;
...
- (id)qualifiedColumnNameForAggregateIndex:(unsigned long long)a0 useShortLabel:(BOOL)a1 allowDuplicateNames:(BOOL)a2 locale:(id)a3;
- (id)columnNameForAggregateIndex:(unsigned long long)a0 allowDuplicateNames:(BOOL)a1;
- (id)compactQualifiedColumnNameForAggregateIndex:(unsigned long long)a0 useShortLabel:(BOOL)a1 allowDuplicateNames:(BOOL)a2 locale:(id)a3;
