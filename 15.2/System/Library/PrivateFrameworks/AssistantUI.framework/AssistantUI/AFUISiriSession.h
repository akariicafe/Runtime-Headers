@class NSString, NSArray, SRUIFSiriSessionInfo, AFConnection, AFAnalyticsTurnBasedInstrumentationContext, SRUIFStateMachine, AFUIWatchAuthenticationManager, NSObject, AFSpeechSynthesisRecord, NSMutableSet, AFSettingsConnection, AFSiriClientStateManager;
...
@property (retain, nonatomic, getter=_watchAuthenticationManager, setter=_setWatchAuthenticationManager:) AFUIWatchAuthenticationManager *watchAuthenticationManager;
...
- (void)performAceCommand:(id)a0 turnIdentifier:(id)a1;
...
- (void)_performAceCommand:(id)a0 turnIdentifier:(id)a1 conflictHandler:(id /* block */)a2;
