...
- (void)revokeRangeOrAoATargetEstimate:(struct BatchSolution { int x0; BOOL x1; int x2; BOOL x3; struct vector<RoseSyntheticApertureFiltering::BatchSolutionParticle, std::allocator<RoseSyntheticApertureFiltering::BatchSolutionParticle>> { struct BatchSolutionParticle *x0; struct BatchSolutionParticle *x1; struct __compressed_pair<RoseSyntheticApertureFiltering::BatchSolutionParticle *, std::allocator<RoseSyntheticApertureFiltering::BatchSolutionParticle>> { struct BatchSolutionParticle *x0; } x2; } x4; double x5; })a0;
