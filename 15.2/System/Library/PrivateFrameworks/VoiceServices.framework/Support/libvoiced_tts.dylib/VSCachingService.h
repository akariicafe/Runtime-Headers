...
- (void)enqueueShortTermCacheWithHash:(id)a0 audio:(id)a1 timingInfo:(id)a2 voiceKey:(id)a3 completion:(id /* block */)a4;
- (void)enqueueCacheWithHash:(id)a0 streamAudio:(id)a1 timingInfo:(id)a2 voiceKey:(id)a3 completion:(id /* block */)a4;
- (id)inMemoryCacheForHash:(id)a0;
- (id)onDiskCacheForHash:(id)a0;
- (id)shortTermCacheForHash:(id)a0;
- (void)enqueueCacheWithHash:(id)a0 audio:(id)a1 timingInfo:(id)a2 voiceKey:(id)a3 completion:(id /* block */)a4;
- (id)initWithCache:(id)a0 shortTermMemory:(id)a1;
- (void)_enqueueCacheWithHash:(id)a0 audioObject:(id)a1 timingInfo:(id)a2 voiceKey:(id)a3 completion:(id /* block */)a4;
