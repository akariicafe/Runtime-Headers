@class NSDictionary, HRContentStatusView, HRContentStatusCell, HKClinicalAccountStore, HKClinicalAccount, NSString, NSTimer, NSArray, HRProfile, NSPredicate, UIButton, WDMedicalRecordCategory, NSSet, HKConceptIdentifier, WDMedicalRecordStandaloneCell, HKMedicalUserDomainConcept, HROverlayRoomViewController, HKCloudSyncObserver, UISearchController, WDMedicalRecordDisplayItemProvider, NSUUID, HKConcept, HKViewTableViewCell, NSHashTable;
