@class WDClinicalSourcesDataProvider, HKSampleTypeUpdateController, HKHealthRecordsStore, HKHealthStore, HKConceptStore, UTCDateFormatter, WDClinicalSampleAccountsLoader, WDClinicalOnboardingManager, HRHealthRecordsMigrator, HRWDUserActivityManager, HKDateCache, HKUCUMUnitDisplayConverter;
