@class NSString, NSMutableDictionary, APOdmlXpcLifecycleHandler, APOdmlUnfairLock, NSArray, APOdmlVector;

@interface APOdmlAppUsageVectorManager : NSObject

@property (retain, nonatomic) NSString *version;
@property (retain, nonatomic) APOdmlVector *appUsageVector;
...
- (id)normalizedAppUsageVector:(id *)a0;
