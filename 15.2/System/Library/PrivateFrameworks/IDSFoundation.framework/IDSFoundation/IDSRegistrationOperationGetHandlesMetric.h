...
- (void).cxx_destruct;
- (id)initWithGuid:(id)a0 success:(BOOL)a1 connectionType:(unsigned int)a2 resultCode:(unsigned int)a3 registrationType:(unsigned int)a4 genericError:(id)a5 URLError:(id)a6 POSIXError:(id)a7;
