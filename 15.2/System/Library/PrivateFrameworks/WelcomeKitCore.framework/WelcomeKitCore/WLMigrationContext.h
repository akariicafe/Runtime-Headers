@class NSDate, WLSourceDeviceMigrationMetadata, WLTimeEstimateAccuracyTracker, NSArray, WLSourceDevice, WLPayload, WLSafeHarborManager, WLSQLController, NSMutableArray, WLURLSessionController, WLMigrationDataCoordinator, WLStatistics;
