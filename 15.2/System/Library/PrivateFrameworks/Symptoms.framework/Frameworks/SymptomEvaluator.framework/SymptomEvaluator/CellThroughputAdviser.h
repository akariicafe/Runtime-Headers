@class NSSet, NSMutableDictionary, AWDSymptomsCellularSDMAdviceChange, WiFiViabilityMonitor, NSMutableSet, FlowOracle, NSObject, FlowScrutinizer;
...
- (void)_traceDelegateCall:(char *)a0 param1:(unsigned int)a1 param2:(unsigned int)a2 param3:(unsigned int)a3 param4:(unsigned int)a4 at:(double)a5;
