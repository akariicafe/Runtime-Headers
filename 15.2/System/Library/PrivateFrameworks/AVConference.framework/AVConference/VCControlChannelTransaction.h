...
+ (BOOL)sendUnreliableMessage:(id)a0 sessionID:(unsigned int)a1 participantID:(id)a2 transactionID:(id)a3 transactionDelegate:(id)a4;
...
- (BOOL)sendReliableMessage:(id)a0 sessionID:(unsigned int)a1 participantID:(id)a2 timeout:(id)a3 useFastRetries:(BOOL)a4;
