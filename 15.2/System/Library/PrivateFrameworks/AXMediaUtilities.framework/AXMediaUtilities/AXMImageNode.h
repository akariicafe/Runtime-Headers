...
- (void)triggerWithImageURL:(id)a0 assetLocalIdentifier:(id)a1 wellKnownPHPhotoLibraryIdentifier:(long long)a2 options:(id)a3 cacheKey:(id)a4 resultHandler:(id /* block */)a5;
...
- (void)triggerWithImageAssetLocalIdentifier:(id)a0 wellKnownPHPhotoLibraryIdentifier:(long long)a1 options:(id)a2 cacheKey:(id)a3 resultHandler:(id /* block */)a4;
