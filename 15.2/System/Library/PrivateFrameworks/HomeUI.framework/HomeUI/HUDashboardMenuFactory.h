...
+ (id)createAddMenuForHome:(id)a0 room:(id)a1 delegate:(id)a2;
...
+ (id)_addAccessoryAction:(id)a0 room:(id)a1 delegate:(id)a2;
+ (id)_addSceneAction:(id)a0 delegate:(id)a1;
+ (id)_addAutomationAction:(id)a0 delegate:(id)a1;
+ (id)_addRoomAction:(id)a0 delegate:(id)a1;
+ (id)_addPeopleAction:(id)a0 delegate:(id)a1;
+ (id)_addHomeActionWithDelegate:(id)a0;
