...
@property (retain, nonatomic) id sentinal;
...
- (id)initWithSentinal:(id)a0 mask:(long long)a1 compare:(long long)a2 fetchResult:(id /* block */)a3;
- (id)initWithSentinal:(id)a0 needsPushTo:(unsigned long long)a1 fetchResult:(id /* block */)a2;
- (id)initWithAlreadyPushedTo:(unsigned long long)a0 result:(id /* block */)a1;
- (id)initWithSentinal:(id)a0 alreadyPushedTo:(unsigned long long)a1 fetchResult:(id /* block */)a2;
