...
+ (id)sendMessageData:(id)a0 autosaveIdentifier:(id)a1 isHMEMessage:(BOOL)a2 completionBlock:(id /* block */)a3;
...
- (void)_sendMessageData:(id)a0 autosaveIdentifier:(id)a1 isHMEMessage:(BOOL)a2 completionBlock:(id /* block */)a3;
