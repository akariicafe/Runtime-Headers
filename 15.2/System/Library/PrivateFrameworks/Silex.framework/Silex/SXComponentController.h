...
@protocol SXComponentViewEngine, SXDOMObjectProviding, SXComponentHosting;
...
@property (readonly, nonatomic) id<SXComponentViewEngine> componentViewEngine;
...
- (id)initWithViewport:(id)a0 componentViewEngine:(id)a1 DOMObjectProvider:(id)a2;
