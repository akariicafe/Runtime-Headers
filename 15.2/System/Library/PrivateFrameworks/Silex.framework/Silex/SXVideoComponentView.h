@class SVVideoPlayerViewController, SVVolumeProvider, SXVideoPlayerViewControllerManager, NSString, SXPosterFrameView, SXVideoComponentAnalyticsReporting, SXVideoAnalyticsRouter;
