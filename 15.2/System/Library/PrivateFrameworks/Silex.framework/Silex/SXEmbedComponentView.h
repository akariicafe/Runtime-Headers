@class WKWebView, NSString, UIActivityIndicatorView, WKNavigation, TFMultiDelegate, WKWebsiteDataStore, SXRelatedWebViewCache, SWCrashRetryThrottler, NSMutableSet, UILabel, SXEmbedResource;
