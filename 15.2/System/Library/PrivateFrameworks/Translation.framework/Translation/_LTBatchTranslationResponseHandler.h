@class FTMutableBatchTranslationRequest, LTBatchEventLog, _LTTranslationParagraph, NSMutableDictionary, NSLocale, NSString, NSURL;
...
@property (retain, nonatomic) LTBatchEventLog *batchLog;
