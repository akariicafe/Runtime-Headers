...
- (void)_addMoreKeysToListIfNeeded:(id)a0 completionHandler:(id /* block */)a1;
...
- (id)initWithDiskCache:(id)a0 delegate:(id)a1 delegateQueue:(id)a2 tileRequesterCreationBlock:(id /* block */)a3;
