@class HDPowerSavingModeManager, HDCarouselServicesManager, HDAlertSuppressor, HDDaemon, NSString, HDBackgroundWorkoutRunner, HDCoreMotionWorkoutInterface, HDAppLauncher, HDHeartRateRecoveryManager;
