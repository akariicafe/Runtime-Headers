...
+ (BOOL)enumerateRecordNamesWithContainerIdentifier:(id)a0 databaseScope:(long long)a1 zoneName:(id)a2 ownerName:(id)a3 profile:(id)a4 error:(id *)a5 enumerationHandler:(id /* block */)a6;
...
+ (BOOL)enumerateRecordNameAndDataWithContainerIdentifier:(id)a0 databaseScope:(long long)a1 zoneName:(id)a2 ownerName:(id)a3 recordType:(id)a4 profile:(id)a5 error:(id *)a6 enumerationHandler:(id /* block */)a7;
