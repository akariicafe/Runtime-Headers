...
+ (BOOL)replaceObjectID:(id)a0 replacementObjectID:(id)a1 deleteOriginalHFDData:(BOOL)a2 insertDeletedObject:(BOOL)a3 profile:(id)a4 transaction:(id)a5 error:(id *)a6;
+ (const struct { id x0; id x1; unsigned char x2; } *)columnDefinitionsWithCount:(unsigned long long *)a0;
+ (BOOL)deleteSeriesWithID:(id)a0 deleteHFDData:(BOOL)a1 insertDeletedObject:(BOOL)a2 profile:(id)a3 transaction:(id)a4 error:(id *)a5;
