...
+ (id)snappingRangeForRange:(id)a0 axisRange:(id)a1 timeScope:(long long)a2 velocity:(struct CGPoint { double x0; double x1; })a3 calendar:(id)a4 options:(long long)a5;
...
+ (id)chartDataRangeForTimeScope:(long long)a0 dataRange:(id)a1 firstWeekday:(long long)a2 calendar:(id)a3 cadence:(long long)a4;
+ (id)_snappingStartDateWithStartDate:(id)a0 velocity:(struct CGPoint { double x0; double x1; })a1 calendar:(id)a2 timeScope:(long long)a3 options:(long long)a4;
