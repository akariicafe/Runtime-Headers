@class NSMutableDictionary, NSMapTable, UIImage, HKMultiTouchPressGestureRecognizer, HKBorderLineView, NSMutableArray, UIView, HKAxis, NSSet, HKValueRange, HKGraphViewSelectionStyle, NSTimer, HKPropertyAnimationApplier, UIColor, NSArray, NSCalendar, NSString, UIScrollView, _HKGraphViewOverlayView;
