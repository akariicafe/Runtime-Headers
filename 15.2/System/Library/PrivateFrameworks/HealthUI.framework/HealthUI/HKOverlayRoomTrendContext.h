@class HKDisplayTypeContextItem, NSString, HKDisplayType, HKChartSummaryTrendModel, HKInteractiveChartOverlayViewController;
...
@property (readonly, nonatomic) HKDisplayType *trendDisplayType;
