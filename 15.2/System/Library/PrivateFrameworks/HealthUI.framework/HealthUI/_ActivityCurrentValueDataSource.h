...
- (id)initWithDisplayTypeController:(id)a0 unitController:(id)a1 wheelchairUseCharacteristicCache:(id)a2 currentValueViewContext:(BOOL)a3 firstWeekday:(long long)a4 currentValueViewCallbacks:(id)a5;
