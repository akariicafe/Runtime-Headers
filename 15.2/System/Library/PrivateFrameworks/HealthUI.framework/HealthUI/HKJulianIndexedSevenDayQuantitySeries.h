...
@property (readonly, nonatomic) NSArray *axisLabelOverride;
...
- (id)initWithColor:(id)a0 lineWidth:(double)a1 axisLabelOverride:(id)a2;
...
- (id)initWithColor:(id)a0 lineWidth:(double)a1 hollowLineRatio:(double)a2 axisLabelOverride:(id)a3;
