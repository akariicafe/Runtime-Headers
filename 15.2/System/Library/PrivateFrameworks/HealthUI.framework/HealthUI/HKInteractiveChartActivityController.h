...
- (id)initWithHealthStore:(id)a0 unitPreferenceController:(id)a1 dateCache:(id)a2 chartDataCacheController:(id)a3 selectedTimeScopeController:(id)a4 sampleTypeDateRangeController:(id)a5 wheelchairUseCharacteristicCache:(id)a6 initialXValue:(id)a7 activityMoveMode:(long long)a8 chartSharableModel:(id)a9;
...
- (id)_displayTypeForActivityValue:(long long)a0 yAxis:(id)a1 dataProvider:(id)a2 displayTypeController:(id)a3 unitPreferenceController:(id)a4 wheelchairUseCharacteristicCache:(id)a5 timescopeToSummariesTable:(id)a6;
