@class HKGraphSeriesDataSource, NSUUID, NSArray, HKAxis, UIView, NSString, NSMutableDictionary, HKValueRange, UIColor;
...
- (BOOL)hasAnyDataLoadedInXAxisRange:(id)a0 dateZoom:(long long)a1 chartRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
