@class NSString, HDBackgroundFeatureDeliveryManager, HKCalendarCache, HDPrimaryProfile, HDMCAnalysisManager, HDMCAnalyticsManager, HDFeatureAvailabilityManager, HKMCSettingsManager, HDMCNotificationManager, HDMCAnalysisScheduler;
