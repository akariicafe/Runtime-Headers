@class CKXORCReader, NSDictionary, CKXUncompressedReader, CKXUncompressedWriter, CKXORCWriter, NSObject;
@protocol CKXBinding;

@interface CKXVersionedReaderWriterStore : NSObject

@property (retain, nonatomic) CKXUncompressedReader *uncompressedReader;
@property (retain, nonatomic) CKXUncompressedWriter *uncompressedWriter;
