@class NSDate, NSString, AVDepthData, NSMutableDictionary, AVCameraCalibrationData, NSDictionary, ARPointCloud, ARFaceData, ADCameraCalibration;
...
@property (nonatomic) long long rawDeviceOrientation;
