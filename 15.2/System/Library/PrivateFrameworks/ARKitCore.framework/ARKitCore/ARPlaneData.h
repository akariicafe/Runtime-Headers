...
@interface ARPlaneData : NSObject <ARResultData, ARQATraceable> {
    ...
    struct { void /* unknown type, empty encoding */ columns[4]; } _anchorConventionRotation;
}
...
+ (float)_orientedPivotForPlane:(struct CV3DPlaneDetectionPlane { } *)a0;
...
- (void)_updateExtentsForPlaneAnchor:(id)a0 plane:(struct CV3DPlaneDetectionPlane { } *)a1 pivot:(float)a2;
- (struct { })_boundsForPlane:(struct CV3DPlaneDetectionPlane { } *)a0 planeOrientedPivot:(float)a1 alignmentRotation:(long long)a2;
- (id)_geometryForPlane:(struct CV3DPlaneDetectionPlane { } *)a0 planeOrientedPivot:(float)a1 alignmentRotation:(long long)a2 planeBounds:(struct { })a3;
- (id)_gridExtentForPlane:(struct CV3DPlaneDetectionPlane { } *)a0 planeOrientedPivot:(float)a1 alignmentRotation:(long long)a2;
- (struct { })_orientedBoundsForPlane:(struct CV3DPlaneDetectionPlane { } *)a0 planeOrientedPivot:(float)a1 alignmentRotation:(long long)a2;
- (id)initWithARPlaneData:(id)a0;
- (id)initWithDetectionResult:(struct CV3DPlaneDetectionPlaneList { } *)a0 detectionTypeMask:(unsigned long long)a1 sceneUnderstandingEnabled:(BOOL)a2 visionToRendering:(struct { void /* unknown type, empty encoding */ x0[4]; })a3;
