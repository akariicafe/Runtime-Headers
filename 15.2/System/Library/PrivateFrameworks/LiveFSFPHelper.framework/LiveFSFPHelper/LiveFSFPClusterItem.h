@class NSData, NSString, NSURL, UTType, NSSet, NSDate, NSDictionary, NSPersonNameComponents, LiveFSFPExtensionHelper, NSError, NSFileProviderItemVersion, NSNumber;
