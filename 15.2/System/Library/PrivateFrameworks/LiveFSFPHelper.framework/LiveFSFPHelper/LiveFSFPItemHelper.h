@class NSURL, LiveFSFPExtensionHelper, NSMapTable, NSDate, NSDictionary, NSError, NSMutableDictionary, NSObject, NSFileProviderItemVersion, NSString, NSSet, NSPersonNameComponents, NSNumber, NSData, UTType, LiveFSFPEnumeratorDataContainer;
