@interface PhotosUIApps.PhotosDetailsSyndicationWidgetViewModel : PhotosUIApps.PhotosDetailsDiscoverabilityViewModel <PXContentSyndicationAttributionInfoChangeDelegate> {
    ...
    void /* unknown type, empty encoding */ _syndicationSharedWithTitle;
