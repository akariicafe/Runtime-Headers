...
@property (readonly, retain, nonatomic) NSDictionary *groupingStrategiesByIdentifier;
@property (readonly, retain, nonatomic) id<CHStrokeProvider> strokeProvider;
@property (readonly, retain, nonatomic) CHRecognitionSessionResult *sessionLastResult;
