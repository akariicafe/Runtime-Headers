@class SBMainDisplaySceneManager, NSString, NSMapTable, SBFloatingDockWindowLevelAssertion, NSMutableSet, SBPIPController;
...
- (id)containerViewControllerForHandle:(id)a0;
