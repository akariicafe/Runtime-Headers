@class SBCoverSheetPositionView, SBFFrameRateAssertion, SBIndirectPanGestureRecognizer, NSObject, SBCoverSheetSystemGesturesDelegate, UIViewController, SBScreenEdgePanGestureRecognizer, SBFluidScrunchGestureRecognizer, NSString, CSCoverSheetTransitionSettings, UIViewFloatAnimatableProperty, CSLockScreenSettings, SBHomeGestureSettings;
