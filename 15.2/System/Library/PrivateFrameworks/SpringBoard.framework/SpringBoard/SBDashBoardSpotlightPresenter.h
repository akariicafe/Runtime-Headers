...
- (long long)zStackParticipantIdentifierForSpotlightViewController:(id)a0;
- (id)initWithPresenterViewController:(id)a0 spotlightMultiplexingLevel:(unsigned long long)a1 remoteSearchViewPresentationSource:(unsigned long long)a2 homeGestureParticipantIdentifier:(long long)a3 zStackParticipantIdentifier:(long long)a4;
