...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_separatorViewReferenceFrameForLayoutRole:(long long)a0 spaceConfiguration:(long long)a1 interfaceOrientation:(long long)a2 frameOptions:(unsigned long long)a3;
...
- (struct CGSize { double x0; double x1; })_layoutSizeForLayoutRole:(long long)a0 spaceConfiguration:(long long)a1 peekConfiguration:(long long)a2 interfaceOrientation:(long long)a3 frameOptions:(unsigned long long)a4;
