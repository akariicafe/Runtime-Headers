@class SBDragAndDropWorkspaceTransaction, NSMapTable, SBWindowDragInteraction, SBFluidSwitcherViewController, NSString, UIDropInteraction, SBMainDisplaySceneManager;
...
@property (readonly, weak, nonatomic) SBMainDisplaySceneManager *sceneManager;
...
- (id)initWithSwitcherContentController:(id)a0 sceneManager:(id)a1 delegate:(id)a2;
