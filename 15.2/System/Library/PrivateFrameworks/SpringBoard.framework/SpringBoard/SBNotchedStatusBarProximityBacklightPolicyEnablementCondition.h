@class SpringBoard, NSString, UIStatusBarServer, SBAppStatusBarAssertionManager, UIApplicationSceneSettingsDiffInspector, SBMainDisplaySceneManager;
...
- (void)dealloc;
- (id)initWithMainDisplaySceneManager:(id)a0 statusBarAssertionManager:(id)a1 statusBarServer:(id)a2 orientationProvider:(id)a3;
