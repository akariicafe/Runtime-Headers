@class UIApplicationSceneClientSettingsDiffInspector, SBBannerManager, SBDeviceApplicationSceneHandle, NSTimer, NSString, NSMutableSet, SBMainDisplaySceneManager;
...
- (id)initWithObserver:(id)a0 bannerManager:(id)a1 sceneManager:(id)a2;
