@class SBNubView, MTLumaDodgePillSettings, UITapGestureRecognizer, SBMedusaSettings, SBHomeGrabberView, UIDropInteraction, UIView, SBDeviceApplicationSceneHandle, NSString, SBTopAffordanceViewController, UIApplicationSceneClientSettingsDiffInspector, NSHashTable, SBDeviceApplicationSceneViewController, SBSetupManager, NSMutableSet, SBApplicationBlurContentView, SBMainWorkspace;
...
- (void)setLayoutRole:(long long)a0 spaceConfiguration:(long long)a1 floatingConfiguration:(long long)a2;
...
- (void)_handleTopAffordanceButtonPressOfType:(long long)a0 forTopAffordanceViewController:(id)a1 desiredFloatingConfiguration:(long long)a2 transitionSource:(long long)a3;
- (void)_handleSplitHomeScreenSwitcherKeyShortcut;
- (void)_updateTopAffordanceHighlight;
- (void)_updateCurrentTopAffordanceAlpha;
- (void)_presentTransientErrorMessageIfNeededForLayoutStateTransitionContext:(id)a0;
- (id)topAffordanceView;
- (void)updateTopAffordanceOverrideUserInterfaceStyle;
- (void)_modifyApplicationContext:(id)a0 forTapOnTopAffordanceButtonType:(long long)a1 spaceConfiguration:(long long)a2 layoutRole:(long long)a3 desiredFloatingConfiguration:(long long)a4;
...
- (BOOL)_shouldShowSplitViewNotSupportedMessageForLayoutStateTransitionContext:(id)a0;
- (BOOL)_shouldShowMultipleWindowsNotSupportedMessageForLayoutStateTransitionContext:(id)a0;
- (void)topAffordanceViewController:(id)a0 didTapOnButtonWithTopAffordanceButtonType:(long long)a1;
