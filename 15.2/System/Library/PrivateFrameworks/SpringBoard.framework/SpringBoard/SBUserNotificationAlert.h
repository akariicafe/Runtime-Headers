@class NSURL, BKSProcessAssertion, _SBUserNotificationImageDescriptor, SBUISound, NSDictionary, NSObject, UIViewController, UIAlertControllerVisualStyle, NSString, _SBLegacyRemoteAlertContentHostViewController, NSTimer, NSArray, _SBSUICFUserNotificationContentHostViewController;
...
- (id)_imageDescriptorForPath:(id)a0 catalogPath:(id)a1 catalogImageKey:(id)a2;
