@class NSString, SBWorkspaceKeyboardFocusController, SBPIPInteractionSettings, SBPIPContainerViewController, _UIRemoteKeyboards, UIApplicationSceneDeactivationAssertion, SBPIPStashableWrapperViewController, UIViewController, SBKeyboardDismissalManager, SBKeyboardSuppressionManager, SBLayoutStateTransitionCoordinator;
