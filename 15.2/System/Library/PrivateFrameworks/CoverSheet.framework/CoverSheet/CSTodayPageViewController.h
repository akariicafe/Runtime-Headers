@class NSString, _UILegibilitySettings, CSPresentation, CSTodayContentViewController, CSAppearance, CSTodayViewController, NSSet, CSBehavior, NSArray, CSLayoutStrategy, SBViewControllerTransitionContext;
