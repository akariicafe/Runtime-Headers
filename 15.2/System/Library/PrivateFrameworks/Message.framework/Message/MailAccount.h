@class MFMailboxUid, NSString, NSArray, MFLock, MFError, MFLocalActionReplayHandler, NSMutableDictionary, MFWeakObjectCache, ACAccount, NSObject, ECAccount, MFMailMessageLibrary;
