@class MFInvocationQueue, NSString, NSArray, NSURL, MailAccount, EMMailboxObjectID, NSMutableDictionary, NSMutableArray, MFWeakReferenceHolder, NSNumber, MFMessageCriterion;
...
- (id)initWithName:(id)a0 attributes:(unsigned int)a1 forAccount:(id)a2 extraAttributes:(id)a3 type:(int)a4;
