...
+ (id)supportedCodecs;
+ (id)supportedCodecsWithH265:(BOOL)a0 vp9Profile0:(BOOL)a1 vp9Profile2:(BOOL)a2;

- (id)supportedCodecs;
- (id)createEncoder:(id)a0;
- (id)initWithH265:(BOOL)a0 vp9Profile0:(BOOL)a1 vp9Profile2:(BOOL)a2 lowLatencyH264:(BOOL)a3;
