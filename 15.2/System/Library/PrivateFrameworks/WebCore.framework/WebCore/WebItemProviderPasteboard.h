...
@interface WebItemProviderPasteboard : NSObject <AbstractPasteboard> {
    ...
    struct Vector<WTF::RetainPtr<WebItemProviderLoadResult>, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> { void *m_buffer; unsigned int m_capacity; unsigned int m_size; } _loadResults;
}
