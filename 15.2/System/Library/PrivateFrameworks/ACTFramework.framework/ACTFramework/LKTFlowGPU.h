...
@interface LKTFlowGPU : NSObject {
    ...
    id<MTLComputePipelineState> _computePipelines[20];
...
@property (nonatomic) int nwarpings_icp;
...
- (id)initWithMetalContext:(id)a0 ICPtransform:(long long)a1 width:(int)a2 height:(int)a3 nscales:(int)a4;
...
- (int)_panoRegistration:(struct { void /* unknown type, empty encoding */ x0[3]; })a0;
...
- (void)setPresetICP:(long long)a0 withRegularizerTerms:(id)a1;
...
- (int)_computeHomographyWithCommandBuffer:(id)a0 in_tex0:(id)a1 in_tex1:(id)a2 in_tex2:(id)a3 weight_tex:(id)a4 regularizer_term:(float)a5;
...
- (void)_dumpTextureFloat:(id)a0 withName:(char *)a1 float16:(BOOL)a2;
