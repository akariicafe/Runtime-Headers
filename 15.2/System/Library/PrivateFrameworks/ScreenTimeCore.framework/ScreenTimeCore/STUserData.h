...
- (void).cxx_destruct;
- (id)initWithIdentifier:(id)a0 givenName:(id)a1 isParent:(BOOL)a2 isRemote:(BOOL)a3 hasPasscode:(BOOL)a4 screenTimeEnabled:(BOOL)a5 syncingEnabled:(BOOL)a6 checkForUnsafePhotos:(BOOL)a7 communicationSafetyNotificationEnabled:(BOOL)a8 familyMemberType:(id)a9;
