...
- (void)_installEventTap:(id)a0 skipDeviceMatching:(BOOL)a1 wantsDigitizerEvents:(BOOL)a2 wantsKeyboardEvents:(BOOL)a3 wantsATVRemoteEvents:(BOOL)a4 wantsLisaEvents:(BOOL)a5 wantsMouseEvents:(BOOL)a6 wantsAccessibilityEvents:(BOOL)a7;
- (void)setFailedToProcessInTimeCallback:(id)a0 callback:(id /* block */)a1;
- (void)_installHIDFilter:(id)a0 skipDeviceMatching:(BOOL)a1 wantsDigitizerEvents:(BOOL)a2 wantsKeyboardEvents:(BOOL)a3 wantsATVRemoteEvents:(BOOL)a4 wantsLisaEvents:(BOOL)a5 wantsMouseEvents:(BOOL)a6 wantsAccessibilityEvents:(BOOL)a7;
- (void)dealloc;
...
- (id)_hidFilterListForPair:(id)a0 wantsDigitizerEvents:(BOOL)a1 wantsKeyboardEvents:(BOOL)a2 wantsATVRemoteEvents:(BOOL)a3 wantsLisaEvents:(BOOL)a4 wantsMouseEvents:(BOOL)a5 wantsAccessibilityEvents:(BOOL)a6;
