@class NSDate, NSString, NSAttributedString, UIImage, UIView, UITapGestureRecognizer, NSArray, MTVisualStylingProvider, NSTimeZone, UIImageConfiguration, NCNotificationSeamlessContentView;
