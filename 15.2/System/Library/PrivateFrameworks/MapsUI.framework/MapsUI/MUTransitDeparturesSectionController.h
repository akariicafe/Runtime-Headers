@class UIView, MUPlaceSectionFooterViewModel, NSString, MUPlaceSectionHeaderViewModel, MUFixedHeightAwareViewController, MKTransitDeparturesViewController, UIViewController, MUPlaceFooterAttributionController, MKUGCCallToActionViewAppearance;
