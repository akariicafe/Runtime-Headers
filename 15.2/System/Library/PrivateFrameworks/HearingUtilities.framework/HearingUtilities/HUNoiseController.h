@class AXDispatchTimer, NSDate, HKHealthStore, ADAMAudioDataReceiver, HKCategorySample, NSMutableArray, NSObject, UNUserNotificationCenter;
...
- (id)measurementConfigurationWithDuration:(unsigned int)a0 period:(unsigned int)a1;
