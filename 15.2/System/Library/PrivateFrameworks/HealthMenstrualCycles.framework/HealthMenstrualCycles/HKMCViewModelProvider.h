...
- (void)setActiveCycle:(id)a0;
- (id)initWithHealthStore:(id)a0 analysisProvider:(id)a1 maximumActiveDuration:(long long)a2 minimumBufferDuration:(long long)a3 calendarCache:(id)a4 queue:(id)a5;
- (id)_initWithDataSource:(id)a0 analysisProvider:(id)a1 maximumActiveDuration:(long long)a2 minimumBufferDuration:(long long)a3 prefetchDuration:(long long)a4 calendarCache:(id)a5 queue:(id)a6;
...
- (id)initWithHealthStore:(id)a0 analysisProvider:(id)a1 maximumActiveDuration:(long long)a2 minimumBufferDuration:(long long)a3 calendarCache:(id)a4;
