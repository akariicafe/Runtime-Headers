...
- (id)initWithStartMean:(double)a0 startStandardDeviation:(double)a1 endMean:(double)a2 endStandardDeviation:(double)a3 allDays:(struct { long long x0; long long x1; })a4 partiallyLogged:(BOOL)a5 daysOffsetFromCalendarMethod:(long long)a6;
