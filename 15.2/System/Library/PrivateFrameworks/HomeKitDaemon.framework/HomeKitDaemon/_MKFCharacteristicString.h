@class NSUUID, NSString, NSData, NSArray, MKFCharacteristicStringDatabaseID, HMDCharacteristicMetadata, NSDictionary, Protocol, NSNumber;
@protocol MKFHome, MKFService;

@interface _MKFCharacteristicString : _MKFCharacteristic <MKFCharacteristicString, MKFCharacteristicStringPrivateExtensions>

@property (class, readonly, copy, nonatomic) Protocol *backingModelProtocol;

@property (copy, nonatomic) NSNumber *maximumLength;
@property (copy, nonatomic) NSNumber *maximumLength;
@property (readonly, copy, nonatomic) MKFCharacteristicStringDatabaseID *databaseID;
