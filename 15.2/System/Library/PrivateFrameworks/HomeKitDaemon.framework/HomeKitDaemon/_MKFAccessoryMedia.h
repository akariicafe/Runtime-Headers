@class NSUUID, NSString, NSArray, HMDUserManagementOperationTimestamp, NSSet, MKFAccessoryMediaDatabaseID, NSData, NSDate, Protocol, NSNumber;
@protocol MKFSoftwareUpdate, MKFRoom, MKFAssistantAccessControl, MKFHome, MKFApplicationData;

@interface _MKFAccessoryMedia : _MKFAccessory <HMDNSManagedObjectBackingStoreModelObjectRepresentable, MKFAccessoryMedia, MKFAccessoryMediaPrivateExtensions>
...
@property (readonly, copy, nonatomic) MKFAccessoryMediaDatabaseID *databaseID;
