@class MKFAccessoryMediaAppleDatabaseID, Protocol, _MKFResidentAccessoryMediaApple, NSArray, HMDUserManagementOperationTimestamp, HMFPairingIdentity, NSDate, NSString, HMFSoftwareVersion, _MKFMediaDestinationController, HMFWiFiNetworkInfo, NSNumber, NSData, _MKFDevice, _MKFAccessorySettingGroup, NSUUID;
...
@interface _MKFAccessoryMediaApple : _MKFAccessoryMedia <HMDNSManagedObjectBackingStoreModelObjectRepresentable, MKFAccessoryMediaApple, MKFAccessoryMediaApplePrivateExtensions>
...
@property (retain, nonatomic) _MKFResidentAccessoryMediaApple *resident;
...
@property (readonly, copy, nonatomic) MKFAccessoryMediaAppleDatabaseID *databaseID;
