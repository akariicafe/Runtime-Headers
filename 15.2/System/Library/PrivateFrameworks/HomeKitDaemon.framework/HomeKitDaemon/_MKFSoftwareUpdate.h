@class NSUUID, NSString, NSDate, NSPredicate, HMSoftwareUpdateDocumentationMetadata, _MKFAccessory, HMDHomeKitVersion, MKFSoftwareUpdateDatabaseID, Protocol, HMFSoftwareVersion, NSNumber;
...
@property (copy, nonatomic) NSNumber *installDuration;
@property (copy, nonatomic) NSDate *releaseDate;
@property (retain, nonatomic) HMDHomeKitVersion *softwareVersion;
@property (copy, nonatomic) NSNumber *state;
