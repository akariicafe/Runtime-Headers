...
- (id)initWithVertexAttributeDescriptor:(const struct VertexAttributeDescriptor { char *x0; unsigned char x1; unsigned char x2; } *)a0 payloadOffset:(unsigned int)a1 count:(unsigned int)a2;
