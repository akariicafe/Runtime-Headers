...
- (void)_updateSceneGeometryWithSettingObserverContext:(struct { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; })a0 windowScene:(id)a1 transitionContext:(id)a2;
