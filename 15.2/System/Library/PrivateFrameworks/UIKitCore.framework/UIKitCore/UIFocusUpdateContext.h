@class UIView, NSString, NSArray, UIImage, _UIFocusMovementInfo, _UIFocusMapSearchInfo, _UIDebugLogReport, _UIDebugIssueReportFormatter, _UIFocusItemInfo, _UIDynamicFocusGroupMap, _UIDebugIssueReport, UIFocusGuide;
@protocol UIFocusEnvironment, UIFocusItemScrollableContainer, _UIFocusUpdateRequesting, _UIFocusBehavior, UIFocusItem;
