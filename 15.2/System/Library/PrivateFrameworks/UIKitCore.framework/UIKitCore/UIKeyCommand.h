@class NSString, UIImage, NSArray, UIEvent, UIResponder, BKSHIDEventDeferringEnvironment, UIViewController, NSIndexSet;
...
@property (nonatomic, setter=_setMatchingPriority:) long long _matchingPriority;
