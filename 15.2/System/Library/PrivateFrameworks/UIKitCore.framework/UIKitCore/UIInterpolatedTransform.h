...
+ (id)valueWithDecomposedTransform:(struct { double x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; })a0 rotationEpsilon:(double)a1 scaleEpsilon:(double)a2 translationEpsilon:(double)a3 rotationDirection:(long long)a4;
