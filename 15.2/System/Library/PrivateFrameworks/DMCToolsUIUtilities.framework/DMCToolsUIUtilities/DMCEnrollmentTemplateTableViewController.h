@class DMCEnrollmentTableViewIconCell, UIView, NSArray, DMCEnrollmentTableViewTitleCell, NSString, NSMutableArray, DMCEnrollmentTableViewTextCell, UIVisualEffectView;
...
- (void)_setupHeaderSectionWithIconNames:(id)a0 iconImages:(id)a1 subTitle:(id)a2 title:(id)a3;
