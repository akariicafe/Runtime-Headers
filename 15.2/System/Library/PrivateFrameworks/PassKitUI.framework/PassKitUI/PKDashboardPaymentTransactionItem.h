@class NSString, PKAccountUserCollection, PKPaymentTransaction, PKTransactionSourceCollection, PKTransactionSource, PKAccount, PKPaymentPass, PKFamilyMemberCollection;
