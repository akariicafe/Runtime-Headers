...
- (id)initWithTransaction:(id)a0 transactionSourceCollection:(id)a1 familyCollection:(id)a2 account:(id)a3 accountUserCollection:(id)a4 contactResolver:(id)a5 peerPaymentWebService:(id)a6 paymentServiceDataProvider:(id)a7 detailViewStyle:(long long)a8 allowTransactionLinks:(BOOL)a9;
