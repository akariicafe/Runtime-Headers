...
- (void)viewControllerForTransaction:(id)a0 transactionSourceCollection:(id)a1 familyCollection:(id)a2 account:(id)a3 accountUserCollection:(id)a4 forcePreventHistory:(BOOL)a5 completion:(id /* block */)a6;
