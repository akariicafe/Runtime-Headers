...
@interface PKPassGroupStackView : UIScrollView <PKPassGroupViewDelegate, PKPassDeleteAnimationControllerDelegate, PKPaymentServiceDelegate, PKPassFooterViewDelegate, PKDashboardPassViewControllerDelegate, PKPassDeleteHandler, PKPassGroupViewReceiver, PKInvalidatable> {
    ...
    struct { unsigned long long numberOfGroups; unsigned long long separatorIndex; double separationPadding; long long pilingMode; double groupCellHeight; unsigned long long externalToTableTransitionModalGroupIndex; unsigned char disableTableModalPresentation : 1; unsigned char hasPaymentPasses : 1; unsigned char hasPasses : 1; unsigned char hasPaymentHeader : 1; unsigned char hasPassHeader : 1; unsigned char hasPaymentHeaderView : 1; unsigned char hasPassHeaderView : 1; unsigned char hasFooter : 1; unsigned char isDeleting : 1; unsigned char isCompactModalPresentation : 1; unsigned char isContinuingModalPresentation : 1; unsigned char forceSubheaderUpdate : 1; unsigned char forceHeaderUpdate : 1; unsigned char forceFooterUpdate : 1; unsigned char preventFooterLayout : 1; unsigned char mutatingForcePileOffscreen : 1; unsigned char transitioningFromExternalToTable : 1; unsigned char transitioningFromExternalToModal : 1; } _layoutState;
