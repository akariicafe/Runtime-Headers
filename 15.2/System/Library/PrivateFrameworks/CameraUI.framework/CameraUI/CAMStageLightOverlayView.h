...
+ (double)_circleDiameterForViewportSize:(struct CGSize { double x0; double x1; })a0 orientation:(long long)a1;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })circleFrameForViewport:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 orientation:(long long)a1 bottomContentInset:(double)a2;
