@class HDFeatureAvailabilityManager, NSString, HDProfile, NSUserDefaults;
...
- (id)initWithProfile:(id)a0 pairedDeviceCapabilityProvider:(id)a1 supportedRegionProvider:(id)a2 heartRateSettingsDefaults:(id)a3;
