...
- (id)_initWithCommitActionBehavior:(id /* block */)a0 scoringFunction:(id /* block */)a1 beamWidth:(unsigned long long)a2 pathCount:(unsigned long long)a3 shouldOptimizeAlignment:(BOOL)a4;
