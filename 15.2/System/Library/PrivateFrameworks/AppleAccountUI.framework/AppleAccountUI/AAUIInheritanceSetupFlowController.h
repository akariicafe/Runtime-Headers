@class AABeneficiaryInfo, NSString, AAUIOBWelcomeController, AAUIInheritanceShareAccessKeyOptionsViewController, AAUIContactsProvider, AALocalContactInfo, AAUIContactSetupNavigationController, ACAccount, AAUIInviteMessageFlowController;
