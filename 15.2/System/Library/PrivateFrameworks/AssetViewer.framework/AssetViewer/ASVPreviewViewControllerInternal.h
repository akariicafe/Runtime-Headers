...
@interface ASVPreviewViewControllerInternal : QLCustomItemViewController <QLPreviewingController, QLPreviewingController_Private, ARQLInlineService, ARQLInlineService2, ARSessionDelegate, ARCoachingOverlayViewDelegate> {
    ...
    void /* unknown type, empty encoding */ audioPlaybackStates;
...
- (void)prepareInlinePreviewWithURL:(id)a0 forUUID:(id)a1 loadingCompletedReply:(id /* block */)a2;
- (void)prepareInlinePreviewWithData:(id)a0 forUUID:(id)a1 loadingCompletedReply:(id /* block */)a2;
...
- (void)updateBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 forUUID:(id)a1 completion:(id /* block */)a2;
- (void)prepareFullscreenPreview:(id)a0 initialFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 previewOptions:(id)a2 fullscreenTransitionCompletion:(id /* block */)a3;
- (void)observeReturnedToInlineForUUID:(id)a0 completion:(id /* block */)a1;
...
- (void)prepareInlinePreviewWithScopedURLWrapper:(id)a0 forUUID:(id)a1 completion:(id /* block */)a2;
