...
- (id)description;
- (void).cxx_destruct;
- (id)initWithAsset:(id)a0 loadingVideoTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a1 loadedVideoPlaybackStartTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 storyPlaybackRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a3 audioInfo:(struct { long long x0; float x1; double x2; double x3; double x4; double x5; })a4;
