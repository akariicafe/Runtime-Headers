...
@property (retain, nonatomic) UIImageView *afterLabelImageView;
...
@property (nonatomic) struct CGRect { struct CGPoint { double x; double y; } origin; struct CGSize { double width; double height; } size; } afterLabelImageFrame;
