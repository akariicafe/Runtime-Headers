@class NSMapTable, PXAssetsDataSourceManager, UIContextMenuInteraction, UIViewController, PXAssetActionManager, UIScrollView, PXGestureProvider, PXUIMediaProvider, PXPhotosDetailsContext, UITargetedPreview, NSString, NSArray, PXAssetReference;
