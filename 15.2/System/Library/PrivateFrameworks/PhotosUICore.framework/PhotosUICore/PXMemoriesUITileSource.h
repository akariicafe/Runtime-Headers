...
- (void)_getImageRequester:(id *)a0 title:(id *)a1 subtitle:(id *)a2 forIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a3 dataSource:(id)a4;
