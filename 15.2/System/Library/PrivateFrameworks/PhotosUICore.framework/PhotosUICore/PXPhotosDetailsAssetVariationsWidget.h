@class PXPhotosDetailsLoadCoordinationToken, PXAssetVariationsDataSourceManager, AVAsset, PXAssetVariationsDataSource, PXAssetVariationRenderProvider, NSString, UILabel, UIImage, PXPhotosDetailsContext, PXPhotoKitAssetActionManager, PHAsset, PXOneUpPresentation, NSObject, UICollectionView, PXAssetEditOperationManager, _PXAssetVariationsContentView, PXTilingController, PXAssetActionManager, PXSectionedSelectionManager, PXAssetVariationCollectionViewCell, PXWidgetSpec, PXActionPerformer;
...
- (void)_logLivePhotoEffectSelected:(long long)a0;
