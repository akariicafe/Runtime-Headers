...
+ (id)currentEventEntryModelWithEntryAndEventDate:(id)a0 atLocation:(id)a1 withDisplayName:(id)a2 constantSun:(long long)a3 animationGroup:(id)a4 device:(id)a5;
+ (id)entryModelWithEntryDate:(id)a0 eventDate:(id)a1 atLocation:(id)a2 withDisplayName:(id)a3 constantSun:(long long)a4 animationGroup:(id)a5 device:(id)a6;
...
- (id)initWithEntryDate:(id)a0 eventDate:(id)a1 atLocation:(id)a2 withDisplayName:(id)a3 constantSun:(long long)a4 currentEvent:(BOOL)a5 animationGroup:(id)a6 device:(id)a7;
