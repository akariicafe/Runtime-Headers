@interface Heart.ElectrocardiogramFeatureStatusAvailability : _TtCs12_SwiftObject <HKHeartRhythmAvailabilityObserver, HKWristDetectionSettingManagerObserver> {
    ...
    void /* unknown type, empty encoding */ currentCountryCode;
