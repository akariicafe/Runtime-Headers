@interface Heart.OnboardingTableViewController : OBTableWelcomeController <UITableViewDelegate> {
    ...
    void /* unknown type, empty encoding */ contentHeightDidChangePublisher;
}
