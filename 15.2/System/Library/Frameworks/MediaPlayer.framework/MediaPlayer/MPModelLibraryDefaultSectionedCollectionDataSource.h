...
@property (readonly, nonatomic) struct shared_ptr<std::vector<std::shared_ptr<mlcore::Entity>>> { void *__ptr_; struct __shared_weak_count *__cntrl_; } itemIdentifierQueryResults;
...
- (id)initWithRequest:(id)a0 itemQueryResults:(struct shared_ptr<mlcore::EntityQueryResult> { struct EntityQueryResult *x0; struct __shared_weak_count *x1; })a1 itemIdentifierQueryResults:(struct shared_ptr<std::vector<std::shared_ptr<mlcore::Entity>>> { void *x0; struct __shared_weak_count *x1; })a2;
- (void).cxx_destruct;
