...
- (id)initWithTileIdentifier:(id)a0 center:(struct CGPoint { double x0; double x1; })a1 size:(struct CGSize { double x0; double x1; })a2 alpha:(double)a3 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a4 zPosition:(double)a5 hitTestOutset:(struct UIEdgeInsets { double x0; double x1; double x2; double x3; })a6 coordinateSystem:(id)a7 isOverContent:(BOOL)a8 contentWidth:(double)a9;
