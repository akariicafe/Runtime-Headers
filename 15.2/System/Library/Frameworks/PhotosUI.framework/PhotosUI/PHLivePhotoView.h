@class ISLivePhotoPlayer, ISPlayerItem, UIView, ISLivePhotoUIView, NSString, PHLivePhoto, NSNumber, UIGestureRecognizer;
...
@interface PHLivePhotoView : UIView <PXLivePhotoView, ISChangeObserver, ISLivePhotoUIViewDelegate> {
    struct { BOOL respondsToCanBeginPlayback; BOOL respondsToWillBeginPlaybackWithStyle; BOOL respondsToDidEndPlayback; } _delegateFlags;
