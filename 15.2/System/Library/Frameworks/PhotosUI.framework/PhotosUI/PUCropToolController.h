@class NSDictionary, PLImageGeometry, PXImageLayerModulator, NSMutableArray, UILongPressGestureRecognizer, NSString, UIImage, CEKBadgeTextView, NSTimer, NSArray, NSMutableDictionary, NUCropModel, NUComposition, PUCropAspectFlipperView, PUAdjustmentsViewController, UIButton, NSObject, PUCropToolControllerSpec, UIView, PXUIButton, PUCropAspectViewController, PUCropPerspectiveAdjustmentsDataSource, PUCropPerspectiveView, PUCropAspect, PUEditActionActivity, PUCropHandleView, PLPhotoEditRenderer, PUCropOverlayView, PUCropVideoScrubberView, PXImageModulationManager;
