...
@property (nonatomic, setter=_setVisualIntelligenceAnalyzeBestImageChanged:) BOOL visualIntelligenceAnalyzeBestImageChanged;
...
@property (readonly, nonatomic) BOOL bestImageChanged;
