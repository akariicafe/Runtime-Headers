@class NSString, PUPhotoSelectionManager, NSPredicate, NSOrderedSet, PXSelectionCoordinator, PHAssetCollection, NSObject, PXLoadingStatusManager, NSPointerArray;
