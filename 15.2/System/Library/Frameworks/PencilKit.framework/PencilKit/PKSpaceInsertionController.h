@class UIView, NSArray, PKSelectionController, PKDrawing, PKSpaceInsertionView, PKImageView, PKStroke, UIPanGestureRecognizer, NSOrderedSet, NSMutableOrderedSet, PKStrokeSelection;
...
@property (copy, nonatomic) NSArray *externalElements;
