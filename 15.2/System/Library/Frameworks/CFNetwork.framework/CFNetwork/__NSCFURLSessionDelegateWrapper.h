...
@interface __NSCFURLSessionDelegateWrapper : NSObject {
    ...
    unsigned char checked__sessionCompanionAvailabilityChanged : 1;
    unsigned char checked__sessionNeedConnectedSocketToHost : 1;
    ...
    unsigned char accept__sessionCompanionAvailabilityChanged : 1;
    unsigned char accept__sessionNeedConnectedSocketToHost : 1;
