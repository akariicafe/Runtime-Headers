@class UIViewController, AVPlayerViewControllerCustomControlsView, AVFullScreenViewController, AVContentOverlayView, NSDictionary, AVSecondScreenConnection, NSString, AVPictureInPictureController, AVPlayerView, AVPlayerViewControllerContentView, NSArray, NSMutableDictionary, AVPlayerController, AVPlayer, NSValue, NSTimer, __AVPlayerLayerView, AVObservationController, AVPlaybackRateCollection, AVBehaviorStorage, UIView, UIHoverGestureRecognizer, AVPlaybackControlsController, AVTransitionController, UIPanGestureRecognizer, AVPlayerControllerVolumeAnimator, AVPresentationContext, UIWindow, UIPopoverPresentationController;
...
- (void)_transitionFromInlineToFullScreenPresentationAnimated:(BOOL)a0 interactive:(BOOL)a1 completionHandler:(id /* block */)a2;
- (void)_transitionFromInlineToDetachedFullScreenPresentationAnimated:(BOOL)a0 completionHandler:(id /* block */)a1;
