@class AVLayoutView, AVVolumeSlider, AVTouchIgnoringView, NSValue, UIViewPropertyAnimator, AVObservationController, AVStyleSheet, AVButton, AVTransportControlsView, AVView, AVScrubber, AVPlaybackControlsRoutePickerView, AVPlayerViewControllerCustomControlsView, AVControlOverflowButton, AVVolumeButtonControl, NSArray, NSUUID;
