@class NSURL, LPIconMetadata, LPImage, LPAssociatedApplicationMetadata, NSObject, LPAudioMetadata, LPAudio, LPImageMetadata, LPSourceApplicationMetadata, LPVideo, NSString, LPVideoMetadata, LPARAsset, SYContentItem, LPSpecializationMetadata, LPARAssetMetadata, NSArray, NSItemProvider, NSMutableArray;
