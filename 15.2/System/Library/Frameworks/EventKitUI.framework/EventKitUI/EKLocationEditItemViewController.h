@class NSMutableDictionary, EKLocationVirtualConferenceSearchFieldsView, EKCalendarItem, EKUILocationSearchModel, EKUIConferenceRoom, EKVirtualConference, UITableView, EKUILocationRowModel, UISearchBar, NSString, EKVirtualConferenceRoomType, EKStructuredLocation, NSError, _UINavigationControllerPalette;
...
- (void)virtualConferenceSearchUpdated:(id)a0;
