@class NSURLCredential, NSString, NSArray, NSExtension, _ASAccountAuthenticationModificationHostViewController, WBSSavedPasswordStore, UIAlertController, WBSPasswordWarning, WBSAutoFillQuirksManager;
