@class NSUUID, NSString, _SFAuthenticationContext, _SFFormAutoFillController, _SFDialogController, WBSPermissionDialogThrottler, WKWebViewConfiguration, WKWebView;
