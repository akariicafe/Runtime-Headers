...
@property (readonly) struct RelativeHumidityMeasurementCluster { void /* function */ **_vptr$ClusterBase; unsigned int mClusterId; struct Device *mDevice; unsigned short mEndpoint; } cppCluster;
...
- (void)configureAttributeMeasuredValueWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 change:(unsigned short)a2 responseHandler:(id /* block */)a3;
