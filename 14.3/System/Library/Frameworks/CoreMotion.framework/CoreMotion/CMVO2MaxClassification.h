@interface CMVO2MaxClassification : NSObject {
    struct unique_ptr<CLVO2MaxClassifier, std::__1::default_delete<CLVO2MaxClassifier> > { struct __compressed_pair<CLVO2MaxClassifier *, std::__1::default_delete<CLVO2MaxClassifier> > { struct CLVO2MaxClassifier *__value_; } __ptr_; } fVO2MaxClassifier;
}
