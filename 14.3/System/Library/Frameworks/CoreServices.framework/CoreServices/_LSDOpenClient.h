...
- (void)openApplicationWithIdentifier:(id)a0 options:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)resolveAppLinksForURL:(id)a0 limit:(unsigned long long)a1 completionHandler:(id /* block */)a2;
