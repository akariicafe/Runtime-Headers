@class PDFScrollView, PDFPasswordViewController, PDFPage, NSObject, PDFAKOverlayAdaptor, PDFAnnotation, NSMutableArray, PDFRenderingProperties, UITapGestureRecognizer, PDFDocument, UILongPressGestureRecognizer, PDFCoachMarkManager, PDFDocumentViewController, NSDictionary, PDFSelection, PDFViewLayout, NSArray, PDFViewController, UIDragInteraction, PDFTimer;
