...
- (void)drawBurnedInAnnotationsWithBox:(long long)a0 inContext:(struct CGContext { } *)a1;
...
- (struct CGImage { } *)_newCGImageWithBox:(long long)a0 bitmapSize:(struct CGSize { double x0; double x1; })a1 scale:(double)a2 offset:(struct CGPoint { double x0; double x1; })a3 backgroundColor:(id)a4 withRotation:(BOOL)a5 withAntialiasing:(BOOL)a6 withAnnotations:(BOOL)a7 withBookmark:(BOOL)a8 withDelegate:(id)a9;
