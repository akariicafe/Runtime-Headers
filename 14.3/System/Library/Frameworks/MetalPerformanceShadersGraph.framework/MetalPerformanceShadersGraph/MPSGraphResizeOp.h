...
- (id)initWithGraph:(id)a0 inputTensors:(id)a1 controlDependencies:(id)a2 size:(id)a3 mode:(unsigned long long)a4 centerResult:(BOOL)a5 alignCorners:(BOOL)a6 layout:(unsigned long long)a7 name:(id)a8 context:(struct MLIRContext { struct unique_ptr<mlir::MLIRContextImpl, std::__1::default_delete<mlir::MLIRContextImpl> > { struct __compressed_pair<mlir::MLIRContextImpl *, std::__1::default_delete<mlir::MLIRContextImpl> > { struct MLIRContextImpl *x0; } x0; } x0; } *)a9;
