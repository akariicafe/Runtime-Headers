@class PUBrowsingBackgroundTileViewController, UIViewController, PUAggregateDictionaryTracer, PUOverOneUpPresentationSession, PUPreviewActionController, PUDoubleTapZoomController, PUReviewScreenBarsModel, PUParallaxComputer, PUOneUpAccessoryViewControllersManager, NSMutableSet, PUTilingView, NSString, CEKBadgeTextView, PUReviewScreenTopBarTileViewController, NSTimer, NSArray, PUOneUpGestureRecognizerCoordinator, PUOneUpBarsController, PUReviewScreenControlBarTileViewController, NSUserActivity, PUAssetDisplayDescriptorNavigationRequest, PUInteractivePinchDismissalController, PUBrowsingSession, PUInteractiveSwipeDismissalController, PULoadingIndicatorController, PUAccessoryVisibilityInteractionController, PUReviewScreenScrubberBarTileViewController, PUOneUpSuggestionsController, UIScrollView, PXUserEventTracker, PUBrowsingOneUpVisibilityHelper, PUOneUpViewControllerSpec;
...
- (void)browsingSession:(id)a0 didExecuteActionPerformer:(id)a1 withCompletionHandler:(id /* block */)a2;
- (void)browsingSessionDidDismissOneUp:(id)a0;
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)a0;
- (void)oneUpSuggestionsController:(id)a0 didSelectSuggestion:(id)a1 forAssetReference:(id)a2;
- (id)viewControllerForOneUpSuggestionsController:(id)a0;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })oneUpSuggestionsController:(id)a0 frameForAssetReference:(id)a1 inCoordinateSpace:(id)a2;
- (BOOL)oneUpSuggestionsController:(id)a0 canShowSuggestion:(id)a1 forAssetReference:(id)a2;
- (id)pu_debugRows;
...
- (BOOL)livePhotoVideoPlaybackTileViewControllerCanBeginPlaying:(id)a0;
