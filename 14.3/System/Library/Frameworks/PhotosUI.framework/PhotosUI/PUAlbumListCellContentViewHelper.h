@class PHCachingImageManager, PUFontManager, UIImage, PHImageRequestOptions, PXExtendedTraitCollection, NSString, PXPhotoKitCollectionsDataSourceManager, PXFeatureSpecManager, PXFeatureSpec, PUAlbumListCellContentViewHelperConfiguration, PXAssetBadgeManager, PXCollectionTileLayoutTemplate;
...
- (id)initWithConfiguration:(id)a0 dataSourceManager:(id)a1 extendedTraitCollection:(id)a2;
