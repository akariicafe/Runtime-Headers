...
- (void)_performActionForActionType:(unsigned long long)a0 withDelegate:(id)a1;
- (void)_performAdditionalKeyCommand:(long long)a0 withDelegate:(id)a1;
- (void)_setVideoToDesiredPlayState:(long long)a0;
- (void)_toggleDetails;
- (void)addKeyCommandsIntoArray:(id)a0 withDelegate:(id)a1;
- (void)performKeyCommand:(id)a0 withDelegate:(id)a1;
