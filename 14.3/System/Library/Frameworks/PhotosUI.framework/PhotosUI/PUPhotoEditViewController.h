...
- (void)editPluginSession:(id)a0 didEndWithCompletionType:(unsigned long long)a1;
...
- (void)_updateAutoEnhanceButtonAnimated:(BOOL)a0;
...
- (void)_saveTrimAsCopyForCompositionController:(id)a0 withCallback:(id /* block */)a1;
