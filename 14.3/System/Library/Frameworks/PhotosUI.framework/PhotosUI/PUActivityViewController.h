@class UIView, NSString, NSArray, PXCPLStatusProvider, PUActivitySharingController, NSOrderedSet, PUActivityProgressController, PUActivitySharingViewModel, PLProgressView, PUActivityItemSourceController, PUSharingHeaderController;
...
- (void)_sendCPAnalyticsShareEventWithActivityType:(id)a0 didComplete:(BOOL)a1;
...
- (void)_presentAlertIfNeededForActivity:(id)a0 withCompletionHandler:(id /* block */)a1;
