...
- (void).cxx_destruct;
- (void)setBadgeInfo:(struct PXAssetBadgeInfo { unsigned long long x0; double x1; long long x2; })a0 style:(long long)a1 forItemAtIndex:(long long)a2;
...
- (void)setBadgeInfo:(struct PXAssetBadgeInfo { unsigned long long x0; double x1; long long x2; })a0 forItemAtIndex:(long long)a1;
