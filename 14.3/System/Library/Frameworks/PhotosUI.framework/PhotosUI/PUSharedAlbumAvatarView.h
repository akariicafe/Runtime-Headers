...
@property (class, readonly, nonatomic) NSObject<OS_dispatch_queue> *sharedSerialQueue;
...
- (void)_updateSubscriberAvatarsWithAlbumCollection:(id)a0;
- (void)_resetImages;
...
- (void)_requestPersonPhoto:(id)a0 resultHandler:(id /* block */)a1;
