...
- (id)clone;
- (id)initWithTileIdentifier:(id)a0 center:(struct CGPoint { double x0; double x1; })a1 size:(struct CGSize { double x0; double x1; })a2 cropInsets:(struct UIEdgeInsets { double x0; double x1; double x2; double x3; })a3 alpha:(double)a4 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a5 zPosition:(double)a6 contentsRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a7 coordinateSystem:(id)a8;
- (id)description;
