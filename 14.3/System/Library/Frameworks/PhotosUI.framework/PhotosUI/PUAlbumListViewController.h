@class PUAlbumListSectionHeaderView, NSUserActivity, PUPhotoPinchGestureRecognizer, PUAlbumListViewControllerSpec, NSMutableSet, PXPlacesAlbumCoverProvider, PXPhotoKitCollectionsDataSourceManagerConfiguration, UIBarButtonItem, PUCollageView, PUPhotosPickerViewController, PXPhotoKitCollectionsDataSource, PHCollection, PUAlbumListTransitionContext, PUCollectionsCollectionViewDropDelegate, PXAssetBadgeManager, UIViewController, PXFeatureSpecManager, UITableView, UIAlertController, PUAlbumStreamActivity, PXPhotoKitCollectionsDataSourceManager, PUFeedViewController, PXEditableNavigationTitleView, PXFeatureSpec, PUFontManager, PXPeopleAlbumProvider, _UIContentUnavailableView, UICollectionViewLayout, PHCachingImageManager, UIView, NSArray, PUSectionedGridLayout, PXCollectionTileLayoutTemplate, NSString, UIAlertAction, PUCollectionView, PXPhotosGlobalFooterView, PUSessionInfo, PHImageRequestOptions;
...
- (void)handleDeleteAlbumAtIndexPath:(id)a0;
