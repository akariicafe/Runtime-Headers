@class _UIDragSnappingFeedbackGenerator, UITapGestureRecognizer, EKCalendarDate, EKUIInviteesViewMessageSendingManager, EKUIRecurrenceAlertController, UIView, UIDropInteraction, UILongPressGestureRecognizer, EKEvent, NSString, NSTimer, EKICSPreviewController, EKDayOccurrenceView, UIDragInteraction;
