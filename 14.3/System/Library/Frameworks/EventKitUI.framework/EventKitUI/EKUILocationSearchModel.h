@class NSCharacterSet, EKOccurrenceCacheLocationSearch, CLLocation, EKEventStore, MKLocalSearch, NSObject, CLGeocoder, NSMutableDictionary, CLLocationManager, NSMutableArray, NSString, CLInUseAssertion, CNContactStore, NSOperationQueue, NSArray, EKStructuredLocation, MKLocalSearchCompleter;
...
- (void)addLocationToRecents:(id)a0 addressString:(id)a1;
