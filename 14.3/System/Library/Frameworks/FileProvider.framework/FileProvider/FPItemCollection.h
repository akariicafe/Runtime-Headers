@class NSString, NSArray, NSPredicate, FPAppRegistry, NSMutableDictionary, FPItemID, _FPItemList, NSObject, NSMutableSet, FPPacer;
@protocol FPItemCollectionMinimalDelegate, FPCollectionDataSource, FPItemCollectionIndexPathBasedDelegate, OS_dispatch_queue, FPItemCollectionItemIDBasedDelegate;
...
@property (retain, nonatomic) NSMutableDictionary *dsCopyProgressTokenMap;
