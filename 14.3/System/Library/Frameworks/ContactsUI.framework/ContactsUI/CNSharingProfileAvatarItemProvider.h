@class CNSharingProfileAvatarItem, NSArray, CNPhotoPickerVariantsManager, CNSharingProfileLogger, CNSharingProfileAvatarItemProviderConfiguration, CNContact, CNAvatarImageRenderer, CNPhotoPickerColorVariant, PRMonogramColor;
