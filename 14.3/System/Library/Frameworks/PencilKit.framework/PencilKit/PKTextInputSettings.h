...
@property (retain, nonatomic) NSArray *_inputModesForTesting;
...
- (id)_remappedBaseLanguage:(id)a0;
- (id)_enabledLanguagesFromSettingsChineseSupported:(BOOL)a0;
- (id)_currentSupportedLocale;
- (id)availableRecognitionLocaleIdentifiers;
- (id)defaultRecognitionLocaleIdentifierFromAvailableIdentifiers:(id)a0;
- (void)_scheduledSaveSettingsTriggered;
- (void)saveSettingsToUserDefaults;
- (void)resetToDefaultValues;
- (void)_performOperations:(id /* block */)a0 withActiveInputModes:(id)a1;
- (void)_performOperations:(id /* block */)a0 withActiveInputModeIdentifiers:(id)a1;
