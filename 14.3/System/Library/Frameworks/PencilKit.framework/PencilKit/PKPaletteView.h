@class UIView, NSString, PKPaletteToolPreview, PKPaletteScaleFactorPolicy, PKPaletteContainerView, UIViewController, MTMaterialView, NSLayoutConstraint;
@protocol PKPaletteViewDelegate, PKPaletteViewInternalDelegate, PKPaletteViewHosting;
...
@property (readonly, nonatomic) BOOL shouldPauseBackgroundUpdates;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })palettePopoverSourceRect;
