...
+ (id)_dictionaryRepresentationForTargetContentInfo:(id)a0 elementType:(id)a1 detailLevel:(long long)a2 contentLevel:(long long)a3 resultAffectedRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a4 localeIdentifier:(id)a5;
