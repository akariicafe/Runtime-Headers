@class NSString, NSArray, PKTextInputElementsController, PKDrawing, NSMutableDictionary, NSDictionary, PKTextInputCanvasController, PKStroke, PKTextInputLanguageSpec, PKTextInputStrokeProvider, NSNumber;
