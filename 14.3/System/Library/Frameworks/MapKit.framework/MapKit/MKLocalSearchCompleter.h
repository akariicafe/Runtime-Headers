@class GEOMapServiceTraits, CLLocation, MKPointOfInterestFilter, GEOSortPriorityMapping, NSMutableArray, GEORetainedSearchMetadata, NSString, GEOClientRankingModel, MKLocalSearchCompletion, NSTimer, GEOAutocompleteSessionData, NSArray, GEOSearchCategory;
