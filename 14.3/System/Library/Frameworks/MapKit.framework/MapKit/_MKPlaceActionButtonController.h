...
+ (id)actionButtonControllerWithTitle:(id)a0 subTitle:(id)a1 selectedBlock:(id /* block */)a2 disabled:(BOOL)a3;

- (void).cxx_destruct;
- (id)infoCardChildPossibleActions;
- (id)infoCardChildUnactionableUIElements;
- (id)initWithTitle:(id)a0 subTitle:(id)a1 analyticsAction:(int)a2 selectedBlock:(id /* block */)a3 disabled:(BOOL)a4;
