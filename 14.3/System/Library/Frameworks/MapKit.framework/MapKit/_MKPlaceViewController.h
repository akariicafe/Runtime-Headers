@class MKUGCCallToActionViewController, GEOCyclingOptions, NSUserActivity, NSMutableArray, MKInfoCardLoadingView, MKPlaceCardActionsRowViewController, MKMapItem, MKPlaceInfoViewController, _MKPlaceActionButtonController, NSMapTable, CNContact, MKPlacePoisInlineMapViewController, CNContactViewController, MKPlaceCuratedCollectionsViewController, _MXExtensionManager, RadiosPreferences, MKPlaceCardHeaderViewController, MKMuninContainerView, MKPlaceEncyclopedicViewController, CLLocation, MKPlaceActionManager, MKOfficialAppViewController, MKPlaceHeaderButtonsViewController, MKPlaceCardFooterActionsViewController, NSString, NSObject, GEOAutomobileOptions, GEOTransitOptions, MKPlaceCollectionViewController, MKETAProvider, CNContactStore, MKUGCCallToActionViewAppearance, CNContactNavigationController, MKPlaceInlineMapViewController, NSTimer, MKMuninView, geo_isolater;
@protocol CNContactViewControllerPrivateDelegate, _MKPlaceItem, _MKPlaceViewControllerDelegate, _MKPlaceViewControllerFeedbackDelegate, OS_dispatch_queue, UIScrollViewDelegate;
...
- (void)placeCardActionControllerDidSelectRequestInformedConsentForAddingContributions:(id)a0;
...
- (void)updateUGCViewsWithHeaderAppearance:(id)a0 rowInfoAppearances:(id)a1 animated:(BOOL)a2;
