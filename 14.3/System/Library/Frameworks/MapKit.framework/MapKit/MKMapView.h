...
@property (nonatomic, getter=_isGeodHealthConsoleEnabled, setter=_setGeodHealthConsoleEnabled:) BOOL geodHealthConsoleEnabled;
...
- (void)_setMapType:(unsigned long long)a0 onInit:(BOOL)a1 animated:(BOOL)a2 forceSetting:(BOOL)a3;
...
- (id)_initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 gestureRecognizerHostView:(id)a1 showsAttribution:(BOOL)a2 showsAppleLogo:(BOOL)a3;
...
- (void)_stopEffects;
- (id)_commonInitFromIB:(BOOL)a0 gestureRecognizerHostView:(id)a1 locationManager:(id)a2 showsAttribution:(BOOL)a3 showsAppleLogo:(BOOL)a4;
