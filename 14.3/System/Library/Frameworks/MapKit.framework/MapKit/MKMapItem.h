@class NSNumber, GEOBusinessHours, NSTimeZone, GEOMapRegion, GEOMapItemStorageUserValues, GEOPDBusinessClaim, NSDictionary, MKMapItemIdentifier, GEOFeatureStyleAttributes, NSString, GEOModuleLayoutEntry, GEOMapItemDetourInfo, NSArray, GEOPDFlyover, _MKMapItemPhotosAttribution, GEOMuninViewState, NSNumberFormatter, _MKMapItemReviewsAttribution, _MKMapItemPlaceAttribution, NSData, GEOMapItemStorage, MKPlacemark, _MKPlaceReservationInfo, GEORelatedPlaceList, GEOPlace, UIColor, NSURL, NSDate, GEOAddress, MKMapItemMetadata;
...
+ (BOOL)_openHandleInMaps:(id)a0 withLaunchOptions:(id)a1;
+ (void)_openHandleInMaps:(id)a0 withLaunchOptions:(id)a1 completionHandler:(id /* block */)a2;
...
- (id)_activityURLUsingWebPlaceCard:(BOOL)a0 muninViewState:(id)a1;
- (id)_bestNavbarBrandIconURLForSize:(struct CGSize { double x0; double x1; })a0 allowSmaller:(BOOL)a1;
- (id)urlRepresentation;
- (id)_activityURL;
- (id)_activityURLUsingWebPlaceCard:(BOOL)a0;
- (id)_cnPostalAddress;
