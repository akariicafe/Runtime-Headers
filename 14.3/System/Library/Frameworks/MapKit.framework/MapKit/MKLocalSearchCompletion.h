@class NSString, NSArray, MKMapItem, GEOCollectionResult, GEOServerResultScoreMetadata, GEOResolvedItem, GEODirectionIntent, GEOPublisherResult, GEORetainedSearchMetadata, GEOSearchCategory;
