...
- (id)initWithRequestRevision:(unsigned long long)a0 pointsData:(id)a1 pointCount:(unsigned long long)a2 constellation:(unsigned long long)a3 precisionEstimatesPerPoint:(id)a4 occlusionFlagsPerPoint:(id)a5 userFacingBBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a6 alignedBBox:(struct _Geometry2D_rect2D_ { struct _Geometry2D_point2D_ { float x0; float x1; } x0; struct _Geometry2D_size2D_ { float x0; float x1; } x1; })a7 landmarkScore:(float)a8;
