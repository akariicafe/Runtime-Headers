...
- (id)_calculateLKTVectorResult:(struct CVPixelBufferWrapper { struct __CVBuffer *x0; })a0 fromPixelBuffer:(struct CVPixelBufferWrapper { struct __CVBuffer *x0; })a1 toPixelBuffer:(struct CVPixelBufferWrapper { struct __CVBuffer *x0; })a2 opticalFlowOptions:(const struct OpticalFlowOptions { id x0; unsigned int x1; unsigned long long x2; unsigned long long x3; BOOL x4; unsigned long long x5; unsigned long long x6; float x7; float x8; float x9; } *)a3 error:(id *)a4;
- (id)_createOpticalFlowForPixelBuffer:(struct CVPixelBufferWrapper { struct __CVBuffer *x0; })a0 opticalFlowOptions:(const struct OpticalFlowOptions { id x0; unsigned int x1; unsigned long long x2; unsigned long long x3; BOOL x4; unsigned long long x5; unsigned long long x6; float x7; float x8; float x9; } *)a1 error:(id *)a2;
