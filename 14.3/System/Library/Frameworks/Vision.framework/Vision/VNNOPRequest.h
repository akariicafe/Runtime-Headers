...
- (struct __CVBuffer { } *)_createScaledImagePixelBufferFromCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 ofImageBuffer:(id)a1 inPixelFormat:(unsigned int)a2 forDetectorInputImageSize:(struct CGSize { double x0; double x1; })a3 usingAnisotropicScaling:(BOOL)a4 options:(id)a5 error:(id *)a6;
- (struct __CVBuffer { } *)_createScaledImagePixelBufferFromImageBuffer:(id)a0 inPixelFormat:(unsigned int)a1 forDetectorInputImageSize:(struct CGSize { double x0; double x1; })a2 usingAnisotropicScaling:(BOOL)a3 options:(id)a4 error:(id *)a5;
