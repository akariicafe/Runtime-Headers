@interface LKTOpticalFlowCPU : LKTOpticalFlow {
    struct unique_ptr<apple::vision::OpticalFlow::LKTCPU, std::__1::default_delete<apple::vision::OpticalFlow::LKTCPU> > { struct __compressed_pair<apple::vision::OpticalFlow::LKTCPU *, std::__1::default_delete<apple::vision::OpticalFlow::LKTCPU> > { struct LKTCPU *__value_; } __ptr_; } _opticalFlow;
