...
+ (id)_faceprintRevision1ModelPathAndReturnError:(id *)a0;
+ (id)_faceprintRevision2ModelPathAndReturnError:(id *)a0;
+ (id)_ageClassifierPathForFaceprintRequestRevision:(unsigned long long)a0 error:(id *)a1;
