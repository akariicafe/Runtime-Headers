@interface FaceCoreDetector : NSObject {
    struct unique_ptr<apple::vision::libraries::facecore::FaceCoreAPI, std::__1::default_delete<apple::vision::libraries::facecore::FaceCoreAPI> > { struct __compressed_pair<apple::vision::libraries::facecore::FaceCoreAPI *, std::__1::default_delete<apple::vision::libraries::facecore::FaceCoreAPI> > { struct FaceCoreAPI *__value_; } __ptr_; } _api;
}
...
+ (id)_createFCRFaceFromFace:(struct Face { int x0; struct coord { int x0; int x1; } x1; struct coord { int x0; int x1; } x2; struct coord { int x0; int x1; } x3; struct coord { int x0; int x1; } x4; float x5; int x6; int x7; struct vector<double, std::__1::allocator<double> > { double *x0; double *x1; struct __compressed_pair<double *, std::__1::allocator<double> > { double *x0; } x2; } x8; int x9; struct vector<apple::vision::libraries::facecore::coord, std::__1::allocator<apple::vision::libraries::facecore::coord> > { struct coord *x0; struct coord *x1; struct __compressed_pair<apple::vision::libraries::facecore::coord *, std::__1::allocator<apple::vision::libraries::facecore::coord> > { struct coord *x0; } x2; } x10; int x11; BOOL x12; BOOL x13; float x14; float x15; BOOL x16; float x17; BOOL x18; float x19; struct naturalSmileData *x20; } *)a0 image:(id)a1;
...
+ (void)_updateFCRFace:(id)a0 fromFace:(struct Face { int x0; struct coord { int x0; int x1; } x1; struct coord { int x0; int x1; } x2; struct coord { int x0; int x1; } x3; struct coord { int x0; int x1; } x4; float x5; int x6; int x7; struct vector<double, std::__1::allocator<double> > { double *x0; double *x1; struct __compressed_pair<double *, std::__1::allocator<double> > { double *x0; } x2; } x8; int x9; struct vector<apple::vision::libraries::facecore::coord, std::__1::allocator<apple::vision::libraries::facecore::coord> > { struct coord *x0; struct coord *x1; struct __compressed_pair<apple::vision::libraries::facecore::coord *, std::__1::allocator<apple::vision::libraries::facecore::coord> > { struct coord *x0; } x2; } x10; int x11; BOOL x12; BOOL x13; float x14; float x15; BOOL x16; float x17; BOOL x18; float x19; struct naturalSmileData *x20; } *)a1 image:(id)a2;
...
+ (void)_addLandmarkOfType:(id)a0 fromMesh:(struct vector<apple::vision::libraries::facecore::coord, std::__1::allocator<apple::vision::libraries::facecore::coord> > { struct coord *x0; struct coord *x1; struct __compressed_pair<apple::vision::libraries::facecore::coord *, std::__1::allocator<apple::vision::libraries::facecore::coord> > { struct coord *x0; } x2; } *)a1 indexes:(id)a2 to:(id)a3 image:(id)a4;
