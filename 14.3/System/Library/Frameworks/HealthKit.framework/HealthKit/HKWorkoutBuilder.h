@class NSMutableDictionary, HKWorkoutBuilderConfiguration, NSDate, NSDictionary, NSObject, HKStateMachine, HKHealthStore, HKTaskServerProxyProvider, NSString, HKWorkoutConfiguration, HKRetryableOperation, NSArray, HKDevice, NSUUID;
