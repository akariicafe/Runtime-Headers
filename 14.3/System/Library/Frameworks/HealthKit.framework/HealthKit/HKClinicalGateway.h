@class NSString, NSURL, HKClinicalBrand, HKFHIRVersion;
...
- (id)initWithExternalID:(id)a0 title:(id)a1 subtitle:(id)a2 displayableDescription:(id)a3 phoneNumber:(id)a4 informationURL:(id)a5 passwordResetURL:(id)a6 patientPortalURL:(id)a7 signupURL:(id)a8 status:(long long)a9 type:(long long)a10 brand:(id)a11 country:(id)a12 FHIRVersion:(id)a13;
- (id)init;
- (void).cxx_destruct;
