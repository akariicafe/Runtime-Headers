@class NSUUID, NSString, NSArray, NSDate, NSLocale, HKSemanticDate, HKConcept, HKFHIRIdentifier;
...
+ (id)_newMedicalRecordWithType:(id)a0 note:(id)a1 enteredInError:(BOOL)a2 modifiedDate:(id)a3 FHIRIdentifier:(id)a4 locale:(id)a5 extractionVersion:(long long)a6 device:(id)a7 metadata:(id)a8 sortDate:(id)a9 country:(id)a10 state:(unsigned long long)a11 config:(id /* block */)a12;
