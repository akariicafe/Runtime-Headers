...
- (id)totalUninstalledAppDataUsageForPeriod:(unsigned long long)a0;
- (id)uninstalledAppDataUsageForPeriod:(unsigned long long)a0;
- (id)totalProxiedOnlyAppDataUsageForPeriod:(unsigned long long)a0;
...
- (id)totalSystemServiceDataUsageForPeriod:(unsigned long long)a0;
- (id)totalDataUsage:(id)a0 forPeriod:(unsigned long long)a1;
- (id)totalDataUsageForPeriod:(unsigned long long)a0;
- (id)totalAppDataUsageForPeriod:(unsigned long long)a0;
