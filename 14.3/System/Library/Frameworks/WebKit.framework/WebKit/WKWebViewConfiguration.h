@class _WKWebsiteDataStore, NSString, NSArray, _WKApplicationManifest, WKWebViewContentProviderRegistry, WKProcessPool, WKPreferences, WKUserContentController, WKWebpagePreferences, _WKVisitedLinkStore, WKWebsiteDataStore, WKWebView;
@protocol _UIClickInteractionDriving;

@interface WKWebViewConfiguration : NSObject <NSSecureCoding, NSCopying> {
    struct RefPtr<API::PageConfiguration, WTF::DumbPtrTraits<API::PageConfiguration> > { struct PageConfiguration *m_ptr; } _pageConfiguration;
    ...
    struct Optional<WTF::RetainPtr<NSString> > { BOOL init_; union storage_t<WTF::RetainPtr<NSString> > { unsigned char dummy_; struct RetainPtr<NSString> { void *m_ptr; } value_; } storage_; } _applicationNameForUserAgent;
...
- (struct Ref<API::PageConfiguration, WTF::DumbPtrTraits<API::PageConfiguration> > { struct PageConfiguration *x0; })copyPageConfiguration;
