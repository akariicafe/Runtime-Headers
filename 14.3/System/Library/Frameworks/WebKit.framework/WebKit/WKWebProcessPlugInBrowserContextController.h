@class WKDOMRange, WKWebProcessPlugInPageGroup, WKBrowsingContextHandle, NSString, WKWebProcessPlugInFrame, _WKRemoteObjectRegistry, WKDOMDocument;
...
@interface WKWebProcessPlugInBrowserContextController : NSObject <WKObject> {
    struct ObjectStorage<WebKit::WebPage> { struct type { unsigned char __lx[2160]; } data; } _page;
