...
@property (readonly) struct InjectedBundleRangeHandle { void /* function */ **x0; id x1; struct Ref<WebCore::Range, WTF::DumbPtrTraits<WebCore::Range> > { struct Range *x0; } x2; } *_rangeHandle;
