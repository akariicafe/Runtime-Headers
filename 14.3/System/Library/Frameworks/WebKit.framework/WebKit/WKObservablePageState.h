...
@interface WKObservablePageState : NSObject <_WKObservablePageState> {
    ...
    struct unique_ptr<WebKit::PageLoadStateObserver, std::__1::default_delete<WebKit::PageLoadStateObserver> > { struct __compressed_pair<WebKit::PageLoadStateObserver *, std::__1::default_delete<WebKit::PageLoadStateObserver> > { struct PageLoadStateObserver *__value_; } __ptr_; } _observer;
}
...
- (void).cxx_destruct;
- (id)initWithPage:(struct RefPtr<WebKit::WebPageProxy, WTF::DumbPtrTraits<WebKit::WebPageProxy> > { struct WebPageProxy *x0; } *)a0;
- (void)dealloc;
- (id).cxx_construct;
