@class NSURL, LPTheme, LPImagePresentationProperties, LPImage, LPHTMLComponent, LPCSSResolver, UIColor, LPVideo, LPCaptionBarPresentationProperties, DOMDocument, NSString, LPMetadataProvider, DOMDocumentFragment, LPLinkMetadata, LPPointUnit, NSArray, DOMElement, LPHTMLVideoComponent;
