@class _SFDialogController, NSUUID, _SFAuthenticationContext, WKWebView, NSString, _SFFormAutoFillController, WKWebViewConfiguration;
...
- (void)_webView:(id)a0 didNegotiateModernTLS:(id)a1;
