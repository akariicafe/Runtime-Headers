@class UIVisualEffectView, _SFNavigationBarURLButton, SFNavigationBarMetrics, UILabel, SFToolbarContainer, SFNavigationBarAccessoryButtonArrangement, NSString, SFDismissButton, _SFNavigationBarTheme, NSArray, NSAttributedString, _SFNavigationBarLabelsContainer, _SFDimmingButton, _UIClickInteraction, _SFBarTheme, UIButton, NSTimer, UIView, _SFFluidProgressView, UIImageView, SFNavigationBarToggleButton, _SFToolbar, UITextField, UIBlurEffect, _SFNavigationBarItem;
