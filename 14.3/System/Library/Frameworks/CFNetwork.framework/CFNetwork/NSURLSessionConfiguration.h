@class NSURL, NSHTTPCookieStorage, NSDictionary, NSURLCache, NSString, _NSHTTPAlternativeServicesStorage, NSSet, NSArray, NSURLCredentialStorage, NSData, _NSHSTSStorage, NSNumber;
