@class NSUUID, NSString, NSURL, NSDate, NSError, NSData, NSDictionary, NSURLResponse, NSURLRequest, AVURLAsset, __CFN_TaskMetrics;
...
- (id)initWithAVAggregateDownloadTaskNoChildTaskKindWithURL:(id)a0 destinationURL:(id)a1 assetTitle:(id)a2 assetArtworkData:(id)a3 options:(id)a4 taskIdentifier:(unsigned long long)a5 uniqueIdentifier:(id)a6 bundleID:(id)a7 sessionID:(id)a8;
...
- (id)initWithAVAssetDownloadURL:(id)a0 destinationURL:(id)a1 assetTitle:(id)a2 assetArtworkData:(id)a3 options:(id)a4 taskIdentifier:(unsigned long long)a5 uniqueIdentifier:(id)a6 bundleID:(id)a7 sessionID:(id)a8;
