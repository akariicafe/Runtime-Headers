...
- (void)_importStoreItemElements:(id)a0 withReferralObject:(id)a1 andAddTracksToCloudLibrary:(BOOL)a2 usingCloudAdamID:(long long)a3 withCompletion:(id /* block */)a4;
