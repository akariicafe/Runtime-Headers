@class ICUserIdentity, MPModelStoreBrowseSectionBuilder, NSString, NSDictionary, MPSectionedCollection, NSRegularExpression, NSIndexSet, MPModelStoreBrowseContentItemBuilder;
...
- (id)initWithRawResponseOutput:(id)a0 sectionBuilder:(id)a1 contentItemBuilder:(id)a2 filteredFCKinds:(id)a3 userIdentity:(id)a4 rootObjectIdentifier:(id)a5 options:(unsigned long long)a6 storeBagDictionary:(id)a7;
