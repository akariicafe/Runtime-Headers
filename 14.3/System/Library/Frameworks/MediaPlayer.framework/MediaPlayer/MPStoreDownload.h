...
+ (id)storeDownloadForStoreItemOffer:(id)a0 attributes:(id)a1;
+ (id)storeDownloadForStoreOffer:(id)a0 type:(long long)a1 attributes:(id)a2;
+ (id)storeDownloadWithDownloadIdentifier:(long long)a0;
+ (BOOL)_getEffectiveStoreDownloadAttributes:(id *)a0 forPlaybackItemMetadata:(id)a1 attributes:(id)a2;
+ (BOOL)canCreateStoreDownloadForPlaybackItemMetadata:(id)a0 type:(long long)a1 attributes:(id)a2;
+ (id)storeDownloadForPlaybackItemMetadata:(id)a0 type:(long long)a1 attributes:(id)a2;
