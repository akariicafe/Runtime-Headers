...
@interface MPModelForYouRecommendationMusicKitItemBuilder : NSObject {
    struct { BOOL isInitialized; BOOL itemType; BOOL url; BOOL backedByStoreItemMetadata; BOOL album; BOOL playlist; BOOL radioStation; BOOL subgroup; } _requestedItemProperties;
