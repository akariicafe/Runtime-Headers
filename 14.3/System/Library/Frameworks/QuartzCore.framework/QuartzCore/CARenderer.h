...
@interface CARenderer : NSObject {
    struct CARendererPriv { id x0; struct Weak<id> { id x0; } x1; id x2; struct Context *x3; struct Renderer *x4; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x5; struct CGColorSpace *x6; struct Update *x7; unsigned int x8; unsigned int x9[2]; unsigned int x10[2]; unsigned int x11; unsigned char x12 : 8; unsigned char x13 : 1; unsigned char x14 : 1; unsigned long long x15; char x16[0]; } *_priv;
}
