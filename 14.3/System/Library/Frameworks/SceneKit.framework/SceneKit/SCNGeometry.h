@class SCNMaterial, NSString, NSArray, SCNGeometryElement, SCNShadableHelper, NSMutableDictionary, NSDictionary, SCNOrderedDictionary, SCNGeometrySource, NSMutableArray, SCNGeometryTessellator, SCNProgram;
