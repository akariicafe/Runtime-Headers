...
@property (class, retain, nonatomic, setter=_setDefaultStore:) ACAccountStore *_defaultStore;
...
- (void)notifyRemoteDevicesOfNewAccount:(id)a0 withCompletion:(id /* block */)a1;
...
- (void)notifyRemoteDevicesOfNewAccount:(id)a0;
...
- (id)typeIdentifierForDomain:(id)a0;
