...
- (id)encodeToCommandBuffer:(id)a0 primaryImage:(id)a1 secondaryImage:(id)a2 inState:(id)a3;
- (void)encodeToCommandBuffer:(id)a0 primaryImage:(id)a1 secondaryImage:(id)a2 inState:(id)a3 destinationImage:(id)a4 subBatchIndex:(unsigned long long)a5 batchSize:(unsigned long long)a6;
