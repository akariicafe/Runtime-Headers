...
- (struct MPSRayIntersectorFunctionHash { union { struct { unsigned char x0 : 2; unsigned char x1 : 2; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned char x5 : 2; unsigned char x6 : 1; unsigned char x7 : 2; unsigned char x8 : 1; unsigned char x9 : 2; unsigned char x10 : 3; unsigned char x11 : 2; unsigned char x12 : 8; unsigned char x13 : 1; unsigned char x14 : 6; unsigned char x15 : 1; unsigned char x16 : 1; unsigned char x17 : 1; unsigned char x18 : 1; unsigned char x19 : 2; unsigned char x20 : 1; unsigned char x21 : 1; unsigned char x22 : 4; unsigned int x23 : 17; } x0; unsigned long long x1; } x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; })getHashForIntersectionType:(unsigned long long)a0 indexing:(BOOL)a1 indexType:(unsigned int)a2 instancing:(BOOL)a3 vertexStride:(unsigned long long)a4 transformType:(unsigned long long)a5 rootNodeType:(int)a6 branchingFactor:(unsigned long long)a7 nodeLayout:(int)a8 polygonType:(unsigned long long)a9 rayIndexing:(BOOL)a10 useRayTexture:(BOOL)a11 useResourceBuffer:(BOOL)a12;
