@class NSString, NSArray, NSHashTable, NSNumber;
...
- (void).cxx_destruct;
- (void)openL2CAPChannel:(id)a0;
- (void)closeRFCOMMChannel:(id)a0;
- (BOOL)isAppleDevice;
- (void)dealloc;
- (void)closeL2CAPChannel:(id)a0;
...
- (void)openRFCOMMChannel:(id)a0;
- (id)channelWithPSM:(unsigned short)a0;
- (void)handleFailedConnection;
- (id)initWithInfo:(id)a0 manager:(id)a1;
- (void)openL2CAPChannel:(id)a0 options:(id)a1;
- (void)handleDisconnection;
- (void)openRFCOMMChannel:(id)a0 options:(id)a1;
