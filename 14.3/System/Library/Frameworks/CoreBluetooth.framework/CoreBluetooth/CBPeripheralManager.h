...
@interface CBPeripheralManager : CBManager {
    struct { unsigned char willRestoreState : 1; unsigned char didAddService : 1; unsigned char didReceiveReadRequest : 1; unsigned char didReceiveWriteRequests : 1; unsigned char centralDidSubscribeToCharacteristic : 1; unsigned char centralDidUnsubscribeFromCharacteristic : 1; unsigned char didStartAdvertising : 1; unsigned char isReadyToUpdate : 1; unsigned char centralDidConnect : 1; unsigned char centralDidUpdateConnectionParameters : 1; unsigned char didPublishL2CAPChannel : 1; unsigned char didUnpublishL2CAPChannel : 1; unsigned char didOpenL2CAPChannel : 1; unsigned char didStopAdvertisingWithError : 1; unsigned char didUpdateANCSAuthorization : 1; } _delegateFlags;
