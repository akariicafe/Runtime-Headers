...
@protocol GCControllerSettingsComponent, GCNamedProfile, GCControllerProductInfo, GCControllerPlayerIndicator, GCDeviceLightComponent, OS_dispatch_queue, GCDeviceHapticCapabilityInfo, NSCopying, NSObject, NSSecureCoding, GCDeviceBatteryComponent, GCControllerMotionConfigurableSensors;
