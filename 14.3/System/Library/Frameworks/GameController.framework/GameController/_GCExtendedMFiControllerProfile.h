...
+ (void)determineCapabilitiesWithServiceInfo:(id)a0 initInfo:(struct { struct { id x0; BOOL x1; BOOL x2; union { struct { int x0; BOOL x1; float x2; } x0; struct { int x0; int x1; int x2; int x3; } x1; } x3; int x4; BOOL x5; BOOL x6; BOOL x7; id x8; id x9; } x0[16]; BOOL x1; BOOL x2; } *)a1;
+ (void)populateInitInfo:(struct { struct { id x0; BOOL x1; BOOL x2; union { struct { int x0; BOOL x1; float x2; } x0; struct { int x0; int x1; int x2; int x3; } x1; } x3; int x4; BOOL x5; BOOL x6; BOOL x7; id x8; id x9; } x0[16]; BOOL x1; BOOL x2; } *)a0 forLogicalDevice:(id)a1;
