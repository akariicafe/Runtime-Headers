...
+ (id)layerWithDevice:(id)a0 descriptor:(id)a1 inputWeights:(id)a2 hiddenWeights:(id)a3 peepholeWeights:(id)a4 biasTerms:(id)a5 gateActivations:(id)a6 outputResultActivation:(id)a7;
...
- (id)initWithDevice:(id)a0 descriptor:(id)a1 inputWeights:(id)a2 hiddenWeights:(id)a3 peepholeWeights:(id)a4 biasTerms:(id)a5 gateActivations:(id)a6 outputResultActivation:(id)a7;
