...
- (id)fusedFullyConnectedAndSoftmaxLayerWithDescriptor:(id)a0 weights:(id)a1 biasTerms:(id)a2;
...
- (id)fusedInstanceNormalizationAndNeuronLayerWithDescriptor:(id)a0 numOfFeatureChannels:(unsigned long long)a1 beta:(id)a2 gamma:(id)a3 varianceEpsilon:(float)a4 momentum:(float)a5;
...
- (BOOL)doesActivationRequireInput:(id)a0;
- (void)fuseLayersForGraph:(id)a0 startAtLayerIndex:(unsigned long long)a1;
...
- (void)allocateResultTensor:(id)a0 resultTensorIsTemporary:(BOOL)a1;
- (void)freeTemporaryTensor:(id)a0;
