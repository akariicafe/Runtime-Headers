...
+ (id)createBNNSNDArrayDescriptorForDescriptor:(id)a0 weightsDelta:(id)a1 fullyConnected:(BOOL)a2;
+ (id)createBNNSNDArrayDescriptorForDescriptor:(id)a0 biasDelta:(id)a1;
