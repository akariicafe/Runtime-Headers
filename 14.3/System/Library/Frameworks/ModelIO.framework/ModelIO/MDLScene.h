...
@interface MDLScene : NSObject {
    ...
    struct vector<ModelIO::RTRenderable *, std::__1::allocator<ModelIO::RTRenderable *> > { struct RTRenderable **__begin_; struct RTRenderable **__end_; struct __compressed_pair<ModelIO::RTRenderable **, std::__1::allocator<ModelIO::RTRenderable *> > { struct RTRenderable **__value_; } __end_cap_; } _sceneObjects;
    struct vector<MDLLight *, std::__1::allocator<MDLLight *> > { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<MDLLight *__strong *, std::__1::allocator<MDLLight *> > { id *__value_; } x1; } _sceneLights;
    int _signature;
}
