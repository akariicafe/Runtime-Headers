...
- (void)createSourceDataVector:(struct vector<float, std::__1::allocator<float> > { float *x0; float *x1; struct __compressed_pair<float *, std::__1::allocator<float> > { float *x0; } x2; } *)a0 attr:(id)a1 srcElementCount:(int)a2 dstElementCount:(int)a3;
- (void)copyDataVector:(struct vector<float, std::__1::allocator<float> > { float *x0; float *x1; struct __compressed_pair<float *, std::__1::allocator<float> > { float *x0; } x2; } *)a0 toAttr:(id)a1;
- (long long)addVertexBuffer:(id)a0;
- (void)_calculateTangentBasisFromPositions:(float *)a0 positionStride:(long long)a1 normals:(float *)a2 normalStride:(long long)a3 uvs:(float *)a4 uvStride:(long long)a5 tangents:(float *)a6 tangentsStride:(long long)a7 bitagents:(float *)a8 bitangentStride:(long long)a9 tangentFormat:(unsigned long long)a10 selector:(SEL)a11;
