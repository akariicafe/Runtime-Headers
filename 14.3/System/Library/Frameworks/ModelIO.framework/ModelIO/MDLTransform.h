...
@interface MDLTransform : NSObject <NSCopying, MDLTransformComponent> {
    struct MDLAffineTransform { struct vector<std::__1::pair<double, float __attribute__((ext_vector_type(3)))>, std::__1::allocator<std::__1::pair<double, float __attribute__((ext_vector_type(3)))> > > { struct pair<double, float __attribute__((ext_vector_type(3)))> *__begin_; struct pair<double, float __attribute__((ext_vector_type(3)))> *__end_; struct __compressed_pair<std::__1::pair<double, float __attribute__((ext_vector_type(3)))> *, std::__1::allocator<std::__1::pair<double, float __attribute__((ext_vector_type(3)))> > > { struct pair<double, float __attribute__((ext_vector_type(3)))> *__value_; } __end_cap_; } _keyedTranslation; struct vector<std::__1::pair<double, float __attribute__((ext_vector_type(3)))>, std::__1::allocator<std::__1::pair<double, float __attribute__((ext_vector_type(3)))> > > { struct pair<double, float __attribute__((ext_vector_type(3)))> *__begin_; struct pair<double, float __attribute__((ext_vector_type(3)))> *__end_; struct __compressed_pair<std::__1::pair<double, float __attribute__((ext_vector_type(3)))> *, std::__1::allocator<std::__1::pair<double, float __attribute__((ext_vector_type(3)))> > > { struct pair<double, float __attribute__((ext_vector_type(3)))> *__value_; } __end_cap_; } _keyedRotation; struct vector<std::__1::pair<double, float __attribute__((ext_vector_type(3)))>, std::__1::allocator<std::__1::pair<double, float __attribute__((ext_vector_type(3)))> > > { struct pair<double, float __attribute__((ext_vector_type(3)))> *__begin_; struct pair<double, float __attribute__((ext_vector_type(3)))> *__end_; struct __compressed_pair<std::__1::pair<double, float __attribute__((ext_vector_type(3)))> *, std::__1::allocator<std::__1::pair<double, float __attribute__((ext_vector_type(3)))> > > { struct pair<double, float __attribute__((ext_vector_type(3)))> *__value_; } __end_cap_; } _keyedShear; struct vector<std::__1::pair<double, float __attribute__((ext_vector_type(3)))>, std::__1::allocator<std::__1::pair<double, float __attribute__((ext_vector_type(3)))> > > { struct pair<double, float __attribute__((ext_vector_type(3)))> *__begin_; struct pair<double, float __attribute__((ext_vector_type(3)))> *__end_; struct __compressed_pair<std::__1::pair<double, float __attribute__((ext_vector_type(3)))> *, std::__1::allocator<std::__1::pair<double, float __attribute__((ext_vector_type(3)))> > > { struct pair<double, float __attribute__((ext_vector_type(3)))> *__value_; } __end_cap_; } _keyedScale; double _startTime; double _greatestTime; BOOL _identity; BOOL _resetTransformStack; double _evaluationTime; struct float4x4 { void /* unknown type, empty encoding */ columns[4]; } _transform; struct float4x4 { void /* unknown type, empty encoding */ columns[4]; } _invTransform; struct float4x4 { void /* unknown type, empty encoding */ columns[4]; } _jacobiRotation; struct float4x4 { void /* unknown type, empty encoding */ columns[4]; } _invJacobiRotation; } _transform;
}
