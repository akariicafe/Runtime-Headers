@class PHImageResourceChooser, PHContentEditingInputRequestOptions, PHAdjustmentDataRequest, NSArray, PAImageConversionServiceClient, PHContentEditingInputResult, NSProgress, PHImageRequest, PHVideoRequest, NSMutableIndexSet;
