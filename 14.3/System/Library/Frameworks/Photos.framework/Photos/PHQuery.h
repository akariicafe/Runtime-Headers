...
+ (id)queryForQuarantinedAssetsWithOptions:(id)a0;
+ (id)queryForKeywordsForAsset:(id)a0 options:(id)a1;
+ (id)queryForKeyFaceOnPerson:(id)a0 options:(id)a1;
+ (id)queryForPhotosHighlightsContainingMomentsWithLocalIdentifiers:(id)a0 options:(id)a1;
...
+ (id)queryForAssetCollectionsWithCloudIdentifiers:(id)a0 options:(id)a1;
...
+ (id)queryForCollectionListsWithCloudIdentifiers:(id)a0 options:(id)a1;
...
+ (id)queryForFirstAssetInEachMonthHighlightWithOptions:(id)a0;
...
+ (id)queryForFacesForPersonsAssociatedWithFaceGroupsContainingFacesWithClusterSequenceNumbers:(id)a0 options:(id)a1;
