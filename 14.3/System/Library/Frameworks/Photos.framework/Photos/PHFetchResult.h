@class PHBatchFetchingArray, NSDictionary, NSObject, NSFetchRequest, PHFetchOptions, NSString, NSSet, PHPhotoLibrary, NSArray, NSNumber, _PHFetchRequestWrapper, NSError, PHQuery;
...
- (void)setRegisteredForChangeNotificationDeltas:(BOOL)a0;
