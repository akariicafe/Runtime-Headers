...
+ (id)_videoAVObjectBuilderFromVideoURL:(id)a0 info:(id)a1 playbackOnly:(BOOL)a2;
+ (void)buildAVPlayerItemFromVideoURL:(id)a0 infoDictionary:(id)a1 completion:(id /* block */)a2;
+ (void)buildAVAssetFromVideoURL:(id)a0 infoDictionary:(id)a1 completion:(id /* block */)a2;
+ (void)buildExportSessionFromVideoURL:(id)a0 infoDictionary:(id)a1 exportPreset:(id)a2 completion:(id /* block */)a3;
...
- (void)_handleActivityForMediaContext:(id)a0;
