@class NSString, INPerson, NSDate, NSNumber;
...
- (id)initWithIdentifier:(id)a0 dateCreated:(id)a1 caller:(id)a2 callRecordType:(long long)a3 callCapability:(long long)a4 callDuration:(id)a5 unseen:(id)a6 preferredCallProvider:(long long)a7 numberOfCalls:(id)a8 providerBundleId:(id)a9;
- (void).cxx_destruct;
