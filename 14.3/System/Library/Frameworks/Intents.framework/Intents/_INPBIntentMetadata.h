...
@interface _INPBIntentMetadata : PBCodable <INJSONSerializable, _INPBIntentMetadata, NSSecureCoding, NSCopying> {
    ...
    struct { unsigned char executionContext : 1; unsigned char intentCategory : 1; unsigned char backgroundLaunch : 1; unsigned char confirmed : 1; unsigned char idiom : 1; unsigned char isOwnedByCurrentUser : 1; unsigned char isPrimaryDisplayDisabled : 1; unsigned char showsWhenRun : 1; unsigned char triggerMethod : 1; unsigned char userConfirmationRequired : 1; } _has;
}
