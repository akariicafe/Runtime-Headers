@class NSString, NWAWDNWAccumulator;

@interface NWAWDNWDeviceReport : PBCodable <NSCopying> {
    struct { unsigned char batteryAbsoluteCapacity : 1; unsigned char batteryCurrentCapacity : 1; unsigned char batteryDesignCapacity : 1; unsigned char batteryMaximumCapacity : 1; unsigned char batteryPercentage : 1; unsigned char batteryTimeRemaining : 1; unsigned char batteryVoltage : 1; unsigned char motionState : 1; unsigned char thermalPressure : 1; unsigned char batteryAtCriticalLevel : 1; unsigned char batteryAtWarnLevel : 1; unsigned char batteryExternalPowerIsConnected : 1; unsigned char batteryFullyCharged : 1; unsigned char batteryIsCharging : 1; unsigned char devicePluggedIn : 1; unsigned char deviceScreenOn : 1; unsigned char rnfEnabled : 1; } _has;
}
