...
- (void)_processAccountFlagsForAccount:(id)a0 oldAccount:(id)a1 store:(id)a2;
- (void)_processPrivacyAcknowledgementForAccount:(id)a0 oldAccount:(id)a1 store:(id)a2;
