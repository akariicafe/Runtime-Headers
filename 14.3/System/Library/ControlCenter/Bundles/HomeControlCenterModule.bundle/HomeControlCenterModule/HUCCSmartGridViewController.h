@class HUGridHomeCell, NSString, HUMosaicLayoutGeometry, HFHomeKitDispatcher, HUGridLayoutOptions, HUMosaicLayout, HUCCSmartGridItemManager, UICollectionViewCell;
...
- (void)layoutInvalidatedForBoundsChange:(BOOL)a0;
