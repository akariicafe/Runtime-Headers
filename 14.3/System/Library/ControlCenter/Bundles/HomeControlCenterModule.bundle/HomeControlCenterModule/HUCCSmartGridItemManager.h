@class HUCCPredictionsItemProvider, NSMutableDictionary, HFStaticItemProvider;
...
@property (retain, nonatomic) HUCCPredictionsItemProvider *predictionsItemProvider;
...
- (void)predictionManagerDidUpdatePredictions:(id)a0;
