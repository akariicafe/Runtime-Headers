...
@interface AGXA11FamilyIndirectRenderCommand : IOGPUMetalIndirectRenderCommand <MTLIndirectRenderCommandSPI> {
    struct IndirectRenderCommandEncoder { id x0; struct IndirectCommandBuffer *x1; } *_encoder;
    unsigned int _index;
}
...
- (id)initWithEncoder:(struct IndirectRenderCommandEncoder { id x0; struct IndirectCommandBuffer *x1; } *)a0 withIndex:(unsigned int)a1;
