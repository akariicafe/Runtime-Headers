@class IMDMessageStore, NSMutableDictionary, IMDCKUtilities, IMDChatRegistry, NSString, NSMutableArray, IMTimer;
...
- (BOOL)isDefaultPairedDeviceToken:(id)a0;
...
- (BOOL)_sendCertifiedDeliveryReceiptIfPossible:(id)a0 messageContext:(id)a1 guid:(id)a2 messageWasStored:(BOOL)a3 needsDeliveryReceipt:(BOOL)a4;
- (BOOL)_shouldIgnoreMessageFromSender:(id)a0 balloonBID:(id)a1 fromMe:(BOOL)a2;
- (BOOL)_isWhitelistedUnencryptedSender:(id)a0;
- (unsigned long long)_computeFlagsForIncomingMessage:(unsigned long long)a0 isFromMe:(BOOL)a1 unfinished:(BOOL)a2 isAudioMessage:(BOOL)a3 isExpirable:(BOOL)a4 messageSource:(unsigned long long)a5 participants:(id)a6 hasUnseenMention:(BOOL)a7;
