...
+ (id)buildWithIdentifier:(id)a0 visibleName:(id)a1 hostname:(id)a2 port:(id)a3 username:(id)a4 authenticated:(id)a5 areCalendarsEnabled:(id)a6 areRemindersEnabled:(id)a7;
