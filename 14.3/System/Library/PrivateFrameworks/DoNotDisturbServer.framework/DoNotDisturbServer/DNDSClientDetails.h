...
- (id)initWithClientIdentifier:(id)a0 identifiers:(id)a1 resolutionContextAssumingDeviceUILocked:(BOOL)a2 userInteractionClient:(BOOL)a3 persistentAssertionClient:(BOOL)a4 syncSuppressedClient:(BOOL)a5;
