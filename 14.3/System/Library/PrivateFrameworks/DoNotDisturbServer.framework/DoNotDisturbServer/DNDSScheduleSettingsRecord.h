...
- (id)_initWithLastUpdatedTimestamp:(id)a0 scheduleEnabledSetting:(id)a1 timePeriodStartTimeHour:(id)a2 timePeriodStartTimeMinute:(id)a3 timePeriodEndTimeHour:(id)a4 timePeriodEndTimeMinute:(id)a5 bedtimeBehaviorEnabledSetting:(id)a6;
