@class CSSPGEndpointAnalyzer, NSObject, NSString, CSAudioStream, CSPlainAudioFileWriter, CSAudioRecordContext, NSMutableArray;
...
- (void)spgEndpointAnalyzer:(id)a0 hasSilenceScoreEstimate:(double)a1;
