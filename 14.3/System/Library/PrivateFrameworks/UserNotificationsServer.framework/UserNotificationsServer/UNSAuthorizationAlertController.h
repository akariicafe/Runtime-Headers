...
- (void).cxx_destruct;
- (void)requestAuthorizationForBundleIdentifier:(id)a0 displayName:(id)a1 withResult:(id /* block */)a2;
...
- (void)_presentAuthorizationAlertForBundleIdentifier:(id)a0 displayName:(id)a1 withResult:(id /* block */)a2;
- (void)_queue_removeAlertActiveForBundleIdentifier:(id)a0;
- (void)_queue_sendResponse:(long long)a0 forBundleIdentifier:(id)a1;
- (void)presentAuthorizationAlertForBundleIdentifier:(id)a0 displayName:(id)a1 withResult:(id /* block */)a2;
