...
- (void)makeAccessResourcesAvailableAtGlobalLevelWithUserInterface:(id)a0 completionHandler:(id /* block */)a1;
- (void)makeAccessResourcesAvailableAtWorkflowLevelWithUserInterface:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)addResource:(id)a0 withRequiredResources:(id)a1;
