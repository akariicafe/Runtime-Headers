@class WFVariableStringParameterState, NSString, NSArray, WFBooleanSubstitutableState, WFNumberStringSubstitutableState, WFContentProperty, WFByteCountUnitSubstitutableState, WFCalendarUnitSubstitutableState, WFVariableSubstitutableParameterState, WFDateSubstitutableState;
