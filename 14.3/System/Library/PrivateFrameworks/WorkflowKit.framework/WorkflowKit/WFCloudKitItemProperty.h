...
+ (id)assetPropertyWithName:(id)a0 ignoredByDefault:(BOOL)a1;
+ (id)itemReferencePropertyWithName:(id)a0 itemClass:(Class)a1;
+ (id)itemPropertyWithName:(id)a0 itemClass:(Class)a1;

- (void).cxx_destruct;
- (id)initWithType:(unsigned long long)a0 name:(id)a1 itemClass:(Class)a2 ignoredByDefault:(BOOL)a3 nilValue:(id)a4;
