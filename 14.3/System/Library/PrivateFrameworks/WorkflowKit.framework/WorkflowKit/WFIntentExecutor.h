...
- (void)deliverIntentForwardingActionToApp:(id)a0 withBundleIdentifier:(id)a1 responseHandler:(id /* block */)a2;
- (void)handleIntent:(id)a0 inBackgroundAppWithBundleIdentifier:(id)a1 reply:(id /* block */)a2;
