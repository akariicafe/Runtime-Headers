...
@interface TCSContacts : NSObject {
    ...
    int _prefSyncToken;
    int _demoResetToken;
    struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } _whitelistLock;
}

@property (retain, nonatomic) NSUserDefaults *defaults;
@property (nonatomic) BOOL shouldObserveWhitelistDefaultChanges;
@property (retain, nonatomic) NSMutableDictionary *whitelist;
...
+ (id)validatedWhitelistFromDictionary:(id)a0;
+ (id)_destinationsFromWhitelistDictionary:(id)a0 onlyAccepted:(BOOL)a1;
