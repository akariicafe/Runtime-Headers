@class HDPeriodicActivity, NSString, HDProfile, HKHRCardioFitnessAnalyticsManager, NSObject, HKHRCardioFitnessAnalyticsDailyEventDataSource;
...
@property (readonly, nonatomic) HKHRCardioFitnessAnalyticsDailyEventDataSource *dataSource;
