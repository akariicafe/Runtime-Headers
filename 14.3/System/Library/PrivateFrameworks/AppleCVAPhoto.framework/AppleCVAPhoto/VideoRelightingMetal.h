@class NSData, NSArray, CVAFilterMaskedVariableBlur, CVAFilterColorAlphaToFgBg, CVAPhotoMTLRingBuffer, NSObject, MTLRenderPassDescriptor, UIColor;
...
@interface VideoRelightingMetal : ImageSaverAndFileConfigRegistrator {
    ...
    struct vector<FaceVertex, std::__1::allocator<FaceVertex> > { struct FaceVertex *__begin_; struct FaceVertex *__end_; struct __compressed_pair<FaceVertex *, std::__1::allocator<FaceVertex> > { struct FaceVertex *__value_; } __end_cap_; } _modelVertices;
    ...
    struct circular_buffer<bool, std::__1::allocator<bool> > { BOOL *m_buff; BOOL *m_end; BOOL *m_first; BOOL *m_last; unsigned long long m_size; struct allocator<bool> { } m_alloc; } _faceDetectedRealHistory;
    struct optional<boost::accumulators::accumulator_set<float, boost::accumulators::stats<boost::accumulators::tag::rolling_variance, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na>, void> > { BOOL m_initialized; struct aligned_storage<boost::accumulators::accumulator_set<float, boost::accumulators::stats<boost::accumulators::tag::rolling_variance, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na>, void> > { union dummy_u { char data[72]; struct a8 { } aligner_; } dummy_; } m_storage; } _faceConfidenceRollingVariance;
    struct optional<boost::accumulators::accumulator_set<float, boost::accumulators::stats<boost::accumulators::tag::rolling_mean, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na>, void> > { BOOL m_initialized; struct aligned_storage<boost::accumulators::accumulator_set<float, boost::accumulators::stats<boost::accumulators::tag::rolling_mean, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na, mpl_::na>, void> > { union dummy_u { char data[64]; struct a8 { } aligner_; } dummy_; } m_storage; } _faceRelightingAngleFactorsRollingMean;
    struct vector<unsigned short, std::__1::allocator<unsigned short> > { unsigned short *__begin_; unsigned short *__end_; struct __compressed_pair<unsigned short *, std::__1::allocator<unsigned short> > { unsigned short *__value_; } __end_cap_; } _faceKitMeshTris;
    ...
    struct optional<unsigned long> { BOOL m_initialized; struct aligned_storage<unsigned long> { union dummy_u { char data[8]; struct a8 { } aligner_; } dummy_; } m_storage; } _closestLeftCheekVertexID;
    struct optional<float> { BOOL m_initialized; struct aligned_storage<float> { union dummy_u { char data[4]; struct a4 { } aligner_; } dummy_; } m_storage; } _cheekAngle;
...
- (void)updateModelAndPose:(struct vector<float, std::__1::allocator<float> > { float *x0; float *x1; struct __compressed_pair<float *, std::__1::allocator<float> > { float *x0; } x2; } *)a0 camera:(struct vector<float, std::__1::allocator<float> > { float *x0; float *x1; struct __compressed_pair<float *, std::__1::allocator<float> > { float *x0; } x2; } *)a1;
- (void)setModelVertices;
- (void)generateModelNormals;
- (void)updateMatrixWithWidth:(int)a0 height:(int)a1 camera:(const struct vector<float, std::__1::allocator<float> > { float *x0; float *x1; struct __compressed_pair<float *, std::__1::allocator<float> > { float *x0; } x2; } *)a2 pose:(const struct vector<float, std::__1::allocator<float> > { float *x0; float *x1; struct __compressed_pair<float *, std::__1::allocator<float> > { float *x0; } x2; } *)a3;
- (void)updateUniforms:(BOOL)a0;
- (void)loadRGBTransformMapsOnceTo:(id *)a0 namePrefix:(const struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> > { struct __compressed_pair<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >::__rep, std::__1::allocator<char> > { struct __rep { union { struct __long { char *x0; unsigned long long x1; unsigned long long x2; } x0; struct __short { char x0[23]; struct { unsigned char x0; } x1; } x1; struct __raw { unsigned long long x0[3]; } x2; } x0; } x0; } x0; } *)a1 forIntermediateResults:(BOOL)a2;
