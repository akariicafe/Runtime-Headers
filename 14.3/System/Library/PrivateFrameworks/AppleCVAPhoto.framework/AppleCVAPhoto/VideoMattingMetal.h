@class CVAFilterHybridResampling, CVAFilterDiffusion, CVAFilterBox, NSObject, MPSImageGuidedFilter, CVAFilterGuided, MPSImageGaussianBlur, MPSImageAreaMin, CVAFilterRenderStagelight, CVAFilterInfimumConvolution, CVAPhotoMTLRingBuffer, CVAFilterRenderComposite, CVAFilterColorAlphaToFgBg, MPSImageBox, NSData, CVAFilterDistanceTransform, CVAFilterMaskedVariableBlur;
@protocol MTLTexture, MTLComputePipelineState, OS_dispatch_queue, MTLPipelineLibrarySPI, MTLLibrary, OS_dispatch_semaphore, MTLDeviceSPI, MTLCommandQueue, MTLResourceGroupSPI;
...
@interface VideoMattingMetal : ImageSaverRegistrator {
    ...
    struct __sFILE { char *x0; int x1; int x2; short x3; short x4; struct __sbuf { char *x0; int x1; } x5; int x6; void *x7; void /* function */ *x8; void /* function */ *x9; void /* function */ *x10; void /* function */ *x11; struct __sbuf { char *x0; int x1; } x12; struct __sFILEX *x13; int x14; unsigned char x15[3]; unsigned char x16[1]; struct __sbuf { char *x0; int x1; } x17; int x18; long long x19; } *_scaledSourceFile;
}
...
- (id)initWithStaticParams:(const struct VideoMattingStaticParams { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; int x6; int x7; unsigned int x8; float x9; float x10; float x11; float x12; float x13; float x14; float x15; float x16; float x17; float x18; float x19; unsigned int x20; unsigned int x21; int x22; float x23; float x24; float x25; float x26; } *)a0 renderingDisparityUpdateRate:(float)a1 renderingDisparityBlurRadius:(float)a2 renderingLensFocalLength_mm:(float)a3 useTemporalConfidence:(BOOL)a4 metalContext:(struct CVAPhotoMetalContext { id x0; id x1; id x2; id x3; id x4; struct unique_ptr<CVAPerfEndTimeProfilerSet, std::__1::default_delete<CVAPerfEndTimeProfilerSet> > { struct __compressed_pair<CVAPerfEndTimeProfilerSet *, std::__1::default_delete<CVAPerfEndTimeProfilerSet> > { struct CVAPerfEndTimeProfilerSet *x0; } x0; } x5; BOOL x6; } *)a5 error:(id *)a6;
...
- (id)disparityPostprocessingWithCanonicalDisparity:(struct __CVBuffer { } *)a0 color:(struct __CVBuffer { } *)a1 postProcessedDisparity:(struct __CVBuffer { } *)a2 staticParams:(const struct VideoMattingStaticParams { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; int x6; int x7; unsigned int x8; float x9; float x10; float x11; float x12; float x13; float x14; float x15; float x16; float x17; float x18; float x19; unsigned int x20; unsigned int x21; int x22; float x23; float x24; float x25; float x26; } *)a3 dynamicParams:(const struct VideoMattingDynamicParams { float x0; float x1; float x2; float x3; float x4; float x5; float x6; struct array<float, 3> { float x0[3]; } x7; float x8; BOOL x9; } *)a4 postProcessingParams:(const struct VideoPostprocessingParams { BOOL x0; float x1; BOOL x2; float x3; float x4; BOOL x5; } *)a5 facesArray:(id)a6 faceModel:(id)a7 isFinalStage:(BOOL)a8 callbackQueue:(id)a9 callback:(id /* block */)a10;
- (void)alphaMattingWithPostprocessedDisparity:(struct __CVBuffer { } *)a0 source:(struct __CVBuffer { } *)a1 inSegmentation:(struct __CVBuffer { } *)a2 alpha:(struct __CVBuffer { } *)a3 staticParams:(const struct VideoMattingStaticParams { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; int x6; int x7; unsigned int x8; float x9; float x10; float x11; float x12; float x13; float x14; float x15; float x16; float x17; float x18; float x19; unsigned int x20; unsigned int x21; int x22; float x23; float x24; float x25; float x26; } *)a4 dynamicParams:(const struct VideoMattingDynamicParams { float x0; float x1; float x2; float x3; float x4; float x5; float x6; struct array<float, 3> { float x0[3]; } x7; float x8; BOOL x9; } *)a5 usePostprocessedDisparity:(BOOL)a6 isFinalStage:(BOOL)a7 dilateForegroundMask:(BOOL)a8 callbackQueue:(id)a9 callback:(id /* block */)a10;
