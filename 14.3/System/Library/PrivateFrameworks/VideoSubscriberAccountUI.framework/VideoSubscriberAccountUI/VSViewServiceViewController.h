...
- (void)_performRequestInternal:(id)a0 withID:(id)a1 identityProviders:(id)a2 accounts:(id)a3;
...
- (void)_showIdentityProviderPickerViewControllerWithIdentityProviders:(id)a0;
