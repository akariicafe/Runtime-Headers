...
- (void)_obtainConsentForBundleIDs:(id)a0 vouchers:(id)a1 withAppleAccount:(id)a2 identityProvider:(id)a3 endingUndoGrouping:(BOOL)a4 arrivedViaNotNowButton:(BOOL)a5 arrivedAfterSigningIn:(BOOL)a6 goingBack:(BOOL)a7;
