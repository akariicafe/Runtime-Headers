@class NSURL, NSMutableDictionary, NSDate, NSDictionary, NSFileProviderItemVersion, BRFileObjectID, NSString, NSSet, NSPersonNameComponents, NSNumber, NSData, NSArray, UTType, NSError;
