...
@interface WK_RTCVideoEncoderH264 : NSObject <RTCVideoEncoder> {
    ...
    struct unique_ptr<webrtc::BitrateAdjuster, std::__1::default_delete<webrtc::BitrateAdjuster> > { struct __compressed_pair<webrtc::BitrateAdjuster *, std::__1::default_delete<webrtc::BitrateAdjuster> > { struct BitrateAdjuster *__value_; } __ptr_; } _bitrateAdjuster;
    ...
    struct optional<webrtc::H264::ProfileLevelId> { union { char __null_state_; struct ProfileLevelId { int profile; int level; } __val_; } ; BOOL __engaged_; } _profile_level_id;
    id /* block */ _callback;
    int _width;
    int _height;
    BOOL _useVCP;
    ...
    struct vector<unsigned char, std::__1::allocator<unsigned char> > { char *__begin_; char *__end_; struct __compressed_pair<unsigned char *, std::__1::allocator<unsigned char> > { char *__value_; } __end_cap_; } _frameScaleBuffer;
