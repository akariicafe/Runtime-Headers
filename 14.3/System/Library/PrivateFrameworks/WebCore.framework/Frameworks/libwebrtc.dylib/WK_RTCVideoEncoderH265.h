...
@interface WK_RTCVideoEncoderH265 : NSObject <RTCVideoEncoder> {
    ...
    int framesLeft;
    struct vector<unsigned char, std::__1::allocator<unsigned char> > { char *__begin_; char *__end_; struct __compressed_pair<unsigned char *, std::__1::allocator<unsigned char> > { char *__value_; } __end_cap_; } _nv12ScaleBuffer;
}
