...
- (id)_generateDistributionSeriesWithColor:(id)a0 numberFormatter:(id)a1;
- (id)_generateHandwashingBarSeriesWithDisplayCategory:(id)a0;
- (id)_generateLineSeriesWithColor:(id)a0 timeScope:(long long)a1;
- (id)_generateBarSeriesWithFillStyle:(id)a0;
- (id)_generateScatterPlotSeriesWithColor:(id)a0;
