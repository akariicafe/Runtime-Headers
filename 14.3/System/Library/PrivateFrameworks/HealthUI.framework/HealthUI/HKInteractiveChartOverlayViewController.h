@class UIColor, NSMutableDictionary, NSString, HKDisplayType, _HKInteractiveChartOverlayWaitForCacheData, HKUIMetricColors, HKValueRange;
...
- (id)initWithHealthStore:(id)a0 primaryDisplayType:(id)a1 unitPreferenceController:(id)a2 dateCache:(id)a3 chartDataCacheController:(id)a4 selectedTimeScopeController:(id)a5 sampleTypeDateRangeController:(id)a6 initialXValue:(id)a7 options:(unsigned long long)a8;
...
- (void)_clearOverlayDisplayTypeWithAutomaticAutoscale:(BOOL)a0;
...
- (void)_deliverOrWaitForDataSource:(id)a0 graphSeriesContext:(id)a1 priorityDelegate:(id)a2 timeScope:(long long)a3 startDate:(id)a4 endDate:(id)a5 completion:(id /* block */)a6;
...
- (id)_overlayChartCacheForDataSource:(id)a0 timeScope:(long long)a1 templateDisplayType:(id)a2;
- (id)initWithFixedRange:(id)a0 healthStore:(id)a1 primaryDisplayType:(id)a2 unitPreferenceController:(id)a3 dateCache:(id)a4 chartDataCacheController:(id)a5 selectedTimeScopeController:(id)a6 sampleTypeDateRangeController:(id)a7 initialXValue:(id)a8 options:(unsigned long long)a9;
