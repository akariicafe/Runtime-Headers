...
- (id)attributedStringFromValue:(id)a0 roundToHours:(BOOL)a1 displayType:(id)a2 unitController:(id)a3 valueFont:(id)a4 unitFont:(id)a5 formatForChart:(BOOL)a6 unitFormatString:(id)a7;
