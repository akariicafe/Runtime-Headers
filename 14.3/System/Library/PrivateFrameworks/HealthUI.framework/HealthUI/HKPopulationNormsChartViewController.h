@class HKPopulationNormsClassificationCollectionView, HKPopulationNormsDescriptionView, UIView, NSString, UILabel, UISegmentedControl, HKPopulationNormsGraphView;
