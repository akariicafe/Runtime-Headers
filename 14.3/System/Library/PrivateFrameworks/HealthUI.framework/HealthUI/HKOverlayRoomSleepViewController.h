@class HKChartCache, NSString, HKDisplayType, HKInteractiveChartDataFormatter;
...
- (id)titleForSelectedRangeData:(id)a0;
- (id)stringForValueRange:(id)a0 timeScope:(long long)a1;
- (void)viewDidLoad;
- (id)initWithDisplayDate:(id)a0 applicationItems:(id)a1 sleepDataSourceProvider:(id)a2 sleepChartFormatter:(id)a3 mode:(long long)a4;
