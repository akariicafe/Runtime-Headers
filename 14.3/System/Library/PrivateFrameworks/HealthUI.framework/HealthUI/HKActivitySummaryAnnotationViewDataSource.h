@class HKActivitySummary, NSString, HKDisplayTypeController, HKUnitPreferenceController, _HKWheelchairUseCharacteristicCache;
...
- (id)initWithDisplayTypeController:(id)a0 unitController:(id)a1 wheelchairUseCharacteristicCache:(id)a2 currentValueViewContext:(BOOL)a3;
