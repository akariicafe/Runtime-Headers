@class NSString, HKDisplayType, HKCardioFitnessLevelData, NSMutableArray, NSNumber;
...
- (id)initWithDisplayDate:(id)a0 applicationItems:(id)a1 mode:(long long)a2 preferredOverlay:(long long)a3 analyticsDelegate:(id)a4 interactiveChartOptions:(unsigned long long)a5;
- (id)_analyticStringForContextItem:(id)a0;
