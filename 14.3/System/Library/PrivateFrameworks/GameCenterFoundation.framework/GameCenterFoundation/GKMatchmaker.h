@class NSDate, NSString, NSSet, NSMutableDictionary, NSDictionary, GKMatch, GKDiscovery, GKDispatchGroup, NSObject, NSMutableArray, NSMutableSet;
...
- (void)reportPlayerConnectedWithPlayerID:(id)a0;
