@class WFImage, NSString, UIInterfaceActionGroup, UIInterfaceActionGroupView, UILabel, UIView, PLTitledPlatterView;
...
@property (weak, nonatomic) PLTitledPlatterView *platterView;
