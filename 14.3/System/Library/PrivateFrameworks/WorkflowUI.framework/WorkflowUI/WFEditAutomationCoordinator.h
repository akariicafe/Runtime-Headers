@class NSString, WFTrigger, UINavigationController, WFWorkflowReference, WFAutomationSummaryViewController, WFEditAutomationWorkflowStorage, WFTriggerManager, WFConfiguredTriggerRecord, WFWorkflow, WFDatabase;
...
@property (retain, nonatomic) WFEditAutomationWorkflowStorage *editingStorage;
