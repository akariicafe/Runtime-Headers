@class TSPReferenceOrderedSet, TSPArchiverManager, NSMapTable, NSObject, TSPComponent, TSPMutableComponentObjectUUIDMap, NSMutableIndexSet, NSString, NSHashTable, NSIndexSet, NSMutableSet, TSPObject, TSPObjectReferenceMap;
...
@interface TSPComponentWriter : NSObject {
    ...
    struct vector<TSP::ObjectStackEntry, std::__1::allocator<TSP::ObjectStackEntry> > { struct ObjectStackEntry *__begin_; struct ObjectStackEntry *__end_; struct __compressed_pair<TSP::ObjectStackEntry *, std::__1::allocator<TSP::ObjectStackEntry> > { struct ObjectStackEntry *__value_; } __end_cap_; } _objectStack;
