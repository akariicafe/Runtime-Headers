...
+ (BOOL)unknownContent:(id)a0 hasSameUnknownFieldsAsUnknownContent:(id)a1 messagePrototype:(const struct Message { void /* function */ **x0; } *)a2;
...
- (BOOL)hasSameUnknownFieldsAsUnknownContent:(id)a0 messagePrototype:(const struct Message { void /* function */ **x0; } *)a1;
