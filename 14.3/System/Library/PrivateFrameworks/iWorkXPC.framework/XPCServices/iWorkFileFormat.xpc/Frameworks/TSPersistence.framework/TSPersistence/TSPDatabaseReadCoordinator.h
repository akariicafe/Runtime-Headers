@class NSUUID, NSString, TSPObjectContext, NSURL, TSPFinalizeHandlerQueue, TSPDatabase, NSMutableDictionary, NSObject, NSMapTable;
...
- (id)dataForReadChannel:(id)a0 filename:(id)a1 linkURLOrNil:(id)a2;
