...
+ (id)eventDataSourceWithEventDict:(id)a0 viewElement:(id)a1 appContext:(id)a2;
+ (id)attachPrefetchedDict:(id)a0 eventDict:(id)a1;
+ (id)_documentDataSourceWithDict:(id)a0 viewElement:(id)a1;
+ (id)_actionForKey:(id)a0 eventDict:(id)a1 viewElement:(id)a2 appContext:(id)a3;
