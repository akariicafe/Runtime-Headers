@class NSTimer, NSDate, TVPVideoView, NSString, TVPStateMachine, TVPPlayer, AVPlayerViewController, VUIMediaInfo, TVPPlaylist, TVImageProxy, _TVImageView, UIViewController;
...
@property (retain, nonatomic) _TVImageView *alphaProxyImageView;
