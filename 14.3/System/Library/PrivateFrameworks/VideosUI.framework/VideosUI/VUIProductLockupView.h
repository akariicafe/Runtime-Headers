@class _TVImageView, VUISeparatorView, VUILabel, VUIRoundButton, TVImageProxy, UIView, NSString, VUIRentalExpirationLabel, NSNumber, NSArray, TVFocusableTextView, VUIMediaTagsView, UIImage;
...
@property (readonly, nonatomic) TVImageProxy *coverArtImageProxy;
