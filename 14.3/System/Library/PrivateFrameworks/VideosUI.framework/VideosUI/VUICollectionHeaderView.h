@class VUISeparatorView, IKViewElement, VUILabel, VUICollectionHeaderViewLayout, _TVImageView, UIButton;
...
+ (id)configureCollectionHeaderViewWithElement:(id)a0 existingView:(id)a1;
