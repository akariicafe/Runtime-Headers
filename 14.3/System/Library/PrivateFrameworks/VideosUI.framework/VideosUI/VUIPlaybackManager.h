@class VUIPostPlayView, VUIPlayer, VUINowPlayingFeatureMonitor, NSDate, NSDictionary, VUIVideoAdvisoryLogoImageDownloader, UIViewController, VUIVideoAdvisoryView, UIButton, VUIDownloadDataSource, VUIProductPlacementView, VideosExtrasContext, AVExternalPlaybackController, NSString, NSObject, TVPStateMachine, VideosExtrasPresenter, NSNumber, UIImage;
@protocol VUIPlayerViewController, TVPMediaItem;
...
+ (void)preflightPlaybackWithMediaItem:(id)a0 presentingViewController:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)dismissPlaybackAnimated:(BOOL)a0 completion:(id /* block */)a1;
