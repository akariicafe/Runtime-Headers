...
- (id)fetchPositiveActionEventsAfterAnchorDate:(id)a0 anchor:(id)a1;
...
- (id)fetchPositiveAppEventsAfterAnchorDate:(id)a0 anchor:(id)a1;
- (id)featurizeAppEvent:(id)a0 anchorOccurrenceDate:(id)a1;
