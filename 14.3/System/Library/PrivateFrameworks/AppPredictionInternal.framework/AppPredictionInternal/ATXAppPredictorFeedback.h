@class _ATXFeedback, _ATXAggregateLogger, NSObject;
...
+ (void)_tryLogCacheAgeEngagementMetricForAppDirectoryWithConsumerType:(unsigned long long)a0 consumerSubType:(unsigned char)a1 engagementType:(unsigned long long)a2 engagedBundleId:(id)a3 bundleIdsShown:(id)a4 explicitlyRejectedBundleIds:(id)a5 abGroupIdentifier:(id)a6 tracker:(id)a7;
...
+ (id)constructFeatureDictionaryWithFeedbackItems:(id)a0 engagedItem:(id)a1 shownItemIndexes:(id)a2 consumerType:(unsigned long long)a3;
...
- (unsigned long long)_engagementTypeFromClientModelResult:(id)a0 engagedSuggestion:(id)a1 engagedBundleId:(id)a2 shownBundleIds:(id)a3;
