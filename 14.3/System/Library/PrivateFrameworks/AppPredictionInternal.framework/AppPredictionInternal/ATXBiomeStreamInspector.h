...
+ (void)makeJSONRepresentationForStreamWithBlock:(id /* block */)a0 blendingPublisher:(id)a1 clientPublisher:(id)a2 uiPublisher:(id)a3 appLaunchPublisher:(id)a4 appIntentPublisher:(id)a5;
