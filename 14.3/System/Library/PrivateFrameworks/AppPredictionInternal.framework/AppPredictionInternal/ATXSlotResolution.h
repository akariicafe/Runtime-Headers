...
+ (void)setDistributionBasedScoreInputsForTimeOfDayForItem:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[807]; float x3; BOOL x4; BOOL x5; } *)a0 withLaunchDistribution:(id)a1;
+ (id)yearMonthDayComponentsForDate:(id)a0;
+ (void)setDistributionBasedScoreInputsForDayOfWeekForItem:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[807]; float x3; BOOL x4; BOOL x5; } *)a0 withLaunchDistribution:(id)a1;
+ (BOOL)isNotLaunchedWithinShortTimeSpan:(id)a0;
+ (BOOL)matchForCurrentGeohash:(long long)a0 rowGeohash:(long long)a1;
+ (void)setSlotResolutionPredictionItemForTopUpcomingMediaActionContainer:(id)a0 appActionPredictionItem:(const struct ATXPredictionItem { id x0; unsigned long long x1; float x2[807]; float x3; BOOL x4; BOOL x5; } *)a1 appActionLogProbability:(double)a2;
+ (void)setSlotLogProbabilityForCandidateActionPredictions:(id)a0;
+ (void)setDistributionBasedScoreInputsForItem:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[807]; float x3; BOOL x4; BOOL x5; } *)a0 withGeoHashResolution:(unsigned long long)a1 withLaunchCounts:(id)a2;

- (id)initWithDataStore:(id)a0;
- (id)init;
- (void).cxx_destruct;
- (id)actionPredictionsForStatistics:(id)a0 appActionPredictionItem:(const struct ATXPredictionItem { id x0; unsigned long long x1; float x2[807]; float x3; BOOL x4; BOOL x5; } *)a1 appActionLogProbability:(double)a2 scoreLogger:(id)a3 currentDate:(id)a4;
