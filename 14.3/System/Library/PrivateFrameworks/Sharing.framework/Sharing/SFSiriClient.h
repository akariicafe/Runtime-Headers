...
- (void)_activate;
- (void)deviceSetupEnd;
- (void)speakPasscode:(id)a0 instructions:(id)a1 languageCode:(id)a2 flags:(unsigned int)a3 completion:(id /* block */)a4;
...
- (void)_speakPasscode:(id)a0 instructions:(id)a1 languageCode:(id)a2 flags:(unsigned int)a3 completion:(id /* block */)a4;
