...
- (void).cxx_destruct;
- (id)initWithMinRefCount:(long long)a0 maxRefCount:(long long)a1 avgRefCount:(double)a2 medianRefCount:(double)a3 earliestDate:(id)a4 latestDate:(id)a5 uniqueBundleIdCount:(long long)a6 uniqueDocIdCount:(long long)a7;
