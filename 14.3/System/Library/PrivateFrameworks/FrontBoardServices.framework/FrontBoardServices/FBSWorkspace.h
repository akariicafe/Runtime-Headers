@class NSString, NSArray, BSServiceConnectionEndpoint, NSMutableDictionary, BSAtomicSignal, FBSWorkspaceFencingImpl, FBSSerialQueue, NSObject, BSServiceConnectionEndpointMonitor;
