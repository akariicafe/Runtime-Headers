...
@property (copy, nonatomic) NSURL *renderedImageURL;
...
- (BOOL)isEqual:(id)a0;
- (id)initWithIdentifier:(long long)a0 name:(id)a1 thumbnailImageURL:(id)a2 fullsizeImageURL:(id)a3 renderedImageURL:(id)a4;
