...
@interface RBStrokeAccumulator : NSObject <RBStroke, RBParticleStroke, NSCopying> {
    struct vector<RBStrokeElement, std::__1::allocator<RBStrokeElement> > { unsigned char *__begin_; unsigned char *__end_; struct __compressed_pair<RBStrokeElement *, std::__1::allocator<RBStrokeElement> > { unsigned char *__value_; } __end_cap_; } _elements;
    struct vector<float, std::__1::allocator<float> > { float *__begin_; float *__end_; struct __compressed_pair<float *, std::__1::allocator<float> > { float *__value_; } __end_cap_; } _values;
