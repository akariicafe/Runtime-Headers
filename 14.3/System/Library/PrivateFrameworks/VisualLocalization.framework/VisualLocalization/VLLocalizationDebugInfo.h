...
- (id)initWithPixelBuffer:(id)a0 monotonicTimestamp:(SEL)a1 timestamp:(struct __CVBuffer { } *)a2 duration:(double)a3 location:(double)a4 heading:(double)a5 gravity:(struct { double x0[3]; float x1; int x2; int x3; })a6 transform:(struct { double x0; double x1; })a7 cameraIntrinsics:(struct { void /* unknown type, empty encoding */ x0[4]; })a8 radialDistortion:(struct { void /* unknown type, empty encoding */ x0[3]; })a9 statistics:(const struct { double *x0; float *x1; int *x2; float *x3; float *x4; float x5[3]; int x6; int x7; int x8; int x9; int x10; int x11; int x12; double x13; double x14; double x15; double x16; double x17; double x18; double x19; double x20; double x21; double x22; double x23; double x24; double x25; double x26; double x27; double x28; double x29; double x30; double x31; double x32; double x33; double x34; struct { int x0; int x1; int x2; int x3; } x35; long long x36; int x37; } *)a10 resultStatus:(unsigned long long)a11 resultPose:(const struct { double x0[3][3]; double x1[3]; float x2; float x3[36]; } *)a12 preserveImageData:(BOOL)a13;
