@class NSUUID, HRProfile, NSArray, NSPredicate, WDMedicalRecordPagingContext, HKMultiTypeSampleIterator, NSDictionary, HKConcept, NSMutableArray, NSObject;
...
- (void)_processAccumulatedRecordsForPage:(id)a0;
