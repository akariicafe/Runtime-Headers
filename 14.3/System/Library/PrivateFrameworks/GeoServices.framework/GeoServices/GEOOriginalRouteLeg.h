...
@interface GEOOriginalRouteLeg : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_destinationWaypointInfo : 1; unsigned char read_evStateInfo : 1; unsigned char read_originWaypointInfo : 1; unsigned char read_zilchPoints : 1; unsigned char wrote_anyField : 1; } _flags;
}
