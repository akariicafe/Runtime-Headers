...
@interface GEOPDModule : PBCodable <NSCopying> {
    ...
    int _type;
    struct { unsigned char has_type : 1; unsigned char read_unknownFields : 1; unsigned char read_moduleDebugDescription : 1; unsigned char read_options : 1; unsigned char wrote_anyField : 1; } _flags;
}
