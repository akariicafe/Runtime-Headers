@class PBDataReader, NSString, GEOPDHours, PBUnknownFields;
...
@interface GEORPFeedbackBusinessHours : PBCodable <NSCopying> {
    ...
    int _hoursType;
    struct { unsigned char has_end : 1; unsigned char has_start : 1; unsigned char has_hoursType : 1; unsigned char read_unknownFields : 1; unsigned char read_comments : 1; unsigned char read_weeklyHours : 1; unsigned char wrote_anyField : 1; } _flags;
}
