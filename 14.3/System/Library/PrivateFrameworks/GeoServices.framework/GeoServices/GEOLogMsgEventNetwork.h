...
@interface GEOLogMsgEventNetwork : PBCodable <NSCopying> {
    ...
    BOOL _rnfTriggered;
    struct { unsigned char has_requestEnd : 1; unsigned char has_requestErrorCode : 1; unsigned char has_requestStart : 1; unsigned char has_decodeTime : 1; unsigned char has_httpResponseCode : 1; unsigned char has_mptcpServiceType : 1; unsigned char has_networkService : 1; unsigned char has_queuedTime : 1; unsigned char has_redirectCount : 1; unsigned char has_requestDataSize : 1; unsigned char has_responseDataSize : 1; unsigned char has_tilesetId : 1; unsigned char has_totalTime : 1; unsigned char has_mptcpNegotiated : 1; unsigned char has_rnfTriggered : 1; unsigned char read_manifestEnv : 1; unsigned char read_requestAppIdentifier : 1; unsigned char read_requestErrorDescription : 1; unsigned char read_requestErrorDomain : 1; unsigned char read_serviceIpAddress : 1; unsigned char read_taskMetrics : 1; unsigned char wrote_anyField : 1; } _flags;
}
