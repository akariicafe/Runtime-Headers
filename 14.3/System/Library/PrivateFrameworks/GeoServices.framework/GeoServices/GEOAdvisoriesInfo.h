...
@interface GEOAdvisoriesInfo : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_clickableAdvisory : 1; unsigned char read_evAdvisory : 1; unsigned char read_incidentAdvisorys : 1; unsigned char read_noticeAdvisorys : 1; unsigned char read_tollAdvisory : 1; unsigned char wrote_anyField : 1; } _flags;
}
