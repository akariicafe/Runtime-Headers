...
@interface GEOETAStep : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_distanceRemaining : 1; unsigned char has_expectedTime : 1; unsigned char has_stepID : 1; unsigned char has_zilchPathIndex : 1; unsigned char has_zilchPointIndex : 1; unsigned char read_unknownFields : 1; unsigned char read_evInfo : 1; unsigned char read_evStateInfo : 1; unsigned char read_timeCheckpoints : 1; unsigned char wrote_anyField : 1; } _flags;
}
