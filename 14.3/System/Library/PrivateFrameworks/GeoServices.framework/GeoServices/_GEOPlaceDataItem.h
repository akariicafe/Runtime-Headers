@class NSDate, geo_isolater, GEOMapItemPlaceAttribution, NSDictionary, GEOAppleRating, GEOMapItemContainedPlace, GEOPDFlyover, GEOAddressObject, GEOMessageLink, GEOAssociatedApp, GEOFeatureStyleAttributes, GEOMapRegion, GEOPDBusinessClaim, GEOMuninViewState, NSData, GEOPlacecardLayoutConfiguration, GEOPlace, GEOStorefrontPresentationInfo, NSMapTable, GEOBusinessHours, GEOMapItemReviewsAttribution, NSURL, GEOPDMultiLocalizedString, GEOPlaceQuestionnaire, GEOMapItemClientAttributes, GEOPlaceResult, NSArray, GEOStyleAttributes, GEOStorefrontInfo, NSString, _GEOEncyclopedicInfo, NSTimeZone, GEORestaurantFeaturesLink, GEOMapItemIdentifier, GEOMapItemDetourInfo, GEOMapItemPhotosAttribution, GEORelatedPlaceList, GEOPDPlace, GEOPriceDescription, GEOAddress;
...
- (BOOL)_showAddForAttribution:(id)a0 requirement:(int)a1;
- (BOOL)_showAttributionForAttribution:(id)a0 requirement:(int)a1;
- (BOOL)_hasMoreForAttribution:(id)a0 requirement:(int)a1;
- (id)_mapItemBySettingIsTransitDisplayFeature:(BOOL)a0;
- (id)_logoPathForAttribution:(id)a0 requirement:(int)a1 scale:(double)a2;
...
- (id)_attributionInfoForAttribution:(id)a0 requirement:(int)a1;
- (id)initWithPlaceData:(id)a0 detourInfo:(id)a1 additionalPlaceDatas:(id)a2;
- (id)_wifiFingerprintComponent;
- (id)_displayNameForAttribution:(id)a0 requirement:(int)a1;
- (id)_bestBrandIconOfType:(int)a0 size:(struct CGSize { double x0; double x1; })a1 allowSmaller:(BOOL)a2;
- (id)shortAddress;
- (id)_attributionWithAnnotatedItemList:(id)a0;
