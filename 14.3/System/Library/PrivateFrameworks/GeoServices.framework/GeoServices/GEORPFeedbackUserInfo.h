@class PBDataReader, NSString, GEORPUserCredentials, NSData, PBUnknownFields;
...
@interface GEORPFeedbackUserInfo : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_devicePushToken : 1; unsigned char read_preferredEmail : 1; unsigned char read_ugcUserId : 1; unsigned char read_userCredentials : 1; unsigned char read_userEmail : 1; unsigned char wrote_anyField : 1; } _flags;
}
