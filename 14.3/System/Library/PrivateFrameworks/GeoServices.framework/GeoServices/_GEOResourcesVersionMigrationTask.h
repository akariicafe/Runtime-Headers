@class GEOActiveTileGroup, GEOActiveTileGroupMigrationTaskOptions, GEOResourcesVersionMigrator, NSObject, GEOResources, GEODataSetDescription, NSString, NSSet, GEOResourceManifestConfiguration, GEOTileGroup, GEOReportedProgress, NSArray, GEOResourceLoader, NSProgress;
