...
- (void)_incrementForApp:(id)a0 requestId:(id)a1 time:(id)a2 requestType:(struct { int x0; union { int x0; int x1; int x2; } x1; })a3 result:(unsigned char)a4 xmitBytes:(long long)a5 recvBytes:(long long)a6;
- (void)recordTrafficProbeCollectionAt:(id)a0 tripId:(id)a1 locationCount:(int)a2 result:(unsigned char)a3;
- (void)clearCounters;
- (void)startPowerLogSessionWithName:(id)a0;
