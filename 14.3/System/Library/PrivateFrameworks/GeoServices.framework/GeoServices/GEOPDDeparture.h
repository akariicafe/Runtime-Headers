...
@interface GEOPDDeparture : PBCodable <GEOTransitDeparture, NSCopying> {
    ...
    BOOL _isCanceled;
    struct { unsigned char has_absDepartureTime : 1; unsigned char has_absLiveDepartureTime : 1; unsigned char has_referenceTripId : 1; unsigned char has_isCanceled : 1; unsigned char read_unknownFields : 1; unsigned char read_realTimeStatus : 1; unsigned char read_vehicleNumber : 1; unsigned char wrote_anyField : 1; } _flags;
}
