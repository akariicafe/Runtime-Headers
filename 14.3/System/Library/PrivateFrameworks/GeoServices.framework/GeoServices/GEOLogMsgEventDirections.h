...
@interface GEOLogMsgEventDirections : PBCodable <NSCopying> {
    ...
    BOOL _preArrival;
    struct { unsigned char has_navigationAudioFeedback : 1; unsigned char has_navSessionId : 1; unsigned char has_durationOfTrip : 1; unsigned char has_originalEta : 1; unsigned char has_stateOfChargeAtDestActual : 1; unsigned char has_stateOfChargeAtDestPredicted : 1; unsigned char has_stateOfChargeAtOrigin : 1; unsigned char has_stateOfChargeDiffAtDest : 1; unsigned char has_acceptedCyclingWorkout : 1; unsigned char has_arrivedAtDestination : 1; unsigned char has_batteryDied : 1; unsigned char has_chargingStopAdded : 1; unsigned char has_isBadEvExperience : 1; unsigned char has_isCoarseLocationUsed : 1; unsigned char has_isCyclingNlgAvailable : 1; unsigned char has_isEvSampleTrip : 1; unsigned char has_isSiriEngaged : 1; unsigned char has_isVlfImprovementUsed : 1; unsigned char has_preArrival : 1; unsigned char read_directionsFeedbacks : 1; unsigned char read_durationInNavigationModes : 1; unsigned char read_evChargingMode : 1; unsigned char read_evConsumptionModel : 1; unsigned char read_finalLocation : 1; unsigned char read_tripOrigin : 1; unsigned char read_waypoints : 1; unsigned char wrote_anyField : 1; } _flags;
}
