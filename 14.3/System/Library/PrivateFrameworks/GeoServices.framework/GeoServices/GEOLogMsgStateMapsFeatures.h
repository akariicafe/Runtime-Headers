@interface GEOLogMsgStateMapsFeatures : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_favoritesCount : 1; unsigned char has_followedPublisherCount : 1; unsigned char has_personalCollectionsCount : 1; unsigned char has_savedCollectionsCount : 1; unsigned char has_submittedPhotosCount : 1; unsigned char has_submittedRatingsCount : 1; unsigned char has_homeFavoriteSet : 1; unsigned char has_schoolFavoriteSet : 1; unsigned char has_workFavoriteSet : 1; } _flags;
}
