@class GEOLogMsgStateApplicationIdentifier, GEOLogMsgStateMapViewLocation, GEOLogMsgStateSuggestions, GEOLogMsgStateRoute, GEOLogMsgStateTileSet, GEOLogMsgStateDeviceSettings, GEOLogMsgStateExperiments, GEOLogMsgStateMapsUserSettings, GEOLogMsgStateLookAroundView, GEOLogMsgStateMapLaunch, GEOLogMsgStateTransit, GEOLogMsgStateMapView, GEOLogMsgStateMapSettings, GEOLogMsgStateDeviceLocale, GEOLogMsgStateMapsFeatures, GEOLogMsgStateUGCPhoto, GEOLogMsgStateUser, GEOLogMsgStateCarPlay, GEOLogMsgStateNavigation, GEOLogMsgStateDeviceConnection, GEOLogMsgStateExtension, GEOLogMsgStateMapRestore, GEOLogMsgStateRoutingSettings, PBDataReader, GEOLogMsgStateMapsServer, GEOLogMsgStateSummaryLookAroundLog, GEOLogMsgStateDetailLookAroundLog, GEOLogMsgStateMapUIShown, GEOLogMsgStateDeviceIdentifier, GEOLogMsgStateUserSession, NSString, GEOLogMsgStateMapUI, GEOLogMsgStatePlaceRequest, GEOLogMsgStateDeviceBase, GEOLogMsgStatePairedDevice, GEOLogMsgStateCuratedCollection, GEOLogMsgStateMuninResource, GEOLogMsgStateDirectionsDetail, GEOLogMsgStatePlaceCard, GEOLogMsgStateRealtimeTrafficProbe, GEOLogMsgStateMarket;
...
@interface GEOLogMsgState : PBCodable <NSCopying> {
    ...
    int _stateType;
    struct { unsigned char has_stateType : 1; unsigned char read_applicationIdentifier : 1; unsigned char read_carPlay : 1; unsigned char read_curatedCollection : 1; unsigned char read_detailLookAroundLog : 1; unsigned char read_deviceBase : 1; unsigned char read_deviceConnection : 1; unsigned char read_deviceIdentifier : 1; unsigned char read_deviceLocale : 1; unsigned char read_deviceSettings : 1; unsigned char read_directionsDetail : 1; unsigned char read_experiments : 1; unsigned char read_extension : 1; unsigned char read_lookAroundView : 1; unsigned char read_mapLaunch : 1; unsigned char read_mapRestore : 1; unsigned char read_mapSettings : 1; unsigned char read_mapUiShown : 1; unsigned char read_mapUi : 1; unsigned char read_mapViewLocation : 1; unsigned char read_mapView : 1; unsigned char read_mapsFeatures : 1; unsigned char read_mapsServer : 1; unsigned char read_mapsUserSettings : 1; unsigned char read_market : 1; unsigned char read_muninResource : 1; unsigned char read_navigation : 1; unsigned char read_pairedDevice : 1; unsigned char read_placeCard : 1; unsigned char read_placeRequest : 1; unsigned char read_realtimeTrafficProbe : 1; unsigned char read_route : 1; unsigned char read_routingSettings : 1; unsigned char read_stateOrigin : 1; unsigned char read_suggestions : 1; unsigned char read_summaryLookAroundLog : 1; unsigned char read_tileSet : 1; unsigned char read_transit : 1; unsigned char read_ugcPhoto : 1; unsigned char read_userSession : 1; unsigned char read_user : 1; unsigned char wrote_anyField : 1; } _flags;
}
