...
@interface GEORPPhotoMetadata : PBCodable <NSCopying> {
    ...
    int _source;
    struct { unsigned char has_size : 1; unsigned char has_source : 1; unsigned char read_clientImageUuid : 1; unsigned char read_geotag : 1; unsigned char read_imageDescription : 1; unsigned char read_mediaType : 1; unsigned char wrote_anyField : 1; } _flags;
}
