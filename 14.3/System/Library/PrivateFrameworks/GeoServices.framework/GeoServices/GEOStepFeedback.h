...
@interface GEOStepFeedback : PBCodable <NSCopying> {
    ...
    BOOL _routePaused;
    BOOL _routeResumed;
    struct { unsigned char has_completionTimeStamp : 1; unsigned char has_expectedTime : 1; unsigned char has_maneuverType : 1; unsigned char has_routeIndex : 1; unsigned char has_stepID : 1; unsigned char has_waypointRouteID : 1; unsigned char has_completedStep : 1; unsigned char has_lightGuidance : 1; unsigned char has_routePaused : 1; unsigned char has_routeResumed : 1; unsigned char read_evStepInfo : 1; unsigned char read_routeID : 1; unsigned char read_stepZilch : 1; unsigned char read_tripID : 1; unsigned char wrote_anyField : 1; } _flags;
}
