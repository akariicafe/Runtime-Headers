@class NSDate, geo_isolater, GEOMapItemPlaceAttribution, NSDictionary, GEOAppleRating, GEOMapItemContainedPlace, GEOPDFlyover, NSMutableArray, GEOMessageLink, GEOAssociatedApp, GEOFeatureStyleAttributes, GEOMapRegion, GEOPDBusinessClaim, GEOMuninViewState, NSData, GEOPlacecardLayoutConfiguration, GEOPlace, GEOStorefrontPresentationInfo, GEOMapItemReviewsAttribution, NSURL, _GEOMapItemStorageNotificationTrampoline, PBDataReader, GEOPlaceQuestionnaire, GEOMapItemClientAttributes, GEOPlaceResult, NSArray, GEOMapItemStorageUserValues, GEOStyleAttributes, GEOStorefrontInfo, NSString, NSTimeZone, GEOPDResultDetourInfo, GEORestaurantFeaturesLink, GEOMapItemIdentifier, GEOMapItemDetourInfo, GEOMapItemPhotosAttribution, GEOLatLng, GEORelatedPlaceList, PBUnknownFields, GEOPDPlace, GEOPriceDescription, GEOAddress;
