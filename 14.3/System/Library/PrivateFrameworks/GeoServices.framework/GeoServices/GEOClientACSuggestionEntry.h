@class NSString, GEOSubactionMetaData, PBDataReader;
...
@interface GEOClientACSuggestionEntry : PBCodable <NSCopying> {
    ...
    BOOL _shownToUser;
    struct { unsigned char has_contactRelevanceScore : 1; unsigned char has_fractionOfMatch : 1; unsigned char has_mapsSuggestionsContactRevelanceScore : 1; unsigned char has_mapsSuggestionsIsTouristScore : 1; unsigned char has_mapsSuggestionsPoiRevelanceScore : 1; unsigned char has_age : 1; unsigned char has_autocompleteResultCellType : 1; unsigned char has_distanceToSuggestion : 1; unsigned char has_peopleSuggesterRank : 1; unsigned char has_poiOpenState : 1; unsigned char has_serverEntryType : 1; unsigned char has_serverItemIndexInSection : 1; unsigned char has_serverSectionIndex : 1; unsigned char has_suggestionType : 1; unsigned char has_tapBehavior : 1; unsigned char has_discreteFeatureValuesAvailable : 1; unsigned char has_isFavorite : 1; unsigned char has_isProminentResult : 1; unsigned char has_matchedUsingAddress : 1; unsigned char has_matchedUsingEventName : 1; unsigned char has_matchedUsingLabel : 1; unsigned char has_matchedUsingName : 1; unsigned char has_matchedUsingOrganization : 1; unsigned char has_shownToUser : 1; unsigned char read_subactionMetaData : 1; unsigned char read_suggestionSectionType : 1; unsigned char wrote_anyField : 1; } _flags;
}
