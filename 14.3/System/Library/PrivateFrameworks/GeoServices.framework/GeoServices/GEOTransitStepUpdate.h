@class GEOInstructionSet, PBUnknownFields, PBDataReader, NSData, GEOTransitVehiclePositionInfo, GEOTransitScheduleInfo;
...
@interface GEOTransitStepUpdate : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_instructions : 1; unsigned char read_scheduleInfo : 1; unsigned char read_updateIdentifier : 1; unsigned char read_vehiclePositionInfo : 1; unsigned char wrote_anyField : 1; } _flags;
}
