@class NSData, NSString, GEOTransitEngineDebugData, GEOTransitRouteDisplayStrings, PBDataReader, PBUnknownFields, GEOPBTransitRoutingIncidentMessage, NSMutableArray;
...
@interface GEOTransitSuggestedRoute : PBCodable <GEOCompanionCompatibility, NSCopying> {
    ...
    struct { unsigned char has_absEndTime : 1; unsigned char has_absStartTime : 1; unsigned char has_rank : 1; unsigned char has_travelTimeAggressiveEstimate : 1; unsigned char has_travelTimeConservativeEstimate : 1; unsigned char has_supportsRouteUpdates : 1; unsigned char read_unknownFields : 1; unsigned char read_routeBadges : 1; unsigned char read_displayStrings : 1; unsigned char read_engineDebugData : 1; unsigned char read_routeHandle : 1; unsigned char read_routePlanningArtworks : 1; unsigned char read_sectionOptions : 1; unsigned char read_sections : 1; unsigned char read_steps : 1; unsigned char read_transitIncidentMessage : 1; unsigned char wrote_anyField : 1; } _flags;
}
