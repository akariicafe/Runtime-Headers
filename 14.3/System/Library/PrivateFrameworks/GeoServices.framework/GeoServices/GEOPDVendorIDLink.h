...
- (void)writeTo:(id)a0;
- (id)description;
- (void)addReservationType:(int)a0;
- (void)clearReservationTypes;
- (void)setReservationTypes:(int *)a0 count:(unsigned long long)a1;
- (id)reservationTypesAsString:(int)a0;
- (int)StringAsReservationTypes:(id)a0;
- (void)copyTo:(id)a0;
- (BOOL)isEqual:(id)a0;
- (id)dictionaryRepresentation;
- (void)clearUnknownFields:(BOOL)a0;
- (id)initWithDictionary:(id)a0;
- (int)reservationTypeAtIndex:(unsigned long long)a0;
