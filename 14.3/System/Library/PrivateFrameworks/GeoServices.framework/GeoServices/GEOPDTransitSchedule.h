...
@interface GEOPDTransitSchedule : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_operatingHoursRange : 1; unsigned char has_ttlSeconds : 1; unsigned char read_unknownFields : 1; unsigned char read_departurePredicateCountdown : 1; unsigned char read_departurePredicateStamp : 1; unsigned char read_departureSequences : 1; unsigned char wrote_anyField : 1; } _flags;
}
...
- (void)writeTo:(id)a0;
- (id)description;
- (void)addDepartureSequence:(id)a0;
- (unsigned long long)departureSequencesCount;
- (void)clearDepartureSequences;
- (id)departureSequenceAtIndex:(unsigned long long)a0;
- (void)copyTo:(id)a0;
- (BOOL)isEqual:(id)a0;
