@class GEOMapItemStorage, NSString, NSData, GEOCompanionWaypoint, GEODirectionsRequest, GEODirectionsResponse, PBDataReader, GEOComposedWaypoint, NSMutableArray, GEOTransitSuggestedRoute, GEOTransitDecoderData;
