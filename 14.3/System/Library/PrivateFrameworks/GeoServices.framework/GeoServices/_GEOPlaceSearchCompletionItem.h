@class GEODirectionIntent, GEOMapServiceTraits, GEOMapItemIdentifier, GEOPublisherResult, GEOServerResultScoreMetadata, GEOPDAutocompleteEntry, NSString, GEORetainedSearchMetadata, GEOResolvedItem, NSArray, NSData, GEOSearchCategory, GEOCollectionResult;
@protocol GEOMapItem;
