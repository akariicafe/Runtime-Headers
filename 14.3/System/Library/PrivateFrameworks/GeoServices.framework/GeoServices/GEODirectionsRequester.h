...
- (void)startRequest:(id)a0 auditToken:(id)a1 skipFinalize:(BOOL)a2 isDoomRequest:(BOOL)a3 requestPriority:(id)a4 callbackQueue:(id)a5 finished:(id /* block */)a6 networkActivity:(id /* block */)a7 error:(id /* block */)a8;
...
- (void)startRequest:(id)a0 auditToken:(id)a1 skipFinalize:(BOOL)a2 isDoomRequest:(BOOL)a3 requestPriority:(id)a4 finished:(id /* block */)a5 networkActivity:(id /* block */)a6 error:(id /* block */)a7;
