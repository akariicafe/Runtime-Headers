...
- (void)setContentTaste:(long long)a0 forMediaItem:(long long)a1 storeIdentifier:(long long)a2 configuration:(id)a3 withCompletionHandler:(id /* block */)a4;
...
- (void)setContentTaste:(long long)a0 forMediaItem:(long long)a1 storeIdentifier:(long long)a2 withCompletionHandler:(id /* block */)a3;
