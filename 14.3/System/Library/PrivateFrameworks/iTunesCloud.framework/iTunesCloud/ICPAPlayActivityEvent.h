@class ICPAPlayActivityEnqueuerProperties, NSString, NSData, NSMutableArray, ICPAPlayModeDictionary;
...
@property (retain, nonatomic) ICPAPlayActivityEnqueuerProperties *enqueuerProperties;
...
@property (retain, nonatomic) NSMutableArray *buildFeatures;
@property (readonly, nonatomic) BOOL hasPlayMode;
@property (retain, nonatomic) ICPAPlayModeDictionary *playMode;
...
- (void)addBuildFeatures:(id)a0;
- (void)clearBuildFeatures;
- (id)buildFeaturesAtIndex:(unsigned long long)a0;
