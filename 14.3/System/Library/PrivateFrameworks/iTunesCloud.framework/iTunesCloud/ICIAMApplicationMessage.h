@class ICIAMMessageRule, NSString, ICIAMMetricEvent, ICIAMLocalNotification, NSMutableArray;

@interface ICIAMApplicationMessage : PBCodable <NSCopying> {
    struct { unsigned char endDate : 1; unsigned char startDate : 1; unsigned char assetPrefetchStrategy : 1; unsigned char globalPresentationPolicyGroup : 1; unsigned char maximumDisplays : 1; unsigned char messageType : 1; unsigned char modalPresentationStyle : 1; unsigned char priority : 1; unsigned char carousel : 1; unsigned char hasCloseButton : 1; } _has;
}
