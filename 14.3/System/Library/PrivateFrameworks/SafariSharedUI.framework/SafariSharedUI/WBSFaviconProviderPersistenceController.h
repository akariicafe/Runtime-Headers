@class WBSFaviconProviderPrivateCache, NSString, NSObject, NSURL, WBSFaviconProviderDatabaseController, WBSOnDiskDataCache, WBSFaviconProviderRecordCache;
...
- (void)rejectedResourceInfoForPageURLString:(id)a0 iconURLString:(id)a1 includingPrivateData:(BOOL)a2 completionHandler:(id /* block */)a3;
