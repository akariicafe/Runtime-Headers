...
- (id)init;
- (void).cxx_destruct;
- (void)generatePreview:(id)a0 previewURL:(id)a1 constraints:(struct IMPreviewConstraints { double x0; struct CGSize { double x0; double x1; } x1; double x2; BOOL x3; })a2 completionBlock:(id /* block */)a3 blockUntilReply:(BOOL)a4;
- (void)_disconnected;
- (BOOL)_connect;
- (BOOL)copyGifFileFromSourcePath:(id)a0 toDestinationPath:(id)a1 error:(id *)a2;
...
- (void)sizePreview:(id)a0 constraints:(struct IMPreviewConstraints { double x0; struct CGSize { double x0; double x1; } x1; double x2; BOOL x3; })a1 completionBlock:(id /* block */)a2 blockUntilReply:(BOOL)a3;
...
- (void)generatePreview:(id)a0 previewURL:(id)a1 constraints:(struct IMPreviewConstraints { double x0; struct CGSize { double x0; double x1; } x1; double x2; BOOL x3; })a2 completionBlock:(id /* block */)a3;
- (void)sizePreview:(id)a0 constraints:(struct IMPreviewConstraints { double x0; struct CGSize { double x0; double x1; } x1; double x2; BOOL x3; })a1 completionBlock:(id /* block */)a2;
...
- (void)_generatePreview:(id)a0 previewURL:(id)a1 constraints:(struct IMPreviewConstraints { double x0; struct CGSize { double x0; double x1; } x1; double x2; BOOL x3; })a2 retries:(unsigned long long)a3 completionBlock:(id /* block */)a4 blockUntilReply:(BOOL)a5;
- (void)sizePreview:(id)a0 constraints:(struct IMPreviewConstraints { double x0; struct CGSize { double x0; double x1; } x1; double x2; BOOL x3; })a1 retries:(unsigned long long)a2 completionBlock:(id /* block */)a3 blockUntilReply:(BOOL)a4;
- (void)copyGifFileFromSourcePath:(id)a0 toDestinationPath:(id)a1 completionBlock:(id /* block */)a2;
