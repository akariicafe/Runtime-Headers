@class DelegateProxy, NSArray, AMSUIWebClientContext, _WKRemoteObjectInterface, AMSBinaryPromise, WKWebView, NSString;
...
@property (retain, nonatomic) DelegateProxy *exportedObjectProxy;
...
- (id)loadHTML:(id)a0 baseURL:(id)a1;
