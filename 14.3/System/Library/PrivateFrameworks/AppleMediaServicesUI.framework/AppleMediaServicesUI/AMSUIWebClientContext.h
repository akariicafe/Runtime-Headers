@class AMSUIWebFlowController, NSString, AMSUIWebPageViewController, AMSSnapshotBag, NSDictionary, AMSUIWebPluginLoader, ACAccount, AMSUIWebJSDataProvider, AMSMetrics, AMSURLSession, AMSProcessInfo;
...
+ (id)_updatedClientInfoMatchingAccount:(id)a0 clientInfo:(id)a1;

- (void).cxx_destruct;
- (id)iTunesAccountFromJSAccount:(id)a0;
- (void)replaceCurrentAccount:(id)a0;
