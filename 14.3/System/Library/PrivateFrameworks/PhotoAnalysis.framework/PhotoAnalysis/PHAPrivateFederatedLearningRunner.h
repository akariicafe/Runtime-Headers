...
- (void).cxx_destruct;
- (id)initWithAttachmentURLs:(id)a0 layersToTrain:(id)a1 numberOfEpochs:(unsigned long long)a2 learningRate:(id)a3 modelInputName:(id)a4 modelOutputName:(id)a5 lossName:(id)a6 optimizerName:(id)a7 iCloudAggServiceKey:(id)a8 clippingNorm:(id)a9 normBinCount:(id)a10 trainingTask:(id)a11 fingerprintVersion:(id)a12 datasetPolicy:(id)a13 labelPolicy:(id)a14 positivesDatasetName:(id)a15 positivesSubsetName:(id)a16 negativesDatasetName:(id)a17 negativesSubsetName:(id)a18 totalNumberOfSamples:(id)a19 oversamplingRate:(id)a20 photoLibrary:(id)a21 graphManager:(id)a22 shouldAddNoise:(BOOL)a23 shouldEncrypt:(BOOL)a24 shouldValidateModel:(BOOL)a25 minProcessedRate:(id)a26 transformersForFeatureExtractors:(id)a27 augmenters:(id)a28 filtersByDatasetName:(id)a29;
