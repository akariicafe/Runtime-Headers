...
@interface MapsSuggestionsQueue : NSObject <MapsSuggestionsObject> {
    struct unique_ptr<MSg::Queue, std::__1::default_delete<MSg::Queue> > { struct __compressed_pair<MSg::Queue *, std::__1::default_delete<MSg::Queue> > { struct Queue *__value_; } __ptr_; } _cppQueue;
}
