@class NSMutableDictionary, NSMutableSet, _QLCacheThread, NSObject, NSOperationQueue;
...
- (void)addImageData:(id)a0 withBitmapFormat:(id)a1 contentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 hasIconModeApplied:(BOOL)a3 flavor:(int)a4 metadata:(id)a5 toCacheAndCompleteRequest:(id)a6;
