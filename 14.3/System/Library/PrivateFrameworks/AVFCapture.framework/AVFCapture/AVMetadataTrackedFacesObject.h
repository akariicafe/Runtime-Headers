...
+ (id)trackedFacesWithTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 faceKitDictionary:(id)a1 input:(id)a2;
...
- (id)initWithTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 faceKitDictionary:(id)a1 input:(id)a2;
