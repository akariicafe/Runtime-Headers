...
@interface CLPLteCellTowerLocation : PBCodable <NSCopying> {
    struct { unsigned char cellLatitude : 1; unsigned char cellLongitude : 1; unsigned char bandInfo : 1; unsigned char bandwidth : 1; unsigned char deploymentType : 1; unsigned char ecn0 : 1; unsigned char pid : 1; unsigned char rscp : 1; unsigned char rssi : 1; unsigned char serverHash : 1; unsigned char uarfcn : 1; unsigned char isLimitedService : 1; } _has;
}
