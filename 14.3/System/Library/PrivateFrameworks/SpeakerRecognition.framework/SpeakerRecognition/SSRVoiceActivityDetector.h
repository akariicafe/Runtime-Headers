@class NSString, EARCaesuraSilencePosteriorGenerator, SSRSpeakerRecognitionContext, CSServerEndpointFeatures, _EAREndpointer, NSObject;
...
@property (retain, nonatomic) CSServerEndpointFeatures *defaultServerEpFeatures;
