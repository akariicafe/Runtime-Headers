...
- (id)init;
- (void).cxx_destruct;
- (id)initWithTrialClient:(id)a0 metricsClient:(id)a1 xpcClient:(id)a2 rkClient:(id)a3;
...
- (id)responsesCache;
- (void)registerImpressionWithPreResponseItems:(id)a0 language:(id)a1 isCached:(BOOL)a2 responseTimePerf:(unsigned long long)a3 promptMessage:(id)a4 generationStatus:(int)a5;
