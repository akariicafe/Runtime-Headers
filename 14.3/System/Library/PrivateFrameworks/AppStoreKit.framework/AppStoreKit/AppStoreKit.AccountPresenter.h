@interface AppStoreKit.AccountPresenter : AppStoreKit.BasePresenter {
    ...
    void /* unknown type, empty encoding */ isMonetaryGiftingEnabled;
    void /* unknown type, empty encoding */ accountTopUpURL;
    void /* unknown type, empty encoding */ manageSubscriptionsURL;
    void /* unknown type, empty encoding */ hasPrimaryiCloudAccount;
    void /* unknown type, empty encoding */ updateAllIndexPath;
    void /* unknown type, empty encoding */ sections;
    void /* unknown type, empty encoding */ $__lazy_storage_$_notificationsAccountSectionLink;
    void /* unknown type, empty encoding */ $__lazy_storage_$_setupFamilySharingSectionLink;
}
