...
- (id)universalPlaybackQueueRequestIdentifierForEpisode:(id)a0;
- (id)universalPlaybackQueueIdentifiersForStationUuid:(id)a0 limit:(long long)a1 queueStatus:(out unsigned long long *)a2;
- (id)episodeUuidForSetPlaybackQueueRequestIdentifier:(id)a0;
- (id)podcastUuidForSetPlaybackQueueRequestIdentifier:(id)a0;
