@class AVTPuppetStore, AVTAvatarRecordImageGenerator, NSString, AVTUIEnvironment, NSObject;
@protocol AVTStoreBackend, AVTStickerBackendDelegate, AVTStickerBackend, OS_dispatch_queue, AVTUILogger;
...
- (id)initWithBackend:(id)a0 backendAccessQueue:(id)a1 puppetStore:(id)a2 imageGenerator:(id)a3 stickerBackend:(id)a4 environment:(id)a5;
