@class UIView, NSString, UITapGestureRecognizer, NSArray, UIImage, UIImageView, UIButton, AVTCircularButton, NSLayoutConstraint, AVTStickerRecentsOverlayViewLayout, UILabel;
