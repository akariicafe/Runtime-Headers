...
+ (id)sendMessageData:(id)a0 autosaveIdentifier:(id)a1 completionBlock:(id /* block */)a2;
...
- (void)_sendMessageData:(id)a0 autosaveIdentifier:(id)a1 completionBlock:(id /* block */)a2;
