@class EFLazyCache, MFMailMessageLibrary, MFMailMessageLibraryQueryTransformer, MFMessageTransformer, NSString, NSObject, NSMutableDictionary;
...
- (id)initWithMailboxPersistence:(id)a0 database:(id)a1 hookRegistry:(id)a2 library:(id)a3;
