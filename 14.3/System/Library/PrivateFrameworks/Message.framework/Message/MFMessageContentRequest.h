@class MFMailMessage, NSString, EDMessagePersistence, EDMailDropMetadataGenerator, EDListUnsubscribeHandler, EMMessageObjectID, MFMessageTransformer, EMContentRequestOptions;
...
@property (readonly, nonatomic) MFMessageTransformer *messageTransformer;
