@class MFMailboxUid, NSString, NSArray, MFLock, MFError, MFLocalActionReplayHandler, NSMutableDictionary, MFWeakObjectCache, ACAccount, NSObject, MFMailMessageLibrary;
...
@property (readonly, nonatomic) MFLocalActionReplayHandler *replayHandler;
