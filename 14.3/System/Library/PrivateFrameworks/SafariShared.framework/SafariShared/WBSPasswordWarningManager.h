@class NSString, WBSSavedPasswordAuditor, WBSRemotePlistController, WBSPasswordBreachHelperProxy, NSArray, WBSPasswordEvaluator, WBSSavedPasswordStore, WBSHistory, NSObject, NSMutableSet, NSUserDefaults, NSMapTable;
...
- (id)_localizedShortWarningDescriptionForIssueTypes:(unsigned long long)a0;
...
- (id)_localizedLongWarningDescriptionStringsForPassword:(id)a0 weakPasswordEvaluation:(id)a1 issueTypes:(unsigned long long)a2;
