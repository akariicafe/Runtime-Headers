@class UIPanGestureRecognizer, NSDate, NSDictionary, UITapGestureRecognizer, CEKLightingFrameCache, CEKSelectionFeedbackGenerator, UILongPressGestureRecognizer, NSSet, CEKLightingNameBadge, CEKAnimationGenerator, NSTimer, CEKLightingDialBackground, NSArray, NSString, UIImageView;
