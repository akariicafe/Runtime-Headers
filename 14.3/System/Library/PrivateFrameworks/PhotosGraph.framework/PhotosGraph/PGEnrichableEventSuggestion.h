...
- (id)initWithType:(unsigned short)a0 subtype:(unsigned short)a1 enrichableEvent:(id)a2 sharingSuggestionResults:(id)a3 manager:(id)a4 loggingConnection:(id)a5;
