@class NSSet, PGTitle, PGGraph, NSDateInterval;
...
- (void).cxx_destruct;
- (id)initWithType:(long long)a0 referenceDateInterval:(id)a1 momentNodes:(id)a2 lineBreakBehavior:(unsigned long long)a3 isForHighlight:(BOOL)a4;
- (id)initWithType:(long long)a0 referenceDateInterval:(id)a1 highlightNode:(id)a2;
- (id)initWithType:(long long)a0 referenceDateInterval:(id)a1 momentNodes:(id)a2;
