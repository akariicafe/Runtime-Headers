@class NSSet, NSString, NSArray, PGIncompleteLocationResolver;
...
+ (void)_aoiTitleWithLocationNodes:(id)a0 momentNodes:(id)a1 allowLongAOI:(BOOL)a2 result:(id /* block */)a3;
...
- (void).cxx_destruct;
- (id)initWithMomentNodes:(id)a0 filterMomentsAndCities:(BOOL)a1;
- (id)initWithMomentNodes:(id)a0 filterMomentsAndCities:(BOOL)a1 allowLongAOI:(BOOL)a2;
