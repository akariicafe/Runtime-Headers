@class PGManager, NSString, PGGraphUpdateJetsamIndicator, PGPhotoChangeToGraphChangeConverter, PGLibraryChangeListener, PGGraphUpdateManagerTargetTokenState, NSMutableSet, NSObject, NSMutableArray;
...
- (BOOL)_performEnrichmentWithGraphUpdateInventory:(id)a0 enrichmentContext:(long long)a1 progressBlock:(id /* block */)a2;
