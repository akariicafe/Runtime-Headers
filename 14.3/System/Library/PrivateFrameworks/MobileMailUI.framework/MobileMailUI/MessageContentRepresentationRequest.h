...
- (id)initWithMessage:(id)a0 includeSuggestionItems:(BOOL)a1 delegate:(id)a2;
- (void)_commonInitWithIncludeSuggestionItems:(BOOL)a0 delegate:(id)a1;
- (id)initWithMessageList:(id)a0 itemIdentifier:(id)a1 includeSuggestionItems:(BOOL)a2 delegate:(id)a3;
