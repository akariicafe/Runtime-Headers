@class NSDictionary, MFAddressAtomStatusManager, EFCancelationToken, MFHasMoreContentBannerView, UIBarButtonItem, NSMutableArray, MFMailboxProvider, NSString, EMContentRepresentation, MFConversationItemFooterView, MFMessageHeaderView, NSError, MFMessageContentLoadingView, NSArray, NSMutableSet, MessageContentItemsHelper, NSObject, MFMailDropBannerView, EMDaemonInterface, UIView, MFLoadBlockedContentBannerView, MFMessageDisplayMetrics, MFMessageLoadingContext, MFBlockedSenderBannerView, MFWebViewLoadingController, WKWebView, UIScrollView, MessageContentRepresentationRequest, MFWebViewDictionary;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_adjustedRectForAttachmentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (void)webProcessDidFinishDocumentLoadForURL:(id)a0;
