...
@interface TISmartSelector : NSObject {
    struct unique_ptr<KB::StaticDictionary, std::__1::default_delete<KB::StaticDictionary> > { struct __compressed_pair<KB::StaticDictionary *, std::__1::default_delete<KB::StaticDictionary> > { struct StaticDictionary *__value_; } __ptr_; } _staticDictionary;
