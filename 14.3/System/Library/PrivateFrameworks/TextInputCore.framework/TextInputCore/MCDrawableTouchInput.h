...
- (id)initWithTouchPoint:(struct CGPoint { double x0; double x1; })a0 radius:(double)a1 timestamp:(double)a2 inflectionPoint:(BOOL)a3 touchHistory:(const struct RefPtr<TI::Favonius::CMTouchHistory> { struct CMTouchHistory *x0; } *)a4;
