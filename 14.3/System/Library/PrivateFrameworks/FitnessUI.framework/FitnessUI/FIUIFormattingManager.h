...
- (id)localizedStringWithDistanceInMeters:(double)a0 distanceUnit:(unsigned long long)a1 unitStyle:(unsigned long long)a2 decimalPrecision:(unsigned long long)a3 roundingMode:(unsigned long long)a4;
- (id)_localizedStringWithDistanceUnit:(unsigned long long)a0 distanceInUnit:(double)a1 unitStyle:(long long)a2 decimalPrecision:(unsigned long long)a3 roundingMode:(unsigned long long)a4;
...
- (id)localizedSpeedUnitStringForDistanceUnit:(unsigned long long)a0;
