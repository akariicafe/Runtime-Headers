@class NSArray, NSXPCConnection, ATXClient, ATXBiomeUIStream, NSObject, _DKEventStream;
...
+ (id)_allBundleIdsFromHomeScreenService:(id)a0;
...
- (void)_logUserFeedbackWithAppDirectoryResponse:(id)a0 engagementType:(unsigned long long)a1 bundleIdentifier:(id)a2 bundleIdsShown:(id)a3 explicitlyRejectedBundleIds:(id)a4;
...
- (void)logLaunchFromSuggestionWithDate:(id)a0 bundleID:(id)a1 bundleIndex:(unsigned long long)a2 appDirectoryResponse:(id)a3;
