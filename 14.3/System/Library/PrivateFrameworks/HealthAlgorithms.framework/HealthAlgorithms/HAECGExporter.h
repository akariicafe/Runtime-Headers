...
@interface HAECGExporter : NSObject <SRMultiSampleExporting> {
    struct unique_ptr<CinnAlgs::CnAlgs, std::__1::default_delete<CinnAlgs::CnAlgs> > { struct __compressed_pair<CinnAlgs::CnAlgs *, std::__1::default_delete<CinnAlgs::CnAlgs> > { struct CnAlgs *__value_; } __ptr_; } _cinAlgs;
