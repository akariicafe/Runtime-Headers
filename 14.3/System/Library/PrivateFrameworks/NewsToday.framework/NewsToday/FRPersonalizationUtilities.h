...
+ (id)diversifyItems:(id)a0 withLimit:(unsigned long long)a1 similarityStartExpectation:(double)a2 similarityEndExpectation:(double)a3 publisherDiversificationSlope:(double)a4 publisherDiversificationYIntercept:(double)a5;
