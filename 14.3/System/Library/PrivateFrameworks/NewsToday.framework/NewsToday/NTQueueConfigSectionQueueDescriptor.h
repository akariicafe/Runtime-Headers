...
- (id)initWithQueueConfig:(id)a0 appConfiguration:(id)a1 todayData:(id)a2 supplementalFeedFilterOptions:(long long)a3 respectsWidgetVisibleSectionsLimit:(BOOL)a4;
