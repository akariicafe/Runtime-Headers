@class NTKCaliforniaColorPalette, NTKCaliforniaContentView, NTKRoundedCornerOverlayView, UIImageView, UIView, NTKCircularAnalogDialView, NSString;
...
- (id)backgroundColorForDial:(unsigned long long)a0 palette:(id)a1;
- (double)californiaContentViewScale;
- (void)_updateSubDialRichComplicationsColor:(id)a0 alternateColor:(id)a1;
- (id)_simpleTextComplicationColorForEditMode:(long long)a0;
- (void)_updateSimpleTextLabelColor:(id)a0;
- (void)_updateDialBezelComplicationColor:(id)a0;
- (void)updateWorldClockComplicationColors:(id)a0 fromPalette:(id)a1 toPalette:(id)a2 fraction:(double)a3;
- (BOOL)shouldFlipColorsForSubDialRichComplicationView:(id)a0;
...
- (void)_applyComplicationColorTransitionFraction:(double)a0 fromColorPalette:(id)a1 toColorPalette:(id)a2;
- (double)alphaForFullscreenEditingNotchWithEditMode:(long long)a0;
