...
- (struct { double x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; struct UIEdgeInsets { double x0; double x1; double x2; double x3; } x12; })_layoutConstants;
