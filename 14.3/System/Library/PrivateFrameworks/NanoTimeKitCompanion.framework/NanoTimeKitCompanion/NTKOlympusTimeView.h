@class NSString, UIImage, NTKOlympusTimeContentView, CLKDevice, NSDate;
...
- (id)initWithDevice:(id)a0 dial:(unsigned long long)a1 style:(unsigned long long)a2 color:(unsigned long long)a3 date:(id)a4 useSmallFont:(BOOL)a5 circularLogoImage:(id)a6;
...
- (id)initWithDevice:(id)a0 dial:(unsigned long long)a1 style:(unsigned long long)a2 color:(unsigned long long)a3 date:(id)a4;
