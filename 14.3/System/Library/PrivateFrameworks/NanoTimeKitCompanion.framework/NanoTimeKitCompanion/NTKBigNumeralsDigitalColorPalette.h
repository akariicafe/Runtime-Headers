...
+ (id)swatchColorForColor:(unsigned long long)a0 device:(id)a1;
...
+ (id)minuteColorForColor:(unsigned long long)a0 device:(id)a1;
+ (BOOL)_needTwoToneSwatchForColor:(unsigned long long)a0;
