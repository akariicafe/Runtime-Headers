@class UIColor, NSArray, NSMutableDictionary, CLKDevice;
...
+ (id)colorSchemeForDevice:(id)a0 withFaceColor:(unsigned long long)a1 units:(unsigned long long)a2;
+ (id)colorSchemeForDevice:(id)a0 withFaceColor:(unsigned long long)a1 foregroundColor:(id)a2 units:(unsigned long long)a3 alternateHighlight:(BOOL)a4;
+ (id)interpolationFrom:(id)a0 to:(id)a1 fraction:(double)a2 brightenUnits:(unsigned long long)a3;
+ (id)interpolationForDevice:(id)a0 fromFaceColor:(unsigned long long)a1 toFaceColor:(unsigned long long)a2 fraction:(double)a3 units:(unsigned long long)a4 brightenUnits:(unsigned long long)a5 overrideColor:(id)a6 alternateHighlight:(BOOL)a7;
