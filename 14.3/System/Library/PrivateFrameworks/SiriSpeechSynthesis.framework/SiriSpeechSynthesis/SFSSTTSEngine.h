...
@interface SFSSTTSEngine : NSObject {
    struct unique_ptr<TTSSynthesizer, std::__1::default_delete<TTSSynthesizer> > { struct __compressed_pair<TTSSynthesizer *, std::__1::default_delete<TTSSynthesizer> > { struct TTSSynthesizer *__value_; } __ptr_; } _synthesizer;
}
