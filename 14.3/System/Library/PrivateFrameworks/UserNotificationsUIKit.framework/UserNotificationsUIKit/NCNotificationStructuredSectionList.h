@class NSString, NCNotificationListView, NCNotificationListSectionHeaderView, NSArray, NSMutableDictionary, NCNotificationListCache, NSMutableSet, NSMutableArray, NCNotificationListSectionRevealHintView;
...
- (void)notificationGroupList:(id)a0 didRemoveNotificationRequest:(id)a1;
...
- (void)mergeNotificationGroups:(id)a0;
...
- (void)notificationGroupListDidRemoveAllNotificationRequests:(id)a0;
...
- (id)notificationGroupListsForMigrationPassingTest:(id /* block */)a0 filterPersistentRequests:(BOOL)a1;
