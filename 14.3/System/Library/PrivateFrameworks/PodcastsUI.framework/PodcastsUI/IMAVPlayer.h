@class NSURL, IMPlayerManifest, IMPlayerItem, NSObject, AVPlayerLayer, NSMutableArray, AVPlayerItem, MPRemoteCommandCenter, IMAVPlayerVideoViewController, NSTimer, IMPlayerChapterInfo, NSString, MPNowPlayingInfoCenter, AVPlayer, UIWindow;
