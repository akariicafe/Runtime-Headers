...
- (void)loadFromArchive:(const struct PencilAnnotationStorageArchive { void /* function */ **x0; struct InternalMetadataWithArena { void *x0; } x1; struct HasBits<1> { unsigned int x0[1]; } x2; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> > { _Atomic int x0; } x0; } x0; } x3; struct RepeatedPtrField<TSP::Reference> { struct Arena *x0; int x1; int x2; struct Rep *x3; } x4; struct RepeatedPtrField<TSP::Reference> { struct Arena *x0; int x1; int x2; struct Rep *x3; } x5; struct Point *x6; struct DataReference *x7; struct DataReference *x8; struct Path *x9; struct Point *x10; struct Size *x11; struct Size *x12; struct Color *x13; struct Date *x14; struct DataReference *x15; struct Point *x16; struct Size *x17; struct Point *x18; struct Size *x19; int x20; int x21; double x22; unsigned long long x23; unsigned long long x24; int x25; int x26; double x27; } *)a0 unarchiver:(id)a1;
