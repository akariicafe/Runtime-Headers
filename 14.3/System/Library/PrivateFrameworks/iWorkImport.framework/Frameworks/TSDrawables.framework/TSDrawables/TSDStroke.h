...
+ (id)instanceWithArchive:(const struct StrokeArchive { void /* function */ **x0; struct InternalMetadataWithArena { void *x0; } x1; struct HasBits<1> { unsigned int x0[1]; } x2; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> > { _Atomic int x0; } x0; } x0; } x3; struct Color *x4; struct StrokePatternArchive *x5; struct SmartStrokeArchive *x6; struct FrameArchive *x7; struct PatternedStrokeArchive *x8; float x9; int x10; int x11; float x12; } *)a0 unarchiver:(id)a1;
