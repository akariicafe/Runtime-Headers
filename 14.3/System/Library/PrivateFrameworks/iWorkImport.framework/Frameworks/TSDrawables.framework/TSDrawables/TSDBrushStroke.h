...
- (void)p_brushPath:(id)a0 withScaling:(struct { double x0; double x1; })a1 inElementRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 intoPath:(id)a3 orIntoVector:(struct vector<TSDBrushVertexData, std::__1::allocator<TSDBrushVertexData> > { struct *x0; struct *x1; struct __compressed_pair<TSDBrushVertexData *, std::__1::allocator<TSDBrushVertexData> > { struct *x0; } x2; } *)a4 sectionIndex:(unsigned long long *)a5 viewScale:(double)a6 withLayoutOptions:(id)a7 currentSubpathIndex:(unsigned long long)a8 cachedCurrentElementPercentage:(struct { id x0; unsigned long long x1; double x2; } *)a9;
- (void)p_brushSection:(id)a0 sectionIndex:(unsigned long long)a1 ontoPath:(id)a2 inElementRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3 intoPath:(id)a4 orIntoVector:(struct vector<TSDBrushVertexData, std::__1::allocator<TSDBrushVertexData> > { struct *x0; struct *x1; struct __compressed_pair<TSDBrushVertexData *, std::__1::allocator<TSDBrushVertexData> > { struct *x0; } x2; } *)a5 viewScale:(double)a6 strokeTileLayout:(struct { double x0; double x1; double x2; double x3; })a7 cachedCurrentElementPercentage:(struct { id x0; unsigned long long x1; double x2; } *)a8;
- (void)p_rasterRenderSection:(id)a0 sectionIndex:(unsigned long long)a1 ontoPath:(id)a2 inElementRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3 into:(struct vector<TSDBrushVertexData, std::__1::allocator<TSDBrushVertexData> > { struct *x0; struct *x1; struct __compressed_pair<TSDBrushVertexData *, std::__1::allocator<TSDBrushVertexData> > { struct *x0; } x2; } *)a4 viewScale:(double)a5 strokeTileLayout:(struct { double x0; double x1; double x2; double x3; })a6 cachedCurrentElementPercentage:(struct { id x0; unsigned long long x1; double x2; } *)a7;
...
- (void)p_finishOpenGLRenderInContext:(struct CGContext { } *)a0 orDirectly:(id)a1 pathVertexData:(struct vector<TSDBrushVertexData, std::__1::allocator<TSDBrushVertexData> > { struct *x0; struct *x1; struct __compressed_pair<TSDBrushVertexData *, std::__1::allocator<TSDBrushVertexData> > { struct *x0; } x2; } *)a2 parameterized:(BOOL)a3 shouldReverseDrawOrder:(BOOL)a4 withLayoutOptions:(id)a5;
