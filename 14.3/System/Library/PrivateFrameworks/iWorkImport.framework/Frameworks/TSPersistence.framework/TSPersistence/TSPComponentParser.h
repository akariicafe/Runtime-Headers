...
@interface TSPComponentParser : NSObject {
    ...
    struct ArchiveInfo { void /* function */ **_vptr$MessageLite; struct InternalMetadataWithArena { void *ptr_; } _internal_metadata_; struct HasBits<1> { unsigned int has_bits_[1]; } _has_bits_; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> > { _Atomic int __a_value; } __a_; } size_; } _cached_size_; struct RepeatedPtrField<TSP::MessageInfo> { struct Arena *arena_; int current_size_; int total_size_; struct Rep *rep_; } message_infos_; unsigned long long identifier_; BOOL should_merge_; } _archiveInfo;
