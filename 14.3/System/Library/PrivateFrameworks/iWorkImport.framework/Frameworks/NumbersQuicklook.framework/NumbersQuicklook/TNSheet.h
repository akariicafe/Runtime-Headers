@class TNDocumentRoot, TSWPStorage, NSEnumerator, TSDLayoutController, NSObject, NSMutableArray, NSString, TSDInfoGeometry, NSMutableSet, TSPObject, NSArray, TSDColorFill, TNSheetStyle;
...
- (void)loadFromArchive:(const struct SheetArchive { void /* function */ **x0; struct InternalMetadataWithArena { void *x0; } x1; struct HasBits<1> { unsigned int x0[1]; } x2; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> > { _Atomic int x0; } x0; } x0; } x3; struct RepeatedPtrField<TSP::Reference> { struct Arena *x0; int x1; int x2; struct Rep *x3; } x4; struct RepeatedPtrField<TSP::Reference> { struct Arena *x0; int x1; int x2; struct Rep *x3; } x5; struct RepeatedPtrField<TSP::Reference> { struct Arena *x0; int x1; int x2; struct Rep *x3; } x6; struct ArenaStringPtr { struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> > *x0; } x7; struct EdgeInsetsArchive *x8; struct Reference *x9; struct Reference *x10; struct Reference *x11; struct Reference *x12; BOOL x13; BOOL x14; BOOL x15; BOOL x16; float x17; int x18; int x19; float x20; float x21; BOOL x22; BOOL x23; BOOL x24; BOOL x25; int x26; } *)a0 unarchiver:(id)a1;
- (void)saveToArchive:(struct SheetArchive { void /* function */ **x0; struct InternalMetadataWithArena { void *x0; } x1; struct HasBits<1> { unsigned int x0[1]; } x2; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> > { _Atomic int x0; } x0; } x0; } x3; struct RepeatedPtrField<TSP::Reference> { struct Arena *x0; int x1; int x2; struct Rep *x3; } x4; struct RepeatedPtrField<TSP::Reference> { struct Arena *x0; int x1; int x2; struct Rep *x3; } x5; struct RepeatedPtrField<TSP::Reference> { struct Arena *x0; int x1; int x2; struct Rep *x3; } x6; struct ArenaStringPtr { struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> > *x0; } x7; struct EdgeInsetsArchive *x8; struct Reference *x9; struct Reference *x10; struct Reference *x11; struct Reference *x12; BOOL x13; BOOL x14; BOOL x15; BOOL x16; float x17; int x18; int x19; float x20; float x21; BOOL x22; BOOL x23; BOOL x24; BOOL x25; int x26; } *)a0 archiver:(id)a1;
