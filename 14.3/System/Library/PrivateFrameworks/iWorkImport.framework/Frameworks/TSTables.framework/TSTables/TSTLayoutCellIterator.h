@class TSTCell, TSTMutableCellIteratorData, TSTMasterLayout;
...
@property (readonly, retain, nonatomic) TSTMasterLayout *masterLayout;

- (void).cxx_destruct;
- (BOOL)getNextCellData:(id *)a0;
- (id)initWithMasterLayout:(id)a0 range:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a1 flags:(unsigned long long)a2 searchFlags:(unsigned long long)a3;
