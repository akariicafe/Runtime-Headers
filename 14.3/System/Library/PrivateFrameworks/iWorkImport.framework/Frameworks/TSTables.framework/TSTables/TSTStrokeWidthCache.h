@interface TSTStrokeWidthCache : NSObject {
    struct vector<TSTStrokeWidthCacheEntry, std::__1::allocator<TSTStrokeWidthCacheEntry> > { struct TSTStrokeWidthCacheEntry *__begin_; struct TSTStrokeWidthCacheEntry *__end_; struct __compressed_pair<TSTStrokeWidthCacheEntry *, std::__1::allocator<TSTStrokeWidthCacheEntry> > { struct TSTStrokeWidthCacheEntry *__value_; } __end_cap_; } _indexToCacheEntriesMap;
}
