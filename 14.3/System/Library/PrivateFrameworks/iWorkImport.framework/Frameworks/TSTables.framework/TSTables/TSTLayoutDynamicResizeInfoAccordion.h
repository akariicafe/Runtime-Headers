...
- (double)p_applyAccordionResizeFactor:(double)a0 region:(id)a1 direction:(long long)a2 totalOfCaptured:(double)a3 count:(unsigned int)a4 capturedArray:(double *)a5 currentArray:(double *)a6 minimumArray:(double *)a7;
