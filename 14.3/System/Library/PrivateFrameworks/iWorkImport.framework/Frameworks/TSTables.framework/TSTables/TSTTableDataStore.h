...
@interface TSTTableDataStore : TSPContainedObject <TSTCompatibilityVersionProviding> {
    ...
    struct vector<TSUCellRect, std::__1::allocator<TSUCellRect> > { struct TSUCellRect *__begin_; struct TSUCellRect *__end_; struct __compressed_pair<TSUCellRect *, std::__1::allocator<TSUCellRect> > { struct TSUCellRect *__value_; } __end_cap_; } _mergedRects;
...
- (id)initWithArchive:(const struct DataStore { void /* function */ **x0; struct InternalMetadataWithArena { void *x0; } x1; struct HasBits<1> { unsigned int x0[1]; } x2; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> > { _Atomic int x0; } x0; } x0; } x3; struct HeaderStorage *x4; struct Reference *x5; struct TileStorage *x6; struct Reference *x7; struct Reference *x8; struct Reference *x9; struct TableRBTree *x10; struct TableRBTree *x11; struct Reference *x12; struct Reference *x13; struct Reference *x14; struct Reference *x15; struct Reference *x16; struct Reference *x17; struct Reference *x18; struct Reference *x19; struct Reference *x20; struct Reference *x21; struct Reference *x22; unsigned int x23; unsigned int x24; unsigned int x25; } *)a0 unarchiver:(id)a1 owner:(id)a2;
...
- (void)setCell:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a1 tableUID:(const struct UUIDData<TSP::UUIDData> { union { unsigned char x0[16]; struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned char x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; unsigned char x11; unsigned char x12; unsigned char x13; unsigned char x14; unsigned char x15; } x1; struct { unsigned long long x0; unsigned long long x1; } x2; } x0; } *)a2 calculationEngine:(id)a3 conditionalStyleOwner:(id)a4 ignoreFormula:(BOOL)a5 clearImportWarnings:(BOOL)a6 doRichTextDOLC:(BOOL)a7;
...
- (void)upgradeDataStoreCellStorageIfNeededWithTableUID:(const struct UUIDData<TSP::UUIDData> { union { unsigned char x0[16]; struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned char x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; unsigned char x11; unsigned char x12; unsigned char x13; unsigned char x14; unsigned char x15; } x1; struct { unsigned long long x0; unsigned long long x1; } x2; } x0; } *)a0 conditionalStyleOwner:(id)a1;
...
- (void)saveToArchive:(struct DataStore { void /* function */ **x0; struct InternalMetadataWithArena { void *x0; } x1; struct HasBits<1> { unsigned int x0[1]; } x2; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> > { _Atomic int x0; } x0; } x0; } x3; struct HeaderStorage *x4; struct Reference *x5; struct TileStorage *x6; struct Reference *x7; struct Reference *x8; struct Reference *x9; struct TableRBTree *x10; struct TableRBTree *x11; struct Reference *x12; struct Reference *x13; struct Reference *x14; struct Reference *x15; struct Reference *x16; struct Reference *x17; struct Reference *x18; struct Reference *x19; struct Reference *x20; struct Reference *x21; struct Reference *x22; unsigned int x23; unsigned int x24; unsigned int x25; } *)a0 archiver:(id)a1 isInTheDocument:(BOOL)a2;
- (id)metadataForRowIndex:(unsigned int)a0 hidingAction:(unsigned char)a1 uuid:(struct UUIDData<TSP::UUIDData> { union { unsigned char x0[16]; struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned char x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; unsigned char x11; unsigned char x12; unsigned char x13; unsigned char x14; unsigned char x15; } x1; struct { unsigned long long x0; unsigned long long x1; } x2; } x0; })a2;
- (id)metadataForColumnIndex:(unsigned short)a0 hidingAction:(unsigned char)a1 uuid:(struct UUIDData<TSP::UUIDData> { union { unsigned char x0[16]; struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned char x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; unsigned char x11; unsigned char x12; unsigned char x13; unsigned char x14; unsigned char x15; } x1; struct { unsigned long long x0; unsigned long long x1; } x2; } x0; })a2 defaultColumnWidth:(double)a3;
...
- (void)setCell:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a1 tableUID:(const struct UUIDData<TSP::UUIDData> { union { unsigned char x0[16]; struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned char x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; unsigned char x11; unsigned char x12; unsigned char x13; unsigned char x14; unsigned char x15; } x1; struct { unsigned long long x0; unsigned long long x1; } x2; } x0; } *)a2 calculationEngine:(id)a3 conditionalStyleOwner:(id)a4 ignoreFormula:(BOOL)a5 clearImportWarnings:(BOOL)a6;
...
- (void)setCellMap:(id)a0 tableUID:(const struct UUIDData<TSP::UUIDData> { union { unsigned char x0[16]; struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned char x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; unsigned char x11; unsigned char x12; unsigned char x13; unsigned char x14; unsigned char x15; } x1; struct { unsigned long long x0; unsigned long long x1; } x2; } x0; } *)a1 calculationEngine:(id)a2 conditionalStyleOwner:(id)a3 ignoreFormulas:(BOOL)a4 skipDirtyingNonFormulaCells:(BOOL)a5 doRichTextDOLC:(BOOL)a6;
...
- (int)valueTypeAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a0;
...
- (struct vector<TSUCellRect, std::__1::allocator<TSUCellRect> > { struct TSUCellRect *x0; struct TSUCellRect *x1; struct __compressed_pair<TSUCellRect *, std::__1::allocator<TSUCellRect> > { struct TSUCellRect *x0; } x2; })mergedRects;
- (BOOL)containsImportWarnings;
- (BOOL)containsControlCellSpecs;
- (struct vector<TSTCell *, std::__1::allocator<TSTCell *> > { id *x0; id *x1; struct __compressed_pair<TSTCell *__strong *, std::__1::allocator<TSTCell *> > { id *x0; } x2; })accumulateCurrentCellsConcurrentlyInRow:(struct TSUModelRowIndex { unsigned int x0; })a0 rowInfo:(id)a1 atColumns:(struct vector<TSUModelColumnIndex, std::__1::allocator<TSUModelColumnIndex> > { struct TSUModelColumnIndex *x0; struct TSUModelColumnIndex *x1; struct __compressed_pair<TSUModelColumnIndex *, std::__1::allocator<TSUModelColumnIndex> > { struct TSUModelColumnIndex *x0; } x2; } *)a2 usingCellCreationBlock:(id /* block */)a3;
- (void)updateDataListsConcurrentlyWithConcurrentCellMap:(id)a0 clearImportWarnings:(BOOL)a1;
- (void)setCellsConcurrently:(id)a0 tableUID:(const struct UUIDData<TSP::UUIDData> { union { unsigned char x0[16]; struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned char x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; unsigned char x11; unsigned char x12; unsigned char x13; unsigned char x14; unsigned char x15; } x1; struct { unsigned long long x0; unsigned long long x1; } x2; } x0; } *)a1 calculationEngine:(id)a2 conditionalStyleOwner:(id)a3 ignoreFormula:(BOOL)a4 clearImportWarnings:(BOOL)a5;
...
- (void)_setCell:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a1 tableUID:(const struct UUIDData<TSP::UUIDData> { union { unsigned char x0[16]; struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned char x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; unsigned char x11; unsigned char x12; unsigned char x13; unsigned char x14; unsigned char x15; } x1; struct { unsigned long long x0; unsigned long long x1; } x2; } x0; } *)a2 calculationEngine:(id)a3 conditionalStyleOwner:(id)a4 ignoreFormula:(BOOL)a5 clearImportWarnings:(BOOL)a6 richTextDOLCHint:(BOOL *)a7;
