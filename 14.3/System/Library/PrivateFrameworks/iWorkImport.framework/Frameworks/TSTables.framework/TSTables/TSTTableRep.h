@class TSDTilingLayer, TSTLayout, NSObject, TSTCellRegionGatherer, TSTAnimation, NSMutableArray, TSTMasterLayout, CALayer, TSTCellSelection, NSString, NSSet, TSTSelectionDragController, CAShapeLayer, TSTTableReferences, TSTTableInfo;
...
@property (retain, nonatomic) TSDTilingLayer *overlayTableName;
@property (retain, nonatomic) TSDTilingLayer *overlayFrozenHeaderCorner;
@property (retain, nonatomic) TSDTilingLayer *overlayFrozenHeaderRows;
@property (retain, nonatomic) TSDTilingLayer *overlayFrozenHeaderColumns;
@property (retain, nonatomic) CALayer *overlayFrozenHeaderRowsMask;
@property (retain, nonatomic) CALayer *overlayFrozenHeaderColumnsMask;
@property (retain, nonatomic) CALayer *overlayFrozenHeaderTableBodyMask;
@property (retain, nonatomic) CALayer *overlayFrozenHeaderTableNameMask;
