...
@interface TSCH3DContext : NSObject <NSCopying> {
    struct FramebufferAttributes { int type; long long samples; int colorDataType; int colorFormat; int depthDataType; BOOL linearFilter; BOOL discardHint; BOOL useIOSurfaceBacking; } mCurrentFramebufferAttributes;
}
