...
- (BOOL)applyEffectsForProperties:(id)a0 series:(id)a1 index:(const struct tvec2<int> { union { int x0; int x1; int x2; } x0; union { int x0; int x1; int x2; } x1; } *)a2 pipeline:(id)a3 injectEffectsUsingBlock:(id /* block */)a4;
...
- (id)geometryForSeries:(id)a0 index:(const struct tvec2<int> { union { int x0; int x1; int x2; } x0; union { int x0; int x1; int x2; } x1; } *)a1 scene:(id)a2;
...
- (struct tvec2<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; })labelOffset:(unsigned int)a0 labelSize:(const struct tvec2<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; } *)a1 textureSize:(const struct tvec2<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; } *)a2 dataSpaceValue:(float)a3;
