...
- (struct { struct CGPoint { double x0; double x1; } x0; BOOL x1; } *)p_centerPointsForSeries:(id)a0 groupIndexSet:(id)a1 xAxis:(id)a2 yAxis:(id)a3 nullsUseIntercept:(BOOL)a4 plotAreaFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5;
- (void)p_addCurvedTopStroke:(struct { id x0; id x1; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x2; id x3; id x4; } *)a0 toPath:(struct CGPath { } *)a1 withPointsArray:(struct { struct CGPoint { double x0; double x1; } x0; double x1; BOOL x2; unsigned long long x3; } *)a2 withCount:(unsigned long long)a3;
- (double)p_bubbleMaxForSeries:(id)a0 inChartBodyLayoutSize:(struct CGSize { double x0; double x1; })a1;
- (struct { struct CGPoint { double x0; double x1; } x0; BOOL x1; } *)p_centerPointsForSeries:(id)a0 groupIndexSet:(id)a1 xAxis:(id)a2 yAxis:(id)a3 plotAreaFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4;
