@class TSCHChartStyle, NSArray, NSUUID, NSString, TSCHReferenceLineStyle, TSCHLegendStyle;
...
- (id)initWithContext:(id)a0 chartStyle:(id)a1 legendStyle:(id)a2 valueAxisStyles:(id)a3 categoryAxisStyles:(id)a4 seriesStyles:(id)a5;
- (BOOL)isEquivalentToPreset:(id)a0;
