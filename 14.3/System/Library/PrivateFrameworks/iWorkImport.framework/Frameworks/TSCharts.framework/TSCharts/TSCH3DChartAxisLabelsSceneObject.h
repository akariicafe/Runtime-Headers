...
- (unsigned int)alignmentForPositioner:(id)a0 scene:(id)a1 enumerator:(id)a2 returningDirection:(struct tvec3<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; union { float x0; float x1; float x2; } x2; } *)a3;
...
- (void)p_renderLabels:(id)a0 labelType:(int)a1 part:(id)a2 positioner:(id)a3 offset:(const struct tvec3<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; union { float x0; float x1; float x2; } x2; } *)a4 offset2DBlock:(id /* block */)a5 strideBlock:(id /* block */)a6 skipFirst:(BOOL)a7 showLast:(BOOL)a8;
...
- (void)p_setOffset:(const struct tvec3<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; union { float x0; float x1; float x2; } x2; } *)a0 forLabelType:(int)a1 pipeline:(id)a2 part:(id)a3 positioner:(id)a4;
