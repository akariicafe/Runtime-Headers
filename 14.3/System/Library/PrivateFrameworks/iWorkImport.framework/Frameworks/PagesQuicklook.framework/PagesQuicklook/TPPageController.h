@class TPFootnoteLayoutController, TSUMutablePointerSet, TPTextFlowLayoutController, TPTextWrapController, NSMutableArray, TSWPLayoutManager, NSString, TPPageControllerCanvasDelegate, _TtC14PagesQuicklook17TPPageLayoutCache, NSArray, TPDocumentRoot, _TtC14PagesQuicklook17TPPaginationState, TSWPLayoutMetricsCache;
@protocol TPPageControllerObserver, TPPageControllerDelegate;
...
@property (weak, nonatomic) TPDocumentRoot *documentRoot;
@property (readonly, weak, nonatomic) id<TPPageControllerDelegate> delegate;
@property (weak, nonatomic) id<TPPageControllerObserver> observer;
@property (readonly, nonatomic) TSWPLayoutManager *bodyLayoutManager;
@property (nonatomic, getter=textLayoutMustIncludeAdornments) BOOL textLayoutMustIncludeAdornments;
...
- (id)i_topicHintsPriorToPageIndex:(unsigned long long)a0;
- (id)i_columnAfterPageIndex:(unsigned long long)a0;
- (id)i_topicHintsAfterPageIndex:(unsigned long long)a0;
...
- (id)masterDrawableProviderForPageIndex:(unsigned long long)a0;
...
- (void)p_notifyObserversWillLayoutWhileSyncing:(BOOL)a0;
