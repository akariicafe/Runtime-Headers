@class NSString, TPPageController, NSMapTable, NSObject;
...
- (id)previousTargetTopicNumbersForTarget:(id)a0;
- (void)deflatePage:(id)a0 intoHints:(inout id)a1 topicNumbers:(inout id)a2;
