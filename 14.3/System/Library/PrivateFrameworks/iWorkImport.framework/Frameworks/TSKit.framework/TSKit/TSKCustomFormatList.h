...
+ (void)archiveKeys:(id)a0 message:(struct RepeatedPtrField<TSP::UUID> { struct Arena *x0; int x1; int x2; struct Rep *x3; } *)a1;
+ (id)unarchiveKeys:(const struct RepeatedPtrField<TSP::UUID> { struct Arena *x0; int x1; int x2; struct Rep *x3; } *)a0;
