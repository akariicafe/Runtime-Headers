...
+ (id)mapWithAttachment:(id)a0 layout:(id)a1 pageNumber:(unsigned long long)a2 pageCount:(unsigned long long)a3 footnoteMarkProvider:(id)a4 styleProvider:(id)a5 colorOverride:(id)a6 textScalePercent:(unsigned long long)a7;
