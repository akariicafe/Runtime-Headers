@class NSString, TSWPMutableDirtyRangeArray, TSWPStorage, TSWPMutableTopicNumberHints, TSWPCTTypesetterCache;
...
@property (copy, nonatomic) TSWPMutableTopicNumberHints *initialTopicNumberHints;
...
- (void *)layoutStateForLayoutWithHint:(id)a0 firstTarget:(id)a1 topicNumbers:(id)a2;
- (void *)layoutStateForLayoutAfterHint:(id)a0 firstTarget:(id)a1 childHint:(id)a2 topicNumbers:(id)a3;
...
- (void)deflateTarget:(id)a0 intoHints:(inout id)a1 childHints:(inout id)a2 anchoredDrawablePositions:(id *)a3 startingPartitionedAttachments:(out id *)a4 topicNumbers:(out id *)a5 layoutState:(void *)a6;
- (void)inflateTarget:(id)a0 fromHints:(id)a1 childHint:(id)a2 anchoredDrawablePositions:(id)a3 topicNumbers:(id)a4 footnoteLayoutRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a5;
