...
- (id)initWithType:(int)a0 imageProvider:(id)a1 size:(struct CGSize { double x0; double x1; })a2 baselineOffset:(double)a3;
- (id)initWithType:(int)a0 labelString:(id)a1 textLine:(struct __CTLine { } *)a2 listNumber:(unsigned long long)a3 isTateChuYoko:(BOOL)a4 baselineOffset:(double)a5;
