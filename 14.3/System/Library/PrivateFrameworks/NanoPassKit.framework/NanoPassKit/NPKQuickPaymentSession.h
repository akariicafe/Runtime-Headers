...
- (BOOL)_sessionQueue_authorizeWithDeferredAuthorization:(BOOL)a0 useCredential:(BOOL)a1;
...
- (void)_internalQueue_updateContactlessSessionForPass:(id)a0 vasPasses:(id)a1;
