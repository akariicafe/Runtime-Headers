...
- (BOOL)supportsInAppPaymentOnNetworks:(id)a0 capabilities:(unsigned long long)a1 issuerCountryCodes:(id)a2 paymentApplicationStates:(id)a3;
- (void)encodeObject:(id)a0 asDataInCoder:(id)a1 withKey:(id)a2;
- (BOOL)supportsInAppPaymentOnNetworks:(id)a0 issuerCountryCodes:(id)a1;
