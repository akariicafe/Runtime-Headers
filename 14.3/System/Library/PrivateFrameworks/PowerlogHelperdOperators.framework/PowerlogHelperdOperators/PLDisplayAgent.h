@class NSMutableDictionary, PLXPCListenerOperatorComposition, PLEntryNotificationOperatorComposition, NSDate, NSDictionary, PLEventForwardDisplayEntry, PLIOKitOperatorComposition, PLDisplayIOReportStats, CBAdaptationClient, NSMutableArray, BrightnessSystemClient, PLEntry, NSString, KeyboardBrightnessClient, PLMonotonicTimer, PLTimer;
