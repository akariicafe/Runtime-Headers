...
- (void).cxx_destruct;
- (id)initWithIdentifier:(id)a0 adType:(long long)a1 desiredPosition:(long long)a2 privacyMarkerPosition:(long long)a3 adSize:(struct CGSize { double x0; double x1; })a4 tapAction:(id)a5 adTag:(id)a6 outstreamVideoInfo:(id)a7;
