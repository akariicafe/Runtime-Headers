...
- (void).cxx_destruct;
- (id)initWithIdentifier:(id)a0 adType:(long long)a1 desiredPosition:(long long)a2 privacyMarkerPosition:(long long)a3 articleID:(id)a4 articleTitle:(id)a5 adSponsor:(id)a6 campaignData:(id)a7 adSize:(struct CGSize { double x0; double x1; })a8;
