@class NSDate, NSString, NSArray, NSURL, NSSet, PXSectionedSelectionManager, PXRecipient, PXPhotosGlobalFooterViewModel;
...
@property (readonly, nonatomic) PXPhotosGlobalFooterViewModel *footerViewModel;
