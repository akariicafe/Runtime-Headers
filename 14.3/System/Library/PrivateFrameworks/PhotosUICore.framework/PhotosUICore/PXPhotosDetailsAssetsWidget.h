@class PXPhotoKitAssetsDataSourceManager, PXBasicUIViewTileAnimator, PXPhotosDetailsLoadCoordinationToken, PXAssetReference, NSString, PXPhotosDetailsInlinePlaybackController, NSMutableSet, PXUITapGestureRecognizer, PXPhotosDetailsAssetsSpecManager, PXPhotosDetailsContext, PXPhotoKitUIMediaProvider, PXTouchingUIGestureRecognizer, PXUIAssetsScene, PXOneUpPresentation, PXPhotosDataSource, PXSwipeSelectionManager, NSObject, NSSet, PXTilingController, UIPinchGestureRecognizer, PXPhotosDataSourceStressTest, PXLayoutGenerator, PXSectionedSelectionManager, PXWidgetSpec, PXSectionedLayoutEngine, NSDate;
@protocol PXWidgetEditingDelegate, PXWidgetDelegate, UIDragSession, PXPhotosDetailsAssetsWidgetEventTracker, PXWidgetUnlockDelegate, PXAnonymousView;
...
- (double)engineDrivenLayout:(id)a0 zPositionForItemAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
...
- (void)_handleTapOnAssetReference:(id)a0 autoPlayVideo:(BOOL)a1;
