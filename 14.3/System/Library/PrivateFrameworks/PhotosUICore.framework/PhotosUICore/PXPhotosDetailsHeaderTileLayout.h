...
@interface PXPhotosDetailsHeaderTileLayout : PXTilingLayout {
    struct { BOOL contentsRectForAspectRatio; BOOL titleFontName; } _delegateRespondsTo;
}
...
@property (readonly, nonatomic) struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } slideshowRect;
