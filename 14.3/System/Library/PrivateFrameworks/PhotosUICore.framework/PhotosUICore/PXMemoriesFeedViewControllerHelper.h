...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })memoriesFeedTilingLayout:(id)a0 contentsRectForItemAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1 forAspectRatio:(double)a2;
- (id)memoryInfoAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a0;
- (void).cxx_destruct;
- (id)memoriesFeedTilingLayout:(id)a0 titleFontNameForItemAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
...
- (struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })indexPathForMemoryInScrollViewAtPoint:(struct CGPoint { double x0; double x1; })a0;
- (struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })indexPathForMemoryObjectReference:(id)a0;
