...
- (void)_initTimelineEntriesAtDate:(id)a0;
- (id)_scheduledTimelineEntriesWithOptions:(id)a0 atDate:(id)a1;
- (id)_findBestContentAndRemoveFromSourceAtDate:(id)a0;
...
- (long long)_startOfDayIndexWithOffsetDay:(long long)a0 entriesCount:(long long)a1 perDayLimit:(long long)a2;
