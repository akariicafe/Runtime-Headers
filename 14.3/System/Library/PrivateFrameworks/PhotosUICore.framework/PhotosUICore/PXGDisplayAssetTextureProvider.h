@class PXMediaProvider, NSString, CIContext, PXGAssetImageCache, NSArray, NSMutableDictionary, PXGImageRequestQueue, NSObject, PXGThumbnailRequestQueue, NSMapTable, NSMutableIndexSet;
...
- (void)_workQueue_provideCGImage:(struct CGImage { } *)a0 orientation:(unsigned int)a1 forRequestID:(int)a2;
...
- (void).cxx_destruct;
- (void)_workQueue_handleCGImageResult:(struct CGImage { } *)a0 orientation:(unsigned int)a1 info:(id)a2 shouldCache:(BOOL)a3 textureRequestID:(int)a4;
- (BOOL)_hasDeliveredThumbnailForTextureRequestID:(int)a0;
- (void)_workQueue_processDeferredImageRequests;
- (void)dealloc;
- (void)_handlePixelBufferChangedForVideoSession:(id)a0;
- (void)_workQueue_processImageRequestsWithAllowedIDs:(id)a0;
- (void)_workQueue_startRequestingVideoTexturesForDisplayAsset:(id)a0 pixelBufferSource:(id)a1 textureRequestID:(int)a2;
- (void)releaseCachedResources;
- (void)_workQueue_provideVideoFrameForVideoSession:(id)a0;
- (id)_requestOptionsForUseCase:(unsigned long long)a0 forDrawing:(BOOL)a1;
...
- (void)_workQueue_requestVideoTexturesForSpriteAtIndex:(unsigned int)a0 spriteReference:(id)a1 displayAsset:(id)a2 textureRequestID:(int)a3;
