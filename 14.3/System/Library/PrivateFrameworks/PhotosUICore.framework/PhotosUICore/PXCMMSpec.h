...
@property (readonly, nonatomic) double composeTableViewCellHeight;
@property (readonly, nonatomic) double composeTableViewCellInset;
@property (readonly, nonatomic) struct CGSize { double width; double height; } composeTableViewCellImageViewSize;
