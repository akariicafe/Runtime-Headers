@class PXPhotosDetailsContext, NSString, PXWidgetSpec, PXTilingController, PXSectionedSelectionManager, NSObject, PXPeopleStripCollectionViewController, PXSharingSuggestionDataSource;
