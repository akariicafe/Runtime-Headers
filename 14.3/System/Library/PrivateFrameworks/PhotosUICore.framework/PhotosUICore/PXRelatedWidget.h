@class PXRelatedSpecManager, NSDictionary, PXRelatedTilingLayout, NSObject, PXSectionedObjectReference, PXTilingController, NSString, PXWidgetSpec, PXPhotosDetailsContext, PXRelatedDataSourceManager, PXRelatedDataSource, PXBasicTileAnimator, PXSectionedSelectionManager;
...
@property (nonatomic, setter=_setAnchorIndexPath:) struct PXSimpleIndexPath { unsigned long long dataSourceIdentifier; long long section; long long item; long long subitem; } _anchorIndexPath;
...
- (BOOL)relatedTilingLayout:(id)a0 isPlaceholderEntryAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
- (id)relatedTilingLayout:(id)a0 titleFontNameForEntryAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
- (id)relatedEntryForTileIdentifier:(struct PXTileIdentifier { unsigned long long x0; unsigned long long x1[10]; })a0 layout:(id)a1;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })relatedTilingLayout:(id)a0 contentsRectForItemAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1 forAspectRatio:(double)a2;
