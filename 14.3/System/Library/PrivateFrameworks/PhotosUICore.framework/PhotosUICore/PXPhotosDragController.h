@class UIView, NSString, PXUpdater, NSSet, PXSectionedSelectionManager, PXAssetReference, NSMutableSet, UIViewController, _UIDragSnappingFeedbackGenerator, PXAssetCollectionActionManager;
