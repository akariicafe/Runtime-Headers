...
@property (nonatomic) struct PXSimpleIndexPath { unsigned long long dataSourceIdentifier; long long section; long long item; long long subitem; } highlightedMemoryIndexPath;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_contentsRectForItemAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a0 forAspectRatio:(double)a1;
- (id)init;
- (void).cxx_destruct;
- (void)setReferenceSize:(struct CGSize { double x0; double x1; })a0;
- (id)initWithSpec:(id)a0 layoutSnapshot:(id)a1;
- (struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })indexPathForMemoryAtPoint:(struct CGPoint { double x0; double x1; })a0;
...
- (struct PXTileIdentifier { unsigned long long x0; unsigned long long x1[10]; })tileIdentifierAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a0 withTileKind:(long long)a1;
...
- (id)_titleFontNameForMemoryAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a0;
