...
- (id)memoriesTileSource:(id)a0 memoryToPreheatForIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
- (void)invalidateLayoutEngine;
- (void)_updateLayoutEngineIfNeeded;
- (id)_createNewLayout;
- (struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })_indexPathForMemoryAtPoint:(struct CGPoint { double x0; double x1; })a0;
- (struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })_indexPathForMemoryInScrollViewAtPoint:(struct CGPoint { double x0; double x1; })a0;
- (void)_presentMemoryAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a0;
- (void)_handleTouch:(id)a0;
- (void)_reconfigureTargetLayout;
- (id)_memoryTileViewForLocation:(struct CGPoint { double x0; double x1; })a0;
- (id)_previewActionMenusForIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a0;
- (id)_photosDetailsContextForIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a0;
- (void)pushViewController:(id)a0 animated:(BOOL)a1;
- (id)_memoryObjectReferenceForPhotosDetailsContext:(id)a0;
- (struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })_memoryIndexPathForViewController:(id)a0;
