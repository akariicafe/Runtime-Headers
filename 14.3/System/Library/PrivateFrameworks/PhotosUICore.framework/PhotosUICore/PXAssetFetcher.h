...
- (id)fetchAssetsInAssetCollection:(id)a0 withFilterPredicate:(id)a1 inclusionPredicate:(id)a2 fetchLimit:(unsigned long long)a3 sortDescriptors:(id)a4 reverseSortOrder:(BOOL)a5 hideHiddenAssets:(BOOL)a6 fetchPropertySets:(id)a7;
...
- (id)existingFetchResultForAssetCollection:(id)a0 withFilterPredicate:(id)a1 inclusionPredicate:(id)a2 fetchLimit:(unsigned long long)a3 sortDescriptors:(id)a4 reverseSortOrder:(BOOL)a5 hideHiddenAssets:(BOOL)a6 fetchPropertySets:(id)a7;
...
- (id)_fetchConfigurationWithFilterPredicate:(id)a0 inclusionPredicate:(id)a1 fetchLimit:(unsigned long long)a2 sortDescriptors:(id)a3 reverseSortOrder:(BOOL)a4 hideHiddenAssets:(BOOL)a5 fetchPropertySets:(id)a6;
