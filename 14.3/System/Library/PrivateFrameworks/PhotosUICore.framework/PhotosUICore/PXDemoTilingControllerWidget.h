@class PXPhotoKitUIMediaProvider, NSString, PXTilingController, PXAssetsDataSourceManager, PXUIAssetsScene, PXPhotosDetailsContext, PXWidgetSpec, PXSectionedSelectionManager, NSMutableSet, NSObject, PXBasicUIViewTileAnimator;
