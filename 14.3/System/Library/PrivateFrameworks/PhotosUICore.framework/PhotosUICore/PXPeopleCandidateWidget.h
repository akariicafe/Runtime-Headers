@class UIView, NSString, PXPhotosDetailsContext, PHPerson, PXWidgetSpec, PXOneUpPresentation, UIButton, PXPeopleSuggestionDataSource, PXTilingController, NSLayoutConstraint, PXSectionedSelectionManager, UILabel;
@protocol PXWidgetDelegate, PXWidgetUnlockDelegate, PXWidgetEditingDelegate;
