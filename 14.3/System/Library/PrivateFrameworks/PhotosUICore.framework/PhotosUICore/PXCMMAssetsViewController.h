@class PXCMMSpecManager, PXAssetReference, PXCMMProgressBannerView, NSString, UILongPressGestureRecognizer, NSMutableSet, PXUITapGestureRecognizer, PXCMMSendBackBannerView, NSArray, PXOneUpPresentation, PXUIAssetsScene, PXCMMFooterViewModel, PXCMMStatusController, PXContextualNotification, PXSwipeSelectionManager, NSSet, PXUpdater, PXCMMSpec, PXTilingController, PXCMMSendBackSuggestionSource, PXLayoutGenerator, PXUIScrollViewController, PXSectionedLayoutEngine, PXBasicTileAnimator, PXMomentShareStatusPresentation, PXPhotosGlobalFooterView, PXCMMBannerTileController;
...
- (BOOL)swipeSelectionManager:(id)a0 shouldSelectItemAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
...
- (void)didPerformDeletionActionForFooterViewModel:(id)a0;
- (long long)engineDrivenLayout:(id)a0 assetStatusAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
- (id)oneUpPresentationHelperScrollView:(id)a0;
- (BOOL)engineDrivenLayout:(id)a0 shouldShowDimmingOverlayAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
- (BOOL)engineDrivenLayout:(id)a0 shouldShowStatusBadgeAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
...
- (void)_toggleAssetSelectionAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a0;
- (struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })_assetIndexPathAtLocation:(struct CGPoint { double x0; double x1; })a0 padding:(struct UIEdgeInsets { double x0; double x1; double x2; double x3; })a1 kind:(unsigned long long)a2;
- (long long)_assetImportStateAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a0 withDataSource:(id)a1;
- (BOOL)_isAssetAlreadyImportedAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a0;
- (BOOL)_isAssetAlreadyImportedAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a0 withEngineDrivenLayout:(id)a1;
...
- (double)engineDrivenLayout:(id)a0 aspectRatioForItemAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })engineDrivenLayout:(id)a0 contentsRectForItemAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1 forAspectRatio:(double)a2;
