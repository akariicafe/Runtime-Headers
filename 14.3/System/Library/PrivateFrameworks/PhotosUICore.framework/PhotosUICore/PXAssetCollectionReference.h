...
- (void).cxx_destruct;
- (id)initWithAssetCollection:(id)a0 keyAssetReference:(id)a1 indexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a2;
