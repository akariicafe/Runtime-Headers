...
@property (retain, nonatomic) NSString *localizedQueryString;
...
- (void)requestImageForPersonUUID:(id)a0 photoLibrary:(id)a1 imageRequestSize:(struct CGSize { double x0; double x1; })a2 resultHandler:(id /* block */)a3;
...
- (void)setSearchResults:(id)a0 searchAssetResults:(id)a1 curatedAssetsFetchResult:(id)a2 reloadItemIdentifiers:(id)a3 localizedQueryString:(id)a4;
