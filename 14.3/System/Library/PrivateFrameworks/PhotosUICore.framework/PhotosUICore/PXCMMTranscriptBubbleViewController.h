@class NSError, PXMomentShareStatusPresentation, NSString, NSURL, PXCMMTranscriptBubbleStatusView, PXCMMSpecManager, PHPhotoLibrary, PXCMMPreviewAsset, PXCMMPreviewUIImageProvider, PHFetchResult, PHMomentShare, PXCMMTranscriptBubbleView;
