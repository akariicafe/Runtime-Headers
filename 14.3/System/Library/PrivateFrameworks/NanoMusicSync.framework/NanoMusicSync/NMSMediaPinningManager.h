@class NSString, NSArray, NSOrderedSet, NMSMediaQuotaManager, NMSMediaSyncInfo, NMSMediaDownloadInfo, NMSyncDefaults, NSObject, NSNumber, NMSPodcastSizeCache;
...
- (BOOL)_isAppDormantForBundleIdentifier:(id)a0;
