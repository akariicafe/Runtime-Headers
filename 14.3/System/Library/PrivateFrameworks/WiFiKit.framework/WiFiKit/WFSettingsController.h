@class WFNetworkScanRecord, WFNetworkSettingsConfig, WFMutableNetworkProfile, WFNetworkSettingsViewController, NSString, NSOperationQueue, WFDetailsContext, WFIPMonitor;
...
@property (nonatomic, getter=isRunningInSetup) BOOL runningInSetup;
...
- (id)initWithDetailsContext:(id)a0 runningInSetup:(BOOL)a1;
