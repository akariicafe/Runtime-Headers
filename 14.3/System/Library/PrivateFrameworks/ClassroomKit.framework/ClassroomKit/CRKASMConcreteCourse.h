...
+ (id)trustedUsersFromPersons:(id)a0 certificateVendor:(id)a1;
+ (id)courseNameforClass:(id)a0;
+ (id)usersFromPersons:(id)a0;
...
- (id)description;
- (BOOL)isEqual:(id)a0;
- (id)initWithBackingClass:(id)a0 location:(id)a1 persons:(id)a2 trustedPersons:(id)a3 identityVendor:(id)a4 certificateVendor:(id)a5 manageableLocationIDs:(id)a6;
