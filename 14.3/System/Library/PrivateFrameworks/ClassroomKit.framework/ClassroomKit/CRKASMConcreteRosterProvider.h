@class NSString, NSArray, CRKASMRosterUpdater, CRKASMRosterProviderConfiguration, CRKASMCertificateIngestor, CRKClassKitChangeNotifier, CRKASMWorldBuildOperation;
