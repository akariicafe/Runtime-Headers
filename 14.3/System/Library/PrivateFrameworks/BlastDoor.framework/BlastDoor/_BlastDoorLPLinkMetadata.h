@class NSURL, _BlastDoorLPVideoMetadata, _BlastDoorLPAudioMetadata, NSItemProvider, _BlastDoorLPAudio, _BlastDoorLPSpecializationMetadata, NSString, _BlastDoorLPAssociatedApplicationMetadata, _BlastDoorLPImageMetadata, _BlastDoorLPImage, NSArray, _BlastDoorLPVideo, _BlastDoorLPIconMetadata;
