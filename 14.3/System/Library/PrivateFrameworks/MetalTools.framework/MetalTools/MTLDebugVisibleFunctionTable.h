...
- (id)initWithVisibleFunctionTable:(id)a0 parent:(id)a1 descriptor:(id)a2;
- (id)initWithVisibleFunctionTable:(id)a0 parent:(id)a1 descriptor:(id)a2 pipelineState:(id)a3;
