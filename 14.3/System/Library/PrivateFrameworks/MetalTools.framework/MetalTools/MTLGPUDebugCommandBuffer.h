...
@interface MTLGPUDebugCommandBuffer : MTLToolsCommandBuffer <MTLGPUDebugBufferEncoder> {
    ...
    struct vector<MetalBuffer, std::__1::allocator<MetalBuffer> > { struct MetalBuffer *__begin_; struct MetalBuffer *__end_; struct __compressed_pair<MetalBuffer *, std::__1::allocator<MetalBuffer> > { struct MetalBuffer *__value_; } __end_cap_; } _usedBuffers;
    ...
    struct vector<id<MTLBuffer>, std::__1::allocator<id<MTLBuffer> > > { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<id<MTLBuffer> *, std::__1::allocator<id<MTLBuffer> > > { id *__value_; } x1; } _reportBufferList;
    struct vector<ReportBufferEntry, std::__1::allocator<ReportBufferEntry> > { struct ReportBufferEntry *__begin_; struct ReportBufferEntry *__end_; struct __compressed_pair<ReportBufferEntry *, std::__1::allocator<ReportBufferEntry> > { struct ReportBufferEntry *__value_; } __end_cap_; } _reportEntryList;
    struct vector<NSString *, std::__1::allocator<NSString *> > { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<NSString **, std::__1::allocator<NSString *> > { id *__value_; } x1; } _encoderLabels;
