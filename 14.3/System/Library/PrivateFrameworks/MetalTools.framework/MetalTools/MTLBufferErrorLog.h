@class NSArray, MTLArgument, NSString;
...
- (void)dealloc;
- (id)initWithType:(unsigned long long)a0 function:(id)a1 encoderLabel:(id)a2 addressSpace:(unsigned long long)a3 buffer:(id)a4 offset:(unsigned long long)a5 operation:(unsigned long long)a6 stackTrace:(id)a7 argument:(id)a8;
