...
- (id)initWithVariant:(long long)a0 macAddr:(unsigned long long)a1 machAbsTime_sec:(double)a2 machContTimeValid:(BOOL)a3 machContTime_sec:(double)a4 range_m:(double)a5 rangeUnc_m:(double)a6 azValid:(BOOL)a7 elValid:(BOOL)a8 az_deg:(double)a9 el_deg:(double)a10 azUnc_deg:(double)a11 elUnc_deg:(double)a12 fovConfidence:(double)a13 soiRssiValid:(BOOL)a14 soiRssi_dBm:(double)a15 antennaType:(long long)a16;
