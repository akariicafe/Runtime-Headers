...
- (id)qlExtensionForContentType:(id)a0 allowExtensionsForParentTypes:(BOOL)a1 applicationBundleIdentifier:(id)a2 extensionPath:(id)a3 extensionType:(unsigned long long)a4 generationType:(unsigned long long)a5;
- (void)_setupCache;
- (id)extensionForContentType:(id)a0 allowExtensionsForParentTypes:(BOOL)a1 firstPartyExtension:(BOOL)a2 applicationBundleIdentifier:(id)a3 extensionPath:(id)a4 extensionType:(unsigned long long)a5 generationType:(unsigned long long)a6;
...
- (id)_cachesForExtensionType:(unsigned long long)a0;
- (id)qlExtensionForContentType:(id)a0 allowExtensionsForParentTypes:(BOOL)a1 firstPartyExtension:(BOOL)a2 applicationBundleIdentifier:(id)a3 extensionPath:(id)a4 extensionType:(unsigned long long)a5 generationType:(unsigned long long)a6;
