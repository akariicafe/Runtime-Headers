...
- (void).cxx_destruct;
- (id)initWithSessionIdentifier:(id)a0 workoutConfiguration:(id)a1 client:(id)a2 processBundleIdentifier:(id)a3 applicationIdentifier:(id)a4 requiresCoreLocationAssertion:(BOOL)a5 supportsAppRelaunchForRecovery:(BOOL)a6;
