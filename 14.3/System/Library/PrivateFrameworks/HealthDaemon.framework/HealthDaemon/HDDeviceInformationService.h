...
- (id)_propertyValueForPropertyName:(id)a0;
- (void)_queue_setDeviceInformationHasBeenLoaded;
- (void)_queue_readProperty:(id)a0;
- (void)_queue_peripheral:(id)a0 didDiscoverCharacteristic:(id)a1;
- (void)_queue_peripheral:(id)a0 didUpdateValueForCharacteristic:(id)a1 error:(id)a2;
- (id)_propertyValueForCharacteristic:(id)a0;
