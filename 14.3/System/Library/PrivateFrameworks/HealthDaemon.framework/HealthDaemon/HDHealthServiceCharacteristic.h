...
+ (BOOL)_bufferHasSpace:(const char **)a0 beforeByte:(const char *)a1 count:(unsigned long long)a2 resetOnFailure:(BOOL)a3;
+ (BOOL)_copyUnsignedInt:(unsigned int *)a0 fromData:(const char **)a1 byteCount:(unsigned long long)a2 beforeByte:(const char *)a3;
+ (BOOL)_copySignedInt:(int *)a0 fromData:(const char **)a1 byteCount:(unsigned long long)a2 beforeByte:(const char *)a3;
