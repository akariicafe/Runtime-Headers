...
- (void)_queue_runPendingCheckpointTasks:(id)a0 completion:(id /* block */)a1;
- (void)_queue_reportResult:(long long)a0;
- (void)_queue_completeCurrentTaskWithResult:(long long)a0 error:(id)a1;
