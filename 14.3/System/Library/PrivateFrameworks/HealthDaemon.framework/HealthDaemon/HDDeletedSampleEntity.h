...
+ (id)databaseTable;
+ (id)_externalSyncMetadataForRow:(struct HDSQLiteRow { } *)a0;
...
+ (BOOL)enumerateDeletedSamplesWithType:(id)a0 profile:(id)a1 restrictedSourceEntities:(id)a2 limit:(unsigned long long)a3 anchor:(long long)a4 error:(id *)a5 handler:(id /* block */)a6;
