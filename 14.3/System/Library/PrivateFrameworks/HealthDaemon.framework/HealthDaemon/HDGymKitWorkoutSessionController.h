@class NSUUID, HDProfile, HDDefaultWorkoutSessionController, NSObject;
...
- (void)_setupRecoveryState:(id)a0;
- (void)_queue_sessionPrepared;
- (void)_queue_sessionFinished;
- (void)_queue_reconnectFitnessMachineFromRecoveryState:(id)a0;
- (void)_queue_storeSessionRecoveryConfiguration:(id)a0;
