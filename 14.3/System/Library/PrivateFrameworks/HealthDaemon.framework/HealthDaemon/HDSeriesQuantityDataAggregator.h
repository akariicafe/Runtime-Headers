...
+ (void)_checkForOverlapWithSeries:(id)a0 lastDatum:(id)a1 provenance:(id)a2 profile:(id)a3;
+ (id)_anySampleThatOverlapsWithSeries:(id)a0 lastDatum:(id)a1 provenance:(id)a2 profile:(id)a3 error:(id *)a4;

- (id)_startSeriesWithDatum:(id)a0 device:(id)a1;
- (id)_validatedState:(id)a0;
...
- (void).cxx_destruct;
- (id)_codableDatumsFromData:(id)a0;
- (BOOL)_successForPersistenceError:(id)a0 series:(id)a1 error:(id *)a2;
- (void)_failSeriesWithUUID:(id)a0;
- (BOOL)_hasFailedSeriesWithUUID:(id)a0;
