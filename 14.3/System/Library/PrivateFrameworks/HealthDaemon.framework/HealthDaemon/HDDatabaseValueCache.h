...
- (id)_storageForTransaction:(id)a0 createIfNecessary:(BOOL)a1;
- (id)init;
- (void).cxx_destruct;
- (void)removeAllObjectsWithTransaction:(id)a0;
- (id)initWithName:(id)a0 cacheScope:(long long)a1;
- (id)_lock_objectForKey:(id)a0 storage:(id)a1;
- (void)dealloc;
- (void)_lock_removeAllObjectsWithTransaction:(id)a0;
- (id)diagnosticDescription;
- (void)_commitTransactionStorage:(id)a0;
- (void)_lock_storeObject:(id)a0 forKey:(id)a1 transaction:(id)a2;
