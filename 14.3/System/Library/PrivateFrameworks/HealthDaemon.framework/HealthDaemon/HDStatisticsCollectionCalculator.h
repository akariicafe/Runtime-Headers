...
@interface HDStatisticsCollectionCalculator : NSObject <HDStatisticsSourceOrderProvider, NSSecureCoding> {
    struct unique_ptr<_HDStatisticsCollectionCalculatorImplementation, std::__1::default_delete<_HDStatisticsCollectionCalculatorImplementation> > { struct __compressed_pair<_HDStatisticsCollectionCalculatorImplementation *, std::__1::default_delete<_HDStatisticsCollectionCalculatorImplementation> > { struct _HDStatisticsCollectionCalculatorImplementation *__value_; } __ptr_; } _implementation;
}
...
- (id)initForQuantityType:(id)a0 intervalCollection:(id)a1 options:(unsigned long long)a2 mergeStrategy:(unsigned long long)a3 computationMethod:(long long)a4;
- (void).cxx_destruct;
- (void)reset;
- (void)orderSourceIDs:(struct vector<long long, std::__1::allocator<long long> > { long long *x0; long long *x1; struct __compressed_pair<long long *, std::__1::allocator<long long> > { long long *x0; } x2; } *)a0;
