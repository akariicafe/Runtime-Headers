...
- (void).cxx_destruct;
- (id)initWithBundleIdentifier:(id)a0 parameterName:(id)a1 displayNameLocalizationKey:(id)a2 descriptionLocalizationKey:(id)a3 sensitiveInformationLocalizationKey:(id)a4 needsWAPIKeys:(BOOL)a5 requiresFollowup:(BOOL)a6 retry:(BOOL)a7;
- (id)initWithBundleIdentifier:(id)a0 parameterName:(id)a1 baseLocalizationKey:(id)a2 needsWAPIKeys:(BOOL)a3 requiresFollowup:(BOOL)a4 retry:(BOOL)a5;
