...
+ (BOOL)isAtrialFibrillationEnabledWithAvailabilityManager:(id)a0;
+ (void)setAtrialFibrillationEnabled:(BOOL)a0;
+ (id)electrocardiogramFooterDescriptionWithAvailabilityManager:(id)a0;
