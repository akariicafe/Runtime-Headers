@class CNContactPickerViewController, NSString, NSArray, NSAttributedString, UIView, CNContactStore, MFComposeRecipientView, SKUIGiftContactSearchController, UILabel;
