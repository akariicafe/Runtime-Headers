...
+ (id)openTypologyRecordWithString:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 language:(id)a2 languages:(id)a3 topLanguages:(id)a4 autocorrect:(BOOL)a5 initialCapitalize:(BOOL)a6 autocapitalize:(BOOL)a7 keyEventArray:(id)a8 appIdentifier:(id)a9 selectedRangeValue:(id)a10;
...
- (id)initWithString:(id)a0 offset:(unsigned long long)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 language:(id)a3 languages:(id)a4 topLanguages:(id)a5 autocorrect:(BOOL)a6 initialCapitalize:(BOOL)a7 autocapitalize:(BOOL)a8 keyEventArray:(id)a9 appIdentifier:(id)a10 selectedRangeValue:(id)a11;
