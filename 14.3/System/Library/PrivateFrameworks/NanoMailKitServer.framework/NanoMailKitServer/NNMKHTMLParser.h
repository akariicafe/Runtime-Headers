...
- (BOOL)_isElementBlacklisted:(id)a0 attributes:(const char **)a1;
...
- (BOOL)_isErrorBlacklisted:(struct _xmlError { int x0; int x1; char *x2; int x3; char *x4; int x5; char *x6; char *x7; char *x8; int x9; int x10; void *x11; void *x12; } *)a0;
- (BOOL)isElementBlacklisted:(id)a0 attributeQueryBlock:(id /* block */)a1;
- (BOOL)isErrorTypeBlacklisted:(char *)a0;
