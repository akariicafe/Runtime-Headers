...
- (void)syncStateManager:(id)a0 didAcknowledgeForwardNotificationPayload:(id /* block */)a1 forBulletin:(id)a2;
...
- (void)_handleForwardNotificationPayload:(id /* block */)a0 forBulletin:(id)a1;
...
- (void)_addImageAttachment:(id)a0 forMessageId:(id)a1 contentId:(id)a2 loadedProtected:(BOOL)a3 mailbox:(id)a4;
...
- (void)_markConversationWithId:(id)a0 forNotify:(BOOL)a1 mailbox:(id)a2;
