@class ADJasperPointCloudFilterParamaters, ADCameraCalibration, ADAggregationParameters;
...
@property (retain, nonatomic) ADJasperPointCloudFilterParamaters *pointCloudFilterParameters;
