...
@property (readonly, nonatomic) struct WFParameterComponentOptions { BOOL editable; BOOL processing; BOOL becomeFirstResponder; NSString *actionName; WFModuleAppearance *appearance; BOOL lastParameter; NSString *widgetSizeClass; UITraitCollection *traitCollection; } options;
...
+ (id)newWithParameter:(id)a0 state:(id)a1 updateBlock:(id /* block */)a2 options:(struct WFParameterComponentOptions { BOOL x0; BOOL x1; BOOL x2; id x3; id x4; BOOL x5; id x6; id x7; })a3 variableProvider:(id)a4 variableUIDelegate:(id)a5 navigationContext:(id)a6;
