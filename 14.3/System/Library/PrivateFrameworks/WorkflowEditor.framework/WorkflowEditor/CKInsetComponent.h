...
+ (id)newWithInsets:(struct UIEdgeInsets { double x0; double x1; double x2; double x3; })a0 component:(id)a1;
...
+ (id)newWithView:(const struct CKComponentViewConfiguration { struct shared_ptr<const CKComponentViewConfiguration::Repr> { struct Repr *x0; struct __shared_weak_count *x1; } x0; } *)a0 insets:(struct UIEdgeInsets { double x0; double x1; double x2; double x3; })a1 component:(id)a2;
