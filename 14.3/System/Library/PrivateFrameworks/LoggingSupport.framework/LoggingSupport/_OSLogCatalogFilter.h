...
- (void)handleDSCContents:(struct uuiddb_dsc_map_s { _Atomic struct uuiddb_dsc_map_s *x0; struct uuiddb_dsc_header_s *x1; struct uuiddb_dsc_range_entry_s *x2; struct uuiddb_dsc_uuid_entry_s *x3; unsigned char x4[16]; unsigned int x5; } *)a0;
- (void)addUUID:(id)a0;
...
- (struct uuiddb_dsc_map_s { _Atomic struct uuiddb_dsc_map_s *x0; struct uuiddb_dsc_header_s *x1; struct uuiddb_dsc_range_entry_s *x2; struct uuiddb_dsc_uuid_entry_s *x3; unsigned char x4[16]; unsigned int x5; } *)getDSCMap;
- (void)readDSOUUIDs;
