...
- (id)nashvilleVoiceIdentifier:(id)a0 footprint:(long long)a1 voiceType:(long long)a2 gender:(long long)a3;
- (id)nashvilleVoiceName:(id)a0 footprint:(long long)a1 voiceType:(long long)a2 gender:(long long)a3;
...
- (void)nashvilleVoiceIdentifier:(id)a0 footprint:(long long)a1 voiceType:(long long)a2 gender:(long long)a3 voiceId:(id *)a4 voiceName:(id *)a5;
