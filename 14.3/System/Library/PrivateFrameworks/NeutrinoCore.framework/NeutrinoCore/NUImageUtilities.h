...
+ (void)copySurface:(id)a0 fromRect:(struct { struct { long long x0; long long x1; } x0; struct { long long x0; long long x1; } x1; })a1 toSurfaceImage:(id)a2 atPoint:(struct { long long x0; long long x1; })a3;
+ (void)copyTexture:(id)a0 fromRect:(struct { struct { long long x0; long long x1; } x0; struct { long long x0; long long x1; } x1; })a1 toSurfaceImage:(id)a2 atPoint:(struct { long long x0; long long x1; })a3 withContext:(id)a4;
