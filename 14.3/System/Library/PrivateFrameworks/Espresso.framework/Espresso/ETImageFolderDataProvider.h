...
@interface ETImageFolderDataProvider : NSObject <ETDataProvider> {
    struct vector<std::__1::pair<NSString *, unsigned long>, std::__1::allocator<std::__1::pair<NSString *, unsigned long> > > { struct pair<NSString *, unsigned long> *__begin_; struct pair<NSString *, unsigned long> *__end_; struct __compressed_pair<std::__1::pair<NSString *, unsigned long> *, std::__1::allocator<std::__1::pair<NSString *, unsigned long> > > { struct pair<NSString *, unsigned long> *__value_; } __end_cap_; } samples;
    struct vector<NSString *, std::__1::allocator<NSString *> > { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<NSString *__strong *, std::__1::allocator<NSString *> > { id *__value_; } x1; } classes;
