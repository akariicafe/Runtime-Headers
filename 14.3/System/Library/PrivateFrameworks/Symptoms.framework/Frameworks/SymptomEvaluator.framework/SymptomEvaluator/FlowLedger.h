...
- (BOOL)statisticsForSampleCount:(unsigned long long *)a0 sampleDuration:(double *)a1 minRxTput:(double *)a2 avgRxTput:(double *)a3 maxRxTput:(double *)a4 normalizedRxStdDeviation:(double *)a5 minTxTput:(double *)a6 avgTxTput:(double *)a7 maxTxTput:(double *)a8 normalizedTxStdDeviation:(double *)a9;
