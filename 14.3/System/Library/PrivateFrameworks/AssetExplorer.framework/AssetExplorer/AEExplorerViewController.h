...
@property (readonly, nonatomic) id<AEHostStatisticsManager> _statisticsManager;
...
- (BOOL)layout:(id)a0 shouldShowVideoDecorationAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
- (BOOL)layout:(id)a0 shouldShowCloudDecorationAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
- (BOOL)layout:(id)a0 shouldShowLoopDecorationAtIndexPath:(struct PXSimpleIndexPath { unsigned long long x0; long long x1; long long x2; long long x3; })a1;
- (id)initWithPackageTransport:(id)a0 mediaProvider:(id)a1 dataSourceManager:(id)a2 statisticsManager:(id)a3 additionalGestureRecognizers:(id)a4;
