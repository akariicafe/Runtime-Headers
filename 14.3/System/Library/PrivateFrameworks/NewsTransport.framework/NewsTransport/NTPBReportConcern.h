...
@interface NTPBReportConcern : PBCodable <NSCopying> {
    struct { unsigned char articleFeedCellHostType : 1; unsigned char articleFeedCellSection : 1; unsigned char articleParentFeedType : 1; unsigned char backendArticleVersion : 1; unsigned char concernReason : 1; unsigned char contentType : 1; unsigned char feedFeedType : 1; unsigned char feedViewPresentationReason : 1; unsigned char publisherArticleVersion : 1; unsigned char isUserSubscribedToFeed : 1; } _has;
}
