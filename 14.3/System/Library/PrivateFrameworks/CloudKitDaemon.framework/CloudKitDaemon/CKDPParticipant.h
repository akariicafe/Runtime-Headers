...
@interface CKDPParticipant : PBCodable <NSCopying> {
    struct { unsigned char acceptTimestamp : 1; unsigned char keyHealth : 1; unsigned char outOfNetworkKeyType : 1; unsigned char participantType : 1; unsigned char permission : 1; unsigned char publicKeyVersion : 1; unsigned char state : 1; unsigned char acceptedInProcess : 1; unsigned char createdInProcess : 1; unsigned char isInNetwork : 1; unsigned char isOrgUser : 1; } _has;
}
