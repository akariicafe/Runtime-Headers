@class HMHome, NSString, NSArray, HFItem, NSSet, NSMutableDictionary, NSMutableSet, HFItemManagerBatchedDelegateAdapter, NSMapTable, NAFuture;
...
- (void)_updateRepresentationForExternalItemsWithUpdatedOrAddedItems:(id)a0 logger:(id)a1;
...
- (id)_accessoryItemsToHideInSet:(id)a0;
