@class NSString, NSArray, AXMVisionFeatureColorInfo, NSMutableDictionary, NSDictionary, AXMVisionFeatureFaceDetectionResult, AXMVisionFeatureAssetMetadata, NSObject, CMDeviceMotion, AXMVisionFeatureAestheticsResult;
...
@property (readonly, nonatomic) long long uiClass;
...
+ (id)objectClassificationWithLabel:(id)a0 localizedValue:(id)a1 boundingBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 confidence:(float)a3 canvasSize:(struct CGSize { double x0; double x1; })a4;
...
+ (id)featureWithCaptionResult:(id)a0 confidence:(double)a1 modelIdentifier:(id)a2 canvasSize:(struct CGSize { double x0; double x1; })a3 isLowConfidence:(BOOL)a4;
...
+ (id)textSequence:(id)a0 canvasSize:(struct CGSize { double x0; double x1; })a1;
+ (id)textLineWithText:(id)a0 boundingBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 sequences:(id)a2 canvasSize:(struct CGSize { double x0; double x1; })a3;
...
- (long long)locationUsingThirds:(BOOL)a0;
