@interface CPLMemoryAssetFlag : PBCodable <NSCopying> {
    struct { unsigned char isCurated : 1; unsigned char isExtendedCurated : 1; unsigned char isKeyAsset : 1; unsigned char isMovieCurated : 1; unsigned char isRepresentative : 1; } _has;
}
