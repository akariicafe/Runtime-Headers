...
@property (retain, nonatomic) id<NFLFeedLayoutSearchConfiguration> headlineSearchConfiguration;
...
+ (id)gapWrapperSearchConfigurationWithHeadlineSearchConfiguration:(id)a0;
...
- (id)initWithHeadlineSearchConfiguration:(id)a0;
