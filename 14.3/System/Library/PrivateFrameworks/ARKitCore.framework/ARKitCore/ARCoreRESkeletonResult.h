...
@interface ARCoreRESkeletonResult : NSObject <NSSecureCoding, NSCopying> {
    struct vector<simd_float4x4, std::__1::allocator<simd_float4x4> > { struct *__begin_; struct *__end_; struct __compressed_pair<simd_float4x4 *, std::__1::allocator<simd_float4x4> > { struct *__value_; } __end_cap_; } _modelTransforms;
    struct vector<ARSRT, std::__1::allocator<ARSRT> > { struct *__begin_; struct *__end_; struct __compressed_pair<ARSRT *, std::__1::allocator<ARSRT> > { struct *__value_; } __end_cap_; } _localTransformsSRT;
    struct vector<simd_float4x4, std::__1::allocator<simd_float4x4> > { struct *__begin_; struct *__end_; struct __compressed_pair<simd_float4x4 *, std::__1::allocator<simd_float4x4> > { struct *__value_; } __end_cap_; } _localTransforms;
