...
@interface AREnvironmentProbeManager : NSObject {
    ...
    struct vector<ARTexturedPlane, std::__1::allocator<ARTexturedPlane> > { struct ARTexturedPlane *__begin_; struct ARTexturedPlane *__end_; struct __compressed_pair<ARTexturedPlane *, std::__1::allocator<ARTexturedPlane> > { struct ARTexturedPlane *__value_; } __end_cap_; } _lastPlanes;
