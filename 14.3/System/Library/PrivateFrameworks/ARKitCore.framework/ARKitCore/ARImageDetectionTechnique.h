...
@interface ARImageDetectionTechnique : ARImageBasedTechnique {
    ...
    struct shared_ptr<arkit::KeyMapBuffer<const void *, std::__1::vector<unsigned char, std::__1::allocator<unsigned char> > > > { struct KeyMapBuffer<const void *, std::__1::vector<unsigned char, std::__1::allocator<unsigned char> > > *__ptr_; struct __shared_weak_count *__cntrl_; } _poseBuffer;
