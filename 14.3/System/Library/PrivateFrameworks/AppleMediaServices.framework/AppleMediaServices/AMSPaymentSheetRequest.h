...
- (void).cxx_destruct;
- (id)_summaryItemsForAttributedList:(id)a0 cache:(id)a1 bag:(id)a2;
- (id)_contentItemsForFlexibleList:(id)a0 cache:(id)a1 bag:(id)a2;
...
- (id)_removeAllImagePlaceholderTags:(id)a0;
...
- (id)ams_createSummaryItemsForAttributedListWithCache:(id)a0 bag:(id)a1;
- (id)ams_createContentItemsForFlexibleListWithCache:(id)a0 bag:(id)a1;
- (id)ams_createContentItemsForPreScreenDialogWithCache:(id)a0 bag:(id)a1;
- (id)ams_createContentItemForRating;
- (id)ams_createContentItemForSalableInfoWithCache:(id)a0 bag:(id)a1;
- (struct CGImage { } *)_createResizedImageWithOriginalImage:(struct CGImage { } *)a0 targetHeight:(double)a1;
