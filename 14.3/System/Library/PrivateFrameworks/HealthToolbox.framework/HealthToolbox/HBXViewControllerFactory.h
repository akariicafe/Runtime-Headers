...
- (id)createDetailViewControllerForType:(id)a0;
...
- (id)createActivityChartForActivityMoveMode:(long long)a0 displayDate:(id)a1;
...
- (id)createDetailViewControllerForType:(id)a0 displayDate:(id)a1;
