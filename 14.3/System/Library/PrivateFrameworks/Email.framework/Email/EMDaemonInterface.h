@class EMClientState, EMSearchableIndex, EMDonationController, EMBlockedSenderManager, NSObject, EMInteractionLogger, EMOutgoingMessageRepository, EMActivityRegistry, NSString, EMAccountRepository, NSHashTable, EMMailboxRepository, EMFetchController, NSXPCConnection, NSXPCInterface, EMMessageRepository;
