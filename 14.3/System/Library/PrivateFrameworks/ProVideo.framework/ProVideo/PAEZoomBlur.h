...
- (void)polarToRect:(id)a0 withInputImage:(id)a1 withInputNode:(struct HGRef<HGNode> { struct HGNode *x0; })a2 centerX:(double)a3 centerY:(double)a4 andOutputNode:(struct HGRef<HGNode> { struct HGNode *x0; } *)a5;
- (void)rectToPolar:(id)a0 withInputImage:(id)a1 withInputNode:(struct HGRef<HGNode> { struct HGNode *x0; })a2 centerX:(double)a3 centerY:(double)a4 andOutputNode:(struct HGRef<HGGLBlend> { struct HGGLBlend *x0; } *)a5;
