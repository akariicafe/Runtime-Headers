...
- (BOOL)doDegrainWithDegrainAmount:(double)a0 degrainIntensity:(double)a1 withInfo:(struct { union { double x0; struct *x1; } x0; unsigned long long x1; unsigned long long x2; double x3; double x4; unsigned long long x5; })a2 outputNode:(struct HGRef<HGNode> { struct HGNode *x0; } *)a3 pcaMatrix:(id)a4 width:(int)a5 height:(int)a6;
- (BOOL)doPreprocessKeyerFootageWithParamAPI:(id)a0 withInfo:(struct { union { double x0; struct *x1; } x0; unsigned long long x1; unsigned long long x2; double x3; double x4; unsigned long long x5; })a1 linearInput:(BOOL)a2 scaleX:(float)a3 scaleY:(float)a4 width:(float)a5 height:(float)a6 fixDVResult:(struct HGRef<HGNode> { struct HGNode *x0; } *)a7 degrainResult:(struct HGRef<HGNode> { struct HGNode *x0; } *)a8 outputNode:(struct HGRef<HGNode> { struct HGNode *x0; } *)a9;
- (void)setKeyer:(id)a0;
