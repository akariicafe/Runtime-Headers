@interface PCMatrix44Double : NSObject <NSSecureCoding, NSCopying> {
    double _m[4][4];
    struct PCMatrix44Tmpl<double> { double x0[4][4]; } *_pcMatrix;
}
...
- (struct PCMatrix44Tmpl<double> { double x0[4][4]; } *)pcMatrix;
- (id)initWithPCMatrix:(struct PCMatrix44Tmpl<double> { double x0[4][4]; } *)a0;
