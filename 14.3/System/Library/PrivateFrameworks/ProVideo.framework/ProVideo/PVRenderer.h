...
@interface PVRenderer : PVRendererBase {
    ...
    struct vector<HGRef<PVCVPixelBufferPool>, std::__1::allocator<HGRef<PVCVPixelBufferPool> > > { struct HGRef<PVCVPixelBufferPool> *__begin_; struct HGRef<PVCVPixelBufferPool> *__end_; struct __compressed_pair<HGRef<PVCVPixelBufferPool> *, std::__1::allocator<HGRef<PVCVPixelBufferPool> > > { struct HGRef<PVCVPixelBufferPool> *__value_; } __end_cap_; } _cvPools;
    ...
    struct unique_ptr<PVGCDLock, std::__1::default_delete<PVGCDLock> > { struct __compressed_pair<PVGCDLock *, std::__1::default_delete<PVGCDLock> > { struct PVGCDLock *__value_; } __ptr_; } _dateLock;
