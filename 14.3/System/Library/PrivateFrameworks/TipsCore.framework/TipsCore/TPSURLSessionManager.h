...
- (void).cxx_destruct;
- (id)newURLSessionItemWithRequest:(id)a0 identifier:(id)a1 attributionIdentifier:(id)a2 networkDelegate:(id)a3 completionHandler:(id /* block */)a4;
...
- (id)newURLSessionItemWithRequest:(id)a0 identifier:(id)a1 attributionIdentifier:(id)a2 completionHandler:(id /* block */)a3;
