...
@property (nonatomic, setter=_setQuickLookPreviewLoaderClient:) struct LegacyPreviewLoaderClient { void /* function */ **x0; unsigned int x1; } *_quickLookPreviewLoaderClient;
...
- (id)_initWithDocumentLoader:(struct Ref<WebDocumentLoaderMac, WTF::DumbPtrTraits<WebDocumentLoaderMac> > { struct WebDocumentLoaderMac *x0; } *)a0;
