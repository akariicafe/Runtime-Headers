@interface WiFiAnalyticsAWDSlowWiFiNotification : PBCodable <NSCopying> {
    struct { unsigned char timestamp : 1; unsigned char actionField : 1; unsigned char recoveryAction : 1; unsigned char recoveryReason : 1; unsigned char userInput : 1; } _has;
}
