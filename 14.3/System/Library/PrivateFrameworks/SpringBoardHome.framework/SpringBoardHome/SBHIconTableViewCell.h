@class SBIcon, NSString, NSArray, UIView, _UILegibilitySettings, NSLayoutConstraint, SBIconView, UILabel;
...
+ (double)leadingImageMarginForIconImageInfo:(struct SBIconImageInfo { struct CGSize { double x0; double x1; } x0; double x1; double x2; })a0 referenceLayout:(id)a1;
...
+ (struct UIEdgeInsets { double x0; double x1; double x2; double x3; })defaultTableViewCellSeperatorInsetForIconImageInfo:(struct SBIconImageInfo { struct CGSize { double x0; double x1; } x0; double x1; double x2; })a0 referenceLayout:(id)a1;
