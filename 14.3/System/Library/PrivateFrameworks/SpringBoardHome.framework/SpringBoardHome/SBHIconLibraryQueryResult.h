@class SBHIconLibraryQuery, SBHLocalizedIndexedCollation, NSSet, NSDiffableDataSourceSnapshot, NSArray, NSDictionary;
...
@property (retain, nonatomic) SBHLocalizedIndexedCollation *collation;
...
+ (void)_hydrateSnapshot:(id)a0 fromIcons:(id)a1 query:(id)a2 outCollation:(id *)a3 outIconForItemIdentifier:(id *)a4 outSortMethodology:(unsigned long long *)a5 sortComparator:(id /* block */)a6;
+ (id)nullQueryResults;
...
- (id)initWithQuery:(id)a0 icons:(id)a1 snapshot:(id)a2 collation:(id)a3 iconForitemIdentifier:(id)a4 sortMethodology:(unsigned long long)a5;
