@class NSTimer, UIView, SBWidgetIcon, NSHashTable, NSArray, NSMutableDictionary, SBFFluidBehaviorSettings, SBHWidgetSettings, NSString, _UILegibilitySettings, UIPageControl, BSUIScrollView;
