...
- (BOOL)isEffectivelyOccludedIfHasInnerFolder:(BOOL)a0;
...
- (void)_updateVisiblySettledForIconView:(id)a0;
- (BOOL)_canAnyIconViewBeVisiblySettled;
- (void)_updateVisiblySettledForIconView:(id)a0 visiblySettled:(BOOL)a1;
