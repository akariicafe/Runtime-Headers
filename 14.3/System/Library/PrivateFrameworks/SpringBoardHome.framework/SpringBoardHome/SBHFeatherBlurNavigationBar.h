@class UIView, NSArray, SBHFeatherBlurView, UILabel, UINavigationBarAppearance, UINavigationItem;
...
@property (retain, nonatomic) SBHFeatherBlurView *featherBlurBackgroundView;
