...
@interface AURemoteHost : NSObject <AUAudioUnitXPCProtocol> {
    ...
    struct KVOAggregator { struct vector<KVOAggregator::Record, std::__1::allocator<KVOAggregator::Record> > { struct Record *__begin_; struct Record *__end_; struct __compressed_pair<KVOAggregator::Record *, std::__1::allocator<KVOAggregator::Record> > { struct Record *__value_; } __end_cap_; } mRecords; } _kvoAggregator;
}
...
- (id)initWithInputItems:(id)a0 xpcConnection:(id)a1 timeOutHandler:(struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char x0[24]; } x0; struct __base<void ()> *x1; } x0; })a2;
