...
- (id)generateTrivialPassThruForFrameTimes:(struct vector<CMTime, std::__1::allocator<CMTime> > { struct *x0; struct *x1; struct __compressed_pair<CMTime *, std::__1::allocator<CMTime> > { struct *x0; } x2; } *)a0 totalDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1;
