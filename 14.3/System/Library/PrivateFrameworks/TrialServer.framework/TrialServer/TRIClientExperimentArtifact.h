...
+ (id)artifactFromCKRecordResult:(id)a0 withNamespaceDescriptorProvider:(id)a1 container:(int)a2 teamId:(id)a3 paths:(id)a4 requireDeploymentId:(BOOL)a5;
...
- (BOOL)isCompatibleWithNamespaceDescriptorProvider:(id)a0;
