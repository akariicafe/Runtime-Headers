...
- (unsigned long long)removeExperimentRecordWithExperimentDeployment:(id)a0;
- (unsigned long long)addExperimentWithExperimentDeployment:(id)a0 environment:(int)a1 type:(int)a2 status:(long long)a3 startDate:(id)a4 endDate:(id)a5 namespaces:(id)a6;
