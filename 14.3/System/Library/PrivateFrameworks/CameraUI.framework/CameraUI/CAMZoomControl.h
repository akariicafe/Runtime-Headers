...
@interface CAMZoomControl : UIControl <CAMZoomButtonDelegate> {
    struct { BOOL respondsToDidChangeZoomFactor; BOOL respondsToCanToggleBetweenZoomFactors; BOOL respondsToToggleBetweenZoomFactors; BOOL respondsToCanPlayHaptics; } _delegateFlags;
}
...
- (void)_handleButtonTappedForTripleCameraMode:(id)a0;
