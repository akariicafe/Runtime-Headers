@class NSHashTable, AVCaptureVideoDataOutput, AVCaptureDeviceInput, CAMCaptureMovieFileOutput, CAMMemoizationCache, NSMutableArray, NSString, AVCaptureMetadataOutput, AVCaptureDevice, NSMutableSet, CAMPanoramaProcessor, AVCaptureSession, NSMutableDictionary, AVCaptureVideoThumbnailOutput, NSObject, AVSpatialOverCaptureVideoPreviewLayer, CAMPanoramaOutput, CIContext, CAMPowerController, NSURL, AVCapturePhotoOutput, CAMPanoramaConfiguration, AVCaptureVideoPreviewLayer;
...
- (id)_validateVideoAtURL:(id)a0 withCaptureID:(long long)a1 withCaptureError:(id)a2 isVideoComplement:(BOOL)a3 stillImageDisplayTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a4 reportedDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a5 outActualDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; } *)a6 outVideoRecordingStoppedReason:(long long *)a7;
