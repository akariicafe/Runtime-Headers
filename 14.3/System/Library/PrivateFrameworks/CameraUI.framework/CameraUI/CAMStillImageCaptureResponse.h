...
- (void).cxx_destruct;
- (id)initWithUUID:(id)a0 captureSession:(unsigned short)a1 captureDate:(id)a2 metadata:(id)a3 burstIdentifier:(id)a4 burstRepresentedCount:(unsigned long long)a5 imageWellImage:(id)a6 coordinationInfo:(id)a7 finalExpectedPixelSize:(struct CGSize { double x0; double x1; })a8 expectingPairedVideo:(BOOL)a9 captureID:(long long)a10 semanticEnhanceScene:(long long)a11;
