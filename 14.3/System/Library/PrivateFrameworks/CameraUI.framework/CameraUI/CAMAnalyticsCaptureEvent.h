...
- (void)populateZoomFactor:(float)a0;
- (void)populateFromVideoCaptureResponse:(id)a0;
- (void)populateDuration:(long long)a0;
- (void)populateFromStillImageCaptureRequest:(id)a0 burst:(BOOL)a1;
- (void)populateFromVideoCaptureRequest:(id)a0;
...
- (void)populatePortraitStatus:(long long)a0 lightingEffectIntensity:(double)a1 apertureValue:(double)a2;
- (void)populateDesiredNightModeControlMode:(unsigned long long)a0 resolvedNightModeControlMode:(unsigned long long)a1 resolvedNightModeMode:(long long)a2;
