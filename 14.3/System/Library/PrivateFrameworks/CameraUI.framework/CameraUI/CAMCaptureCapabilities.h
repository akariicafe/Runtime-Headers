...
- (double)maximumDepthEffectApertureForDevicePosition:(long long)a0;
...
- (BOOL)isSupportedVideoConfiguration:(long long)a0 forVideoEncodingBehavior:(long long)a1;
- (double)defaultDepthEffectApertureForDevice:(long long)a0;
...
- (BOOL)isAutoLowLightVideoSupportedForMode:(long long)a0 videoConfiguration:(long long)a1;
...
- (BOOL)isVariableFramerateVideoSupportedForMode:(long long)a0 videoConfiguration:(long long)a1;
...
- (BOOL)isAutoFPSVideoSupportedForMode:(long long)a0 videoConfiguration:(long long)a1;
...
- (double)minimumDepthEffectApertureForDevicePosition:(long long)a0;
