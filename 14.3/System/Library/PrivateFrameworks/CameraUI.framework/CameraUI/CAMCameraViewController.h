@class CAMMotionController, NSMutableDictionary, CAMThumbnailGenerator, CAMLocationController, NSObject, CUCaptureController, PAImageConversionServiceClient, CAMPowerController, CAMKeepAliveController, PAVideoConversionServiceClient, CAMViewfinderViewController, NSString, CAMBurstController, CAMProtectionController, CAMRemoteShutterController, CAMTimelapseController, CAMReviewButton, CAMPersistenceController, CAMNebulaDaemonProxyManager;
...
- (id)_mediaConversionOptionsForAdjustments:(id)a0 mediaType:(long long)a1;
