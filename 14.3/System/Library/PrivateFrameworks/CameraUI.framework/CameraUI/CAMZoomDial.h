@class NSArray, UIImageView, CAMZoomDialDotsView, UIView, NSObject, NSString;
...
+ (id)_createMaskImageWithSize:(struct CGSize { double x0; double x1; })a0 tickLabelCenterRadialInset:(double)a1 notchMaskImage:(id)a2 labelMaskImage:(id)a3;
