...
- (id)videoDeviceForMode:(long long)a0 desiredDevice:(long long)a1 videoConfiguration:(long long)a2 resolvedDevice:(long long *)a3;
- (void)registerVideoCaptureRequest:(id)a0;
- (id)metadataOutputForMode:(long long)a0;
- (id)initWithCaptureEngine:(id)a0;
- (id)_captureEngineDeviceForMode:(long long)a0 desiredDevice:(long long)a1 videoConfiguration:(long long)a2 resolvedDevice:(long long *)a3;
- (void)registerStillImageCaptureRequest:(id)a0 withSettings:(id)a1;
- (void)stopPanoramaCaptureInterrupted:(BOOL)a0;
- (id)outputsForMode:(long long)a0 shouldUseThumbnailOutputForFilters:(BOOL)a1;
- (id)audioDeviceInput;
