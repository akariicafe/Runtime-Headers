@class NSArray, NSString, PMLSessionDescriptor, PMLModelWeights, PMLTrainingStore;
...
@property (readonly, nonatomic) id<PMLTransformerProtocol> transformer;
@property (readonly, nonatomic) NSArray *refeaturizationDescriptors;
