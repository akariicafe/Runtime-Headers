...
+ (int)argmax:(id)a0;
+ (id)_calculateTrainingMetricsWithSamplingProb:(double)a0 groundTruthProvider:(id)a1 predictionsProvider:(id)a2 trueLabelName:(id)a3 trainingOutputName:(id)a4 lossValueName:(id)a5 probThreshold:(double)a6;
