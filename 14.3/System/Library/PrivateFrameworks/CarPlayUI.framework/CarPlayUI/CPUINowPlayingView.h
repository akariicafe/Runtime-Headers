...
- (void)recalculateLayout:(BOOL)a0 allowsAlbumArt:(BOOL)a1 hasDataSource:(BOOL)a2 viewArea:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 safeArea:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4;
