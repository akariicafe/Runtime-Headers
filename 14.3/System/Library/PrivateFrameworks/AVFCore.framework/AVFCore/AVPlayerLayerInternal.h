@class AVPlayer, AVNetworkPlaybackPerfHUDLayer, NSString, FigVideoContainerLayer, FigSubtitleCALayer, NSSet, NSDictionary, CALayer, AVKeyPathDependencyManager, NSObject, AVPlayerLayer, FigBaseCALayer;
