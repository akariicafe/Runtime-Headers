...
- (void)_sendFinishLoadingForPreloadedKeyRequest:(struct __CFDictionary { } *)a0 withRequestID:(unsigned long long)a1 fromHandler:(struct OpaqueFigCustomURLHandler { } *)a2;
