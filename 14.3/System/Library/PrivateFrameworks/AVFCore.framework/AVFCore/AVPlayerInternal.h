@class AVPixelBufferAttributeMediator, NSMutableDictionary, NSObject, NSDictionary, AVOutputContext, NSMutableArray, AVPlayerItem, NSString, NSHashTable, AVAudioSession, NSMutableSet, NSArray, NSNumber, AVWeakReference, NSError, AVAudioSessionMediaPlayerOnly;
