@class NSTimer, NSString, NSArray, NSURL, RUIElement, NSMutableDictionary, RUIPage, NSDictionary, NSMutableArray, RUIStyle, RUIAlertView;
...
- (void)showModalWebViewWithLinkURL:(id)a0 scaleToFit:(BOOL)a1 loadCompletion:(id /* block */)a2 doneHandler:(id /* block */)a3;
...
- (void)remoteUIWebViewControllerDonePressed:(id)a0;
