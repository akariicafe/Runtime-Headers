@class RUIElement, RUIDetailHeaderElement, NSArray, RUISubHeaderElement, UIView, RUITableView, RUITableViewRow, RUITableViewHeaderFooterView, NSMutableArray, NSNumber;
