@class CKFunCameraViewController, UITapGestureRecognizer, CKVideoTrimController, CKQLDetailsPreviewController, CKChatInputController, CADisplayLink, CKNavigationBarTitleController, CKNavbarCanvasViewController, IMPluginPayload, CKAudioTrimViewController, CKDetailsContactsManager, CKMessageEntryViewController, CKThrowAnimationManager, CKOnboardingController, UIImagePickerController, IMScheduledUpdater, CKVideoMessageRecordingViewController, CKGroupUpdateBannerView, UIToolbar, UIViewController, CKMacRecipientsController, CKInlineReplyChatController, SGFoundInSuggestionPresenter, UIWindow, NSLayoutConstraint, UIKeyboardInputMode, NSNumber, CKQLPreviewController, CNContactPickerViewController, CKInvisibleInkEffectController, CKNicknameBannerView, CKScheduledUpdater, CKComposition, CKQLPreviewControllerDataSource, UIView, CKBusinessMacToolbarViewController, CKUnreadBannerView, STConversationContext, NSString, NSObject, CKNicknameUpdatesViewController, UIContextMenuInteraction, CKMacToolbarController, CKUnexpectedlyLoggedOutNotificationView, CKNicknameUpdate, CKEffectPickerViewController, CKMacToolbarItem, CKMessageEntryView, CKRaiseGesture;
@protocol OS_dispatch_group, UIDragSession, CKChatControllerDelegate, UIDropSession, CKEffectPickerViewControllerProtocol;
...
@property (retain, nonatomic) CKMacToolbarItem *detailsToolbarItem;
...
+ (id)detailsToolbarItemImageForConversation:(id)a0;
...
- (BOOL)transcriptCollectionViewShouldBeginMultipleSelectionInteractionAtIndexPath:(id)a0;
- (void)transcriptCollectionViewDidBeginMultipleSelectionInteractionAtIndexPath:(id)a0;
...
- (id)_recipientHandle;
- (void)correctSpellingAutomatically:(id)a0;
- (void)checkSpellingWhileTyping:(id)a0;
- (void)capitalizeSentencesAutomatically:(id)a0;
...
- (void)smartQuotes:(id)a0;
- (void)smartDashes:(id)a0;
- (void)smartInsertDelete:(id)a0;
- (void)emojiReplacement:(id)a0;
...
- (void)deleteAllBarButtonItemPressed:(id)a0;
...
- (void)navbarCanvasViewController:(id)a0 facetimeAudioButtonTapped:(id)a1;
- (void)navbarCanvasViewController:(id)a0 facetimeVideoButtonTapped:(id)a1;
...
- (id)_exportActionForChatItem:(id)a0;
...
- (id)_copyActionForChatItem:(id)a0;
...
- (id)transcriptCollectionViewController:(id)a0 accessoriesForContextMenuWithConfiguration:(id)a1 layoutAnchor:(struct { unsigned long long x0; unsigned long long x1; double x2; double x3; })a2;
