...
@property (readonly, nonatomic) struct UIEdgeInsets { double x0; double x1; double x2; double x3; } conversationListFilterSegmentInset;
@property (readonly, nonatomic) struct UIEdgeInsets { double x0; double x1; double x2; double x3; } conversationListFilterSegmentInsetiPhoneLandscape;
...
@property (readonly, nonatomic) UIImage *orbComposeImage;
