...
- (void)terminateApplicationGroup:(long long)a0 forReason:(long long)a1 andReport:(BOOL)a2 withDescription:(id)a3 source:(id)a4 completion:(id /* block */)a5;
- (id)initWithQueue:(id)a0;
- (void)prepareDisplaysForExit;
- (void).cxx_destruct;
- (BOOL)_isWhitelistedLaunchSuspendedApp:(id)a0;
...
- (void)terminateApplication:(id)a0 forReason:(long long)a1 andReport:(BOOL)a2 withDescription:(id)a3 source:(id)a4 completion:(id /* block */)a5;
- (void)dealloc;
