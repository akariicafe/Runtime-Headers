...
@interface UIViewSpringAnimation : NSObject <UIIntervalAnimating> {
    ...
    struct { struct { double targetValue; double tension; double friction; } dampingRatioParameters; struct { double targetValue; double tension; double friction; } responseParameters; struct { double targetValue; double tension; double friction; } targetParameters; BOOL dampingRatioSmoothingDisabled; BOOL responseSmoothingDisabled; BOOL targetSmoothingDisabled; } _parameters;
