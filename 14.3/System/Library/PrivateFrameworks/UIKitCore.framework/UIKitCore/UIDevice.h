...
@interface UIDevice : NSObject {
    ...
    float _batteryLevel;
    struct { unsigned char batteryMonitoringEnabled : 1; unsigned char proximityMonitoringEnabled : 1; unsigned char expectsFaceContactInLandscape : 1; unsigned char orientation : 3; unsigned char batteryState : 2; unsigned char proximityState : 1; unsigned char hasTouchPadOverride : 1; unsigned char hasTouchPad : 1; } _deviceFlags;
}
