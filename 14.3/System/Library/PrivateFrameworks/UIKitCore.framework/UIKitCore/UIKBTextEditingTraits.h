...
@property (readonly, weak, nonatomic) UIResponder *actionResponder;

+ (id)traitsWithResponder:(id)a0 keyMaskFlags:(unsigned long long)a1;
+ (id)traitsForEditingInteractionWithFirstResponder:(id)a0 actionResponder:(id)a1 keyMaskFlags:(unsigned long long)a2;

- (void).cxx_destruct;
- (id)initWithResponder:(id)a0 actionResponder:(id)a1 keyMaskFlags:(unsigned long long)a2 sender:(id)a3;
