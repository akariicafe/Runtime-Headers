@class UIView, NSString, NSArray, UIPointerInteraction, UIResponder, UISelectionGrabber, NSMutableArray, UITouch, UITextRangeAdjustmentInteraction, UITextSelectionView;
