...
@property (nonatomic, getter=isCounterTransformLayer) BOOL counterTransformLayer;
@property (nonatomic, getter=isInverseTransformLayer) BOOL inverseTransformLayer;
