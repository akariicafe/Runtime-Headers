@class NSProgress, _DUIPotentialDrop, UIWindowScene, _UIApplicationModalProgressController, _UIDataTransferMonitor, _UIDragSetDownAnimation, UIView, NSString, _UIInternalDraggingSessionSource, NSPointerArray, NSMutableSet, NSArray, UIDragEvent, PBItemCollection, _UIDropSessionImpl, UIWindow;
...
- (void).cxx_destruct;
- (void)requestDropOnView:(id)a0 withOperation:(unsigned long long)a1 perform:(id /* block */)a2 completion:(id /* block */)a3;
