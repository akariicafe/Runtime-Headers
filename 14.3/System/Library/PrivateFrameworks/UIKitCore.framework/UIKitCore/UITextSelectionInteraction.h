@class _UIKeyboardTextSelectionController, UITextGestureTuning, UITextSelectionGrabberSuppressionAssertion;
...
- (long long)_textGranularityForRepeatedTap:(long long)a0;
