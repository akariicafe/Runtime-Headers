@class NSString, UIKeyboardEmojiCollectionView, UICollectionViewFlowLayout, UIKBTree, UIResponder, UIKeyboardEmojiGraphicsTraits, UIKeyboardEmojiCategory, NSIndexPath;
