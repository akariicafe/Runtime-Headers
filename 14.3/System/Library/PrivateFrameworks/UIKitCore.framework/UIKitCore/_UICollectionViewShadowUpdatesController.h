...
- (double)collectionView:(id)a0 listLayout:(id)a1 heightForFooterInSection:(long long)a2;
...
- (double)collectionView:(id)a0 listLayout:(id)a1 heightForHeaderInSection:(long long)a2;
...
- (id)_collectionView:(id)a0 templateLayoutCellForCellsWithReuseIdentifier:(id)a1;
- (void)_collectionView:(id)a0 willLayoutCell:(id)a1 usingTemplateLayoutCell:(id)a2 forItemAtIndexPath:(id)a3;
...
- (double)collectionView:(id)a0 listLayout:(id)a1 heightForRowAtIndexPath:(id)a2;
