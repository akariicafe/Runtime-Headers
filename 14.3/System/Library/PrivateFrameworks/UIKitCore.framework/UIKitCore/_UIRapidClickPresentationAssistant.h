@class _UIClickPresentation, NSString, NSValue, UIView, UITargetedPreview, UIViewController;
...
- (void)_restoreInputViewWithReason:(unsigned long long)a0 forPresentation:(id)a1;
