...
@interface UIToolbar : UIView <UIAccessibilityHUDGestureDelegate, _UIBarPositioningInternal, UIGestureRecognizerDelegatePrivate, UIBarPositioning> {
    ...
    struct { unsigned char barStyle : 3; unsigned char barTranslucence : 3; unsigned char isLocked : 1; unsigned char linkedBeforeWhitetailAndInitializedFromCoder : 1; unsigned char disableBlurTinting : 1; unsigned char delegateRespondsToInterfaceOrientationWindowSelector : 1; } _toolbarFlags;
