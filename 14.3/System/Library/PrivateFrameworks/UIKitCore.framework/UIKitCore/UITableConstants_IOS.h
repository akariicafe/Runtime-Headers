...
- (double)defaultCellContentLeadingPaddingForOutline:(BOOL)a0;
...
- (id)defaultHeaderFooterBackgroundColorForTableViewStyle:(long long)a0 tableBackgroundColor:(id)a1 floatingHeaderFooter:(BOOL)a2;
...
- (id)defaultHeaderFontForView:(id)a0 inTableView:(id)a1;
- (id)defaultFooterFontForView:(id)a0 inTableView:(id)a1;
...
- (struct UIEdgeInsets { double x0; double x1; double x2; double x3; })defaultOutlineLayoutMarginsForElementsInsideSection;
- (id)defaultSidebarPlainMultiSelectSeparatorColor;
- (id)defaultImageTintColorForState:(unsigned long long)a0;
- (id)defaultTextLabelFontForCellStyle:(long long)a0;
- (id)defaultTextColorForCellStyle:(long long)a0 traitCollection:(id)a1 tintColor:(id)a2 state:(unsigned long long)a3;
- (id)defaultDetailTextFontForCellStyle:(long long)a0;
- (id)defaultDetailTextColorForCellStyle:(long long)a0 traitCollection:(id)a1 state:(unsigned long long)a2;
- (double)defaultImageToTextPaddingForOutline:(BOOL)a0;
