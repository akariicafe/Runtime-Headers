...
@interface _UITreeDataSourceSnapshotter : NSObject <_UITreeDataSourceSnapshotter, NSCopying> {
    struct vector<_UIOutlineNode, std::__1::allocator<_UIOutlineNode> > { struct _UIOutlineNode *__begin_; struct _UIOutlineNode *__end_; struct __compressed_pair<_UIOutlineNode *, std::__1::allocator<_UIOutlineNode> > { struct _UIOutlineNode *__value_; } __end_cap_; } _nodes;
...
- (BOOL)isEqual:(id)a0;
- (id)initWithNodes:(struct vector<_UIOutlineNode, std::__1::allocator<_UIOutlineNode> > { struct _UIOutlineNode *x0; struct _UIOutlineNode *x1; struct __compressed_pair<_UIOutlineNode *, std::__1::allocator<_UIOutlineNode> > { struct _UIOutlineNode *x0; } x2; })a0 count:(long long)a1 expandedIndexes:(id)a2;
