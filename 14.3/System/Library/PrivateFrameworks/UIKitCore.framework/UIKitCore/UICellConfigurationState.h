@interface UICellConfigurationState : UIViewConfigurationState <_UICellConfigurationStateReadonly> {
    struct { unsigned char isEditing : 1; unsigned char isExpanded : 1; unsigned char isSwiped : 1; unsigned char isReordering : 1; unsigned char cellDragState : 2; unsigned char cellDropState : 2; } _cellStateFlags;
}
