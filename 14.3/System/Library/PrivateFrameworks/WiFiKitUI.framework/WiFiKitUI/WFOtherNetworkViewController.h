@class UIColor, NSOrderedSet, NSString, WFValueListViewController, NSArray, WFTextFieldCell;
...
- (id)initWithOtherNetworkProviderContext:(id)a0 deviceCapability:(long long)a1;
- (id)initWithCredentialsProviderContext:(id)a0 deviceCapability:(long long)a1;
