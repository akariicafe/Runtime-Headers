@class NSMutableDictionary, BWEspressoInferenceAdapter, NSDictionary, BWVideoProcessingInferenceAdapter, BWInferenceScheduler, NSMutableArray, BWFigVideoCaptureDevice, NSString, BWFigCaptureISPProcessingSession, BWVisionInferenceAdapter, NSMutableSet, BWEspressoInferenceContext, BWInferenceDependencyProvider, BWVisionInferenceContext;
