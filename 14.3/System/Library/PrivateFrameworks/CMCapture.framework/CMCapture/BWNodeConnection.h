...
+ (void)initialize;
+ (id)_inputAndRequirementsDebugArrayStartingFromInput:(id)a0 forAttachedMediaKey:(id)a1;
+ (id)_requirementsArrayStartingFromInput:(id)a0 forAttachedMediaKey:(id)a1 firstOptionalPassthroughInputOut:(id *)a2 firstOptionalPassthroughInputAttachedMediaKeyOut:(id *)a3;
...
- (BOOL)_resolveCommonVideoBufferFormatForAttachedMediaKey:(id)a0;
