...
- (float)_zoomFactorForRateBasedRampAtPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 updateCurrentZoomRampState:(BOOL)a1;
- (id)init;
- (struct { float x0; int x1; BOOL x2; })_updateAppliedZoomFactorForDelayedISPAppliedZoomFactor:(float)a0 zoomFactorChangedOut:(BOOL *)a1;
- (BOOL)haveUpdatedZoomModelForPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
- (void)_activateRampMode:(BOOL)a0;
- (float)_applyFudgeToZoomFactor:(float)a0;
- (void)dealloc;
- (void)resetZoomDelayBuffer;
- (float)_updateZoomModelForNextFrameWithPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
- (float)applyFudgeToZoomFactor:(float)a0;
- (float)_zoomFactorForRampAtPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 updateCurrentZoomRampState:(BOOL)a1;
...
- (void)_resetZoomFactorOfInterestIfReachedWithZoomFactor:(float)a0 direction:(int)a1;
- (void)setTypicalISPZoomDelay:(unsigned int)a0 clientCanCompensateForDelay:(BOOL)a1;
- (BOOL)_haveUpdatedZoomModelForPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
- (float)_zoomFactorForSpringBasedRampAtPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 updateCurrentZoomRampState:(BOOL)a1;
...
- (float)_zoomFactorForDurationBasedRampAtPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 updateCurrentZoomRampState:(BOOL)a1;
