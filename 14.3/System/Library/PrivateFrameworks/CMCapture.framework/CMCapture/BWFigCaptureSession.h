...
- (void)stillImageCoordinator:(id)a0 didResolveStillImagePTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 forSettings:(id)a2 resolvedCaptureSettings:(id)a3 isPreBracketedEV0:(BOOL)a4;
...
- (void)stillImageCoordinator:(id)a0 willCapturePhotoForSettings:(id)a1 sisActive:(BOOL)a2 error:(int)a3;
...
- (id)initWithFigCaptureSession:(struct OpaqueFigCaptureSession { } *)a0;
