...
- (void)_processDisparityForSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0;
- (void)_removeConsumedAttachedMediaFromSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0;
- (id)processorOptionsForProcessorVersion:(int)a0;
- (void)_attachDepthMetadataToSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0;
