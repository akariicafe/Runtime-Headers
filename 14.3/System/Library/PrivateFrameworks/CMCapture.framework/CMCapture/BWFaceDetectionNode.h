...
- (unsigned long long)append:(id)a0 toBoxedData:(char *)a1 localIDs:(unsigned int *)a2 isFace:(BOOL)a3;
- (void)didSelectFormat:(id)a0 forInput:(id)a1;
- (void)configurationWithID:(long long)a0 updatedFormat:(id)a1 didBecomeLiveForInput:(id)a2;
- (id)nodeType;
- (id)initWithObjectMetadataIdentifiers:(id)a0 movieFileOutputMetadataIdentifierGroups:(id)a1;
- (void)_renderSampleBufferForBoxedMetadataOutput:(struct opaqueCMSampleBuffer { } *)a0 withFaceArray:(id)a1;
- (void)_renderSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0 forBoxedMetadataOutput:(id)a1 withDetectedObjectsInfo:(id)a2;
- (int)_populateLocalIDsForHumanBodiesWithFormatDescription:(struct opaqueCMFormatDescription { } *)a0;
- (id)nodeSubType;
- (void)didReachEndOfDataForInput:(id)a0;
- (BOOL)boxedMetadataOutputEnabled;
- (void)renderSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0 forInput:(id)a1;
- (int)_populateLocalIDsForCatBodiesWithFormatDescription:(struct opaqueCMFormatDescription { } *)a0;
- (void)setMetadataObjectOutputEnabled:(BOOL)a0;
- (int)_populateLocalIDsForDogBodiesWithFormatDescription:(struct opaqueCMFormatDescription { } *)a0;
- (void)dealloc;
- (int)_populateLocalIDsForFacesWithFormatDescription:(struct opaqueCMFormatDescription { } *)a0;
- (unsigned int *)localIDsForKey:(id)a0;
...
- (BOOL)_addFacesArray:(id)a0 toSampleBuffer:(struct opaqueCMSampleBuffer { } *)a1;
- (int)_populateLocalIDsForSalientObjectsWithFormatDescription:(struct opaqueCMFormatDescription { } *)a0;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })rectOfInterest;
- (BOOL)_addDetectedObjectsInfo:(id)a0 toSampleBuffer:(struct opaqueCMSampleBuffer { } *)a1;
- (void)_renderSampleBufferForBoxedMetadataOutput:(struct opaqueCMSampleBuffer { } *)a0 withDetectedObjectsInfo:(id)a1;
