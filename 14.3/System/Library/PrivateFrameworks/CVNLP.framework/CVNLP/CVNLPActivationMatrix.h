...
@property struct CVNLPCTCPriorityQueue { struct priority_queue<CVNLPCTCCandidate, std::__1::vector<CVNLPCTCCandidate, std::__1::allocator<CVNLPCTCCandidate> >, CVNLPCTCPriorityQueue::QueueComparison> { struct vector<CVNLPCTCCandidate, std::__1::allocator<CVNLPCTCCandidate> > { struct CVNLPCTCCandidate *x0; struct CVNLPCTCCandidate *x1; struct __compressed_pair<CVNLPCTCCandidate *, std::__1::allocator<CVNLPCTCCandidate> > { struct CVNLPCTCCandidate *x0; } x2; } x0; struct QueueComparison { } x1; } x0; BOOL x1; struct vector<CVNLPCTCCandidate, std::__1::allocator<CVNLPCTCCandidate> > { struct CVNLPCTCCandidate *x0; struct CVNLPCTCCandidate *x1; struct __compressed_pair<CVNLPCTCCandidate *, std::__1::allocator<CVNLPCTCCandidate> > { struct CVNLPCTCCandidate *x0; } x2; } x2; } *_cachedTimesample;
