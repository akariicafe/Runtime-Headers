...
+ (void)_addSlaveCommandsToCommand:(id)a0 fromCommandProperties:(id)a1 overlayProperties:(id)a2;
...
- (id)_resolvedSlaveCommandForProfileCommand:(id)a0 resolver:(id)a1;
