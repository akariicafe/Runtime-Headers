...
@property (nonatomic) struct vector<espresso_buffer_t, std::__1::allocator<espresso_buffer_t> > { struct *__begin_; struct *__end_; struct __compressed_pair<espresso_buffer_t *, std::__1::allocator<espresso_buffer_t> > { struct *__value_; } __end_cap_; } inputBlobs;
@property (nonatomic) struct vector<espresso_buffer_t, std::__1::allocator<espresso_buffer_t> > { struct *__begin_; struct *__end_; struct __compressed_pair<espresso_buffer_t *, std::__1::allocator<espresso_buffer_t> > { struct *__value_; } __end_cap_; } outputBlobs;
...
- (int)prepareModelInputs:(struct vector<float *, std::__1::allocator<float *> > { float **x0; float **x1; struct __compressed_pair<float **, std::__1::allocator<float *> > { float **x0; } x2; })a0;
- (int)espressoForwardInputs:(struct vector<float *, std::__1::allocator<float *> > { float **x0; float **x1; struct __compressed_pair<float **, std::__1::allocator<float *> > { float **x0; } x2; })a0;
