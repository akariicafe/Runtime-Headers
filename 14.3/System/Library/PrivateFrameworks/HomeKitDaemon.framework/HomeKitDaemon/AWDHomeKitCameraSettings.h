...
@property (retain, nonatomic) NSMutableArray *numPointsInActivityZonesBinStrings;
...
- (void)addNumPointsInActivityZonesBinStrings:(id)a0;
- (unsigned long long)numPointsInActivityZonesBinStringsCount;
- (void)clearNumPointsInActivityZonesBinStrings;
- (id)numPointsInActivityZonesBinStringsAtIndex:(unsigned long long)a0;
