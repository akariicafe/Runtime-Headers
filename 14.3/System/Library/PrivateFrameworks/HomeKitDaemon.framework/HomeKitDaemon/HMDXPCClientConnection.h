@class NSXPCConnection, NSString, HMDProcessInfo, HMDXPCMessageCountTracker, NSSet, NSDictionary, HMDXPCRequestTracker, NSObject, HMDXPCMessageSendPolicyParameters;
