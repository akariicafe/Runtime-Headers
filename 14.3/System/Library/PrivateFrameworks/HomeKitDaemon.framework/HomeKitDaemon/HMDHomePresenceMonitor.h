@class HMDHomePresenceUpdate, NSMutableDictionary, NSString, HMDHomePresence, HMDBackgroundTaskAgentTimer;
@protocol HMFLocking;
...
@property (readonly, nonatomic) NSMutableDictionary *presenceMap;
