@class NSHashTable, HMFTimer, HMDMediaBrowser, HMFUnfairLock, HMDHAP2Storage, NSMutableArray, NSMutableSet, HMDHomeManager, NSString, NSArray, HMDAuthServer, HMFMessageDispatcher, HMDUnassociatedWACAccessory, NSObject, NSData, HMDWACBrowser, NSUUID, HAPAccessoryServerBrowserBTLE, HMDDAccessoryServerBrowserDemo, HAPAccessoryServerBrowser, HAPAccessoryServerBrowserRelay, HAPWACAccessoryBrowser, HAPAccessoryServerBrowserIP;
...
@property (retain, nonatomic) HAPWACAccessoryBrowser *wacAccessoryBrowser;
...
@property (retain, nonatomic) HMDDAccessoryServerBrowserDemo *demoAccessoryServerBrowser;
@property (retain, nonatomic) HMFTimer *stopReprovisioningTimer;
@property (retain, nonatomic) HMFTimer *stopBrowsingAccessoriesNeedingReprovisioningTimer;
...
- (id)initWithMessageDispatcher:(id)a0 workQueue:(id)a1 injectedSettings:(id)a2;
...
- (void)_stopDiscoveringAccessoriesWithForce:(BOOL)a0 error:(id)a1;
...
- (void)accessoryServer:(id)a0 isBlockedWithCompletionHandler:(id /* block */)a1;
...
- (BOOL)shouldEnableReachabilityForAccessoryServer:(id)a0;
...
- (void)configureDemoBrowserWithTestAccessories:(id)a0;
