@class HMFTimer, NSString, NSMapTable, HMDDataStreamControlProtocol, NSMutableSet, HAPSecuritySessionEncryption, NSObject;
...
- (void)_sendMessageWithHeader:(id)a0 payload:(id)a1 completion:(id /* block */)a2;
- (id)createRequestIdentifier;
- (void)sendRequestForProtocol:(id)a0 topic:(id)a1 payload:(id)a2 completion:(id /* block */)a3;
- (BOOL)handleFirstMessageReceivedOnDataStream:(id)a0 payload:(id)a1;
- (void)handlePendingRequests;
- (void)fulfillPendingRequestWithResponseHeader:(id)a0 payload:(id)a1;
