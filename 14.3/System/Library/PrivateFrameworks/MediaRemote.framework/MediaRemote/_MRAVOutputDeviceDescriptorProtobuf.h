...
@interface _MRAVOutputDeviceDescriptorProtobuf : PBCodable <NSCopying> {
    struct { unsigned char batteryLevel : 1; unsigned char clusterType : 1; unsigned char configuredClusterSize : 1; unsigned char deviceSubType : 1; unsigned char deviceType : 1; unsigned char volume : 1; unsigned char volumeCapabilities : 1; unsigned char canAccessAppleMusic : 1; unsigned char canAccessRemoteAssets : 1; unsigned char canAccessiCloudMusicLibrary : 1; unsigned char canFetchMediaDataFromSender : 1; unsigned char canPlayEncryptedProgressiveDownloadAssets : 1; unsigned char canRelayCommunicationChannel : 1; unsigned char groupContainsGroupLeader : 1; unsigned char isAddedToHomeKit : 1; unsigned char isAirPlayReceiverSessionActive : 1; unsigned char isDeviceGroupable : 1; unsigned char isGroupLeader : 1; unsigned char isGroupable : 1; unsigned char isLocalDevice : 1; unsigned char isProxyGroupPlayer : 1; unsigned char isRemoteControllable : 1; unsigned char isVolumeControlAvailable : 1; unsigned char parentGroupContainsDiscoverableLeader : 1; unsigned char presentsOptimizedUserInterfaceWhenPlayingFetchedAudioOnlyAssets : 1; unsigned char requiresAuthorization : 1; unsigned char shouldForceRemoteControlabillity : 1; unsigned char supportsBufferedAirPlay : 1; unsigned char supportsExternalScreen : 1; unsigned char supportsHAP : 1; unsigned char usingJSONProtocol : 1; } _has;
}
