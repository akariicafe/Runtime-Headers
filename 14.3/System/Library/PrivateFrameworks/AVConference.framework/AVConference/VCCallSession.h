...
@property (readonly) struct tagVCAudioReceiver { struct tagVCAudioReceiverConfig { unsigned int x0; struct tagVCAudioReceiverStream { struct tagHANDLE *x0; unsigned short x1; BOOL x2; BOOL x3; struct tagVCAudioReceiver *x4; } x1[3]; void *x2; unsigned int x3; int x4; int x5; BOOL x6; struct opaqueRTCReporting *x7; int x8; BOOL x9; struct __CFString *x10; struct __CFString *x11; unsigned short x12; BOOL x13; BOOL x14; } x0; void *x1; struct opaqueVCJitterBuffer *x2; BOOL x3; struct AudioStreamBasicDescription *x4; int x5; double x6; struct { long long x0; int x1; unsigned int x2; long long x3; } x7; struct tagVCRealTimeThread *x8; struct tagVCAudioReceiverReportingTask { struct opaqueRTCReporting *x0; int x1; struct tagHANDLE *x2; } x9; BOOL x10; BOOL x11; struct _opaque_pthread_mutex_t { long long x0; char x1[56]; } x12; struct _opaque_pthread_mutex_t { long long x0; char x1[56]; } x13; struct tagVCAudioDecoderList { struct tagDecoderSettings *x0; unsigned int x1; } x14; unsigned int x15; struct tagVCAudioReceiverStatistics { _Atomic unsigned int x0; } x16; struct tagWRMMetricsInfo *x17; void /* function */ *x18; struct tagVCAudioReceiverCallbackContext { void *x0; void /* function */ *x1; void /* function */ *x2; } x19; void /* function */ *x20; struct tagVCAudioReceiverCallbackContext { void *x0; void /* function */ *x1; void /* function */ *x2; } x21; unsigned int x22; struct _RTCPPacketList { union tagNTP { unsigned long long x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; unsigned char x1; struct tagRTCPPACKET *x2[10]; struct OpaqueCMBlockBuffer *x3; char *x4; unsigned long long x5; unsigned int x6; unsigned char x7[1472]; struct { struct _RTCPPacketList *x0; } x8; } x23[2]; double x24; unsigned int x25; struct tagPacketHistoryInfo { unsigned int x0; unsigned short x1; unsigned int x2; BOOL x3; BOOL x4; } x26[300]; unsigned short x27; unsigned short x28; struct tagVCAudioReceiverStream *x29; unsigned short x30; unsigned short x31; BOOL x32; unsigned short x33; unsigned short x34; unsigned short x35; unsigned short x36; unsigned int x37; BOOL x38; BOOL x39; unsigned long long x40; } *audioReceiver;
...
- (int)interfaceFromConnection:(id)a0;
...
- (id)getFeaturesListStringForPayload:(int)a0;
- (int)applyFeaturesListStringForPayload:(int)a0;
...
- (BOOL)isBetterForSIPInviteWithSourceDestinationInfo:(struct tagVCSourceDestinationInfo { int x0; union { struct { struct tagIPPORT { int x0; char x1[16]; union { unsigned int x0; unsigned char x1[16]; } x2; unsigned short x3; } x0; struct tagIPPORT { int x0; char x1[16]; union { unsigned int x0; unsigned char x1[16]; } x2; unsigned short x3; } x1; struct { BOOL x0; unsigned short x1; } x2; } x0; struct { int x0; int x1; struct tagIPPORT { int x0; char x1[16]; union { unsigned int x0; unsigned char x1[16]; } x2; unsigned short x3; } x2; } x1; struct { unsigned int x0; struct { char x0; unsigned short x1; unsigned char x2; unsigned short x3; unsigned char x4; } x1; } x2; struct { id x0; } x3; } x1; struct tagVCSourceDestinationInfo *x2; void *x3; } *)a0 thanSession:(id)a1;
...
- (id)getCompatibleLocalFeaturesListForPayloads:(int *)a0 count:(int)a1;
- (BOOL)createSDP:(int *)a0 audioPayloadCount:(int)a1 secondaryPayloadTypes:(int *)a2 secondaryPayloadCount:(int)a3 videoPayloadTypes:(int *)a4 videoPayloadCount:(int)a5 localFeaturesList:(id)a6 answerBandwidth:(int)a7 maxBandwidth:(int)a8 imageSizesSend:(struct imageTag **)a9 imageSendCount:(int *)a10 imageSizesRecv:(struct imageTag **)a11 imageRecvCount:(int *)a12 sdp:(char *)a13 numSDPBytes:(int *)a14 error:(id *)a15;
...
- (id)pickFeaturesStringForPayload:(int)a0 featuresListDict:(id)a1 remote:(BOOL)a2;
...
- (void)processResolutionChangeToVideoRule:(id)a0 captureRule:(id)a1 featuresListString:(id)a2;
