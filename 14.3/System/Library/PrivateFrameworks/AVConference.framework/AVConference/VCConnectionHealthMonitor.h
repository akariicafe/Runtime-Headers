...
- (BOOL)isPrimaryConnectionImprovedFromHistory:(struct ConnectionStatsHistory { unsigned char x0; unsigned char x1[5]; unsigned char x2[2][5]; unsigned char x3[2][5]; } *)a0 withIndex:(int)a1;
