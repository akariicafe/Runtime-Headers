...
- (void)recordDidActivateCardWithBundleID:(id)a0 launchReason:(id)a1 deviceLocked:(BOOL)a2;
- (void)didPresentInvocationCardForClip:(id)a0 adamID:(id)a1 sourceBundleIdentifier:(id)a2 referrerBundleIdentifier:(id)a3 event:(id)a4 url:(id)a5;
...
- (void)didCancelInterstitialForClip:(id)a0 withEvent:(long long)a1;
- (void)recordDidTapOpenButtonInCardWithBundleID:(id)a0 metadata:(id)a1 launchReason:(id)a2 launchOptions:(id)a3;
