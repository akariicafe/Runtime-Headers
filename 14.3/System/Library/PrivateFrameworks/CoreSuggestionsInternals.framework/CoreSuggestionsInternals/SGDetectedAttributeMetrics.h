...
+ (void)recordBirthdayExtractionAccuracy:(unsigned char)a0 withOffset:(id)a1 withModelVersion:(id)a2 isFromCongratulation:(unsigned char)a3 didRegexTrigger:(unsigned char)a4;
