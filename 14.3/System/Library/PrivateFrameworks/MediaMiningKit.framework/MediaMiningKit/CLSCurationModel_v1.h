...
- (id)faceInformationSummaryWithFaces:(id)a0 personUUIDs:(id)a1 hiddenPersonLocalIdentifiers:(id)a2;
- (BOOL)isNonMemorableWithAsset:(id)a0;
- (BOOL)isGoldWithAsset:(id)a0;
- (BOOL)assetIsJunkWithSceneClassifications:(id)a0 confidenceThresholdBySceneIdentifierForScenesPreventingJunking:(id)a1 confidenceThresholdBySceneIdentifierForJunkingScenes:(id)a2 confidenceThresholdBySceneIdentifierForScenesPreventingSceneBasedJunking:(id)a3;
...
- (BOOL)imageAssetIsJunkForMemoriesFromSceneAndJunkClassifications:(id)a0 forKeyAsset:(BOOL)a1;
