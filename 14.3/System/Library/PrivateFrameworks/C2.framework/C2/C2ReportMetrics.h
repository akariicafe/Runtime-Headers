...
+ (id)gzipEncode:(id)a0;
+ (void)_reportWithOptions:(id)a0 networkEvent:(id)a1 genericEvent:(id)a2 triggers:(int)a3;
+ (id)requestForMetricRequestOptions:(id)a0 networkEvent:(id)a1 genericEvent:(id)a2 triggers:(int)a3;
+ (id)gzipDecode:(id)a0;
