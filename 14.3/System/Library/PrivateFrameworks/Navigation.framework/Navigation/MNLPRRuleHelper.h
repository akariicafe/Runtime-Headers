...
- (void)_findTileKeysForRegions:(id)a0 forceUpdate:(BOOL)a1 asyncCompletion:(id /* block */)a2;
- (void)_loadRules:(id)a0 asyncCompletion:(id /* block */)a1;
- (void)_loadTileKeys:(id)a0 forceUpdate:(BOOL)a1 asyncCompletion:(id /* block */)a2;
