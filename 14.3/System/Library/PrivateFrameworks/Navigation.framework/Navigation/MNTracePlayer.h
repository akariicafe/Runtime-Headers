@class NSData, NSString, MNTrace, NSDate, NSHashTable, MNTracePlayerTimelineStream, MNTracePlayerScheduler, MNLocation, MNSessionUpdateManager, MNTracePlayerETAUpdater;
