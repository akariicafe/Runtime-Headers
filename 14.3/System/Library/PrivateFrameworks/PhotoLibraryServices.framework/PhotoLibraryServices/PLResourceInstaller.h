...
+ (BOOL)resetImageRequestHintsInStore:(id)a0 migrator:(id)a1;
...
+ (id)generateValidatedExternalImageResourceOfType:(unsigned int)a0 forFilePath:(id)a1 requireFileToBePresent:(BOOL)a2 version:(unsigned int)a3 basedOnFullSizeWidth:(long long)a4 andHeight:(long long)a5 isNativeColorSpace:(BOOL)a6 isLosslessEncoding:(BOOL)a7 recipe:(id)a8 assetKind:(short)a9 context:(id)a10;
