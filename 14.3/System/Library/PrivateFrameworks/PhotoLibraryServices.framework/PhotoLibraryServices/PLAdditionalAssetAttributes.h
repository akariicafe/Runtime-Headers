@class PLEditedIPTCAttributes, PLSceneprint, CLLocation, NSDate, PLAssetDescription, PLCloudMasterMediaMetadata, PLSpatialOverCaptureInformation, NSString, NSSet, PLManagedAsset, NSNumber, NSData, PLUnmanagedAdjustment;
