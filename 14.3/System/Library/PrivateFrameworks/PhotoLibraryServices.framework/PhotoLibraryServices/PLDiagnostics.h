...
+ (void)collectYearsStatWithLibraryContext:(id)a0 completionBlock:(id /* block */)a1;
...
+ (void)collectCollectionsStatWithLibraryContext:(id)a0 completionBlock:(id /* block */)a1;
+ (id)diagnosticsURLs;
