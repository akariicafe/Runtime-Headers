...
+ (id)_fetchGlobalKeyValuesForKeys:(id)a0 withManagedObjectContext:(id)a1;
+ (id)entityName;
...
+ (id)_fetchGlobalKeyValueForKey:(id)a0 withManagedObjectContext:(id)a1 createIfMissing:(BOOL)a2;
...
+ (id)dictionaryWithManagedObjectContext:(id)a0;
