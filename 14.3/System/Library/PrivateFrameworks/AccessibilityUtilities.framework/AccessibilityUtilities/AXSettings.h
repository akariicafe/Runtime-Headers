@class NSMutableDictionary, NSURL, NSDate, NSDictionary, NSOrderedSet, AXVoiceOverActivity, NSString, NSSet, NSMutableSet, NSArray, NSNumber, NSData, NSLock, NSUUID;
...
- (id)_userDefaultsStoreForDomain:(int)a0;
...
- (void).cxx_destruct;
- (BOOL)preferenceHasExistingValue:(SEL)a0;
...
- (void)_postNotificationForPreferenceKey:(id)a0;
...
- (void)clearExistingValueForPreference:(SEL)a0;
- (void)_synchronizeIfNecessary:(id)a0 domain:(int)a1;
