@class PKPeerPaymentContactResolver, NSObject, PKPeerPaymentWebService, PKPeerPaymentAccount, PKPeerPaymentRequestToken, PKPaymentAuthorizationCoordinator, NSString, PKPaymentPass, PKPeerPaymentRecipient, PKPeerPaymentPerformResponse, PKPeerPaymentQuote, PKPeerPaymentControllerInternalState, NSError;
