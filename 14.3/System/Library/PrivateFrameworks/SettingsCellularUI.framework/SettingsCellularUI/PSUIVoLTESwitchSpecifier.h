@class PSSpecifier, PSConfirmationSpecifier, PSUICoreTelephonyCarrierBundleCache, CTXPCServiceSubscriptionContext, PSUICoreTelephonyCapabilitiesCache, PSListController, PSUICoreTelephonyCallCache;
