...
+ (id)enableLostModeForBeaconUUID:(id)a0 message:(id)a1 phoneNumber:(id)a2;
...
- (id)initWithBeaconUUID:(id)a0 type:(long long)a1 expiration:(id)a2 duration:(id)a3 handle:(id)a4 lostModeMessage:(id)a5 lostModePhoneNumber:(id)a6 obfuscatedIdentifier:(id)a7 identifier:(id)a8;
