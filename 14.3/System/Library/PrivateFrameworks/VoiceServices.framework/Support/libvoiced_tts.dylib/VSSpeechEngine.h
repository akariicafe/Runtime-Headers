...
@property (nonatomic) struct TTSSynthesizer { struct unique_ptr<TTSSynthesizer::TTSSynthesizerInternal, std::__1::default_delete<TTSSynthesizer::TTSSynthesizerInternal> > { struct __compressed_pair<TTSSynthesizer::TTSSynthesizerInternal *, std::__1::default_delete<TTSSynthesizer::TTSSynthesizerInternal> > { struct TTSSynthesizerInternal *x0; } x0; } x0; } *synthesizer;
