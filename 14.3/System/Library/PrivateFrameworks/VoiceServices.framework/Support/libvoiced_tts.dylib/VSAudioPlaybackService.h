@class NSString, NSCondition, NSDate, VSMappedData, NSMutableArray;
...
- (id)_enqueueAudioBytesLength:(long long)a0 audioBytes:(const void *)a1 packetCount:(long long)a2 packetDescriptions:(const void *)a3;
