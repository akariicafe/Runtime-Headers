@class NSString, NSURL, MobileCalDAVPrincipal, NSArray, NSMutableDictionary, NSDictionary, NSSet, CalDAVDBChangeTrackingHelper, NSTimeZone, CalDiagCalendarCollectionSync;
