...
- (void).cxx_destruct;
- (void)dealloc;
- (BOOL)saveWithLocalObject:(void *)a0 toContainer:(void *)a1 shouldMergeProperties:(BOOL)a2 outMergeDidChooseLocalProperties:(BOOL *)a3 account:(id)a4 calendar:(id)a5;
- (id)initWithCalRecord:(void *)a0 inContainer:(id)a1;
- (void)addChangeOfType:(id)a0 forChangeRowid:(int)a1;
- (void)setLocalItem:(void *)a0;
- (id)_getDetachedEventUniqueIdentifiersForCalEvent:(void *)a0;
- (void)_setModificationInfoOnItem:(void *)a0;
- (void)_removeCalEvent:(void *)a0 fromUniqueIdentifiersSet:(id)a1;
- (void)_removeDetachedEventsWithUniqueIdentifiers:(id)a0 fromEvent:(void *)a1 withContainer:(void *)a2;
