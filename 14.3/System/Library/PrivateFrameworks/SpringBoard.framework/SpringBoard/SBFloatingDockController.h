@class SBReusableViewMap, SBApplication, SBHomeGestureParticipant, SBIndirectPanGestureRecognizer, NSString, SBMainScreenActiveInterfaceOrientationWindow, SBFloatingDockRootViewController, NSPointerArray, SBFloatingDockBehaviorAssertion, SBIconListView, UIHoverGestureRecognizer, NSSet, PTToggleTestRecipe, SBFailingSystemGestureRecognizer, SBLayoutStateTransitionCoordinator, SBFAnalyticsClient, SBIconController, SBDeviceOrientationUpdateDeferralAssertion, _UILegibilitySettings, SBFloatingDockViewController, SBFolderController;
...
- (void)floatingDockRootViewController:(id)a0 willChangeToHeight:(double)a1;
