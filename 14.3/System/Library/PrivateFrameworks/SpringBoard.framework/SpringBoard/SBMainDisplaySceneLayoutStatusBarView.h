@class UIView, NSString, _UIStatusBar, NSMutableDictionary, SBMedusaSettings, SBOrientationTransformWrapperView, NSMutableSet, UIStatusBar, UIColor;
...
- (void)_applyStatusBarStyleOverridesToSuppress:(int)a0 toSceneWithIdentifier:(id)a1;
