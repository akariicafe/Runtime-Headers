@class SBMainSwitcherViewController, SBMainWorkspace, SBUIController, NSMutableArray, NSString, SBBannerManager, SpringBoard, NSMutableSet, UIApplicationSceneDeactivationAssertion, NSMutableDictionary, SBInCallTransientOverlayViewController, UIApplicationSceneDeactivationManager, SBLockScreenManager, SBAppStatusBarSettingsAssertion, UIScreen, BSEventQueue, SBWorkspaceKeyboardFocusController, SBMainDisplaySceneManager, SBDeviceApplicationSceneHandle, SBBacklightController, SBLayoutElement, NSMapTable, SBSetupManager, SBInCallBannerPresentableViewController;
...
- (id)initWithSceneHandle:(id)a0 screen:(id)a1 sceneManager:(id)a2 workspace:(id)a3 bannerManager:(id)a4 lockScreenManager:(id)a5 deactivationManager:(id)a6 mainSwitcherViewController:(id)a7 backlightController:(id)a8 keyboardFocusController:(id)a9 springBoard:(id)a10 setupManager:(id)a11 uiController:(id)a12;
...
- (void)_applicationProcessDidExit:(id)a0;
...
- (void)_destroySceneEntityUsingMainEventQueueWithCompletion:(id /* block */)a0;
...
- (void)presentWithRequestedPresentationMode:(long long)a0 isUserInitiated:(BOOL)a1 animated:(BOOL)a2 analyticsSource:(id)a3 completion:(id /* block */)a4;
