@class SBMainWorkspaceTransaction, NSTimer, NSUUID, NSString, SBFluidSwitcherViewController, SBSceneLayoutWorkspaceTransaction, SBAutoPiPWorkspaceTransaction, UIApplicationSceneDeactivationAssertion, SBAppLayout, SBUISwitcherAnimationController, SBMainDisplayLayoutState, SBTransientOverlayViewController;
