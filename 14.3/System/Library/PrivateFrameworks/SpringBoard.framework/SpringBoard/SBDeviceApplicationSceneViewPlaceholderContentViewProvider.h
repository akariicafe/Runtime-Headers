...
- (id)_contentViewFromSceneHandle:(id)a0 displayConfiguration:(id)a1 orientation:(long long)a2 snapshot:(id)a3 size:(struct CGSize { double x0; double x1; })a4 statusBarDescriptor:(id)a5;
