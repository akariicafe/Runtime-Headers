@class NSHashTable, NSString, _SBPendingMesaUnlockBehaviorUnlockRequest, SBUIBiometricResource, SBWalletPreArmController, SBWalletPrearmRecognizer, NSMutableOrderedSet, PKPassLibrary;
