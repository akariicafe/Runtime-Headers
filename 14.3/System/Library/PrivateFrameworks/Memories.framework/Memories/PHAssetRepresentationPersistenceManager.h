@class NSHashTable, PHAssetRepresentation, NSRecursiveLock, NSString, NSOperationQueue, NSMutableDictionary, NSMutableArray, Reachability, NSMutableSet, NSMapTable;
