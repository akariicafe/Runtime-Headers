...
@interface _SWCServiceDetails : NSObject <SWCRedactedDescription, NSSecureCoding> {
    struct SWCFields { unsigned char userApproval : 2; unsigned char siteOrFrameworkApproval : 2; unsigned char updating : 1; unsigned char systemApplication : 1; unsigned char enabledConfiguration : 2; unsigned char lowBitsOfProvenance_getRidOfMeOnNextDBVersionChange : 2; unsigned char enterpriseManaged : 1; unsigned char systemPlaceholder : 1; unsigned char provenance : 3; char relativeOrder; } _fields;
}
...
- (id)_initWithServiceSpecifier:(id)a0 fields:(const struct SWCFields { unsigned char x0 : 2; unsigned char x1 : 2; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 2; unsigned char x5 : 2; unsigned char x6 : 1; unsigned char x7 : 1; unsigned char x8 : 3; char x9; } *)a1;
