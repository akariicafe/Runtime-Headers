...
- (id)initWithStoreFront:(id)a0 locale:(id)a1 contentSizeCategory:(id)a2 canvasSize:(struct CGSize { double x0; double x1; })a3 contentFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 dataSources:(id)a5 location:(id)a6 sourceURL:(id)a7;
