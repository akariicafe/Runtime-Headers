...
@interface VMUTaskMemoryScanner : NSObject <VMUCommonGraphInterface> {
    ...
    struct _VMURegionNode { id x0; void *x1; unsigned long long x2; struct _VMURegionNode *x3; struct *x4; unsigned int x5; unsigned long long x6; unsigned long long x7; } *_regions;
    struct _VMURegionMap { void *x0; struct _VMURegionNode *x1; unsigned int x2; unsigned long long x3; unsigned long long x4; unsigned int x5[0]; } *_regionMap;
...
- (void)_orderedScanWithScanner:(id /* block */)a0 recorder:(id /* block */)a1 keepMapped:(BOOL)a2 actions:(id /* block */)a3;
...
- (id)processSnapshotGraphWithMallocStackLogs:(BOOL)a0;
...
- (void)orderedNodeTraversal:(unsigned int)a0 withBlock:(id /* block */)a1;
- (void)removeRootReachableNodes;
- (id)processSnapshotGraph;
- (id)classInfoForObjectAtAddress:(unsigned long long)a0;
- (BOOL)validateAddressRange:(struct _VMURange { unsigned long long x0; unsigned long long x1; })a0;
