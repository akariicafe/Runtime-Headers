@class NSDate, NSString, NSData, NSArray, IDSOutgoingMessageCheckpointTrace, NSMutableDictionary, NSDictionary, IDSDestination, NSNumber;
...
- (id)dictionaryRepresentationIncludingTrace:(BOOL)a0;
