...
@property (readonly, retain, nonatomic) NSArray *textInputTargets;

+ (struct vector<CGRect, std::__1::allocator<CGRect> > { struct CGRect *x0; struct CGRect *x1; struct __compressed_pair<CGRect *, std::__1::allocator<CGRect> > { struct CGRect *x0; } x2; })_boundingBoxesOfStrokesInGroup:(id)a0 rotatedAroundPoint:(struct CGPoint { double x0; double x1; })a1 byAngle:(double)a2;
...
- (id)_writingDirectionSortedStrokeIdentifiersFromSubstrokes:(id)a0 localWritingOrientations:(struct vector<CGVector, std::__1::allocator<CGVector> > { struct CGVector *x0; struct CGVector *x1; struct __compressed_pair<CGVector *, std::__1::allocator<CGVector> > { struct CGVector *x0; } x2; } *)a1;
- (id)_lastSubstrokeCoalescedWithOverlappingSubstrokes:(id)a0 strokeDeviation:(struct CGVector { double x0; double x1; })a1;
- (double)_strokeGroupConfidenceForSortedSubstrokes:(id)a0 writingDirectionSortedStrokeIdentifiers:(id)a1 localStrokeWritingOrientations:(const struct vector<CGVector, std::__1::allocator<CGVector> > { struct CGVector *x0; struct CGVector *x1; struct __compressed_pair<CGVector *, std::__1::allocator<CGVector> > { struct CGVector *x0; } x2; } *)a2 averageWritingOrientation:(struct CGVector { double x0; double x1; })a3 averageStrokeDeviation:(struct CGVector { double x0; double x1; })a4;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_normalizedBoundsForWritingDirectionSortedStrokes:(id)a0 strokeWritingOrientations:(const struct vector<CGVector, std::__1::allocator<CGVector> > { struct CGVector *x0; struct CGVector *x1; struct __compressed_pair<CGVector *, std::__1::allocator<CGVector> > { struct CGVector *x0; } x2; } *)a1 firstStrokeDeviation:(struct CGVector { double x0; double x1; })a2 originalDrawing:(id *)a3 rotatedSortedStrokes:(struct vector<std::__1::vector<CGPoint, std::__1::allocator<CGPoint> >, std::__1::allocator<std::__1::vector<CGPoint, std::__1::allocator<CGPoint> > > > { struct vector<CGPoint, std::__1::allocator<CGPoint> > *x0; struct vector<CGPoint, std::__1::allocator<CGPoint> > *x1; struct __compressed_pair<std::__1::vector<CGPoint, std::__1::allocator<CGPoint> > *, std::__1::allocator<std::__1::vector<CGPoint, std::__1::allocator<CGPoint> > > > { struct vector<CGPoint, std::__1::allocator<CGPoint> > *x0; } x2; } *)a4;
...
- (void)smoothLocalWritingOrientations:(struct vector<CGVector, std::__1::allocator<CGVector> > { struct CGVector *x0; struct CGVector *x1; struct __compressed_pair<CGVector *, std::__1::allocator<CGVector> > { struct CGVector *x0; } x2; } *)a0;
- (struct vector<CGPoint, std::__1::allocator<CGPoint> > { struct CGPoint *x0; struct CGPoint *x1; struct __compressed_pair<CGPoint *, std::__1::allocator<CGPoint> > { struct CGPoint *x0; } x2; })flippedCenters:(const struct vector<CGPoint, std::__1::allocator<CGPoint> > { struct CGPoint *x0; struct CGPoint *x1; struct __compressed_pair<CGPoint *, std::__1::allocator<CGPoint> > { struct CGPoint *x0; } x2; } *)a0 ofSubstrokes:(id)a1 maxStrokesGap:(long long)a2 begnning:(BOOL)a3;
