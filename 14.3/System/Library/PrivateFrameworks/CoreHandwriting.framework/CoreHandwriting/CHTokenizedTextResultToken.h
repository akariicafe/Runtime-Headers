...
+ (id)tokenWithString:(id)a0 strokeIndexes:(id)a1 wordID:(unsigned int)a2 recognitionScore:(double)a3 combinedScore:(double)a4 alignmentScore:(double)a5 properties:(unsigned long long)a6 substrokeCount:(long long)a7;
...
- (id)initWithString:(id)a0 strokeIndexes:(id)a1 wordID:(unsigned int)a2 recognitionScore:(double)a3 combinedScore:(double)a4 alignmentScore:(double)a5 properties:(unsigned long long)a6 substrokeCount:(long long)a7;
