...
- (BOOL)updateLegacyTransferGUIDIfNeeded:(id)a0;
...
- (BOOL)_fileEligibleForCacheDelete:(id)a0;
- (BOOL)_cloudkitSyncingEnabled;
- (void)markAttachment:(id)a0 purgeable:(BOOL)a1;
- (void)markFile:(id)a0 asPurgeable:(BOOL)a1;
- (id)getAuxVideoPath:(id)a0;
- (BOOL)_updateLegacyTransferGUIDOnMessageIfNeeded:(id)a0 andUpdateTransfer:(id)a1;
