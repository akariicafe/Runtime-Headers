...
- (void)_writeDirtyMessagesToCloudKitWithCompletion:(id /* block */)a0;
- (id)_syncOperationGroupName;
- (void)_processRecordWriteCompletionForRecord:(id)a0 NSError:(id)a1;
- (void)_processModifyRecordsCompletion:(id)a0 deletedRecordIDs:(id)a1 operationError:(id)a2 isLastBatchOfWrite:(BOOL)a3 writeCompletionBlock:(id /* block */)a4;
...
- (BOOL)_isCoreDuetSyncForMaxBatchCount:(long long)a0;
- (BOOL)_shouldDeferCoreDuetMessagesSync;
- (long long)_numberOfBatchesOfMessagesToFetchInInitialSync;
- (id)_changeTokenKey;
- (void)_fetchArchivedRecordsIfNeeded:(BOOL)a0 currentBatchCount:(long long)a1 maxNumberOfBatches:(long long)a2 WithCompletionBlock:(id /* block */)a3;
- (void)_resetArvchivedRecordSyncToken;
- (void)_processRecordChange:(id)a0;
- (void)_processArchivedRecordsFetchCompletionZoneID:(id)a0 serverChangeToken:(id)a1 moreComing:(BOOL)a2 currentBatchCount:(long long)a3 maxNumberOfBatches:(long long)a4 NSError:(id)a5 completionBlock:(id /* block */)a6;
- (void)_processFetchArchivedRecordCompletionWithError:(id)a0 WithCompletionBlock:(id /* block */)a1;
- (void)_fetchMessageZoneChangesSyncType:(long long)a0 currentBatchCount:(long long)a1 maxNumberOfBatches:(long long)a2 completionBlock:(id /* block */)a3;
...
- (void)_processRecordZoneFetchCompletionZoneID:(id)a0 serverChangeToken:(id)a1 clientChangeTokenData:(id)a2 moreComing:(BOOL)a3 NSError:(id)a4 syncType:(long long)a5 currentBatchCount:(long long)a6 maxNumberOfBatches:(long long)a7 shouldFetchArchivedRecords:(BOOL)a8 completionBlock:(id /* block */)a9;
