...
- (BOOL)_updateDisplayMessageWithUnreadWrappedMessages:(id)a0 threadExpression:(id)a1;
...
- (id)threadObjectIDBeforeThreadObjectID:(id)a0 forSortDescriptors:(id)a1 excluding:(id)a2;
...
- (void)_updateAllThreadsAfterDeleteInThreadScope:(id)a0 withDatabaseID:(id)a1 generationWindow:(id)a2;
...
- (BOOL)_canResetThreadScope:(id)a0;
...
- (void)_deleteAllMessagesInThreadScope:(id)a0 withDatabaseID:(id)a1 generationWindow:(id)a2;
