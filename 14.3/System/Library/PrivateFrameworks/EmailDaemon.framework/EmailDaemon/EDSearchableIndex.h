@class EFStoppableScheduler, NSString, CSSearchableIndex, EFCancelationToken, _EMSearchableIndexPendingRemovals, EFLazyCache, NSObject, EFFuture, NSMutableSet, NSMutableArray, EFObservable;
...
- (id)bundleIdentifierForSearchableIndexVerifier:(id)a0;
...
- (void)indexAttachmentsForMessageWithIdentifier:(id)a0;
