...
@interface AUPasscodeEncoder : AUAudioUnit {
    struct unique_ptr<APCEncoderBase, std::__1::default_delete<APCEncoderBase> > { struct __compressed_pair<APCEncoderBase *, std::__1::default_delete<APCEncoderBase> > { struct APCEncoderBase *__value_; } __ptr_; } _kernel;
    ...
    struct unique_ptr<EOFReachedMessage, std::__1::default_delete<EOFReachedMessage> > { struct __compressed_pair<EOFReachedMessage *, std::__1::default_delete<EOFReachedMessage> > { struct EOFReachedMessage *__value_; } __ptr_; } _eofMessage;
