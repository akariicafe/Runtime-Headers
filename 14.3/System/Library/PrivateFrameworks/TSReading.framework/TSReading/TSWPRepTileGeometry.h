...
@interface TSWPRepTileGeometry : NSObject <TSDTileGeometryProviding> {
    struct vector<TSWPRepBoundsAnalyzer::Info, std::__1::allocator<TSWPRepBoundsAnalyzer::Info> > { struct Info *__begin_; struct Info *__end_; struct __compressed_pair<TSWPRepBoundsAnalyzer::Info *, std::__1::allocator<TSWPRepBoundsAnalyzer::Info> > { struct Info *__value_; } __end_cap_; } _infos;
}
