...
- (void)p_finishMetalRenderInContext:(struct CGContext { } *)a0 orDirectly:(id)a1 pathVertexData:(struct vector<TSDBrushVertexData, std::__1::allocator<TSDBrushVertexData> > { struct *x0; struct *x1; struct __compressed_pair<TSDBrushVertexData *, std::__1::allocator<TSDBrushVertexData> > { struct *x0; } x2; } *)a2 parameterized:(BOOL)a3 shouldReverseDrawOrder:(BOOL)a4 withLayoutOptions:(id)a5;
