...
+ (void)setupTokensInEDFormulaFromXlFormulaProcessor:(struct XlFormulaProcessor { void /* function */ **x0; struct XlFormulaParser *x1; struct XlBaseFormulaTable *x2; struct ChVector<CsString *> { struct CsString **x0; struct CsString **x1; struct __compressed_pair<CsString **, ChAllocator<CsString *> > { struct CsString **x0; } x2; } x3; struct XlNameTable *x4; struct ChVector<OcText> *x5; struct XlLinkTable *x6; unsigned int x7; unsigned int x8; char x9[64]; unsigned short *x10; char *x11; BOOL x12; unsigned int x13; unsigned short x14; unsigned short x15; } *)a0 length:(int)a1 edFormula:(id)a2 edSheet:(id)a3;
