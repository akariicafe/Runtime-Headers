@class TVPProgressiveJumpingScrubber, AVQueuePlayer, TVPPlayerReporter, TVPTimeRange, NSMutableArray, NSString, NSMutableSet, TVPChapter, TVPMediaItemLoader, TVPInterstitial, TVPPlayerItem, TVPExternalImagePlayer, NSMutableDictionary, TVPPlaylist, NSArray, TVPInterstitialCollection, NSTimer, AVPlayer, TVPPlayerBookmarkMonitor, NSObject, TVPChapterCollection, TVPDateRange, AVPlayerItem, TVPAudioOption, TVPSubtitleOption, TVPStateMachine, NSDate, TVPPlaybackState, NSNumber, NSHashTable;
...
@property (retain, nonatomic) NSTimer *HDCPUnprotectedTooLongTimer;
@property (retain, nonatomic) NSTimer *HDCPStatusPollTimer;
...
+ (long long)_audioFormatForAudioCodecType:(unsigned int)a0;
...
- (void)_timeControlStatusDidChangeTo:(long long)a0;
- (void)_outputObscuredDidChangeTo:(BOOL)a0 dueToKVONotification:(BOOL)a1;
...
- (id)tvp_PlaybackErrorFromError:(id)a0 forMediaItem:(id)a1;
...
- (void)_HDCPUnprotectedTooLongTimerFired:(id)a0;
...
- (void)_HDCPStatusPollTimerFired:(id)a0;
