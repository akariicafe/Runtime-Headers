...
@property (readonly, weak, nonatomic) id<WLMigrationDataCoordinatorDelegate> delegate;
@property (nonatomic) BOOL stashDataLocally;
@property (readonly, nonatomic) NSString *downloadsPath;
@property (readonly, nonatomic) NSString *safeHarborsPath;
...
- (id)databasePathForSQLController:(id)a0;
...
- (void)updateSource:(id)a0 withProgress:(double)a1 completion:(id /* block */)a2;
