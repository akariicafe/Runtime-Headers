...
- (void)clearCacheForInputString:(id)a0 keyboardInput:(id)a1 selectedDisambiguationCandidateIndex:(unsigned long long)a2;
- (id)transLiterateReading:(id)a0 withName:(id)a1;
