...
- (struct __CVBuffer { } *)newPixelBufferRenderedFromARFrame:(id)a0 withEffect:(id)a1 depthData:(id)a2 captureOrientation:(long long)a3 interfaceOrientation:(long long)a4 preRecordedBlendShapes:(id)a5;
...
- (void)renderAnimoji:(id)a0 withPresentationTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 depthData:(id)a2 completionBlock:(id /* block */)a3;
...
- (void)renderFrame:(id)a0 withEffect:(id)a1 depthData:(id)a2 captureOrientation:(long long)a3 interfaceOrientation:(long long)a4 preRecordedBlendShapes:(id)a5 completionBlock:(id /* block */)a6;
