@class JFXThreadSafeArray, CAMZoomControl, NSString, CAMControlStatusBar, JTPassThroughContainerView, CAMSnapshotView, CFXFaceReticleView, CAMZoomSlider, NSObject, UIView, CFXControlsViewController, CFXEffectComposition, NSLayoutConstraint, CFXEffectBrowserContentPresenterViewController, PUReviewScreenDoneButton, CAMElapsedTimeView, CAMTopBar, CAMViewfinderReticleView, CFXEffectEditorView, CAMFlashButton, CAMDynamicShutterControl, CFXViewfinderFlipTransition, CFXLiveCaptureViewController, JFXOrientationMonitor;
...
@property (retain, nonatomic) JTPassThroughContainerView *effectEditorContainerView;
...
@property (nonatomic) struct { long long tapBehavior; long long longPressBehavior; long long dragRightBehavior; long long dragLeftBehavior; BOOL allowsLockButton; long long ringStyle; long long stopColor; long long idleColor; } dynamicShutterSettings;
...
@property (readonly, nonatomic) long long captureInterfaceOrientationForDisplay;
