@class JFXCapturePreviewProperties, NSObject;
...
- (id)initWithPreviewProperties:(id)a0;
- (id)createPVRenderRequestUsingAnimojiRenderer:(id)a0 metadataValidator:(id)a1 additionalTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2 effectStack:(id)a3 animojiTapPoint:(BOOL)a4 requestHandler:(id *)a5;
