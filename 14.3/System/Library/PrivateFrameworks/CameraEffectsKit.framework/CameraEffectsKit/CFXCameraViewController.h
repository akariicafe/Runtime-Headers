@class UIView, NSString, JFXThreadSafeDictionary, CFXEffectBrowserViewController, CFXCameraControlsViewController, NSTimer, JFXMetadataValidator, CFXCaptureViewController, JFXRemoteCommandServer, NSObject, JFXPixelRotationSession, CFXThermalPolicyManager;
...
- (void)remoteCommandServer:(id)a0 didReceiveAddStickerCommandWithURL:(id)a1 offset:(struct CGPoint { double x0; double x1; })a2 scale:(double)a3 rotation:(double)a4;
