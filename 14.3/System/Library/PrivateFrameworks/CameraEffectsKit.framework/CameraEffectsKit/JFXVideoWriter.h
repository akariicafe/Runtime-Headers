@class NSData, AVAssetWriterInputPixelBufferAdaptor, NSURL, AVAssetWriter, AVAssetWriterInputMetadataAdaptor, NSLock, NSDictionary, WriterReorderQ, JFXDepthCompressor, NSMutableArray, AVAssetWriterInput, JFXOrientationMonitor;
...
@property (weak, nonatomic) JFXOrientationMonitor *orientationMonitor;
