@class CFXEffectEditorView, NSString, JFXOrientationMonitor, UIView, CFXEffect, JFXOverlayEffectDebugViewOptions;
...
- (id)effectEditorView:(id)a0 calculateAnimatedFaceTrackingTransformWithCurrentFaceTrackingDataFromTrackingType:(long long)a1 interpolatedWithFaceTrackingTransform:(id)a2 fromTrackingType:(long long)a3 atAnimationProgress:(float)a4;
