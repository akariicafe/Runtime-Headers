...
@interface NSRTFWriter : NSObject {
    ...
    struct { unsigned char _forceColorWrite : 1; unsigned char _activeFontFeatures : 1; unsigned char _preserveNaturalAlignment : 1; unsigned char _textScalingNeedsConvert : 1; unsigned char _wroteCocoaVersion : 1; unsigned int _reserved : 27; } _rwFlags;
    double _rightMargin;
