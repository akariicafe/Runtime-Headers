...
- (void)drawMarkedTextUnderlineAtPoint:(struct CGPoint { double x0; double x1; })a0 graphicsContext:(id)a1;
...
- (void)drawMarkedTextUnderlineAtPoint:(struct CGPoint { double x0; double x1; })a0 context:(struct CGContext { } *)a1;
- (void)dealloc;
