...
- (id)_lineItemsForPeerPaymentTransaction:(id)a0 transactionSource:(id)a1;
- (id)_lineItemsForPurchaseTransaction:(id)a0 transactionSource:(id)a1 associatedReceipt:(id)a2;
- (id)_lineItemsForWithdrawalTransaction:(id)a0 transactionSource:(id)a1;
...
- (id)_primaryFundingSourceLineItemForTransaction:(id)a0 transactionSource:(id)a1;
...
- (id)lineItemsForTransaction:(id)a0 transactionSource:(id)a1 associatedTransaction:(id)a2 associatedReceipt:(id)a3;
