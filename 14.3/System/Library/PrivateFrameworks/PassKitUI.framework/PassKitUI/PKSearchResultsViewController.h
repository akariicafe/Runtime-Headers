@class PKSearchSuggestionCollectionViewCell, PKTransactionGroupThumbnailPresenter, NSMutableDictionary, PKWorldRegionUpdater, PKTransactionSource, PKSearchService, NSObject, PKTransactionGroupItemPresenter, UILabel, NSString, PKDashboardTitleHeaderView, NSMutableOrderedSet, PKSearchQuery, PKPassLibrary, PKTransactionHistoryViewController, PKDashboardPaymentTransactionItemPresenter, NSArray, PKAccountService;
