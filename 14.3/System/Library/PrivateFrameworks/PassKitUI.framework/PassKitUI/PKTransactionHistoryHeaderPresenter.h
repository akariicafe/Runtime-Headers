@class PKPaymentService, UIVisualEffect, PKMapsSnapshotManager, NSString, UICollectionViewCell, UIImage, PKPeerPaymentContactResolver, PKObjectDownloader, UIColor;
