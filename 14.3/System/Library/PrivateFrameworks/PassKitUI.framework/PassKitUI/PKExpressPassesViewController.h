@class LAContext, NSString, PKExpressPassController, NSArray, NSMutableDictionary, NSMutableArray, PKPassSnapshotter;
...
- (id)initWithPasses:(id)a0 paymentDataProvider:(id)a1 controller:(id)a2 style:(long long)a3;
