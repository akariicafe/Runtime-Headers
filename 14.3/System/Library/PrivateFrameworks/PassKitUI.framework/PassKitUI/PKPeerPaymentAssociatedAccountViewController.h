@class PKPeerPaymentPreferencesUpdateRequest, NSString, PKPeerPaymentPreferences, PKPeerPaymentWebService, PKPeerPaymentAccount, PKTransactionSource, PKFamilyMember, PKPeerPaymentService, PKDashboardPaymentTransactionItemPresenter, PKPaymentService;
...
- (id)initWithFamilyMember:(id)a0 viewer:(id)a1 account:(id)a2;
