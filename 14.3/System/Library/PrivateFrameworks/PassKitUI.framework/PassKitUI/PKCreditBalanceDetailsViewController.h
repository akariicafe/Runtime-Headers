@class PKBalanceSummaryFetcher, PKDashboardBalanceSummaryItemPresenter, PKDashboardBalanceSummaryItem, PKTransactionSource, PKDashboardBalancePresenter, PKDashboardTransactionFetcher, PKDashboardBalanceItem, PKBalanceSummary, NSDictionary, NSDateFormatter, PKAccount, NSString, PKCreditAccountStatement, PKDashboardTitleHeaderView, NSArray, PKPaymentWebService, PKCreditAccountSummary, PKDashboardFooterTextView;
...
- (id)initWithStyle:(long long)a0 transactionSource:(id)a1 webService:(id)a2 account:(id)a3 statement:(id)a4 previousStatements:(id)a5;
- (BOOL)_shouldInset;
