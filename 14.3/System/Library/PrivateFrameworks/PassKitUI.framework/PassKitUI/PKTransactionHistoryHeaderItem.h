@class PKMerchant, NSString, CNContact, PKInstallmentPlanProduct, PKPaymentTransaction, PKPaymentTransactionGroup;
...
@property (retain, nonatomic) PKInstallmentPlanProduct *installmentProduct;
