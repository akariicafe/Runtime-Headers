@class NSURL, FCIssue, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSDate, NTPBFeedViewportHeadline, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, FCSharedStringIndex, FCFeedPersonalizedItemScoreProfile, FCTopStoriesStyleConfiguration, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, FCHeadlineThumbnail, NSString, NSSet, FCCoverArt, FCArticleAudioTrack, NSArray, NSData, FCHeadlineExperimentalTitleMetadata;
...
@property (readonly, nonatomic) NTPBFeedViewportHeadline *pbHeadline;
...
- (BOOL)isGap;
- (id)initWithPBHeadline:(id)a0 sharedStrings:(id)a1;
