@class NSURL, FCIssue, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSDate, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, FCFeedPersonalizedItemScoreProfile, FCTopStoriesStyleConfiguration, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, FCHeadlineThumbnail, NSString, NSSet, FCCoverArt, FCArticleAudioTrack, NSArray, NSData, FCHeadlineExperimentalTitleMetadata;
