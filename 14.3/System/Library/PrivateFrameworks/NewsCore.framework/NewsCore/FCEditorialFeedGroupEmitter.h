...
@property (readonly, copy, nonatomic) id<FCFeedGroupInsertionDescriptor> insertionDescriptor;
...
+ (id)editorialFeedTransformationWithContext:(id)a0;

- (id)initWithInsertionDescriptor:(id)a0;
- (id)init;
- (void).cxx_destruct;
