@class NSString, FCPrivateChannelMembershipController, FCSubscriptionList, FCPersonalizationData, FCAudioPlaylist, FCUserInfo, FCReadingList, FCReadingHistory, FCIssueReadingHistory, FCTagSettings, FCNetworkBehaviorMonitor;
