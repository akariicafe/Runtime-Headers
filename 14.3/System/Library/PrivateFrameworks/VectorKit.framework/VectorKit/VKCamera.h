...
@property (nonatomic) const struct Matrix<double, 3, 1> { double x0[3]; } *position;
@property (nonatomic) const struct Quaternion<double> { struct Matrix<double, 3, 1> { double x0[3]; } x0; double x1; } *orientation;
...
@property (readonly, nonatomic) const struct Matrix<double, 4, 4> { double x0[16]; } *scaledViewMatrix;
@property (readonly, nonatomic) const struct Matrix<double, 4, 4> { double x0[16]; } *scaledProjectionMatrix;
@property (readonly, nonatomic) const struct Matrix<double, 4, 4> { double x0[16]; } *scaledViewProjectionMatrix;
@property (readonly, nonatomic) const struct Matrix<double, 4, 4> { double x0[16]; } *unscaledViewMatrix;
@property (readonly, nonatomic) const struct Matrix<double, 4, 4> { double x0[16]; } *unscaledProjectionMatrix;
...
- (struct CGPoint { double x0; double x1; })screenPointFromGroundPoint:(const struct Mercator3<double> { double x0[3]; } *)a0;
...
- (void)setMercatorPosition:(const struct Mercator3<double> { double x0[3]; } *)a0;
- (float)zoomAtCentrePoint;
- (id)descriptionDictionaryRepresentation;
- (void)_setPosition:(const struct Matrix<double, 3, 1> { double x0[3]; } *)a0;
