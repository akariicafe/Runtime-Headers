@class NSTimeZone, NSString, NSDictionary, NSMutableDictionary, NSURL, NSSet, NSDate;
...
- (BOOL)_pathExtension:(id)a0 matchesUTIType:(struct __CFString { } *)a1 error:(id *)a2;
