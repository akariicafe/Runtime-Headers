...
+ (double)scaleFactorForThumbnailWithSize:(struct CGSize { double x0; double x1; })a0 constraints:(struct IMPreviewConstraints { double x0; struct CGSize { double x0; double x1; } x1; double x2; BOOL x3; })a1 targetPxSize:(struct CGSize { double x0; double x1; })a2 shouldScaleUpPreview:(BOOL)a3 maxUpScale:(double)a4;
