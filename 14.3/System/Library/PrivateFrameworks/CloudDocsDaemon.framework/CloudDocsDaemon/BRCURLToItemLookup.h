@class NSString, BRCRelativePath, NSURL, BRCServerItem, BRCDocumentItem, BRCPQLConnection, BRCAccountSession, BRCLocalItem;
...
- (BOOL)_shouldBounceSourceItemWithLookup:(id)a0 localItem:(id)a1 serverItem:(id)a2 bounceNamespace:(unsigned char)a3 applyNamespace:(unsigned char)a4 urlMatch:(struct { id x0; id x1; id x2; id x3; unsigned long long x4; } *)a5;
