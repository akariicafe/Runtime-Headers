...
- (void)_addTargetAppLibraryForAliasItem:(id)a0;
- (BOOL)isEqualToAppLibrary:(id)a0;
- (void)updateFromFSAtPath:(id)a0;
- (BOOL)wasMovedToCloudDocs;
- (void)_removedAliasItemForTargetAppLibrary:(id)a0;
- (id)rootItemID;
...
- (void)_addTargetAppLibrary:(id)a0;
- (void)_addTargetSharedServerZone:(id)a0;
- (BOOL)isStillTargetingAppLibrary:(id)a0;
...
- (void)_removeTargetSharedServerZoneForSharedServerZone:(id)a0;
