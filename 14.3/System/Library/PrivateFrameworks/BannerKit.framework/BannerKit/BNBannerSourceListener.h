...
- (id)_createSceneWithIdentifier:(id)a0 forProcess:(id)a1 preferredContentSize:(struct CGSize { double x0; double x1; })a2 contentOutsets:(struct UIEdgeInsets { double x0; double x1; double x2; double x3; })a3;
