...
+ (BOOL)home:(id)a0 canShowHomeTheaterOnboardingWithUsageOptions:(id)a1;
...
+ (BOOL)home:(id)a0 canShowNaturalLightingOnboardingWithUsageOptions:(id)a1;
...
+ (BOOL)home:(id)a0 canShowAnnounceOnboardingWithUsageOptions:(id)a1;
+ (BOOL)hasUserSaidYesToVoiceIdentificationInResults:(id)a0;
+ (id)_checkIdentifyVoicePrerequisitesForHome:(id)a0;
+ (BOOL)isDeviceUsingASupportedVoiceRecognitionSiriLanguage:(id)a0;
...
+ (BOOL)home:(id)a0 voiceRecognitionIsSupportedForCurrentUserOnHomePod:(id)a1;
+ (BOOL)userWhomIsNotOwnerHasCompletedHomeSwitchingOnboarding:(id)a0;
+ (BOOL)currentUserHasUnfinishedFeatureOnboardingForHome:(id)a0;
+ (BOOL)home:(id)a0 canShowIdentifyVoiceOnboardingWithUsageOptions:(id)a1;
