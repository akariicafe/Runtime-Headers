@class NSURL, HUHomeControlServiceContext, UILabel, UIVisualEffectView, UIBlurEffect, UITapGestureRecognizer, ANAnnounce, UIButton, UIView, NSLayoutConstraint, NSString, HUWaveformView, HURecordingButton, HFAudioRecorder, UIImpactFeedbackGenerator;
