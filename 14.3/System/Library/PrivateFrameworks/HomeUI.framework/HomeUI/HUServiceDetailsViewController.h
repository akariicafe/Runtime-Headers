@class HUAccessorySettingsItemModuleController, HUQuickControlSummaryNavigationBarTitleView, HMHome, HUServiceDetailsTextViewDelegate, NAFuture, HUQuickControlProxHandOffSummaryViewUpdater, HUAvailableRelatedTriggerItemModuleController, HUAssociatedSceneAndTriggerModuleController, HFNamingComponents, HUServiceDetailsItemManager, UILongPressGestureRecognizer, UIButton, NSHashTable, HUControlPanelController, HUChildServiceItemModuleController, HUNameItemModuleController, HUSoftwareUpdateItemModuleController, NSString, HUTelevisionSettingsItemModuleController, HFItem;
