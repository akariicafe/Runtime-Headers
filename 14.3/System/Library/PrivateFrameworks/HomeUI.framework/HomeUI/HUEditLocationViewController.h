@class HUHomeUsersCollectionViewController, HUEditableTextViewCell, NSString, HFHomeBuilder, HUUserNotificationTopicListModuleController, HUEditableTextCell, HUEditLocationItemManager, HUWallpaperPickerInlineViewController, UIBarButtonItem;
...
@property (readonly, nonatomic) HUHomeUsersCollectionViewController *usersViewController;
