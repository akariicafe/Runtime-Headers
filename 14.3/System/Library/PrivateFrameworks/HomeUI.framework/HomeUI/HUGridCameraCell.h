@class UILabel, UIView, NSArray, _UILegibilitySettings, NADecayingTimer, UIImageView, HUVisualEffectContainerView, HUGridCameraCellLayoutOptions, HFItem, HUCameraView, HULegibilityLabel;
