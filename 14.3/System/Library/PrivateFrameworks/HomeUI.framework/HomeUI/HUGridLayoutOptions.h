@class UIFont, HUGridScenePlaceholderLayoutOptions, HUDashboardButtonCellLayoutOptions, HUGridStatusBannerCellLayoutOptions, HUGridBannerCellLayoutOptions, HUGridSceneCellLayoutOptions, HUGridStatusCellLayoutOptions, HUGridCameraCellLayoutOptions, NSString, HUGridWelcomeUIBannerCellLayoutOptions, HUNavigationBarLayoutOptions, HUGridServiceCellLayoutOptions, NSNumber, HUGridHeadlineCellLayoutOptions, HUGridPlaceholderServiceCellLayoutOptions;
...
@property (copy, nonatomic) HUDashboardButtonCellLayoutOptions *dashboardButtonCellOptions;
