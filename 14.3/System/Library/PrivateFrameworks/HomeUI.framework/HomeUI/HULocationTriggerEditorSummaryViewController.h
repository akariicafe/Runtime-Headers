@class HULocationTriggerEditorSummaryItemManager, NSString, HUTriggerConditionEditorItemModuleController, HUPresenceUserPickerItemModuleController, HFLocationTriggerBuilder;
