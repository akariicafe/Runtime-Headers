...
@property (readonly, nonatomic) NSSet *blacklistedConditionTypes;

- (void).cxx_destruct;
- (id)buildSectionsWithDisplayedItems:(id)a0;
- (void)_buildItemProviders;
- (id)initWithItemUpdater:(id)a0 home:(id)a1 conditionCollection:(id)a2 blacklistedConditionTypes:(id)a3;
