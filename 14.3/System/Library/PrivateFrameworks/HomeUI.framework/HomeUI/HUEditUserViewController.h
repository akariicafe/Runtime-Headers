@class NSString, HUPendingAccessoriesGridViewController, HUEditUserItemManager, HUAccessorySettingsItemModuleController, HUMediaServiceSettingsItemModuleController, HUAboutResidentDeviceFooterView, HFUserItem;
