...
- (id)_newAltimeter;
- (id)startAltimeterUpdateWithUpdateRateAndHandler:(double)a0 handler:(id /* block */)a1;
- (void)_updateAltimeterRunning:(double)a0;
...
- (BOOL)_shouldChangeAltimeterUpdateRate:(double)a0;
