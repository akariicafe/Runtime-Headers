@class NSString, DupDownscaleHalfConvert, StereoDisparityEstimator, NSDictionary, FigDisparityMetadata, GDCProcessor, FigMetalContext, RegToolboxGPU, DisparityDiagnostics, DisparityTuningParameters;
