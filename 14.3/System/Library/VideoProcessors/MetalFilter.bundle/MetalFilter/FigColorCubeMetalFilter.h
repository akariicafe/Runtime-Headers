...
@property (nonatomic) struct { int x0; int x1; BOOL x2; int x3; } *filterDescriptor;
...
- (int)runWithInputPixelBuffer:(struct __CVBuffer { } *)a0 mattePixelBuffer:(struct __CVBuffer { } *)a1 outputPixelBuffer:(struct __CVBuffer { } *)a2;
- (id)createPipelineStateWithVertexFunction:(id)a0 fragmentName:(id)a1 isLuma:(BOOL)a2 useBgCube:(BOOL)a3 manyFgCubes:(BOOL)a4 colorSpace:(int)a5;
