...
- (void)setTimer:(id)a0 history:(id)a1 error:(id *)a2;
- (id)getHistory:(id)a0 error:(id *)a1;
...
- (void)parseTransit:(id)a0 file1E:(id)a1 file1A:(id)a2 ctx:(id)a3 into:(id)a4;
...
- (void)parseTransitGalileo:(id)a0 file1E:(id)a1 file1A:(id)a2 into:(id)a3;
