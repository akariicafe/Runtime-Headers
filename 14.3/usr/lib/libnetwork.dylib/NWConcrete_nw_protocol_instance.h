@class NSString, NWConcrete_nw_protocol_options, NWConcrete_nw_protocol_definition, NSObject;
@protocol OS_nw_path, OS_nw_context, OS_nw_parameters, OS_nw_endpoint, OS_nw_path_flow_registration, OS_nw_array;
