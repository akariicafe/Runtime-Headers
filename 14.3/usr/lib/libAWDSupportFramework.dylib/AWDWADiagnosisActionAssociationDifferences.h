@interface AWDWADiagnosisActionAssociationDifferences : PBCodable <NSCopying> {
    struct { unsigned char timestamp : 1; unsigned char changedChannel : 1; unsigned char changedDNSPrimary : 1; unsigned char changedDNSSecondary : 1; unsigned char changedMAC : 1; unsigned char newBSSID : 1; } _has;
}
