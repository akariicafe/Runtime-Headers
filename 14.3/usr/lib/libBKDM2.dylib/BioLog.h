...
- (void)logTemplateList:(id)a0 withTemplateSize:(unsigned long long)a1 sequenceNumber:(unsigned short)a2 date:(id)a3 toPath:(id)a4;
...
- (void)logTemplate:(id)a0 withSequenceNumber:(unsigned short)a1 date:(id)a2 index:(unsigned char)a3 toPath:(id)a4;
- (void)logTemplateList:(id)a0 withContext:(struct { unsigned long long x0; unsigned long long x1; struct { unsigned long long x0; unsigned short x1; unsigned char x2; } x2; } *)a1;
...
- (void)logRemoveIdentity:(id)a0 withTemplateListData:(id)a1 templateSize:(unsigned long long)a2 client:(id)a3;
