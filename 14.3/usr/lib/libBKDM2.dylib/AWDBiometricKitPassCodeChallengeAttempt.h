@interface AWDBiometricKitPassCodeChallengeAttempt : PBCodable <NSCopying> {
    struct { unsigned char overallTime : 1; unsigned char timestamp : 1; unsigned char ambientLux : 1; unsigned char attentionScore : 1; unsigned char deviceOrientation : 1; unsigned char faceDistance : 1; unsigned char matchIdentityCount : 1; unsigned char ppmAllocatedBudget : 1; unsigned char ppmRequestedBudget : 1; unsigned char sensorTemperature : 1; unsigned char hasOcclusion : 1; unsigned char passcodeChallengeResult : 1; unsigned char passcodeChallengeTemplateUpdated : 1; } _has;
}
