...
- (id)init;
- (id)initWithHeartbeatIntervalResolution:(double)a0 maxHeartbeatInterval:(double)a1 dispatchTimerLeeway:(double)a2 requiredHorizontalAccuracy:(double)a3 activeDuration:(double)a4 minMetricSubmissionAge:(double)a5 maxHorizontalAccuracyForCoarseLocation:(double)a6;
