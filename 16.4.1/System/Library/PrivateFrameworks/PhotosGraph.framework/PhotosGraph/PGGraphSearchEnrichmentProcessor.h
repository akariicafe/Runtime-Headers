...
- (void)_processGraphUpdateInventory:(id)a0 onGraph:(id)a1 photoLibrary:(id)a2 curationManager:(id)a3 curationContext:(id)a4 searchComputationCache:(id)a5 progressBlock:(id /* block */)a6 completionBlock:(id /* block */)a7;
