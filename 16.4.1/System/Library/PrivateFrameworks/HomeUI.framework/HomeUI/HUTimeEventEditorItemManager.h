@class NSSet, NSMutableDictionary, HUInstructionsItem, HFEventTriggerBuilder, NSDateComponents, HFStaticItem, HFEventBuilder;
...
- (id)initWithTimeEvent:(id)a0 triggerBuilder:(id)a1 delegate:(id)a2;
