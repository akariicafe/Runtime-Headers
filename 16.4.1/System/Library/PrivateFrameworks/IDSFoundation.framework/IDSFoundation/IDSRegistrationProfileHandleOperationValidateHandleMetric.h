...
- (void).cxx_destruct;
- (id)initWithGuid:(id)a0 success:(BOOL)a1 connectionType:(unsigned int)a2 resultCode:(unsigned int)a3 registrationError:(unsigned int)a4 vettingStatus:(unsigned int)a5 genericError:(id)a6 URLError:(id)a7 POSIXError:(id)a8;
