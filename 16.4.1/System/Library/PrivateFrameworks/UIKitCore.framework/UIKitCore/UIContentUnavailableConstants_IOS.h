...
- (id)defaultEmptyExtraProminentImageSymbolConfigurationForTraitCollection:(id)a0;
- (id)defaultEmptyExtraProminentImageTintColor;
- (double)defaultEmptyExtraProminentImageToTextPadding;
- (id)defaultEmptyExtraProminentSecondaryTextFontForTraitCollection:(id)a0;
- (id)defaultEmptyExtraProminentTextColor;
- (id)defaultEmptyExtraProminentTextFontForTraitCollection:(id)a0;
...
- (id)defaultEmptyProminentImageSymbolConfigurationForTraitCollection:(id)a0;
- (id)defaultEmptyProminentImageTintColor;
- (double)defaultEmptyProminentImageToTextPadding;
- (id)defaultEmptyProminentSecondaryTextFontForTraitCollection:(id)a0;
- (id)defaultEmptyProminentTextColor;
- (id)defaultEmptyProminentTextFontForTraitCollection:(id)a0;
...
- (double)defaultMaximumWidthForTraitCollection:(id)a0;
