@class NSSet, NSString, CEMAssetBaseDescriptor, CEMAssetBaseReference;
...
+ (id)buildRequiredOnlyWithIdentifier:(id)a0 withDescriptor:(id)a1 withReference:(id)a2;
+ (id)buildWithIdentifier:(id)a0 withDescriptor:(id)a1 withReference:(id)a2 withKind:(id)a3 withVersion:(id)a4 withAuthor:(id)a5 withTitle:(id)a6;
