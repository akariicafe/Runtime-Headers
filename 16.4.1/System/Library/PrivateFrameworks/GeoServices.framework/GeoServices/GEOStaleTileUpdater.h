@class GEOTileDB, GEOTileKeyList, GEOResourceManifestManager;
...
- (void).cxx_destruct;
- (void)_addMoreKeysToListIfNeeded:(id)a0 staleCachedETags:(id)a1 staleCachedData:(id)a2 completionHandler:(id /* block */)a3;
...
- (id)initWithDiskCache:(id)a0 manifestManager:(id)a1 tileRequesterCreationBlock:(id /* block */)a2;
