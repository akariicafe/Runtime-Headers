@interface AGXA11FamilyIndirectArgumentBufferLayout : _MTLIndirectArgumentBufferLayout {
    struct unique_ptr<AGX::G10::IndirectArgumentLayout, std::default_delete<AGX::G10::IndirectArgumentLayout>> { struct __compressed_pair<AGX::G10::IndirectArgumentLayout *, std::default_delete<AGX::G10::IndirectArgumentLayout>> { struct IndirectArgumentLayout *__value_; } __ptr_; } _impl;
}
