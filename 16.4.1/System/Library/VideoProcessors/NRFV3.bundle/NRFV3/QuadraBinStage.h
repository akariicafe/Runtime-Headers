@class QuadraBinShaders, FigMetalContext, NSString, SoftISPStaticParameters;
@protocol MTLBuffer, SoftISPStage;
...
- (id)initWithDownstreamStage:(id)a0 metalContext:(id)a1 staticParameters:(id)a2;
