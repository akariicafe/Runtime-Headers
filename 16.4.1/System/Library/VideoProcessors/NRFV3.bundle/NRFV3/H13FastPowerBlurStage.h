@class H13FastPowerBlurStageMetal, NSString, FigMetalContext, H13FastPowerBlurShaders, SoftISPStaticParameters;

@interface H13FastPowerBlurStage : NSObject <SoftISPStage> {
    H13FastPowerBlurStageMetal *_stageMetal;
    H13FastPowerBlurShaders *_shaders;
}
