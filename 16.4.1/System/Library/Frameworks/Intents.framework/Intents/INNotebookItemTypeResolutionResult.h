...
+ (id)confirmationRequiredWithNotebookItemTypeToConfirm:(long long)a0;
+ (id)disambiguationWithNotebookItemTypesToDisambiguate:(id)a0;
+ (id)successWithResolvedNotebookItemType:(long long)a0;
